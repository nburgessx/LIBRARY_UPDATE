				...
				const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		std::vector<double> DFs = validation_api::tryMirGetDF1(g_root, terms, curveID, dayCount, interpolation, IsBasisFlag, curveName);
		ret = DFs[0];
	} 
	catch (MEError& mesx) 
	{
								...
								const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		ret = validation_api::tryMirGetDF1(g_root, Terms, curveID, dayCount, interpolation, IsBasisFlag, curveName);
	} 
	catch (MEError& mesx) 
	{
		throw std::exception(mesx.getMsg());
				...
				const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		std::vector<double> DFs = validation_api::tryMirGetDF2(g_root, terms, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
		ret = DFs[0];
	} 
	catch (MEError& mesx) 
	{
							...
							const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		ret = validation_api::tryMirGetDF2(g_root, terms, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
	} 
	catch (MEError& mesx) 
	{
		throw std::exception(mesx.getMsg());
				...
				const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		std::vector<double> DFs = validation_api::tryMirGetDF3(g_root, fromDates, toDates, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
		ret = DFs[0];
	} 
	catch (MEError& mesx) 
	{
				...
				const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		ret = validation_api::tryMirGetDF3(g_root, fromDates, toDates, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
	} 
	catch (MEError& mesx) 
	{
		throw std::exception(mesx.getMsg());
							...
							const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		std::vector<double> DFs = validation_api::tryMirGetDF4(g_root, fromDates, terms, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
		ret = DFs[0];
	} 
	catch (MEError& mesx) 
	{
							...
							const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		ret = validation_api::tryMirGetDF4(g_root, fromDates, Terms, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
	} 
	catch (MEError& mesx) 
	{
		throw std::exception(mesx.getMsg());
					...
					const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		std::vector<double> DFs = validation_api::tryMirGetDF5(g_root, fromDates, term, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
		ret = DFs[0];
	} 
	catch (MEError& mesx) 
	{
					...
					const std::string& CurveName) throw(std::exception)
{
	...
	try 
	{
		...
		ret = validation_api::tryMirGetDF5(g_root, fromDates, term, curveID, dayCount, slidingRule, calendar, interpolation, IsBasisFlag, curveName);
	} 
	catch (MEError& mesx) 
	{
		throw std::exception(mesx.getMsg());
