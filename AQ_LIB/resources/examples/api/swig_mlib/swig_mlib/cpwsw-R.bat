...
copy /y %MLIB%\api\swig_mlib\Release\swig_mlib.dll %MLIB%\api\client_apps\swig_mlib_java_main
...
copy /y %MLIB%\api\swig_mlib\Release\swig_mlib.dll %MLIB%\api\client_apps\swig_mlib_java_swing
copy /y %MLIB%\api\swig_mlib\Release\swig_mlib.dll %MLIB%\api\client_apps\swig_mlib_java_swing\dist
