...
set PYTHON3_DLL_RELEASE_64_SOURCE="%MLIBQ%\target2017\64\ReleasePython3\MLIB_CLIENT_API\out\DLL"
set PYTHON3_GENERATEDFILES_64_SOURCE="%MLIBQ%\target2017\64\ReleasePython3\MLIB_CLIENT_API\out\GeneratedFiles"
...
set PYTHON3_FOLDER_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\Python3"
set PYTHON3_DLL_FOLDER_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\Python3\DLL"
set PYTHON3_DLL_RELEASE_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\Python3\DLL\Release"
set PYTHON3_GENERATEDFILES_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\Python3\GeneratedFiles"

REM R Folder Settings
set R_DLL_RELEASE_32_SOURCE="%MLIBQ%\target2017\32\ReleaseR\MLIB_CLIENT_API\out\DLL"
set R_DLL_RELEASE_64_SOURCE="%MLIBQ%\target2017\64\ReleaseR\MLIB_CLIENT_API\out\DLL"
set R_GENERATEDFILES_32_SOURCE="%MLIBQ%\target2017\32\ReleaseR\MLIB_CLIENT_API\out\GeneratedFiles"
set R_GENERATEDFILES_64_SOURCE="%MLIBQ%\target2017\64\ReleaseR\MLIB_CLIENT_API\out\GeneratedFiles"

set R_FOLDER_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\R"
set R_DLL_FOLDER_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\R\DLL"
set R_DLL_DEBUG_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\R\DLL\Debug"
set R_DLL_RELEASE_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\R\DLL\Release"
set R_GENERATEDFILES_COPY="%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\DeployAPI\R\GeneratedFiles"
...
REM set SOURCE="%MLIBQ%\target2017\32\Release\MLIBQ_ADDIN\out\MLIBQ_ADDIN.xll"
Set VERSION="%DATESTAMP%"
REM Set CONFIG="%MLIBQ%\resource\config"


REM === ***************************************** ===
REM === ***** 1. DEPLOY THE 32 BIT BINARIES ***** ===
REM === ***************************************** ===
...
REM === ***************************************** ===
REM === ***** 2. DEPLOY THE 64 BIT BINARIES ***** ===
REM === ***************************************** ===
...
xcopy /s /y "%EXCEL_RELEASE_64_SOURCE%" "%EXCEL_RELEASE_COPY%"
xcopy /s /y "%CONFIG%" "%EXCEL_RELEASE_COPY%\config\"
...
REM xcopy /s /y "%CSHARP_DLL_DEBUG_SOURCE%" "%CSHARP_DLL_DEBUG_COPY%"
xcopy /s /y "%CSHARP_DLL_RELEASE_64_SOURCE%" "%CSHARP_DLL_RELEASE_COPY%"
xcopy /s /y "%CSHARP_GENERATEDFILES_64_SOURCE%" "%CSHARP_GENERATEDFILES_COPY%"
...
REM xcopy /s /y "%JAVA_DLL_DEBUG_SOURCE%" "%JAVA_DLL_DEBUG_COPY%"
xcopy /s /y "%JAVA_DLL_RELEASE_64_SOURCE%" "%JAVA_DLL_RELEASE_COPY%"
xcopy /s /y "%JAVA_GENERATEDFILES_64_SOURCE%" "%JAVA_GENERATEDFILES_COPY%"
...
REM xcopy /s /y "%PYTHON_DLL_DEBUG_SOURCE%" "%PYTHON_DLL_DEBUG_COPY%"
xcopy /s /y "%PYTHON_DLL_RELEASE_64_SOURCE%" "%PYTHON_DLL_RELEASE_COPY%"
xcopy /s /y "%PYTHON_GENERATEDFILES_64_SOURCE%" "%PYTHON_GENERATEDFILES_COPY%"

TITLE *** CREATE PYTHON3 API PACKAGE ***
REM ============================================================================================


REM Copy Source Files to the Local Copy of the Deployment Folder
REM Note We Clear the Copy Folder First, Suppressing Any Command Output Using ">nul 2>&1"
RD /S /Q "%PYTHON3_FOLDER_COPY%" >nul 2>&1

MD "%PYTHON3_FOLDER_COPY%"
MD "%PYTHON3_DLL_FOLDER_COPY%"
MD "%PYTHON3_DLL_RELEASE_COPY%"
MD "%PYTHON3_GENERATEDFILES_COPY%"

xcopy /s /y "%PYTHON3_DLL_RELEASE_64_SOURCE%" "%PYTHON3_DLL_RELEASE_COPY%"
xcopy /s /y "%PYTHON3_GENERATEDFILES_64_SOURCE%" "%PYTHON3_GENERATEDFILES_COPY%"
...
REM xcopy /s /y "%R_DLL_DEBUG_SOURCE%" "%R_DLL_DEBUG_COPY%"
xcopy /s /y "%R_DLL_RELEASE_64_SOURCE%" "%R_DLL_RELEASE_COPY%"
xcopy /s /y "%R_GENERATEDFILES_64_SOURCE%" "%R_GENERATEDFILES_COPY%"


REM *** DEPLOY API BINARIES ***
REM ============================================================================================

set NEW_FOLDER_PATH_WIN64=%NEW_FOLDER_PATH%\Win64
MD "%NEW_FOLDER_PATH_WIN64%\Excel"
MD "%NEW_FOLDER_PATH_WIN64%\CSharp"
MD "%NEW_FOLDER_PATH_WIN64%\Java"
MD "%NEW_FOLDER_PATH_WIN64%\Python"
MD "%NEW_FOLDER_PATH_WIN64%\Python3"
MD "%NEW_FOLDER_PATH_WIN64%\R"

xcopy /s /y "%EXCEL_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\Excel"
xcopy /s /y "%CSHARP_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\Csharp"
xcopy /s /y "%JAVA_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\Java"
xcopy /s /y "%PYTHON_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\Python"
xcopy /s /y "%PYTHON3_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\Python3"
xcopy /s /y "%R_FOLDER_COPY%" "%NEW_FOLDER_PATH_WIN64%\R"

REM *** DEPLOY LINUX API BINARIES ***
set NEW_FOLDER_PATH_LINUX64=%NEW_FOLDER_PATH%\Linux64
MD "%NEW_FOLDER_PATH_LINUX64%"

REM Package up the build artifacts on the remote Linux server

"C:\Program Files\Putty\plink.exe" -pw e4jPLezoetDi svc_quant_dev@adl-quant01 /home2/svc_quant_dev/scripts/svc_quant_dev_package_deploy_zip.sh

REM Copy the Linux_64.zip file from remote Linux server to deployment folder

pscp -pw e4jPLezoetDi svc_quant_dev@adl-quant01:/workspace/svc_quant_dev/MLIBQ/src/lib/Linux_64.zip "%NEW_FOLDER_PATH_LINUX64%"
