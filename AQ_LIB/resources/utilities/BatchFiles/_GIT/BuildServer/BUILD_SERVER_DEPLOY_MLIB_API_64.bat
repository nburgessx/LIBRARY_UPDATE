...
set EXCEL_FOLDER_COPY="%MLIBQ%\resource\utilities\BatchFiles\DeployAPI\Excel"
set EXCEL_DEBUG_COPY="%MLIBQ%\resource\utilities\BatchFiles\DeployAPI\Excel\Debug"
