...
TITLE MLIBQ -- DEPLOY EXCEL ADDIN -- TOKYO
...
set PRODUCTION="%DEPLOYMENT_FOLDER_TOKYO_MLIBQ_PRODUCTION%\%VERSION%"
set UAT="%DEPLOYMENT_FOLDER_TOKYO_MLIBQ_UAT%\%VERSION%"
...
REM REM Create a folder with today's date and version then copy the Excel Add-In and Config Files to that path
REM call %~dp0\UpdateFolderVersion.bat "%PRODUCTION%"
