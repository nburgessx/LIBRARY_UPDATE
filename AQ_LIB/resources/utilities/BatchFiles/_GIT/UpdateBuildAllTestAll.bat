...
TITLE MLIBQ GIT PULL, BUILD ALL, TEST ALL
REM ===============================================
...
REM CHECK MLIBQ ENVIRONMENT VARIABLE HAS BEEN SET
IF %MLIBQ%=="" (
ECHO .
...
CALL "%MLIBQ%\resource\utilities\BatchFiles\_GIT\BuildServer\BUILD_SERVER_INCREDIBUILD_ALL.bat"
set build_end=%time%
