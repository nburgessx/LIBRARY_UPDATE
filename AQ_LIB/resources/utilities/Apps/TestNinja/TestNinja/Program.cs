    ...
    static class Program
    {
        ...
        static int Main( string[] args )
        {
            ...
            else
            {
                ...
                // 2 https://stackoverflow.com/questions/7198639/c-sharp-application-both-gui-and-commandline/7198945#7198945   <--- This seems not bad, but the console runs concurrently. So no way to know when Ninja terminates
                ...
                Console.Out.WriteLine("TestNinja is running in command line mode! ");
                ...
                if (args.Length % 2 > 0)
                {
                    ...
                    Console.Out.WriteLine("Exanple usage: TestNinja.exe --visualStudio 2015 --arch win32 --build release --threads 8 --workspace \"%MLIBQ%\" --filter \"*.UNIT_*\" --logFolder \"C:\\temp\"");
                    Environment.Exit(1);
                }

                string visualStudio = "2015";
                string arch = "Win32";
                ...
                for (int i = 0; i < numArgs; i+=2)
                {
                    ...
                    else
                    {
                        ...
                        Console.Out.WriteLine("Exanple usage: TestNinja.exe --visualStudio 2015 --arch win32 --build release --threads 8 --workspace \"%MLIBQ%\" --logFolder \"C:\\temp\" --filter testfilter");
                        Environment.Exit(1);
                    }
                }
                ...
                if (workspace == "")
                {
                    Console.Out.WriteLine("#Error: Please specify a valid workspace. For example: --workspace \"%MLIBQ%\"");
                    Environment.Exit(1);
                }
                ...
                Console.Out.WriteLine("TestNinja completed at: " + localDate.ToString(culture), localDate.Kind);
                return numFailures;
            }
        }
    }
