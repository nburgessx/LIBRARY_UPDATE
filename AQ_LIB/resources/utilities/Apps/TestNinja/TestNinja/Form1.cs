...
/* @brief TestNinja, a tool for Quants which allows the library tests to run graphically in parallel
...
namespace TestNinja
{
    ...
    {
        private string testVisualStudio_;   // Which Visual Studio was used to build Google_test? 2017 or 2015
        ...
        public Form1()
        {
            ...
            comboBox1.SelectedItem = Properties.Settings.Default.Architecture;
            comboBox2.SelectedItem = Properties.Settings.Default.BuildType;
            comboBox3.SelectedItem = Properties.Settings.Default.VisualStudio;
        ...
        {
            Properties.Settings.Default.Architecture = comboBox1.Text;
            Properties.Settings.Default.BuildType = comboBox2.Text;
            Properties.Settings.Default.VisualStudio = comboBox3.Text;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox6.Text == "")
            {
                textBox6.Text = "%MLIBQ%\\Resource\\utilities\\BatchFiles\\GoogleTestErrorLogs";
            }
            ...
            if (rowsToProcess.Count > 0)
            {
                bool permissionToGoAhead =
                       MessageBox.Show("WARNING: This will rebase "
                                + rowsToProcess.Count
                                + " Test(s)! Have you done proper due diligence to explain the numerical differences? "
