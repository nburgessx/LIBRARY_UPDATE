...
namespace validation
{
    ...
    */
    std::string tryAqFuturesTickerCurrent( const AQLDate & valuationDate, const bool includeToday = false, const bool showYearWithTwoDigits = false );
    ...
    */
    std::string tryAqFuturesTickerNext( const AQLDate & referenceDate, const bool showYearWithTwoDigits = false );
    ...
    */
    std::string tryAqFuturesTickerPrevious( const AQLDate & referenceDate, const bool showYearWithTwoDigits = false );
    ...
    */
    std::string tryAqFuturesTickerNth( const AQLDate & valuationDate, const int nthIMM, const bool includeToday = false, const bool showYearWithTwoDigits = false );
}