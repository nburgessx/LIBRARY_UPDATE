...
namespace validation
{
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveObjectBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveObjectBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
