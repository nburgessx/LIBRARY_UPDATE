...
namespace validation
{
	...
	*  @return			swapName
	*/
	std::string tryAqSwapObjectCreateFromLegs(const std::string& swapName, const std::vector<std::string>& legObjectNames, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys=true);
	...
	*  @return			swapName
	*/
	std::string tryAqSwapObjectCreateFromLegLVBs(const std::string& swapName, const LabelValueBlock& leg1LVB, const LabelValueBlock& leg2LVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys=true);
	...
	*  @return			swapName
	*/
	std::string tryAqSwapObjectCreate(const std::string& swapName, const AQLStringMatrix& swapLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys=true);
	...
	*  @return			swapName
	*/
	std::string tryAqSwapObjectCreateFromSchedule(const std::string& swapName, const std::string& schedule1Name, const std::string& schedule2Name, const LabelValueBlock& leg1LVB, const LabelValueBlock& leg2LVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys=true);
	...
	*/
	std::string tryAqSwapGeneratorCreate(const std::string& swapGeneratorName, const AQLStringMatrix& swapGeneratorLVB, bool validateKeys=true);
	...
	*  @return			swapName
	*/
	std::string tryAqSwapObjectCreateFromGenerator(const std::string& swapName, const std::string& swapGeneratorName, const LabelValueBlock& expressionLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys=true);
