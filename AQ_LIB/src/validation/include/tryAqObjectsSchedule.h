...
namespace validation
{
	...
	*/
	std::string tryAqObjectsScheduleCreate(const std::string& scheduleName, const LabelValueBlock& swapScheduleLVB, bool validateKeys = true);
    ...
    */
    AnyTypeMatrix tryAqObjectsScheduleDisplay( const std::string& scheduleName, bool showBespokeProperties=false, bool showColumnHeaders=true,
    ...
    */
	std::string tryAqObjectsScheduleCreateBespoke(const std::string& scheduleName, const LabelValueBlock& bespokeScheduleProperties, const AQLStringMatrix& bespokeScheduleLVB, bool validateKeys = true);
	...
	*  @return			The schedule name
	*/
	std::string tryAqObjectsScheduleCreateBespokeFromCashflows(const std::string& scheduleObjectName, const LabelValueBlock& bespokeScheduleProperties, const AQLStringMatrix& bespokeCashflowsLVB, bool validateKeys = true);
