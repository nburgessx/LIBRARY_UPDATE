...
namespace validation
{
	...
	*  @return			swapName
	*/
	std::string tryAqObjRatesFraCreate(const std::string& FraObjectName, const LabelValueBlock& FraLVB, bool validateKeys=true);
	...
	*/
	AnyTypeMatrix tryAqObjRatesFraDisplayCashflows(const std::string& FraObjectName, const LabelValueBlock& valuationSettingsLVB, bool showColumnHeaders=true, 
