...
namespace validation
{
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjConstantMaturitySwapPVUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const AQLString& legName, const LabelValueBlock& fixingTableNames=LabelValueBlock() );
	...
	*/
	double tryAqObjConstantMaturitySwapParRateUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const LabelValueBlock& fixingTableNames=LabelValueBlock() );
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjTotalReturnSwapPV( const std::string& swapName, const std::string& creditModelName,  const std::string& legName="", const LabelValueBlock& fixingTableNames=LabelValueBlock() );
	...
	*/
	double tryAqObjTotalReturnSwapParRate( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames=LabelValueBlock() );
	...
	*/
	double tryAqObjTotalReturnSwapParSpread( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames=LabelValueBlock() );
