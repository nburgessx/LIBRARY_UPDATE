...
namespace validation
{
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
