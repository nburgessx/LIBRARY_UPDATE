...
namespace validation
{
    ...
    */
	 void tryAqObjectsSwapDeltaLadder( AQLStringVector& headers,
    ...
    *  @param [in]		xccyFXSpotRates			        A vector of doubles representing Xccy FX Spot Rates
    */
	 void tryAqObjectsSwapDeltaLadderHorizontally( AQLStringVector& headers,
    ...
    *  @param [in]		xccyFXSpotRates			        A vector of doubles representing Xccy FX Spot Rates
    */
	void tryAqObjectsSwapDelta( AQLStringVector& positionIDs,
							DoubleVector& deltas,
							const AQLStringVector& swapNames,
							const AQLStringMatrix& curveCollectionNames,
							const AQLStringMatrix& fixingTableNames,
