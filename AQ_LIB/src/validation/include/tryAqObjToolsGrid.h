...
namespace validation
{
    ...
    /* @brief			validation interface for the tryAqObjCreateRange method
    ...
    */
    ...
    std::string tryAqObjToolsGridSave(
        const std::string& objectName,
    ...
    */
    ...
    std::pair<const bool, std::string> tryAqObjToolsGridLoad(
        const std::string& fileName );

    std::vector<std::string> tryAqObjToolsGridObjectNames();
