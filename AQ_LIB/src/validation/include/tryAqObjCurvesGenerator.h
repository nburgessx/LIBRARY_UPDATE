...
namespace validation
{
    ...
    /* @brief Creates a AQObjCurveGenerator object, containing all of the curve properties.
	...
	/* @brief Displays the specified property of a AQObjCurveGenerator. If propertyName is blank, all properties are returned.
	 ...
	 */
    const etrading::VariantMatrix  tryAqObjCurvesGeneratorDisplay( const std::string& objectName,
