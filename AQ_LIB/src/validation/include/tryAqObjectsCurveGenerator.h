...
namespace validation
{
    ...
    /* @brief Creates a AQOCurveGenerator object, containing all of the curve properties.
	 ...
	 */
    std::string tryAqObjectsCurveGeneratorCreate( const std::string& objectName,
                                              const std::vector<std::string>& propertyNames,
                                              const std::vector<TableInfo>& infoBlocks );

	/* @brief Displays the specified property of a AQOCurveGenerator. If propertyName is blank, all properties are returned.
	 ...
	 */
    const etrading::VariantMatrix  tryAqObjectsCurveGeneratorDisplay( const std::string& objectName,
	...
	*/
	std::string tryAqObjectsCurveGeneratorModify( const std::string& newObjectName,
	 ...
	 * @param [out]                  A VariantMatrix containing a LabelValue block of properties.
	 */
	const etrading::VariantMatrix tryAqObjectsCurveDisplayConventions(const std::string& objectName, const std::string& propertyKey );
}