...
namespace validation_api
{
    ...
    */
    double tryMeMathLiborConvexityAdjustmentInArrears( const double & liborRate, const double & couponYearFraction, const double & timeToMaturity, const double & volatility, const etrading::VolatilityTypeEnum & volatilityType, const double & volatilityShift = 0.0, const bool useHullApproximation = false );
    ...
    */
    double tryMeMathLiborRateInArrears(const double & liborRate, const double & couponYearFraction, const double & timeToMaturity, const double & volatility, const etrading::VolatilityTypeEnum & volatilityType, const double & volatilityShift = 0.0, const bool useHullApproximation = false );
