...
namespace validation
{
	 ...
	 */
    std::string tryAqObjectsCurveMarketDataCreate(  const std::string& objectName,
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveMarketDataBumpClear( const std::string& objectName );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps = false );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments = true );
	...
	*/
    etrading::VariantMatrix tryAqObjectsCurveMarketDataDisplay( const std::string& marketDataObjectName,
	...
	* @param [out]						A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantMatrix tryAqObjectsCurveMarketDataDisplayFromCurve( const std::string& curveObjectName,
																	 const std::string& marketDataKey,
																	 const int columnIndexToDisplay = -1 );
	...
	* @param [out]                  A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantVector tryAqObjectsCurveMarketDataColumn( const std::string& curveObjectName,
														   const std::string& marketDataKey,
