...
#include "tryAqObjectsCurveCreateOIS.h"
...
namespace validation
{
    ...
    /* @brief			validation interface for the aqObjectsCurveCreateOIS method
    ...
    */
    const AQLString tryAqObjectsCurveCreateOIS( const std::string& lwoCurveName,
