...
{
    /* @brief			validation interface for the aqCurveObjectCreateBasis method
    ...
    */
    const AQLString tryAqCurveObjectCreateBasis( const std::string& aqObjCurveName,
                                             ...
                                             const AQLStringMatrix& spotFxRates )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateBasis_inputs", curveCollection, staticDataTable ) );
            file.write( "generatorFunction", "tryAqCurveObjectCreateBasis" );
        ...
        if( default_env.has( newCurveName ) )
        {
            ...
            if ( CreateDataFile::recordEnabled() )
            {
                CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateBasis_outputs", curveCollection, staticDataTable ) );
