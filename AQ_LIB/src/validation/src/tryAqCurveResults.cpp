...
#include "tryAqToolClean.h"              // trimming utility methods
...
namespace validation
{
    ...
    etrading::VariantMatrix tryAqCurveResultsJacobianRiskTotals( const std::string & curveCollection, const std::string & curveIndex, const etrading::RiskTypeEnum & riskType, const bool & useOutrightInstrumentsOnly )
    {
        VALID_EXCEPTION_START
