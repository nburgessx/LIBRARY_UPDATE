...
namespace validation
{
    ...
    */
    std::vector<std::string> tryAqAssetSwapSpreadLVBKeys()
    {
    ...
    */
    ...
    /* @brief			validation interface for the aqAssetSwapSpread method
    ...
    */
    double tryAqAssetSwapSpread( double bondPrice, const LabelValueBlock& assetSwapLVB, bool validateKeys)
    {
        VALID_EXCEPTION_START

        etrading::validateKeysForLVB( tryAqAssetSwapSpreadLVBKeys(), assetSwapLVB.getKeys(), validateKeys );
