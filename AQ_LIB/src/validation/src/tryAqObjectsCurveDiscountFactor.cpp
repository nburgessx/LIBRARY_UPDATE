...
namespace validation
{
    ...
    */
    ...
    /* @brief			Validation interface for aqObjectsCurveDiscountFactorsTable, which generates a date schedule and
	...
	*/
	void tryAqObjectsCurveDiscountFactorsTable( DateVector& paymentDates,
    ...
    */
	DoubleVector tryAqObjectsCurveDiscountFactorsWithSpread( const DateVector& paymentDates,
