...
namespace validation
{
	 ...
	 */
	std::string tryAqObjectsInflationCurveCreate( const std::string& objectName,
	...
	*/
	double tryAqObjectsInflationZCSwapPVFromIndex( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double baseIndex, const double resetIndex, const std::string& legName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjectsInflationZCSwapPV method.
	*			Calculates the PV of the specified Zero Coupon Inflation Swap.
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjectsInflationZCSwapPV( const std::string& swapName, const std::string& inflationCurveName, const LabelValueBlock& valuationSettingsLVB, const std::string& legName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjectsInflationZCSwapParRateFromIndex method.
	...
	*/
	double tryAqObjectsInflationZCSwapParRateFromIndex( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double baseIndex, const double resetIndex )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjectsInflationZCSwapParRate method.
	...
	* @returns	The calculated break-even par-rate value
	*/
	double tryAqObjectsInflationZCSwapParRate( const std::string& swapName, const std::string& inflationCurveName, const LabelValueBlock& valuationSettingsLVB )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjectsInflationCPI method.
	...
	*/
	double tryAqObjectsInflationCPI( const std::string& inflationCurveName, const AQLDate& date, const std::string& inflationResetType, const std::string& lag )
	{
		VALID_EXCEPTION_START
