...
namespace validation
{
	...
	*/
	std::string tryAqCapFloorObjectCreate(const std::string& objectName, const LabelValueBlock& tradeLVB, const bool& validateKeys)
	{
	...
	/* @brief			validation interface for the aqCapFloorObjectDisplay method
	*  @param [in]		objectName		CapFloor object name
	...
	*/
	AnyTypeMatrix tryAqCapFloorObjectDisplayCashflows(const std::string& objectName, const std::string& volObjectName, const std::string& curveCollection, const std::string& fixingTableName, const bool& showColumnHeaders, const std::vector<std::string>& columnList)
	{
		VALID_EXCEPTION_START
	...
	*/
	AnyTypeMatrix tryAqCapFloorObjectGreeksAnalytical(const std::string& objectName, const std::string& volObjectName, const std::string& curveCollection, const std::string& fixingTableName, const bool& showColumnHeaders)
	{
		VALID_EXCEPTION_START
	...
	*  @return			CapFloor cashflow display
	*/
	AnyTypeMatrix tryAqCapFloorObjectDisplayCashflowsFromRates(const std::string& objectName, const std::string& volObjectName, const DoubleMatrix& rateData, const bool& showColumnHeaders, const std::vector<std::string>& columnList)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqCapFloorObjectGreeksAnalyticalFromRates method
	*  @param [in]		objectName		Cap Floor object name
	*  @param [in]		volObjectName	Volatility object name
	*  @param [in]		rateData		External discountFactors and liborRates
	*  @param [in]		showColumnHeaders	showColumnHeaders
	*  @return			CapFloor Greeks' display
	*/
	AnyTypeMatrix tryAqCapFloorObjectGreeksAnalyticalFromRates(const std::string& objectName, const std::string& volObjectName, const DoubleMatrix& rateData, const bool& showColumnHeaders)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqCapFloorObjectGreeksFromRates method
	*  @param [in]		objectName		Cap Floor object name
	*  @param [in]		volObjectName	Volatility object name
	*  @param [in]		rateData		External discountFactors and liborRates
	*  @param [in]		deltaBump		Delta bump size
