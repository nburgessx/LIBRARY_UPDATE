...
namespace validation
{
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjConstantMaturitySwapPVUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const AQLString& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjConstantMaturitySwapParRateUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjTotalReturnSwapPV( const std::string& swapName, const std::string& creditModelName,  const std::string& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjTotalReturnSwapParRate( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjTotalReturnSwapParSpread( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjTotalReturnSwapAnnuity( const std::string& swapName, const std::string& creditModelName,  const std::string& legName )
	{
		VALID_EXCEPTION_START
