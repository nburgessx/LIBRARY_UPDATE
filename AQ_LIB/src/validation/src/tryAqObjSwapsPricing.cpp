...
namespace validation
{
    ...
    /* @brief			Helper utility method for the aqObjSwapsPV method
	...
	*/
    ...
    /* @brief			validation interface for the aqObjSwapsPVs method
	...
	*  @return			Swap PV
	*/
	std::vector<double> tryAqObjSwapsPVs(const std::vector<std::string>& swapNames, const std::vector<LabelValueBlock>& valuationSettingsLVB, std::vector<std::string>& legNames, std::vector<LabelValueBlock>& fixingTableNames, const bool optimize)
    {
 	...
 	/* @brief			validation interface for the aqObjSwapsPV method
	*  @param [in]		swapName			Swap object name
	...
	*  @return			Swap PV
	*/
	double tryAqObjSwapsPV(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const AQLString& legName, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjSwapsPV01 method
	*  @param [in]		swapName			Swap object name
	*  @param [in]		curveCollection		Valuation settings
    *  @param [in]		fixingTableNames	Fixing table object names
	*  @return			Swap PV01
	*/
	double tryAqObjSwapsPV01(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjSwapsParRate method
	*  @param [in]		swapName		        Swap object name
	...
	*/
	double tryAqObjSwapsParRate(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& legName)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjSwapsAnnuity method
	*  @param [in]		swapName		Swap object name
	*  @param [in]		curveCollection Valuation settings
	*  @param [in]		legName		    Leg name
	*  @return			Swap PV
	*/
	double tryAqObjSwapsAnnuity(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const AQLString& legName)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjSwapsSpread method
	...
	*/
	double tryAqObjSwapsSpread(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& spreadLegName)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjSwapsParSpread method 
    *  @param [in]		swapName			Swap name
	...
	*/
	double tryAqObjSwapsParSpread(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& spreadLegName)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjSwapsDisplayCashflows method
	*  @param [in]		swapName		    Swap name
	...
	*  @return			Swap display
	*/
	std::vector<AnyTypeMatrix> tryAqObjSwapsDisplayCashflows(const std::string& swapName, 
                                                            ...
                                                            const std::vector<std::string>& columnList)
	{
		...
		{
			CreateDataFile file(decorateFilename("tryAqObjSwapsDisplayCashflows_outputs", swapName.c_str()));
	...
	/* @brief			validation interface for the aqObjSwapsAccruedInterest method
	*  @param [in]		swapName		Swap object name
	...
	*/
	double tryAqObjSwapsAccruedInterest(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const AQLString& legName, const LabelValueBlock& fixingTableNames)
	{
	    VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditDefaultSwapPVFromHazardRate method.
	...
	*/
    double tryAqObjCreditDefaultSwapPVFromHazardRate( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double hazardRate, const double recoveryRate, const AQLString& legName, const bool includeAccruedInterest )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjCreditDefaultSwapPV( const std::string& swapName, const std::string& creditModelName,  const AQLString& legName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjCreditDefaultSwapPVByIntegration method.
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjCreditDefaultSwapPVByIntegration( const std::string& swapName, const std::string& creditModelName, const AQLString& legName, const size_t numberOfIntegrationPoints, const bool evaluateInParallel, const bool payDefaultCashflowsOnNextCouponDate )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqObjCreditDefaultSwapPVByMonteCarlo method.
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjCreditDefaultSwapPVByMonteCarlo( const std::string& swapName, const std::string& creditModelName, const AQLString& legName, const LabelValueBlock& mcParametersLVB, const bool payDefaultCashflowsOnNextCouponDate, double& standardError )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjCreditDefaultSwapRiskyAnnuityFromHazardRate( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double hazardRate, const double recoveryRate, const AQLString& legName, const bool includeAccruedInterest )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The risky annuity
	*/
	double tryAqObjCreditDefaultSwapRiskyAnnuity( const std::string& swapName, const std::string& creditModelName, const AQLString& legName )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjCreditDefaultSwapAccruedYearFraction( const std::string& swapName, const std::string& creditModelName, const AQLDate& toDate, const AQLString& legName )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The risky annuity
	*/
	double tryAqObjCreditDefaultSwapCS01( const std::string& swapName, const std::string& creditModelName, const AQLString& legName )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjCreditDefaultSwapParSpreadFromHazardRate( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double hazardRate, const double recoveryRate, const AQLString& premiumLegName, const AQLString& protectionLegName, const bool includeAccruedInterest )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The CDS par spread
	*/
	double tryAqObjCreditDefaultSwapParSpread( const std::string& swapName, const std::string& creditModelName, const AQLString& premiumLegName, const AQLString& protectionLegName )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjCreditDefaultSwapHazardRateFromParSpread( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double parSpread, const double recoveryRate, const AQLString& premiumLegName, const AQLString& protectionLegName, const bool includeAccruedInterest )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The CDS hazard rate
	*/
	double tryAqObjCreditDefaultSwapHazardRateFromParSpread( const std::string& swapName, const std::string& creditModelName, const double parSpread, const AQLString& premiumLegName, const AQLString& protectionLegName )
	{
		VALID_EXCEPTION_START
	 ...
	 */
    std::string tryAqObjCreditModelCreate( const std::string& objectName,
                                           ...
                                           const etrading::JSONInfoBlockTuples& infoBlocks )
    {
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCreditModelCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqObjCreditModelCreate");
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCreditModelCreate_outputs", objectName.c_str()));
	 ...
	 */
	AQLDate tryAqObjCreditModelAsOfDate( const std::string& creditModelName )
	{
		VALID_EXCEPTION_START
	 ...
	 */
	AnyTypeMatrix tryAqObjCreditModelCalibrationParameters( const std::string& creditModelName )
	{
		VALID_EXCEPTION_START
	...
	double tryAqObjCreditModelHazardRate( const std::string& creditModelName, const AQLDate& paymentDate )
	{
		VALID_EXCEPTION_START
	...
	double tryAqObjCreditModelSurvivalProbability( const std::string& creditModelName, const AQLDate& toDate, const AQLDate& fromDate )
	{
		VALID_EXCEPTION_START
	...
	double tryAqObjCreditBasketModelSurvivalProbability( const std::string& creditBasketModelName, const AQLDate& toDate, const AQLDate& fromDate )
	{
		VALID_EXCEPTION_START
	...
	double tryAqObjCreditModelDefaultProbability( const std::string& creditModelName, const AQLDate& toDate, const AQLDate& fromDate )
	{
		VALID_EXCEPTION_START
	...
	*/ 
	AQLDate tryAqObjCreditModelImpliedSurvivalDate( const std::string& creditModelName, const double survivalProbability )
	{
		VALID_EXCEPTION_START
		...
		if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( "tryAqObjCreditModelImpliedSurvivalDate_outputs" );
    ...
    DoubleVector tryAqObjCreditModelRiskyDiscountFactors( const std::string& creditModelName, const DateVector& paymentDates )
	{
        VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditSpread method.
	...
	*/
	double tryAqObjCreditSpread( const std::string& creditModelName, const AQLDate& startDate, const AQLDate& endDate )
	{
		VALID_EXCEPTION_START
	...
	double tryAqObjCreditIndexSpread( const std::string& creditModelName, const AQLDate& startDate, const AQLDate& endDate )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditOptionPV method.
	...
	*/
	double tryAqObjCreditOptionPV( const std::string& creditModelName, const std::string& payerReceiver, const double strike, const AQLDate& optionExpiryDate, const AQLDate& cdsMaturityDate, const double volatility )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditOptionPVFromForward method.
	...
	* @returns	The calculated option price
	*/
	double tryAqObjCreditOptionPVFromForward(const std::string& creditModelName, const std::string& payerReceiver, const double strike, const AQLDate& optionExpiryDate, const AQLDate& cdsStartDate, const AQLDate& cdsMaturityDate, const double volatility, const double forwardSpread)
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditIndexOptionPV method.
	...
	* @returns	The calculated option price
	*/
	double tryAqObjCreditIndexOptionPV( const std::string& creditModelName, const etrading::LabelValueBlock& optionLVB )
	{
		VALID_EXCEPTION_START
	...
	/* @brief  validation interface for the aqObjCreditIndexOptionImpliedVol method.
	...
	*/
	double tryAqObjCreditIndexOptionImpliedVol( const std::string& creditModelName, const etrading::LabelValueBlock& optionLVB )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditIndexOptionVega method.
	*  Calculates the value of a credit index option i.e. option on a CDS index
	*  See Bloomberg Whitepaper "Pricing Credit Index Options", March 1st, 2012
	*
	* @param[in]	creditModelName				Credit Model object name
	...
	*/
	double tryAqObjCreditIndexOptionVega( const std::string& creditModelName, const etrading::LabelValueBlock& optionLVB, const double volatilityBump )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditIndexOptionCS01 method.
	*  Calculates the value of a credit index option i.e. option on a CDS index
	*  See Bloomberg Whitepaper "Pricing Credit Index Options", March 1st, 2012
	*
	* @param[in]	creditModelName				Credit Model object name
	...
	*/
	double tryAqObjCreditIndexOptionCS01( const std::string& creditModelName, const etrading::LabelValueBlock& optionLVB )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjCreditIndexOptionTheta method.
	*  Calculates the value of a credit index option i.e. option on a CDS index
	*  See Bloomberg Whitepaper "Pricing Credit Index Options", March 1st, 2012
	*
	* @param[in]	creditModelName				Credit Model object name
	...
	*/
	double tryAqObjCreditIndexOptionTheta( const std::string& creditModelName, const etrading::LabelValueBlock& optionLVB )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The implied volatility
	*/
	double tryAqObjCreditOptionImpliedVol( const std::string& creditModelName, const std::string& payerReceiver, const double strike, const AQLDate& optionExpiryDate, const AQLDate& cdsMaturityDate, const double targetOptionValue )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The implied volatility
	*/
	double tryAqObjCreditOptionImpliedVolFromForward( const std::string& creditModelName, const std::string& payerReceiver, const double strike, const AQLDate& optionExpiryDate, const AQLDate& cdsStartDate, const AQLDate& cdsMaturityDate, const double targetOptionValue, const double forwardSpread )
	{
		VALID_EXCEPTION_START
	 ...
	 * @param [out]                  The objectName
	 */
    std::string tryAqObjCreditBasketModelCreate( const std::string& objectName,
												 const std::vector<std::string>& dataBlockNames,
												 const etrading::JSONInfoBlockTuples& infoBlocks )
    {
		VALID_EXCEPTION_START
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCreditBasketModelCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqObjCreditBasketModelCreate");
			file.write("objectName", objectName);
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCreditBasketModelCreate_outputs", objectName.c_str()));
			file.write("output", objectName);
		}
	...
	/* @brief validation interface for the aqObjSwapsConstantMaturitySwapPVFromConvexity() method.
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjSwapsConstantMaturitySwapPVUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const AQLString& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	/* @brief validation interface for the aqObjSwapsConstantMaturitySwapParRateFromConvexity() method.
	...
	*/
	double tryAqObjSwapsConstantMaturitySwapParRateUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjSwapsTotalReturnPV( const std::string& swapName, const std::string& creditModelName,  const std::string& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjSwapsTotalReturnParRate( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjSwapsTotalReturnParSpread( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjSwapsTotalReturnAnnuity( const std::string& swapName, const std::string& creditModelName,  const std::string& legName )
	{
		VALID_EXCEPTION_START
