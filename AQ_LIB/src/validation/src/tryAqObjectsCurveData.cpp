#include "tryAqObjectsCurveData.h"
...
namespace validation
{
    ...
    etrading::VariantMatrix tryAqObjectsCurveDataDisplay( const std::string& mdcName )
    {
	...
	const std::string tryAqObjectsCurveDataCreate (
