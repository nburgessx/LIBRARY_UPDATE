/*
 * @brief			validation interface for meForwardRate methods
...
namespace validation_api
{
    ...
    */
    ...
    /* @brief			validation interface for tryMeCurveForwardRatesFromForwardDates
    *  @param [in]		fromDates	    A vector of from dates
    ...
    */
    ...
    /* @brief			validation interface for meCurveForwardRates, which uses the curve frequency
    ...
    */
	...
	/* @brief			Validation interface for meLWOCurveForwardRatesTable, which generates a date schedule and
