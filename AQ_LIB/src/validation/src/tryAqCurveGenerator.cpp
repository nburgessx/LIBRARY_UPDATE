...
namespace validation
{
	 ...
	 */
    std::string tryAqCurveGeneratorCreate( const std::string& objectName,
                                              ...
                                              const std::vector<TableInfo>& infoBlocks )
    {
		...
		{
			CreateDataFile file(decorateFilename("tryAqCurveGeneratorCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqCurveGeneratorCreate");
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqCurveGeneratorCreate_outputs", objectName.c_str()));
	 ...
	 */
	const etrading::VariantMatrix tryAqCurveGeneratorDisplay(const std::string& objectName, const std::string& propertyKey )
    {
		VALID_EXCEPTION_START
	...
	*/
	std::string tryAqCurveGeneratorModify( const std::string& newObjectName,
	 ...
	 * @param [out]                  A VariantMatrix containing a LabelValue block of properties.
	 */
	const etrading::VariantMatrix tryAqCurveObjectDisplayConventions(const std::string& objectName, const std::string& propertyKey )
    {
		VALID_EXCEPTION_START
