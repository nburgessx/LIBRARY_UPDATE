#include "tryAqObjectsCapFloor.h"
...
namespace validation
{
	...
	*/
	std::string tryAqObjectsCapFloorCreate(const std::string& objectName, const LabelValueBlock& tradeLVB, const bool& validateKeys)
	{
	...
	/* @brief			validation interface for the aqObjectsCapFloorDisplay method
	*  @param [in]		objectName		CapFloor object name
	...
	*/
	AnyTypeMatrix tryAqObjectsCapFloorDisplayCashflows(const std::string& objectName, const std::string& volObjectName, const std::string& curveCollection, const std::string& fixingTableName, const bool& showColumnHeaders, const std::vector<std::string>& columnList)
	{
		VALID_EXCEPTION_START
	...
	*/
	AnyTypeMatrix tryAqObjectsCapFloorGreeksAnalytical(const std::string& objectName, const std::string& volObjectName, const std::string& curveCollection, const std::string& fixingTableName, const bool& showColumnHeaders)
	{
		VALID_EXCEPTION_START
	...
	*  @return			CapFloor cashflow display
	*/
	AnyTypeMatrix tryAqObjectsCapFloorDisplayCashflowsFromRates(const std::string& objectName, const std::string& volObjectName, const DoubleMatrix& rateData, const bool& showColumnHeaders, const std::vector<std::string>& columnList)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsCapFloorGreeksAnalyticalFromRates method
	*  @param [in]		objectName		Cap Floor object name
	*  @param [in]		volObjectName	Volatility object name
	*  @param [in]		rateData		External discountFactors and liborRates
	*  @param [in]		showColumnHeaders	showColumnHeaders
	*  @return			CapFloor Greeks' display
	*/
	AnyTypeMatrix tryAqObjectsCapFloorGreeksAnalyticalFromRates(const std::string& objectName, const std::string& volObjectName, const DoubleMatrix& rateData, const bool& showColumnHeaders)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsCapFloorGreeksFromRates method
	*  @param [in]		objectName		Cap Floor object name
	*  @param [in]		volObjectName	Volatility object name
	*  @param [in]		rateData		External discountFactors and liborRates
	*  @param [in]		deltaBump		Delta bump size
	...
	*/
	...
	/* @brief			validation interface for the aqObjectsCapFloorPVFromRate method
	*  @param [in]		objectName		Cap Floor object name
	*  @param [in]		volObjectName	Volatility object name
	*  @param [in]		rateData		External discountFactors and liborRates
	*  @return			CapFloor PV
