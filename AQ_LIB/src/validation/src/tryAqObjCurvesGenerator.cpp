...
namespace validation
{
	 ...
	 */
    std::string tryAqObjCurvesGeneratorCreate( const std::string& objectName,
                                              ...
                                              const std::vector<TableInfo>& infoBlocks )
    {
		...
		{
			CreateDataFile file(decorateFilename("tryAqObjCurvesGeneratorCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqObjCurvesGeneratorCreate");
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCurvesGeneratorCreate_outputs", objectName.c_str()));
	 ...
	 */
	const etrading::VariantMatrix tryAqObjCurvesGeneratorDisplay(const std::string& objectName, const std::string& propertyKey )
    {
		VALID_EXCEPTION_START
	...
	*/
	std::string tryAqObjCurvesGeneratorModify( const std::string& newObjectName,
	 ...
	 * @param [out]                  A VariantMatrix containing a LabelValue block of properties.
	 */
	const etrading::VariantMatrix tryAqObjCurvesDisplayConventions(const std::string& objectName, const std::string& propertyKey )
    {
		VALID_EXCEPTION_START
