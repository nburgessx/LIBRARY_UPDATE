...
namespace validation
{
    ...
    /* @brief			validation interface for tryAqCurvesDelete
    ...
    */
	AQLString tryAqCurvesDelete(const AQLString& curveCollection, const AQLString& curveIndex)
	{
