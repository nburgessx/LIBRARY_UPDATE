...
namespace validation
{
    ...
    */
    AQLStringMatrix tryAqSwapSchedule( bool showColumnHeaders, const LabelValueBlock& swapScheduleLVB, bool validateKeys, const std::vector<std::string>& columnList, const bool& convertDatesToExcelFormat )
    {
    ...
    *  @return			A matrix containing the swap schedule
    */
    AQLStringMatrix tryAqSwapScheduleFixed( bool showColumnHeaders, const LabelValueBlock& swapScheduleLVB, bool validateKeys, const std::vector<std::string>& columnList, const bool& convertDatesToExcelFormat )
	{
	    VALID_EXCEPTION_START
    ...
    *  @return			A matrix containing the swap schedule
    */
    AQLStringMatrix tryAqSwapScheduleFloat( bool showColumnHeaders, const LabelValueBlock& swapScheduleLVB, bool validateKeys, const std::vector<std::string>& columnList, const bool& convertDatesToExcelFormat )
	{
	    VALID_EXCEPTION_START
