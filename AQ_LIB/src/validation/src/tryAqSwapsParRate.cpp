...
namespace validation
{
    ...
    */
    double tryAqSwapsParRate( const LabelValueBlock& swapLVB, bool validateKeys )
    {
        VALID_EXCEPTION_START

        etrading::validateKeysForLVB( tryAqSwapsParRateLVBKeys(), swapLVB.getKeys(), validateKeys );
