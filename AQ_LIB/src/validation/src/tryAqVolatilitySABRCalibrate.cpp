...
namespace validation
{
    ...
    /* @brief	validation interface for the aqVolatilitySABRCalibrate method
    */
    const AQLString tryAqVolatilitySABRCalibrate(const AQLString& approxMethod,
											...
											const std::string& volType )
    {
		...
		if (CreateDataFile::recordEnabled())
		{
			...
			file.write("generatorFunction", "tryAqVolatilitySABRCalibrate");
