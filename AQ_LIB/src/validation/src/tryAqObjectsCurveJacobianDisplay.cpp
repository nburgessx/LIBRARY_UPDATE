#include "tryAqObjectsCurveJacobianDisplay.h"
...
namespace validation
{
	...
	*/
	void tryAqObjectsCurveEngineJacobianDisplay(DoubleMatrix& matrix,
	...
	* @param [in] displayInverseMatrix				Display inverse Jacobian matrix or not
	*/
	void tryAqObjectsCurveJacobianDisplay(DoubleMatrix& matrix,
										const AQLString& curveCollection,
