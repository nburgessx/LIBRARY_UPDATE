...
namespace validation
{
    ...
    */
    AnyTypeMatrix tryAqCurvesVasicekChecking(const DateVector& fixingDates, const DoubleVector& targetForwardRates, const std::string& curveCollection, const std::string& curveIndex, 
    ...
    */
	DoubleVector tryAqCurvesVasicekForwardRates(const DateVector& fixingDates, const std::string& curveCollection, const std::string& curveIndex,
