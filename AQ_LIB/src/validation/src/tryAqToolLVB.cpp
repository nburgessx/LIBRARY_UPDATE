...
namespace validation
{
    ...
    /* @brief			validation interface for aqToolLVBFromKeysValues method
    ...
    */
    AQLStringMatrix tryAqToolLVBFromKeysValues( const AQLStringVector& keys, const AQLStringVector& values, const AQLString& keyPrefix )
    {
        ...
        //{
        //	CreateDataFile file("tryAqToolLVBFromKeysValues_inputs");
        //	file.write("generatorFunction", "tryAqToolLVBFromKeysValues");
        ...
        //if (CreateDataFile::recordEnabled())
        //{
        //	CreateDataFile file("tryAqToolLVBFromKeysValues_outputs");
    ...
    /* @brief			validation interface for aqToolLVB method
    ...
    */
    AQLStringMatrix tryAqToolLVB( const AQLStringMatrix& sMatrix, AQLStringVector& keyPrefixes, bool verticalKeys )
    {
        VALID_EXCEPTION_START
        ...
        //if (CreateDataFile::recordEnabled())
        //{
        //	CreateDataFile file("tryAqToolLVB_inputs");
        //	file.write("generatorFunction", "tryAqToolLVB");
        ...
        //if (CreateDataFile::recordEnabled())
        //{
        //	CreateDataFile file("tryAqToolLVB_outputs");
        //	file.write("output", ret);
        //}
    ...
    /* @brief			validation interface for aqToolLVBGroup method
    ...
    */
    AQLStringMatrix tryAqToolLVBGroup( const std::vector<AQLStringMatrix>& lvbs )
    {
        VALID_EXCEPTION_START
        ...
        //if (CreateDataFile::recordEnabled())
        //{
        //	CreateDataFile file("tryAqToolLVBGroup_inputs");
        //	file.write("generatorFunction", "tryAqToolLVBGroup");
        //	for (size_t i=0; i<lvbs.size(); ++i)
        //	{
        ...
        //if (CreateDataFile::recordEnabled())
        //{
        //	CreateDataFile file("tryAqToolLVBGroup_outputs");
        //	file.write("output", ret);
        //}
    ...
    /* @brief			validation interface for aqToolLVBFromMultipleKeysValues method
    *  @param [in]		keys			Multiple lists of keys from user input
    *  @param [in]		values			Multiple lists of values from user input
    *  @return			a AQLStringMatrix representing LabelValueBlock, i.e. first columns are keys, second columns are values
    */
    AQLStringMatrix tryAqToolLVBFromMultipleKeysValues( const std::vector<AQLStringVector>& keys,
    ...
    /* @brief			validation interface for aqToolLVBFromKeysAndMultipleValues method
    ...
    */
    AQLStringMatrix tryAqToolLVBFromKeysAndMultipleValues( const AQLStringVector& commonKeys, const std::vector<AQLStringVector>& multiValues)
    {
        VALID_EXCEPTION_START
    ...
    */
    STDStringMatrix tryAqToolLVBCreate( const STDStringVector& keys, const STDStringVector& values )
    {
    ...
    *  @return			A string matrix of keys and values as a single data block
    */
    STDStringMatrix tryAqToolLVBCreate( const STDStringVector& keys, const STDStringVector& values1, const STDStringVector& values2 )
    {
    ...
    */
    void tryAqToolLVBAdd( STDStringMatrix& LVB, const std::string& key, const std::string& value )
    {
    ...
    */
    void tryAqToolLVBAdd( STDStringMatrix& LVB, const std::string& key, const std::string& value1, const std::string& value2 )
    {
         // Access Violation Guard
        if ( LVB.size() > 0 )
        {
