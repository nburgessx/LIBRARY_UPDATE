...
namespace validation
{
	...
	*/
	AQLStringVector tryAqObjCurvesEngineCalibrate(const std::string& engineObjectName,
												...
												const std::vector<std::string>& marketDataObjects)
    {
		...
		{
			CreateDataFile file(decorateFilename("tryAqObjCurvesEngineCalibrate_inputs", engineObjectName.c_str()));
			file.write("generatorFunction", "tryAqObjCurvesEngineCalibrate");
