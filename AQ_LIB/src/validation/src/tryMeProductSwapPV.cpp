...
namespace validation_api
{
    ...
    *  @return			Swap PV
    */
    double tryMeProductSwapPV( const LabelValueBlock& swapLVB, bool validateKeys )
    {
		...
		LAString floatFrequency                 = swapLVB.getCompulsoryValueAsLAString( etrading::IRS_KEY::FLOAT_FREQUENCY );
