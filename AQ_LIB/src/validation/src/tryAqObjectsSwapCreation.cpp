...
namespace validation
{
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsSwapCreateFromLegs(const std::string& swapName, const std::vector<std::string>& legObjectNames, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsSwapCreateFromLegLVBs(const std::string& swapName, const LabelValueBlock& leg1LVB, const LabelValueBlock& leg2LVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsSwapCreate(const std::string& swapName, const AQLStringMatrix& swapLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsSwapCreateFromSchedule(const std::string& swapName, const std::string& schedule1Name, const std::string& schedule2Name, 
	...
	*/
	std::string tryAqObjectsSwapGeneratorCreate(const std::string& swapGeneratorName, const AQLStringMatrix& swapGeneratorLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsSwapCreateFromGenerator(const std::string& swapName, const std::string& swapGeneratorName, const LabelValueBlock& expressionLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
