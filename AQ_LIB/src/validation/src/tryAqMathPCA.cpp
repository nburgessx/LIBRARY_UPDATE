...
namespace validation
{
    ...
    */
    ...
    /* @brief			validation interface for the aqMathPCA method
    *  @param [in]		key						Key used to identify a PCA analysis
    ...
    *  @return			A AQLStringMatrix for the PCA results
    */
    AQLStringMatrix tryAqMathPCA( const AQLString& key, const DoubleMatrix& data, bool useCorrelationMatrix, int nFactors )
    {
