#include "tryAqCurvesHullWhite.h"
...
namespace validation
{
    ...
    */
	DoubleVector tryAqCurvesHullWhiteForwardRates(const DateVector& fixingDates, const std::string& curveCollection, const std::string& curveIndex,
