...
namespace validation
{
    ...
    */
    double tryAqMathLiborConvexityAdjustmentInArrears( const double & liborRate, const double & couponYearFraction, const double & timeToMaturity, const double & volatility, const etrading::VolatilityTypeEnum & volatilityType, const double & volatilityShift, const bool useHullApproximation )
    {
        VALID_EXCEPTION_START
    ...
    */
    double tryAqMathLiborRateInArrears( const double & liborRate, const double & couponYearFraction, const double & timeToMaturity, const double & volatility, const etrading::VolatilityTypeEnum & volatilityType, const double & volatilityShift, const bool useHullApproximation )
    {
        VALID_EXCEPTION_START
