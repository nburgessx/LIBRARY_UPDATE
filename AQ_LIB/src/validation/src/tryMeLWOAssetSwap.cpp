...
namespace validation_api
{
	...
	*/
														...
														const std::string& swapObjectName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
    {
        ...
        for ( unsigned int i = 0; i < expectedSize; ++i )
        {
			...
			double spread							= tryMeLWOAssetSwapSpreadFromPrice( bondPrice, bondAccrualStartDate, isCleanPrice, swapObjectName, valuationSettingsLVB, fixingTableNames);
    ...
    *  @return			Par/Par Asset Swap Spreads
	*/
    std::vector< double > tryMeLWOAssetSwapSpread( const std::string& swapObjectName, const std::string& bondObjectName, const std::vector< double >& bondPrices, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
        ...
        {
            const double bondPrice          = bondPrices[i];
			double spread                 = tryMeLWOAssetSwapSpread( swapObjectName, bondObjectName, bondPrice, valuationSettingsLVB, fixingTableNames);
	...
	/* @brief			Helper interface for the meLWOAssetSwapSpread method. Calculate the Par/Par Asset Swap Spread.
	*  @param [in]		swapObjectName		Swap object name
	*  @param [in]		bondObjectName		Bond object name
    *  @param [in]		bondPrice		    Bond price
	*  @param [in]		valuationSettingsLVB    A LVB containing ModelName, CurveCollection, ValuationDate, etc.
    ...
    *  @return			Par/Par Asset Swap Spread
	*/
    double tryMeLWOAssetSwapSpread( const std::string& swapObjectName, const std::string& bondObjectName, const double& bondPrice, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
	    VALID_EXCEPTION_START
	...
	*/
	double tryMeLWOAssetSwapFixedEqvCoupon(const std::string& swapObjectName, const std::string& bondObjectName, const double& bondPrice, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryMeLWOAssetSwapSpreadFromFixedEqvCoupon(const std::string& swapObjectName, const double& fixedEqvCoupon, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the meLWOAssetSwapSpreadToCleanPrice method. Calculate the Bond Clean Prices.
	*  @param [in]		swapObjectName		Swap object name
    ...
    *  @return			Par/Par Asset Swap Spreads
	*/
    std::vector< double > tryMeLWOAssetSwapSpreadToCleanPrice( const std::string& swapObjectName, const std::vector< double >& assetSwapParParSpreads, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
        ...
        for ( unsigned int i = 0; i < expectedSize; ++i )
        {
			...
			double bondCleanPrice               = tryMeLWOAssetSwapSpreadToCleanPrice( swapObjectName, assetSwapParParSpread, valuationSettingsLVB, fixingTableNames);
	...
	/* @brief			Helper interface for the meLWOAssetSwapSpreadToCleanPrice method. Calculate the Bond Clean Price.
	*  @param [in]		swapObjectName		Swap object name
    ...
    *  @return			Par/Par Asset Swap Spread
	*/
    double tryMeLWOAssetSwapSpreadToCleanPrice( const std::string& swapObjectName, const double& assetSwapParParSpread, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
	    VALID_EXCEPTION_START
