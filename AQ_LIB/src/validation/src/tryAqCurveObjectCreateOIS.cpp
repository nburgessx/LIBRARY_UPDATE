...
#include "tryAqCurveObjectCreateOIS.h"
...
namespace validation
{
    ...
    /* @brief			validation interface for the aqCurveObjectCreateOIS method
    ...
    */
    const AQLString tryAqCurveObjectCreateOIS( const std::string& aqObjCurveName,
                                           ...
                                           const AQLStringMatrix& swapRates )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateOIS_inputs", curveCollection, staticDataTable ) );
