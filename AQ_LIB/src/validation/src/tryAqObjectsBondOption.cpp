#include "tryAqObjectsBondOption.h"
...
namespace validation
{
	...
	/* @brief			validation interface for the aqObjectsBondOptionCreate method
	...
	*/
	std::string tryAqObjectsBondOptionCreate(const std::string& objectName, const LabelValueBlock& optionLVB, const bool& validateKeys)
	{
    ...
    /* @brief			validation interface for the aqObjectsBondOptionDisplay method, which displays the INPUT parameters of the cached option
	*  @param [in]		objectName		BondOption object name
	*  @return			Display of the swaption input parameters
	*/
	AnyTypeMatrix tryAqObjectsBondOptionDisplay(const std::string& objectName)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsBondOptionPV method, which calculates the PV of the cached bond option
	*  @param [in]		objectName			BondOption object name
	...
	*/
	double tryAqObjectsBondOptionPV(const std::string& objectName, const AQLStringMatrix& valuationSettings, const double& bondPrice, const double& repoRate, const std::string& repoDaycount, const double& discountRate, const std::string& discountDayCount)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsBondFutureOptionPV method, which calculates the PV of the cached bond future option
	*  @param [in]		objectName			BondOption object name
	*  @param [in]		valuationSettings	A LabelValueBlock containing valuation settings such as Bond's valuation date, discountCurve's curveCollection
	...
	*  @return			The Bond Option PV
	*/
	double tryAqObjectsBondFutureOptionPV(const std::string& objectName, const AQLStringMatrix& valuationSettings, const double& bondFuturePrice, const double& discountRate, const std::string& discountDayCount)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsBondFutureOptionGreeks method, to calculate Numerical greeks
	...
	*/
	...
	/* @brief			validation interface for the aqObjectsBondOptionGreeks method, to calculate Numerical greeks
	*  @param [in]		greekType			Greek type: Analytical or Numerical
	*  @param [in]		objectName			BondOption object name
	*  @param [in]		valuationSettings	A LabelValueBlock containing valuation settings such as Bond's valuation date, discountCurve's curveCollection
	*  @param [in]		bondFuturePrice		Bond forward price at option expiry date
	...
	*  @return			Bond option Greeks' display
	*/
	AnyTypeMatrix tryAqObjectsBondOptionGreeks(const std::string& greekType, const std::string& objectName, const AQLStringMatrix& valuationSettings, const double& bondSpotPrice, const double& repoRate, const std::string& repoDaycount, const double& discountRate, const std::string& discountDayCount, const double & deltaBump, const double & gammaBump, const double & vegaBump, const double & thetaBump, const double & rhoBump, const bool& showColumnHeaders)
	{
		VALID_EXCEPTION_START
