...
namespace validation
{
	...
	*/
    std::string tryAqObjectsFixingTableCreate( const std::string& tableName,
	...
	*/
    ...
    etrading::VariantMatrix tryAqObjectsFixingTableDisplay( const std::string& tableName )
    {
         VALID_EXCEPTION_START
    ...
    double tryAqObjectsFixingTableValue( const std::string& tableName, const boost::gregorian::date fixingDate )
    {
        VALID_EXCEPTION_START
	...
	*/
    std::vector< double > tryAqObjectsFixingTableValues( const std::string& tableName, const std::vector< boost::gregorian::date >& fixingDates )
    {
        VALID_EXCEPTION_START
	...
	*  @return			A vector of fixing values
	*/
    std::vector< double > tryAqObjectsFixingTableValues( const std::string& tableName, const std::string& currency, const std::string& curveTenor, const std::vector< boost::gregorian::date >& fixingDates )
    {
        VALID_EXCEPTION_START
	...
	*  @return			A vector of fixing values
	*/
	std::vector< double > tryAqObjectsFixingTableValues(const std::string& tableName, const etrading::LabelValueBlock& parameterLVB, const std::vector< boost::gregorian::date >& fixingDates)
	{
		VALID_EXCEPTION_START;
