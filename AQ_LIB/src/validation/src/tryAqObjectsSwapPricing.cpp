...
namespace validation
{
    ...
    /* @brief			Helper utility method for the aqObjectsSwapPV method
	...
	*  @return			Swap PV
	*/
	double tryAqObjectsSwapPV(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const AQLString& legName, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	*  @return			Swap PV01
	*/
	double tryAqObjectsSwapPV01(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsSwapParRate(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& legName)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsSwapSpread(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& spreadLegName)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsSwapParSpread(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames, const AQLString& spreadLegName)
	{
		VALID_EXCEPTION_START
	...
	*  @return			Swap display
	*/
	std::vector<AnyTypeMatrix> tryAqObjectsSwapDisplayCashflows(const std::string& swapName, 
	...
	*/
	double tryAqObjectsSwapAccruedInterest(const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const AQLString& legName, const LabelValueBlock& fixingTableNames)
	{
	    VALID_EXCEPTION_START
	...
	*/
	...
	/* @brief validation interface for the aqObjectsCreditOptionPVFromForward method.
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjectsConstantMaturitySwapPVUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const AQLString& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsConstantMaturitySwapParRateUsingConvexityAdjustment( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double convexityAdjustment, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	* @returns	The calculated PV value
	*/
	double tryAqObjectsTotalReturnSwapPV( const std::string& swapName, const std::string& creditModelName,  const std::string& legName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsTotalReturnSwapParRate( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqObjectsTotalReturnSwapParSpread( const std::string& swapName, const std::string& creditModelName, const LabelValueBlock& fixingTableNames )
	{
		VALID_EXCEPTION_START
