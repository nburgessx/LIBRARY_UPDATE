...
namespace validation
{
	...
	*  @return			swapName
	*/
	std::string tryAqObjSwapsCreateFromLegs(const std::string& swapName, const std::vector<std::string>& legObjectNames, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
	...
	*  @return			swapName
	*/
	std::string tryAqObjSwapsCreateFromLegLVBs(const std::string& swapName, const LabelValueBlock& leg1LVB, const LabelValueBlock& leg2LVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjSwapsCreate(const std::string& swapName, const AQLStringMatrix& swapLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjSwapsCreateFromSchedule(const std::string& swapName, const std::string& schedule1Name, const std::string& schedule2Name, 
	...
	*/
	std::vector<AnyTypeMatrix> tryAqObjSwapsDisplay(const std::string& swapName)
	{
		...
		{
			CreateDataFile file(decorateFilename("tryAqObjSwapsDisplay_outputs", swapName.c_str()));
	...
	*/
	std::string tryAqObjSwapsGeneratorCreate(const std::string& swapGeneratorName, const AQLStringMatrix& swapGeneratorLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*  @return			swapName
	*/
	std::string tryAqObjSwapsCreateFromGenerator(const std::string& swapName, const std::string& swapGeneratorName, const LabelValueBlock& expressionLVB, const LabelValueBlock& swapPropertiesLVB, bool isXccySwap, bool validateKeys)
	{
		VALID_EXCEPTION_START
