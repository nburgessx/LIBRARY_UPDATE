...
namespace validation
{
	...
	/* @brief			validation interface for the aqObjectsLegCreate method
	...
	*/
	std::string tryAqObjectsLegCreate(const std::string& legObjectName, const LabelValueBlock& legLVB, bool validateKeys)
	{
	...
	*  @return			legObjectName
	*/
	std::string tryAqObjectsFeeLegCreate(const std::string& legObjectName, const LabelValueBlock& feeProperties, const AQLStringMatrix& feeScheduleLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsLegCreateFromSchedule method
	*  @param [in]		legObjectName	Leg object name
	...
	*  @return			swapName
	*/
	std::string tryAqObjectsLegCreateFromSchedule(const std::string& legObjectName, const std::string& scheduleName, const LabelValueBlock& legLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjectsLegPV method
	*  @param [in]		legObjectName		Leg object name
	...
	*  @return			Leg PV
	*/
	double tryAqObjectsLegPV(const std::string& legObjectName, const LabelValueBlock& valuationSettingsLVB, const std::string& fixingTableName)
	{
		VALID_EXCEPTION_START
    ...
    /* @brief			validation interface for the aqObjectsLegDisplay method, which display the INPUT parameters of the cached swap
	*  @param [in]		legObjectName		Leg object name
	*  @return			Leg display of the input parameters
	*/
	AQLStringMatrix tryAqObjectsLegDisplay(const std::string& legObjectName)
	{
		VALID_EXCEPTION_START
	...
	*/
	AnyTypeMatrix tryAqObjectsLegDisplayCashflows(const std::string& legObjectName, const LabelValueBlock& valuationSettingsLVB, const std::string& fixingTableName, bool showColumnHeaders, const std::vector<std::string>& columnList)
	{
		VALID_EXCEPTION_START
