...
namespace validation
{
	...
	*/
	AnyTypeMatrix tryAqSwapsLegDisplay(const LabelValueBlock& legLVB, bool validateKeys, bool showColumnHeaders, const std::vector<std::string>& columnList)
	{
	...
	*  @return			Swap Leg PV
	*/
	double tryAqSwapsLegPV(const LabelValueBlock& legLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqSwapsLegAnnuity(const LabelValueBlock& legLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
