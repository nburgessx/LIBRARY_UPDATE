#include "tryAqCurvesEuroDollarConvexityAdjustment.h"
...
namespace validation
{
	...
	/* @brief			Calculate the FRA rate from Future price, validation API for aqRatesFuturePriceToFraRate
	...
	*/
	double tryAqRatesFuturePriceToFraRate(const double& futurePrice, const AQLDate& curveAsOfDate, const AQLDate& futuresStartDate, const AQLDate& futuresEndDate, const double& meanReversion, const double& volatility)
	{
	...
	/* @brief			Calculate the FRA rate from Future price, validation API for aqRatesFuturePriceToFraRateFromConvAdj
	* @param [in]		futurePrice			The given future price
	* @param [in]		convexityAdjustment The given convexity adjustment between Future rate and Fra rate
	* @param [out]		Returns Fra rate
	*/
	double tryAqRatesFuturePriceToFraRateFromConvAdj(const double& futurePrice, const double& convexityAdjustment)
	{
