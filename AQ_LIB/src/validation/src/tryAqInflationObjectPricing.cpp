...
namespace validation
{
	 ...
	 */
	std::string tryAqInflationCurveCreate( const std::string& objectName,
											  ...
											  const etrading::JSONInfoBlockTuples& infoBlocks )
	{
		...
		{
			CreateDataFile file(decorateFilename("tryAqInflationCurveCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqInflationCurveCreate");
	 ...
	 */
	AnyTypeMatrix tryAqInflationCurveCalibrationParameters( const std::string& inflationCurveName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqInflationObjectZCSwapPVFromIndex method.
	...
	*/
	double tryAqInflationObjectZCSwapPVFromIndex( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double baseIndex, const double resetIndex, const std::string& legName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqInflationObjectZCSwapPV method.
	*			Calculates the PV of the specified Zero Coupon Inflation Swap.
	...
	* @returns	The calculated PV value
	*/
	double tryAqInflationObjectZCSwapPV( const std::string& swapName, const std::string& inflationCurveName, const LabelValueBlock& valuationSettingsLVB, const std::string& legName )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqInflationObjectZCSwapParRateFromIndex method.
	...
	*/
	double tryAqInflationObjectZCSwapParRateFromIndex( const std::string& swapName, const LabelValueBlock& valuationSettingsLVB, const double baseIndex, const double resetIndex )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqInflationObjectZCSwapParRate method.
	...
	* @returns	The calculated break-even par-rate value
	*/
	double tryAqInflationObjectZCSwapParRate( const std::string& swapName, const std::string& inflationCurveName, const LabelValueBlock& valuationSettingsLVB )
	{
		VALID_EXCEPTION_START
	...
	/* @brief	validation interface for the aqInflationObjectCPI method.
	...
	*/
	double tryAqInflationObjectCPI( const std::string& inflationCurveName, const AQLDate& date, const std::string& inflationResetType, const std::string& lag )
	{
		VALID_EXCEPTION_START
