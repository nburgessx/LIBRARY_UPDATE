...
namespace validation
{
	...
	*/
														...
														const std::string& swapObjectName, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
    {
        ...
        for ( unsigned int i = 0; i < expectedSize; ++i )
        {
			...
			double spread							= tryAqAssetSwapObjectSpreadFromPrice( bondPrice, bondAccrualStartDate, isCleanPrice, swapObjectName, valuationSettingsLVB, fixingTableNames);
    ...
    *  @return			Par/Par Asset Swap Spreads
	*/
    std::vector< double > tryAqAssetSwapObjectSpread( const std::string& swapObjectName, const std::string& bondObjectName, const std::vector< double >& bondPrices, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
        ...
        {
            const double bondPrice          = bondPrices[i];
			double spread                 = tryAqAssetSwapObjectSpread( swapObjectName, bondObjectName, bondPrice, valuationSettingsLVB, fixingTableNames);
	...
	/* @brief			Helper interface for the aqAssetSwapObjectSpread method. Calculate the Par/Par Asset Swap Spread.
	*  @param [in]		swapObjectName		Swap object name
	*  @param [in]		bondObjectName		Bond object name
    *  @param [in]		bondPrice		    Bond price
	*  @param [in]		valuationSettingsLVB    A LVB containing ModelName, CurveCollection, ValuationDate, etc.
    ...
    *  @return			Par/Par Asset Swap Spread
	*/
    double tryAqAssetSwapObjectSpread( const std::string& swapObjectName, const std::string& bondObjectName, const double& bondPrice, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
	    VALID_EXCEPTION_START
	...
	*/
	double tryAqAssetSwapObjectFixedEqvCoupon(const std::string& swapObjectName, const std::string& bondObjectName, const double& bondPrice, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	*/
	double tryAqAssetSwapObjectSpreadFromFixedEqvCoupon(const std::string& swapObjectName, const double& fixedEqvCoupon, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqAssetSwapObjectSpreadToCleanPrice method. Calculate the Bond Clean Prices.
	*  @param [in]		swapObjectName		Swap object name
    ...
    *  @return			Par/Par Asset Swap Spreads
	*/
    std::vector< double > tryAqAssetSwapObjectSpreadToCleanPrice( const std::string& swapObjectName, const std::vector< double >& assetSwapParParSpreads, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
        ...
        for ( unsigned int i = 0; i < expectedSize; ++i )
        {
			...
			double bondCleanPrice               = tryAqAssetSwapObjectSpreadToCleanPrice( swapObjectName, assetSwapParParSpread, valuationSettingsLVB, fixingTableNames);
	...
	/* @brief			Helper interface for the aqAssetSwapObjectSpreadToCleanPrice method. Calculate the Bond Clean Price.
	*  @param [in]		swapObjectName		Swap object name
    ...
    *  @return			Par/Par Asset Swap Spread
	*/
    double tryAqAssetSwapObjectSpreadToCleanPrice( const std::string& swapObjectName, const double& assetSwapParParSpread, const LabelValueBlock& valuationSettingsLVB, const LabelValueBlock& fixingTableNames )
    {
	    VALID_EXCEPTION_START
