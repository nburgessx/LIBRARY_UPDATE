...
namespace validation
{
    ...
    */
    std::string tryMeFuturesTickerCurrent( const LADate & valuationDate, const bool includeToday, const bool showYearWithTwoDigits )
    {
    ...
    */
    std::string tryMeFuturesTickerNext( const LADate & referenceDate, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
    ...
    */
    std::string tryMeFuturesTickerPrevious( const LADate & referenceDate, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
    ...
    */
    std::string tryMeFuturesTickerNth( const LADate & valuationDate, const int nthIMM, const bool includeToday, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
