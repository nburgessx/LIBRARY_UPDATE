...
namespace validation
{
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjectsCurveBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
