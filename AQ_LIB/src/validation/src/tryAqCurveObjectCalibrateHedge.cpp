...
{
    /* @brief			Validation interface for the aqCurveObjectCalibrateHedge method. This method calibrates a hedge curve to a pricing curve
	*  @param [in]		oisCurveObjectName			AQObj object name of the ois hedge curve
	*  @param [in]		swapCurveObjectName			AQObj object name of the swap hedge curve
    ...
    */
	etrading::HedgeCurveInfo tryAqCurveObjectCalibrateHedge( const std::string& oisCurveObjectName,
