...
namespace validation
{
    ...
    std::pair<const bool, std::string> tryAqObjectsGridLoad(	const std::string& fileName )
    {
    ...
    std::string tryAqObjectsGridSave( const std::string& objectName,
