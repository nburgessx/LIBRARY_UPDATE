...
namespace validation_api
{
    ...
    */
                                            ...
                                            const bool optimize )
    {
        ...
        const DoubleVector result = tryMeMathIntegrateUsingTerms( terms, values, interpolationType, joinDateAsDouble, lowerBoundsAsDouble, upperBoundsAsDouble, nSteps, optimize );
        return result;
