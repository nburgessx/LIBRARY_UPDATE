...
namespace validation
{
	...
	/* @brief			validation interface for the aqObjectsScheduleCreate method
	...
	*/
	std::string tryAqObjectsScheduleCreate(const std::string& scheduleName, const LabelValueBlock& swapScheduleLVB, bool validateKeys)
	{
    ...
    */
    AnyTypeMatrix tryAqObjectsScheduleDisplay( const std::string& scheduleName, bool showBespokeProperties, bool showColumnHeaders, const std::vector<std::string>& columnList)
    {
        VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsScheduleCreateBespoke method
    ...
    *  @return			The schedule name
    */
	std::string tryAqObjectsScheduleCreateBespoke(const std::string& scheduleName, const LabelValueBlock& bespokeScheduleProperties, const AQLStringMatrix& bespokeScheduleLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
	...
	/* @brief			validation interface for the aqObjectsScheduleCreateBespokeFromCashflows method
	...
	*  @return			The schedule name
	*/
	std::string tryAqObjectsScheduleCreateBespokeFromCashflows(const std::string& scheduleObjectName, const LabelValueBlock& bespokeScheduleProperties, const AQLStringMatrix& bespokeCashflowsLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
   	...
   	/* @brief			validation interface for the aqObjectsFeeScheduleCreate method
	*  @param [in]		scheduleName				Fee schedule name
	*  @param [in]		feeScheduleLVB				Fee schedule cashflow label value block
	*  @param [in]		validateKeys		True to validate the all keys provided are valid. Default to True
    *  @return			The schedule name
    */
	std::string tryAqObjectsFeeScheduleCreate(const std::string& scheduleName, const AQLStringMatrix& feeScheduleLVB, bool validateKeys)
	{
		VALID_EXCEPTION_START
