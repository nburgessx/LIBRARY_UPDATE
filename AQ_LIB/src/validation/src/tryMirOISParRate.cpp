...
namespace validation_api
{
    ...
    */
                             ...
                             const LAString& oisCompoundingType )
    {
        ...
        {
            CreateDataFile file( decorateFilename( "tryMirOISParRate_inputs", curveID ) );
            file.write( "generatorFunction", "tryMirOISParRate" );
            ...
            file.write( "oisCompoundingType", oisCompoundingType );
        }
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryMirOISParRate_outputs", curveID ) );
