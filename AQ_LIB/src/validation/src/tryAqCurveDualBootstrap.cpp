#include "tryAqCurveDualBootstrap.h"
...
namespace validation
{
    ...
    */
    const AQLString tryAqCurveDualBootstrap(const AQLString& curveCollection,
											...
											const AQLStringMatrix& tenorBasisRates_swap)
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveDualBootstrap_inputs", curveCollection, curveName_db) );
            file.write( "generatorFunction", "tryAqCurveDualBootstrap" );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveDualBootstrap_outputs", curveCollection, curveName_db ) );
