...
#include "tryAqObjToolsMultiGrid.h"
...
namespace validation
{
                                            ...
                                            const bool allowJaggedData )
    {
        ...
        {
			throw AQLCoreInvalidData( "#Error: No Grid Information provided to tryAqObjToolsMultiGridCreate", __FILE__, __LINE__ );
        }
    ...
    tryAqObjToolsMultiGridSubNames( const std::string&  objectName )
    {
