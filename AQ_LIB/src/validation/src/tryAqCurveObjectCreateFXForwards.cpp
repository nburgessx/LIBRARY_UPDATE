...
namespace validation
{
    ...
    /* @brief			validation method for aqCurveObjectCreateFXForwards
    ...
    */
    AQLString tryAqCurveObjectCreateFXForwards( const std::string& aqObjCurveName,
                                            ...
                                            const AQLStringMatrix& fxFwdConv )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateFXForwards_inputs", curveCollection, staticDataTable ) );
        ...
        if( curve_store.has( aqObjCurveName ) )
        {
            ...
            if ( CreateDataFile::recordEnabled() )
            {
                CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateFXForwards_outputs", curveCollection, staticDataTable ) );
