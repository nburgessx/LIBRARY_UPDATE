...
#include "tryAqToolClean.h" // Data Trimming Methods
...
namespace validation
{
    ...
    */
                                  ...
                                  const DoubleVector& xccyFXSpotRates )
    {
        ...
        {
            CreateDataFile file( decorateFilename( "tryAqSwapObjectDeltaLadder_outputs") );
    ...
    */
                                              ...
                                              const DoubleVector& xccyFXSpotRates )
	{
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryAqSwapObjectDeltaLadderHorizontal_outputs") );
    ...
    */
                            ...
                            const DoubleVector& xccyFXSpotRates)
    {
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryAqSwapObjectDelta_outputs") );
