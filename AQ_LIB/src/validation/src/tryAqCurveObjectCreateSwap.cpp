...
#include "tryAqCurveObjectCreateSwap.h"
...
namespace validation
{
    ...
    /* @brief			validation interface for aqCurveObjectCreateSwap
    ...
    */
    const AQLString tryAqCurveObjectCreateSwap( const std::string& aqObjCurveName,
                                            ...
                                            const AQLStringMatrix& convexityAdjRates )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateSwap_inputs", curveCollection, staticDataTable ) );
            file.write( "generatorFunction", "tryAqCurveCalibrateSwap" );
        ...
        if( curve_store.has( curveNameForAQObjCurve ) )
        {
            ...
            if ( CreateDataFile::recordEnabled() )
            {
                CreateDataFile file( decorateCurvename( "tryAqCurveObjectCreateSwap_outputs", curveCollection, staticDataTable ) );
