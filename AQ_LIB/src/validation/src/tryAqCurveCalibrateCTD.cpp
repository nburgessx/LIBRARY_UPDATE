...
namespace validation
{
    ...
    */
                                    ...
                                    const AQLStringVector& collateralCurves )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateCTD_inputs", curveCollection, curveName ) );
            file.write( "generatorFunction", "tryAqCurveCalibrateCTD" );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateCTD_outputs", curveCollection, curveName ) );
