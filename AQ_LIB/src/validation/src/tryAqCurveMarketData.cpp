...
namespace validation
{
	 ...
	 */
    std::string tryAqCurveMarketDataCreate(  const std::string& objectName,
												...
												const std::vector<TableInfo>& infoBlocks )
	{
		...
		{
			CreateDataFile file(decorateFilename("tryAqCurveMarketDataCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqCurveMarketDataCreate");
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqCurveMarketDataCreate_outputs", objectName.c_str()));
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveMarketDataBumpClear( const std::string& objectName )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveObjectBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqCurveObjectBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
	...
	*/
	etrading::VariantMatrix tryAqCurveMarketDataDisplay( const std::string& marketDataObjectName,
	...
	* @param [out]						A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantMatrix tryAqCurveMarketDataDisplayFromCurve( const std::string& curveObjectName,
																	 const std::string& marketDataKey,
																	 const int columnIndexToDisplay )
    {
		VALID_EXCEPTION_START
	...
	* @param [out]                  A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantVector tryAqCurveMarketDataColumn( const std::string& curveObjectName,
														   const std::string& marketDataKey,
