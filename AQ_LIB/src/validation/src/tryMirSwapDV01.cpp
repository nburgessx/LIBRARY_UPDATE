...
namespace validation
{
    ...
    */
    double tryMirSwapDV01( AQLDataInstance* dataInstance,
                           double notional,
                           ...
                           double floatSpread )
    {
        ...
        {
            CreateDataFile file( decorateFilename( "tryMirSwapDV01_inputs", curveID ) );
            file.write( "generatorFunction", "tryMirSwapDV01" );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryMirSwapDV01_outputs", curveID ) );
