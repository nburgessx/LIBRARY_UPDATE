...
namespace validation
{
    ...
    */
														...
														const std::string& businessDayAdjust)
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromYearFraction_inputs", curveCollection, curveIndex ) );
            file.write( "generatorFunction",    "tryAqCurveForwardRatesFromYearFraction" );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromYearFraction_outputs", curveCollection, curveIndex ) );
    ...
    /* @brief			validation interface for tryAqCurveForwardRatesFromForwardDates
    *  @param [in]		fromDates	    A vector of from dates
    ...
    */
														 ...
														 const std::string& businessDayAdjust)
    {
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromForwardDates_inputs", curveCollection, curveIndex ) );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromForwardDates_outputs", curveCollection, curveIndex ) );
    ...
    */
																   ...
																   const std::string& businessDayAdjust)
    {
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromForwardDates_inputs", curveCollectionFromHandle, curveIndex ) );
            file.write( "generatorFunction",    "tryAqCurvesForwardRatesFromForwardRates" );
            file.write( "fromDates",			fromDates );
            file.write( "toDates",			    toDates );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRatesFromForwardDates_outputs", curveCollectionFromHandle, curveIndex ) );
            file.write( "output", results );
        }
    ...
    */
										 ...
										 const std::string& businessDayAdjust)
    {
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRates_inputs", curveCollectionFromHandle, curveIndex ) );
            file.write( "generatorFunction", "tryAqCurveForwardRates" );
		...
		if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveForwardRates_outputs", curveCollectionFromHandle, curveIndex ) );
            file.write( "output", result );
        }
