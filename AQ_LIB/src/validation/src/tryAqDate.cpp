...
namespace validation
{
    ...
    */
                               ...
                               const AQLString& rollConvention )
    {
        ...
        DateVector ret = tryAqDateFromTenor( startDateVector, tenor, businessDayAdj, calendar, rollConvention );
        return ret[0];
    ...
    */
    AQLDate tryAqDateFuturesContract( const AQLString& futuresTicker )
    {
        ...
        {
            CreateDataFile file( "tryAqDateFuturesContract_inputs" );
            file.write( "generatorFunction", "tryAqDateFutureStart" );
