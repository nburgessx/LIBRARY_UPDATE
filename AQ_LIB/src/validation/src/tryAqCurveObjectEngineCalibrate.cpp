...
namespace validation
{
	...
	*/
												...
												const std::vector<std::string>& marketDataObjects)
    {
		...
		{
			CreateDataFile file(decorateFilename("tryAqCurveObjectEngineCalibrate_inputs", engineObjectName.c_str()));
			file.write("generatorFunction", "tryAqCurveObjectEngineCalibrate");
