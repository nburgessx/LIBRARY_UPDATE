...
namespace validation
{
    ...
    */
    const VariantMatrix tryMeUtilityDataFilter( const VariantVector & dataVector, const bool displayByRow )
    {
        VALID_EXCEPTION_START

        // Record Inputs for logs, tests and playback
        RECORD_INPUTS( dataVector, displayByRow );
