...
{
	/* @brief			validation interface for the aqCurveCalibrateBasis method
    ...
    */
    const AQLString tryAqCurveCalibrateBasis( const AQLString& curveCollection,
											 ...
											 const AQLStringMatrix& liborRates)
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateBasis_inputs", curveCollection, staticDataTable ) );
            file.write( "generatorFunction", "tryAqCurveCalibrateBasis" );
        ...
        */
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateBasis_outputs", curveCollection, staticDataTable ) );
