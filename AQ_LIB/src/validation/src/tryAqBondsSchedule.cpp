...
namespace validation
{
    ...
    */
    AQLStringMatrix tryAqBondsSchedule( const LabelValueBlock& bondScheduleLVB, bool validateKeys, bool showColumnHeaders, const std::vector<std::string>& columnList )
    {
