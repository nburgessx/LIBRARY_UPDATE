...
namespace validation
{
    ...
    */
	void tryAqObjSwapsDeltaLadder( AQLStringVector& headers,
                                  ...
                                  const DoubleVector& xccyFXSpotRates )
    {
        ...
        {
            CreateDataFile file( decorateFilename( "tryAqObjSwapsDeltaLadder_outputs") );
    ...
    *  @param [in]		xccyFXSpotRates			        A vector of doubles representing Xccy FX Spot Rates
    */
	void tryAqObjSwapsDeltaLadderHorizontally( AQLStringVector& headers,
                                              ...
                                              const DoubleVector& xccyFXSpotRates )
	{
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryAqObjSwapsDeltaLadderHorizontal_outputs") );
    ...
    *  @param [in]		xccyFXSpotRates			        A vector of doubles representing Xccy FX Spot Rates
    */
	void tryAqObjSwapsDelta( AQLStringVector& positionIDs,
							DoubleVector& deltas,
							const AQLStringVector& swapNames,
							const AQLStringMatrix& curveCollectionNames,
							const AQLStringMatrix& fixingTableNames,
                            ...
                            const DoubleVector& xccyFXSpotRates)
    {
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateFilename( "tryAqObjSwapsDelta_outputs") );
