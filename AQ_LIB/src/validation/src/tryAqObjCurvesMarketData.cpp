...
namespace validation
{
	 ...
	 */
    std::string tryAqObjCurvesMarketDataCreate(  const std::string& objectName,
												...
												const std::vector<TableInfo>& infoBlocks )
	{
		...
		{
			CreateDataFile file(decorateFilename("tryAqObjCurvesMarketDataCreate_inputs", objectName.c_str()));
			file.write("generatorFunction", "tryAqObjCurvesMarketDataCreate");
		...
		if (CreateDataFile::recordEnabled()) 
		{
			CreateDataFile file(decorateFilename("tryAqObjCurvesMarketDataCreate_outputs", objectName.c_str()));
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesMarketDataBumpClear( const std::string& objectName )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesMarketDataBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesBumpInstrument( const std::string& objectName, const std::string & marketDataType, const double bumpSize, const bool clearExistingBumps )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesMarketDataBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
     ...
     * @param [out]                                 The objectName
	 */
    std::string tryAqObjCurvesBumpAll( const std::string& objectName, const double bumpSize, const bool onlyBumpOutrightInstruments )
    {
        VALID_EXCEPTION_START
	...
	/* @brief Displays a AQObjCurveMarketData
	...
	*/
	etrading::VariantMatrix tryAqObjCurvesMarketDataDisplay( const std::string& marketDataObjectName,
	...
	* @param [out]						A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantMatrix tryAqObjCurvesMarketDataDisplayFromCurve( const std::string& curveObjectName,
																	 const std::string& marketDataKey,
																	 const int columnIndexToDisplay )
    {
		VALID_EXCEPTION_START
    ...
    /* @brief Displays a Column AQObjCurveMarketData for use with Google Test Calibration Tests
	* @param [in] curveObjectName      The curve object whose market data you wish to display
	* @param [in] marketDataKey     The name of the marketData label-value block that you wish to display
    * @param [in] columnNumber      Optional Column Number to display using column base index 1 and -1 to display all columns
	* @param [out]                  A VariantMatrix containing a LabelValue block of properties
	*/
	etrading::VariantVector tryAqObjCurvesMarketDataColumn( const std::string& curveObjectName,
														   const std::string& marketDataKey,
