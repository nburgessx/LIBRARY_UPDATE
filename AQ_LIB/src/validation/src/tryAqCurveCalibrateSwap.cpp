...
namespace validation
{
    ...
    */
                                            ...
                                            const AQLStringMatrix& tenorBasisRates )
    {
        ...
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateSwap_inputs", curveCollection, staticDataTable ) );
        ...
        if ( CreateDataFile::recordEnabled() )
        {
            CreateDataFile file( decorateCurvename( "tryAqCurveCalibrateSwap_outputs", curveCollection, staticDataTable ) );
