...
namespace validation
{
    ...
    */
    std::string tryAqFutureTickerCurrent( const AQLDate & valuationDate, const bool includeToday, const bool showYearWithTwoDigits )
    {
    ...
    */
    std::string tryAqFutureTickerNext( const AQLDate & referenceDate, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
    ...
    */
    std::string tryAqFutureTickerPrevious( const AQLDate & referenceDate, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
    ...
    */
    std::string tryAqFutureTickerNth( const AQLDate & valuationDate, const int nthIMM, const bool includeToday, const bool showYearWithTwoDigits )
    {
        VALID_EXCEPTION_START
