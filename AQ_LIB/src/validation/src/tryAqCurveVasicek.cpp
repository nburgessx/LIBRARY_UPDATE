...
namespace validation
{
    ...
    */
    AnyTypeMatrix tryAqCurveVasicekChecking(const DateVector& fixingDates, const DoubleVector& targetForwardRates, const std::string& curveCollection, const std::string& curveIndex, 
    ...
    */
	DoubleVector tryAqCurveVasicekForwardRates(const DateVector& fixingDates, const std::string& curveCollection, const std::string& curveIndex,
