...
*/
AQLScenarioConfigurationVolatility::AQLScenarioConfigurationVolatility(void)
{
}
...
*/
vector<AQLObject *>
AQLScenarioConfigurationVolatility::createParallelShiftVol(AQLDataInstance &dataInstance, AQLMathVolatility &baseVol, const AQLScenarioParam &param) const
{
	vector<AQLObject *> ret(0);
	...
	AQLCalibrateVolatility *volCreator = AQLCalibrateVolatilityManager::getInstance()->createVolCreator(param.model);
...
*/
vector<AQLObject *>
AQLScenarioConfigurationVolatility::createGridShiftVol(AQLDataInstance &dataInstance, AQLMathVolatility &baseVol, const AQLScenarioParam &param) const
{
	vector<AQLObject *> ret(0);
	AQLString inputType = param.inputType;
	inputType.toUpper();
...
*/
void 
AQLScenarioConfigurationVolatility::searchCoordinatesMatrix(const DoubleArray &grid_t, const DoubleArray &grid_T,
...
{
	AQLCalibrationUtilities<double>::searchNearestPos(grid_t, area[0], pos_t_s);
	AQLCalibrationUtilities<double>::searchNearestPos(grid_t, area[1], pos_t_e);
	AQLCalibrationUtilities<double>::searchNearestPos(grid_T, area[2], pos_T_s);
	AQLCalibrationUtilities<double>::searchNearestPos(grid_T, area[3], pos_T_e);
...
*/
void 
AQLScenarioConfigurationVolatility::getCoordinatesMatrix(const AQLStringVector &term, DoubleMatrix &matrix) const
{
	matrix.clear();
	// day count
