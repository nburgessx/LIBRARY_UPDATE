...
//  2007, AlgoQuantHub.
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLCalibrationParametersSZ.cpp
//
...
*/
AQLCalibrationParametersSZ::AQLCalibrationParametersSZ(void)
...
*/
AQLString
AQLCalibrationParametersSZ::createCalibrationInfo(AQLObjectPool &objPool, const AQLString &fx)
{
	AQLString keyFX = fx;
	...
	AQLString infoname = AQLCalibrationParametersSZ::createCalibrationInfo2(objPool, fx);
...
AQLString
AQLCalibrationParametersSZ::createCalibrationInfo2(AQLObjectPool &objPool, const AQLString &fx)
{
	AQLString keyFX = fx;
	const AQLString CALIBINFONAME = keyFX.toUpper() + "_SZCalibInfoEntity";
	AQLObject *info = 0;
...
*/
AQLString
AQLCalibrationParametersSZ::getCalibStaticDataValue(const AQLString &key, const AQLString &grid)
{
