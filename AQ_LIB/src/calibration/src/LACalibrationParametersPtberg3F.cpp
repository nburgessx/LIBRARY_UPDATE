...
*/
AQLString 
LACalibrationParametersPtberg3F::createCalibrationInfo(AQLObjectPool &objPool, const AQLString &fx)
{
	AQLString keyFX = fx;
	...
	AQLString infoname = LACalibrationParametersPtberg::createCalibrationInfo(objPool, fx);
