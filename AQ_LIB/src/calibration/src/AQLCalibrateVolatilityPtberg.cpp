...
*/
AQLCalibrateVolatilityPtberg::AQLCalibrateVolatilityPtberg(void)
{
}
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(DoubleArray &grid_t, vector<DoubleMatrix> &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(vector<vector<AQLFunctionBase *> > &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(DoubleArray &grid_T, vector<AQLFunctionBase *> &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
	(void)grid_T, (void)vol, (void)filePath, (void)param, (void)objPool;
	throw AQLCoreInvalidData("This create method is not support in ptberg.", __FILE__, __LINE__);
}
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(DoubleArray &grid_t, DoubleMatrix &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
	(void)grid_t, (void)vol, (void)filePath, (void)param, (void)objPool;
	throw AQLCoreInvalidData("This create method is not support in ptberg.", __FILE__, __LINE__);
}
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(vector<AQLFunctionBase *> &vol, const AQLStringVector &filePath, 
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(DoubleArray &grid_T, AQLFunctionBase *vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
	(void)grid_T, (void)vol, (void)filePath, (void)param, (void)objPool;
	throw AQLCoreInvalidData("This create method is not support in ptberg.", __FILE__, __LINE__);
}
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(DoubleArray &grid_t, DoubleArray &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
	(void)grid_t, (void)vol, (void)filePath, (void)param, (void)objPool;
	throw AQLCoreInvalidData("This create method is not support in ptberg.", __FILE__, __LINE__);
}
...
*/
AQLFunctionBase * 
AQLCalibrateVolatilityPtberg::createVolatility(const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool, int gridPos) const
{
	// null check
	if (!param || !objPool)
	{
	...
	if (param->isCalib)
	{
		...
		AQLCalibratePtberg *request = 0;
		const bool is3F = AQLPtbergUtils::is3FCalib();
		if (is3F)
		{
			request = new AQLCalibratePtberg3F();
		}
		else
		{
			request = new AQLCalibratePtberg();
		}
		//AQLCalibratePtberg *request = new AQLCalibratePtberg();
		// set up
...
////////////////////////////////////////////////////////////////////////////////////// for XLL Plus
		...
		AQLString includeFX = AQLCoreDataService::getStaticDataManager().getStaticData().getStaticData(propKey+FX_KEY_PTBERG_VOLATILITY_CALIB_FILE_FORWORDGRIDS_ISINCLUDE);
...
*/
void 
AQLCalibrateVolatilityPtberg::createVolatility(double &vol, const AQLStringVector &filePath, const AQLScenarioParam *param, AQLObjectPool *objPool) const
{
...
*/
void 
AQLCalibrateVolatilityPtberg::getGrid_T(DoubleArray &grid_T, const AQLStringVector &filePath) const
{
	filePath;
