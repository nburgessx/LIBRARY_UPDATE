...
{
	AQLString is3FStr = LACoreDataService::getStaticDataManager().getStaticData().getStaticData(KEY_PTBERG_IS3F);
	...
	if (is3FCalib.get())
	{
		AQLString is3FCalibStr = LACoreDataService::getStaticDataManager().getCalibStaticData().getStaticData(KEY_CALIB_PTBERG_IS3F);
