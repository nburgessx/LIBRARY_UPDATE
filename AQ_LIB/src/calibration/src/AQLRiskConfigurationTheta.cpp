...
*/
AQLRiskConfigurationTheta::AQLRiskConfigurationTheta(void)
...
AQLRiskConfigurationTheta::createRiskEntity(AQLObjectPool &objPool) const
{
	AQLStringVector ccys = AQLDealUtils::getSimulationSDECurrencys();
...
*/
void
AQLRiskConfigurationTheta::setUpTargetNames(const AQLString &ccy, AQLObject &e, AQLDataInstance &dataInstance) const
{
	(void)ccy;
	...
	AQLMathPathEntity* pPath = AQLMarketData::getPathEnitty(objPool);
	if (pPath)
	{
		...
		{
			AQLMathFXEntity *pFX = AQLMarketData::getFXEntity(objPool, "USEMODEL");
			if (!pFX)
			{
...
*/
vector<AQLObject *> 
AQLRiskConfigurationTheta::createScenario1Entity(const AQLString &ccy, AQLDataInstance &dataInstance, int index)  const
{
...
*/
vector<AQLObject *> 
AQLRiskConfigurationTheta::createScenario2Entity(const AQLString &ccy, AQLDataInstance &dataInstance, int index)  const
{
...
*/
vector<AQLObject *> 
AQLRiskConfigurationTheta::createThetaEntity(const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	index;
	...
	for (unsigned int i = 0; i < targetNames.size(); i++)
	{
		...
		{
			AQLString mainModel = AQLMarketData::getModelName(AQLDealUtils::getSDECurrencys()[0]);
			const AQLObjectConfiguration *setUpper = AQLObjectConfigurationManager::getInstance()->createEntitySetUpper(mainModel);
...
*/
AQLString
AQLRiskConfigurationTheta::getRiskName(void) const
{
...
*/
AQLString
AQLRiskConfigurationTheta::getBumpDirection(const AQLString &ccy) const
{
	(void)ccy;
...
*/
double
AQLRiskConfigurationTheta::getShiftVal(const AQLString &ccy, SCENARIONUM scenarioNum) const
{
...
*/
double
AQLRiskConfigurationTheta::getDivUnit(const AQLString &ccy) const
{	
	ccy;
...
*/
AQLString
AQLRiskConfigurationTheta::getOutPutName1(const AQLString &fx) const
{
	fx;
...
*/
bool
AQLRiskConfigurationTheta::isRiskCurrencyMode(const AQLString &fx) const
{
...
*/
bool
AQLRiskConfigurationTheta::isPLChangeMode(const AQLString &fx) const
{
	AQLString tmpCurrency = fx;
	//if MA_NODATA return false;
