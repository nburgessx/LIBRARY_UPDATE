...
//  2008, AlgoQuantHub.
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLScenarioConfigurationYieldCurveMultiParallel.cpp
//
...
*/
AQLScenarioConfigurationYieldCurveMultiParallel::AQLScenarioConfigurationYieldCurveMultiParallel(void)
{
}
...
*/
vector<AQLObject *>
AQLScenarioConfigurationYieldCurveMultiParallel::createScenario(AQLDataInstance &dataInstance, const AQLScenarioParam &param) const
{
	// get ArbFree Flag
	...
	if (param.isGrid)
	{
		throw AQLCoreInvalidData("Grid shift is not supported in AQLScenarioConfigurationYieldCurveMultiParallel", __FILE__, __LINE__);
	}
	if (!param.isParallel)
	{
		throw AQLCoreInvalidData("Parallel shift must be specified in AQLScenarioConfigurationYieldCurveMultiParallel", __FILE__, __LINE__);
	}
