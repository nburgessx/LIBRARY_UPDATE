...
*/
AQLString 
LACalibrationParametersFXVannaVolga::createCalibrationInfo(AQLObjectPool &objPool, const AQLString &fx)
{
	AQLString keyFX = fx;
...
*/
AQLString 
LACalibrationParametersFXVannaVolga::getCalibStaticDataValue(const AQLString &key, const AQLString &grid)
{
