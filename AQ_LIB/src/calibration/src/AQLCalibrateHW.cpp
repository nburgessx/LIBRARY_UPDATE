...
*/
void
AQLCalibrateHW::setUp(AQLObjectPool &objPool,  const AQLScenarioParam &param, AQLCalibrationFunc *method, int gridPos)
{
	cout << static_cast<int>(AQLCoreThread::getThreadID()) << " AQLCalibrateHW set up called" << endl;
	if (!method)
	{
	...
	cout << static_cast<int>(AQLCoreThread::getThreadID()) << " AQLCalibrateHW set up end" << endl;
}
...
*/
void
AQLCalibrateHW::doCalibrate()
{
	//calibration start
	cout << static_cast<int>(AQLCoreThread::getThreadID()) << " AQLCalibrateHW calibrate called.." << endl;
...
double time = (double)(cend - cstart) / CLOCKS_PER_SEC;
	cout << static_cast<int>(AQLCoreThread::getThreadID()) << " AQLCalibrateHW calibrate end.." << endl;
cout << "-> time = " << time << endl;
}
