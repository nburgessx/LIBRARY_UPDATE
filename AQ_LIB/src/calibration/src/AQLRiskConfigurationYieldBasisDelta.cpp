...
*/
AQLRiskConfigurationYieldBasisDelta::AQLRiskConfigurationYieldBasisDelta(void)
...
*/
vector<AQLObject *> 
AQLRiskConfigurationYieldBasisDelta::createYieldEntity(const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	if (isZeroBump(ccy))
	{
...
*/
vector<AQLObject *> 
AQLRiskConfigurationYieldBasisDelta::createZeroBumpYieldEntity(const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
...
*/
vector<AQLObject *> 
AQLRiskConfigurationYieldBasisDelta::createMarketBumpYieldEntity(const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	const AQLString model = AQLMarketData::getModelName(ccy);
	const AQLString riskName = getRiskName();
	AQLString bumpDirection = getBumpDirection(ccy);
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getOutPutName1(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isGridSensitivity(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
int
AQLRiskConfigurationYieldBasisDelta::getIMMFwdRiskMode(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
std::vector<int>
AQLRiskConfigurationYieldBasisDelta::getIMMTerm(const AQLString &ccy) const
{
	if (getIMMFwdRiskMode(ccy))
	{
		AQLDataInts immTerm;
...
*/
AQLStringVector
AQLRiskConfigurationYieldBasisDelta::getIMMRiskYieldCurveName(const AQLString &ccy) const
{
	if (!getIMMFwdRiskMode(ccy))
	{
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getIMMRiskFloorTerm(const AQLString &ccy, AQLObjectPool &objPool) const
{
	if (getIMMFwdRiskMode(ccy))
	{
		AQLString proName = AQLMarketData::getBaseYieldProName(ccy);
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isParallelShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return convertBoolFromStr(mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getRiskName(void) const
{
...
*/
vector<AQLString>
AQLRiskConfigurationYieldBasisDelta::getShiftGridTerm(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
vector<AQLString>
AQLRiskConfigurationYieldBasisDelta::getGridTerm(const AQLString &ccy) const
{
	AQLStringVector ret;
	...
	else
	{
		...
		sort(fwdfx.begin(), fwdfx.end(), AQLComp_StrTerm());
		sort(basis.begin(), basis.end(), AQLComp_StrTerm());
...
*/
vector<AQLString>
AQLRiskConfigurationYieldBasisDelta::getBucketGridTerm(const AQLString &ccy) const
{
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getPropertyBucketGridTerm(const AQLString &ccy) const
{
	AQLString tmpccy = ccy;
...
*/
void
AQLRiskConfigurationYieldBasisDelta::getScenario1ParallelShift(const AQLString &ccy, DoubleArray &vals) const
{
	vals.clear();
	AQLString tmpCurrency = ccy;
...
*/
AQLString 
AQLRiskConfigurationYieldBasisDelta::getScenario1ParallelShiftStr(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
void
AQLRiskConfigurationYieldBasisDelta::getScenario2ParallelShift(const AQLString &ccy, DoubleArray &vals) const
{
...
*/
double
AQLRiskConfigurationYieldBasisDelta::getScenario1ParallelShift(const AQLString &ccy) const
{
	DoubleArray tmp;
...
*/
double
AQLRiskConfigurationYieldBasisDelta::getScenario2ParallelShift(const AQLString &ccy) const
{
...
*/
DoubleArray
AQLRiskConfigurationYieldBasisDelta::getScenario1GridShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getScenario1GridShiftStr(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
DoubleArray
AQLRiskConfigurationYieldBasisDelta::getScenario2GridShift(const AQLString &ccy) const
{
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getBumpDirection(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return  mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isFwdFXZeroRateBump(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isFwdPointBump(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isWave(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return convertBoolFromStr(mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getShiftType(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return  mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getBasisType(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return  mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getTargetCurrencies() const
{
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getCalibTargetCurrencies() const
{
...
*/
double
AQLRiskConfigurationYieldBasisDelta::getDivUnit(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
int 
AQLRiskConfigurationYieldBasisDelta::getGridCalcBuffer() const
{
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isTarget(const AQLString &ccy) const
{
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isRiskCurrencyMode(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::isZeroBump(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	AQLString proprslt = mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
													STATIC_DATA_KEY_RISK_FRONT_YIELD_BASISDELTA_ISZERORATEBUMP + getCurveSuffix(ccy));
...
*/
vector<AQLObject *>
AQLRiskConfigurationYieldBasisDelta::createBaseScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
...
*/
AQLString
AQLRiskConfigurationYieldBasisDelta::getBaseOutPutName(const AQLString &ccy , int index) const
{
	if (omitNotionalExposure(ccy))
	{
		AQLString tmpCcy = ccy;
...
*/
bool
AQLRiskConfigurationYieldBasisDelta::omitNotionalExposure(const AQLString &ccy) const
{
	AQLString tmpCcy = ccy;
	tmpCcy.toLower();
