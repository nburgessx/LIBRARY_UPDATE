...
*/
AQLCalibrateModel::AQLCalibrateModel()
...
*/
AQLCalibrateModel::~AQLCalibrateModel(void)
{
}
...
*/
void
AQLCalibrateModel::generateSDE(const AQLString &key, AQLDataInstance &dataInstance, bool isMarketCreate, bool isFirst) const
{
	if (isFirst)
	{
...
*/
bool
AQLCalibrateModel::isFwdFXConst(const AQLString& ccy) const
{
...
*/
bool
AQLCalibrateModel::isCollateral(const AQLString& ccy) const
{
	AQLString tmpCcy = ccy;
...
*/
void
AQLCalibrateModel::loadVolatilityDataAndCalibrate(const AQLString &key, AQLDataInstance &dataInstance) const
{
...
*/
bool
AQLCalibrateModel::isCalibTarget(const AQLString &ccy) const
{
...
*/
bool
AQLCalibrateModel::isCancelForFunding(const AQLString &ccy) const
{

	AQLStringVector simCur = AQLDealUtils::getSimulationSDECurrencys(true);
	if (simCur.size() == 0)
		return false;
