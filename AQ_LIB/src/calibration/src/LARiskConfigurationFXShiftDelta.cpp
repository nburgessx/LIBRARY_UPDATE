...
*/
AQLString
LARiskConfigurationFXShiftDelta::getBaseOutPutName(const AQLString &ccy , int index) const
{
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getBaseCoefficient(const AQLString &ccy) const
{
	ccy;
...
*/
DoubleArray  
LARiskConfigurationFXShiftDelta::getBaseShiftVals(const AQLString &ccy) const
{
...
*/
double
LARiskConfigurationFXShiftDelta::getBaseSpotVal(const AQLString &ccy, int index) const
{
	...
	{
		throw AQLCoreInvalidData("LARiskConfigurationFXShiftDelta::getBaseShifts index is less than zero or over shift grid.", __FILE__, __LINE__);
	}
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getOutPutName1(const AQLString &fx) const
{
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getOutPutName1(const AQLString &ccy , int index) const
{
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getBumpDirection(const AQLString &fx) const
{
	AQLStringVector ccys = fx.toToken(FX_DELIMITER);
	AQLString fxKey =  LAMarketData::getFXKey(ccys[0], ccys[1]);
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getShiftType(const AQLString &fx) const
{
	AQLStringVector ccys = fx.toToken(FX_DELIMITER);
	AQLString fxKey =  LAMarketData::getFXKey(ccys[0], ccys[1]);
...
*/
double
LARiskConfigurationFXShiftDelta::getDivUnit(const AQLString &fx) const
{
	AQLStringVector ccys = fx.toToken(FX_DELIMITER);
	AQLString fxKey =  LAMarketData::getFXKey(ccys[0], ccys[1]);
...
*/
double
LARiskConfigurationFXShiftDelta::getShiftVal(const AQLString &fx, SCENARIONUM scenarioNum) const
{
	AQLStringVector ccys = fx.toToken(FX_DELIMITER);
	AQLString fxKey = LAMarketData::getFXKey(ccys[0], ccys[1]);
...
*/
vector<AQLObject *>
LARiskConfigurationFXShiftDelta::createBaseScenarioEntity(const AQLString &fx, AQLDataInstance &dataInstance, int index) const
{
...
*/
AQLString
LARiskConfigurationFXShiftDelta::getBaseTargetNames(const AQLString &ccy, AQLDataInstance &dataInstance) const
{
...
*/
bool
LARiskConfigurationFXShiftDelta::isRiskCurrencyMode(const AQLString &fx) const
{
	AQLStringVector ccys = fx.toToken(FX_DELIMITER);
	AQLString fxKey =  LAMarketData::getFXKey(ccys[0], ccys[1]);
...
vector<AQLObject *>
LARiskConfigurationFXShiftDelta::createBaseExtraScenarioEntity(const AQLString &fx, AQLDataInstance &dataInstance, int index) const
{
...
AQLStringVector
LARiskConfigurationFXShiftDelta::getBaseExtraTargetNames(const AQLString &fx, AQLDataInstance &dataInstance) const
{
	AQLStringVector ret;
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	...
	if(isCalibTarget(fx))
	{
		const AQLString FXVolName = LAMarketData::getBaseVolatilityName(fx);
...
vector<AQLObject *> 
LARiskConfigurationFXShiftDelta::createBaseExtraYieldEntity(const AQLString &fx, const AQLString &ccy, AQLDataInstance &dataInstance, int index, const bool isFirst)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
...
vector<AQLObject *> 
LARiskConfigurationFXShiftDelta::createBaseCollateralYieldEntity(const AQLString &fx, const AQLString &ccy, AQLDataInstance &dataInstance, int index)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
