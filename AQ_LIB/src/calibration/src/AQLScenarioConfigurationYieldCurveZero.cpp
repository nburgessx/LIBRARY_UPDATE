...
*/
AQLScenarioConfigurationYieldCurveZero::AQLScenarioConfigurationYieldCurveZero(bool isBasis)
: mIsBasis(isBasis)
{
}
...
*/
AQLScenarioConfigurationYieldCurveZero::~AQLScenarioConfigurationYieldCurveZero(void)
{
}
