...
*/
AQLRiskConfigurationYieldDelta::AQLRiskConfigurationYieldDelta(void)
...
*/
vector<AQLObject *> 
AQLRiskConfigurationYieldDelta::createYieldEntity(const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	(void)index;
	double pShift = 0.0;
	DoubleArray gShifts;	
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getOperator1(void) const
{
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getOperator2(void) const
{
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getCoefficient1(const AQLString &ccy) const
{
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getCoefficient2(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getOutPutName1(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getOutPutName2(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	return mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
bool
AQLRiskConfigurationYieldDelta::isGridSensitivity(const AQLString &ccy) const
{
	(void)ccy;	
...
*/
bool
AQLRiskConfigurationYieldDelta::isParallelShift(const AQLString &ccy) const
{
	(void)ccy;
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getRiskName(void) const
{
...
*/
vector<AQLString>
AQLRiskConfigurationYieldDelta::getGridTerm(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
vector<AQLString>
AQLRiskConfigurationYieldDelta::getBucketGridTerm(const AQLString &ccy) const
{
...
*/
double
AQLRiskConfigurationYieldDelta::getScenario1ParallelShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
double
AQLRiskConfigurationYieldDelta::getScenario2ParallelShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	AQLString strBPShift = mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
DoubleArray
AQLRiskConfigurationYieldDelta::getScenario1GridShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
DoubleArray
AQLRiskConfigurationYieldDelta::getScenario2GridShift(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	AQLString strBPShifts = mpRiskStaticData->getStaticData(tmpCurrency.toLower() + 
...
*/
int 
AQLRiskConfigurationYieldDelta::getGridCalcBuffer() const
{
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getTargetCurrencies() const
{
...
*/
AQLString
AQLRiskConfigurationYieldDelta::getCalibTargetCurrencies() const
{
	if (!isRealCalib())
	{
		return AQ_NO_DATA;
...
*/
double
AQLRiskConfigurationYieldDelta::getCoefficientRatio1(const AQLString &ccy, AQLObject& e, AQLDataInstance& dataInstance) const
{
	AQLString ircur = ccy;
...
*/
double
AQLRiskConfigurationYieldDelta::getCoefficientRatio2(const AQLString &ccy, AQLObject& e, AQLDataInstance& dataInstance) const
{
	AQLString ircur = ccy;
	AQLString isadjstr = mpRiskStaticData->getStaticData(ircur.toLower() + 
...
*/
bool
AQLRiskConfigurationYieldDelta::isRiskCurrencyMode(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
