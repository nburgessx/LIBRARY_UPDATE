...
*/
AQLString
LARiskConfigurationFX::getTargetNames(const AQLString &fx, AQLDataInstance &dataInstance) const
{
...
*/
vector<AQLObject *> 
LARiskConfigurationFX::createScenario1Entity(const AQLString &fx, AQLDataInstance &dataInstance, int index)  const
{
...
*/
vector<AQLObject *> 
LARiskConfigurationFX::createScenario2Entity(const AQLString &fx, AQLDataInstance &dataInstance, int index)  const
{
...
*/
vector<AQLObject *> 
LARiskConfigurationFX::createFXEntity(const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	// scenario param
...
*/
vector<AQLObject *> 
LARiskConfigurationFX::createFXVolEntity(const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index) const
{
	// scenario param
	MAScenarioParam param;
...
*/
bool
LARiskConfigurationFX::isGridSensitivity(const AQLString &fx) const
{
	//fx;
	return false;
}
...
*/
bool
LARiskConfigurationFX::isParallelShift(const AQLString &fx) const
{
	//fx;
	return true;
}
...
AQLStringVector
LARiskConfigurationFX::getRiskCurrencys(AQLObjectPool& objPool) const
{
...
*/
vector<AQLString>
LARiskConfigurationFX::getGridTerm(const AQLString &fx) const
{
	//(void)fx;
	return vector<AQLString>();
}
...
*/
vector<AQLString>
LARiskConfigurationFX::getBucketGridTerm(const AQLString &fx) const
{
	//fx;
...
LARiskConfigurationFX::createExtraScenario1Entity(const AQLString &fx, AQLDataInstance &dataInstance, int index)  const
{
	if (isRealCalib())
	{
...
vector<vector<AQLObject *> > 
LARiskConfigurationFX::createExtraScenarioEntity(const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
...
vector<AQLObject *> 
LARiskConfigurationFX::createExtraYieldEntity(const AQLString &fx, const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index, const bool isFirst)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	AQLString bumpDirection = getBumpDirection(fx);
	bumpDirection.toUpper();
...
AQLStringVector
LARiskConfigurationFX::getExtraTargetNames1(const AQLString &fx, AQLDataInstance &dataInstance) const
{
	...
	for (int unsigned i = 0; i < curs.size(); ++i)
	{
		...
		{
			const AQLString yieldName = LAMarketData::getBaseYieldName(ccy_tmp);
	...
	for (unsigned int i = 0; i < curs.size(); ++i)
	{
		...
		if (isCalibTarget(ccy_tmp))
		{
			...
			AQLString IRVolName = LAMarketData::getBaseVolatilityName(ccy_tmp);
	...
	if(isCalibTarget(fx))
	{
		...
		AQLString FXVolName = LAMarketData::getBaseVolatilityName(fx);
	...
	for(unsigned int i = 0; i < SDEccys.size(); ++i)
	{
		...
		for(unsigned int j = 0; j < curs.size(); ++j)
		{
			...
			{
				AQLString FXVolNames;
				AQLString FXVolName = LAMarketData::getBaseVolatilityName(SDEccys[i]);
...
vector<AQLObject *> 
LARiskConfigurationFX::createExtraIRVolEntity(const AQLString &fx, const AQLString& ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index) const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	...
	const AQLString& baseForYieldName = LAMarketData::getBaseYieldName(ccy);
...
vector<AQLObject *> 
LARiskConfigurationFX::createExtraFXVolEntity(const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index) const
{
	// scenario param
	MAScenarioParam param;
	setFXVolEntityParams(AQ_NO_DATA, fx, dataInstance, scenarioNum, index, param, false);
...
vector<AQLObject *> 
LARiskConfigurationFX::createCollateralYieldEntity(const AQLString &fx, const AQLString &ccy, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	AQLString bumpDirection = getBumpDirection(fx);
	bumpDirection.toUpper();
...
vector<vector<AQLObject *> > 
LARiskConfigurationFX::createExtraScenario2Entity(const AQLString &fx, AQLDataInstance &dataInstance, int index)  const
{
	if (isRealCalib())
	{
...
vector<AQLObject *> 
LARiskConfigurationFX::createExtraIRVolEntityBase(const AQLString &fx, const AQLString& ccy, AQLDataInstance &dataInstance, int index) const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	const AQLString model = LAMarketData::getModelName(ccy);
	const AQLString riskName = getRiskName();
...
*/
vector<AQLObject *>
LARiskConfigurationFX::createBaseScenarioEntity(const AQLString &fx, AQLDataInstance &dataInstance, int index) const
{
...
*/
AQLString
LARiskConfigurationFX::getBaseOutPutName(const AQLString &ccy , int index) const
{
...
*/
double
LARiskConfigurationFX::getBaseSpotVal(const AQLString &ccy, int index) const
{
	...
	{
		throw AQLCoreInvalidData("LARiskConfigurationFX::getBaseShifts index is less than zero or over shift grid.", __FILE__, __LINE__);
	}
...
*/
bool
LARiskConfigurationFX::omitNotionalExposure(const AQLString &ccy) const
{
	AQLStringVector ccys = ccy.toToken(FX_DELIMITER);
