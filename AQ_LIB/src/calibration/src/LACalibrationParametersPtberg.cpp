...
*/
AQLString 
LACalibrationParametersPtberg::createCalibrationInfo(AQLObjectPool &objPool, const AQLString &fx)
{
	AQLString keyFX = fx;
	...
	{
		// get initial file
		AQLString fileName = LAMarketData::getNumFileName(mpCalibStaticData->getStaticData(keyFX + FX_KEY_CALIB_PTBERG_INITIALPARAM_FILE));
...
*/
AQLString 
LACalibrationParametersPtberg::getCalibStaticDataValue(const AQLString &key, const AQLString &grid)
{
