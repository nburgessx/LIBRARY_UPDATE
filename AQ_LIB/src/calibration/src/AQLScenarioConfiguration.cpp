...
void
AQLScenarioConfiguration::dataoutCurve(AQLDataInstance &dataInstance, const AQLMathYieldCurvePro& yieldCurvePro, const vector<AQLObject *>& ret) const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	dataInstance.getReferencePool().completeDependency();
...
vector<AQLObject *>
AQLScenarioConfiguration::createScenarioExtraFwdFXConstCurveForFXDelta(AQLDataInstance &dataInstance, const AQLScenarioParam &param) const
{
	vector<AQLObject *> ret(0);
	AQLObjectPool &objPool = dataInstance.getObjectPool();
...
vector<AQLObject *>
AQLScenarioConfiguration::createScenarioExtraXccyCurveForFXDelta(AQLDataInstance &dataInstance, const AQLScenarioParam &param) const
{
	vector<AQLObject *> ret(0);
	AQLObjectPool &objPool = dataInstance.getObjectPool();
