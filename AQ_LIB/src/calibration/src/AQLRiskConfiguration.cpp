...
*/
AQLRiskConfiguration::AQLRiskConfiguration(bool fxFlg)
: mpStaticData(&AQLCoreDataService::getStaticDataManager().getStaticData()), 
  ...
  mpRiskStaticData(&AQLCoreDataService::getStaticDataManager().getRiskStaticData()), mFXFlg(fxFlg)
{
...
*/
AQLRiskConfiguration::~AQLRiskConfiguration(void)
{
}
...
*/
void
AQLRiskConfiguration::setCurveType(const AQLString &ccy, const AQLString &curveType)
{
...
*/
void
AQLRiskConfiguration::setBaseScenarioTarget(const AQLString &ccy, const AQLString &target)
{
	AQLString tmpCurrency = ccy;
	tmpCurrency.toUpper();
...
*/
bool
AQLRiskConfiguration::isBaseScenarioTarget(const AQLString &ccy, int index) const
{
	AQLString tmpCurrency = ccy;
	tmpCurrency.toUpper();
...
*/
AQLString
AQLRiskConfiguration::getCurveSuffix(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	tmpCurrency.toUpper();
...
*/
AQLString
AQLRiskConfiguration::getBaseShiftCurveSuffix(const AQLString &ccy) const
{
...
*/
AQLString
AQLRiskConfiguration::getCurveType(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
	tmpCurrency.toUpper();
...
*/
AQLString
AQLRiskConfiguration::getBaseShiftCurveType(const AQLString &ccy) const
{
...
*/
void
AQLRiskConfiguration::setUpRiskEntity(AQLDataInstance &dataInstance, bool isReflesh) const
{
	...
	if (!isReflesh)
	{
		AQLStringVector riskENames = AQLCoreDataService::getContext(CONTEXT_KEY_RISKENTITY_NAMES).toToken(':');
	...
	AQLCoreDataService::setContext(CONTEXT_KEY_RISKENTITY_NAMES, refStr);
	//if (!isReflesh)
	//{
...
AQLRiskConfiguration::createRiskEntity(AQLObjectPool &objPool) const
{
...
*/
void
AQLRiskConfiguration::setUpTargetNames(const AQLString &ccy, AQLObject &e, AQLDataInstance &dataInstance) const
{
...
*/
void
AQLRiskConfiguration::setUpBaseScenario(const AQLString &ccy, AQLObject &e, AQLDataInstance &dataInstance, int index) const
{
cout << "[ Currency = " << ccy << ", BaseScenarioNum = " << index << " ]" << endl;
cout << "AQLRiskConfiguration create base scenario called.." << endl;
clock_t cstart = clock();
	vector<AQLObject *> bSce= createBaseScenarioEntity(ccy, dataInstance, index);
clock_t cend = clock();
double time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create base scenario end.." << endl;
cout << "-> time = " << time << endl;
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	...
	if (bSize > 0)
	{
		...
		// extra scneario
cout << "AQLRiskConfiguration create base extra scenario called.." << endl;
clock_t cstart = clock();
		vector<AQLObject *>  exSce = createBaseExtraScenarioEntity(ccy, dataInstance, index);
clock_t cend = clock();
double time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create base extra scenario end.." << endl;
cout << "-> time = " << time << endl;
...
*/
void
AQLRiskConfiguration::setUpScenario(const AQLString &ccy, AQLObject &e, AQLDataInstance &dataInstance, int index) const
{
	mSce1Names.clear();
	mSce2Names.clear();
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	...
	// scenario1
	//////////////////
cout << "AQLRiskConfiguration create scenario 1 called.." << endl;
clock_t cstart = clock();
	vector<AQLObject *> sce1 = createScenario1Entity(ccy, dataInstance, index);
clock_t cend = clock();
double time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create scenario 1 end.." << endl;
cout << "-> time = " << time << endl;
	...
	// extra scneario1
cout << "AQLRiskConfiguration create extra scenario 1 called.." << endl;
cstart = clock();
	vector<vector<AQLObject *> > exSce1 = createExtraScenario1Entity(ccy, dataInstance, index);
cend = clock();
time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create extra scenario 1 end.." << endl;
cout << "-> time = " << time << endl;
	...
	// scenario2
	//////////////////
cout << "AQLRiskConfiguration create scenario 2 called.." << endl;
cstart = clock();
	vector<AQLObject *> sce2 = createScenario2Entity(ccy, dataInstance, index);
cend = clock();
time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create scenario 2 end.." << endl;
cout << "-> time = " << time << endl;
	if (!sce2.empty())
	{
		...
		// extra scneario2
cout << "AQLRiskConfiguration create extra scenario 2 called.." << endl;
cstart = clock();
		vector<vector<AQLObject *> > exSce2 = createExtraScenario2Entity(ccy, dataInstance, index);
cend = clock();
time = (double)(cend - cstart) / CLOCKS_PER_SEC;
cout << "AQLRiskConfiguration create extra scenario 2 end.." << endl;
cout << "-> time = " << time << endl;
...
*/
void
AQLRiskConfiguration::setUpOperator(const AQLString &ccy, AQLObject &e) const
{
	ccy;
...
*/
void
AQLRiskConfiguration::setUpCoefficient(const AQLString &ccy, AQLObject &e, AQLDataInstance& dataInstance) const
{
...
*/
AQLString
AQLRiskConfiguration::getOperator1(void) const
{
...
*/
AQLString
AQLRiskConfiguration::getCoefficient1(const AQLString &ccy) const
{
...
*/
int
AQLRiskConfiguration::getIMMFwdRiskMode(const AQLString &ccy) const
{
	return 0;
}
...
*/
AQLStringVector
AQLRiskConfiguration::getIMMRiskYieldCurveName(const AQLString &) const
{
...
*/
AQLString
AQLRiskConfiguration::getIMMRiskFloorTerm(const AQLString &ccy, AQLObjectPool &objPool) const
{
	return "";
}
...
*/
AQLString
AQLRiskConfiguration::getWaveOperator(void) const
{
	return FN_LINEAR_STR;
}
...
*/
AQLString
AQLRiskConfiguration::getWaveCoefficient(const AQLString &ccy) const
{
...
*/
AQLString
AQLRiskConfiguration::getBaseWaveCoefficient(const AQLString &ccy) const
{
	AQLString bumpDirection = getBumpDirection(ccy);
	bumpDirection.toUpper();
...
*/
void
AQLRiskConfiguration::setUpOutputName(const AQLString &ccy, AQLObject &e, int index) const
{
...
*/
void
AQLRiskConfiguration::setUpIsGridSensitivity(const AQLString &ccy, AQLObject &e) const
{
...
*/
void
AQLRiskConfiguration::setUpIsWave(const AQLString &ccy, AQLObject &e) const
{
...
*/
void
AQLRiskConfiguration::setUpValuableEntityInfo(const AQLString &ccy, AQLObjectPool &objPool, AQLObject &e, int index) const
{
	...
	if (isGridSensitivity(ccy))
	{
		...
		{
			termvals[i] = AQLMarketData::getCalendarTime(asOfDate,gridTerm[i]);
		}
	...
	else
	{
		...
		{
			asOf = AQLMarketData::getAsofDate(objPool);
	...
	//			{
	//				AQLString matuterm;
	//				double term = AQLMarketData::getMaturityTermFromPlainVanillaEntity(trade.get(), asOf); 
	//				unsigned int pos = 0;
...
*/
bool
AQLRiskConfiguration::isTarget(const AQLString &ccy) const
{
...
*/
bool
AQLRiskConfiguration::isCalibTarget(const AQLString &ccy) const
{
	if (isRealCalib() && !AQLMarketData::isCalibrateModel(AQLMarketData::getModelName(ccy)))
	{
		return false;
	}
...
*/
bool
AQLRiskConfiguration::convertBoolFromStr(const AQLString &str) const
{
	if (str == "") 
	{
		return false;
...
*/
AQLStringVector
AQLRiskConfiguration::getCalibTargetFX(const AQLString &ccy, AQLDataInstance &dataInstance) const
{
...
*/
bool
AQLRiskConfiguration::isRealCalib() const
{
...
*/
bool 
AQLRiskConfiguration::isAdjustDf(const AQLString &ccy) const
{
	AQLString tmpCurrency = ccy;
...
*/
DoubleArray
AQLRiskConfiguration::convertToRateValues(const AQLStringVector &vec) const
{
...
*/
void
AQLRiskConfiguration::setFXEntityParams(const AQLString& ccy, const AQLString& fx, AQLDataInstance& dataInstance, const SCENARIONUM scenarioNum, int index, AQLScenarioParam& param) const
{
	param.ccy = /*fx*/ccy;
	...
	param.model = AQLMarketData::getModelName(fx);
...
*/
void
AQLRiskConfiguration::setFXVolEntityParams(const AQLString &ccy, const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index, AQLScenarioParam& param, bool isYield) const
{
	AQLStringVector ccys;
	AQLMarketData::convertToCurrency(fx, ccys);
	...
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	// set reference
	AQLCalibrationParameters *calibInfoCreator = AQLCalibrationParametersManager::getInstance()->createCalibInfoCreator(model);
		...
		for(unsigned int i = 0; i < ccys.size(); ++i)
		{
			...
			if(FwdFXGrids.isDefined() && FwdFXGrids != AQ_NO_DATA)
			{
				   ...
				   riskName == RISK_OFFICIAL_FX_DELTA)
				{
					...
					param.refName.push_back(AQLMarketData::getBaseYieldName(ccys[i]) + "_" + ExtraCalcType);
					param.refName.push_back(AQLMarketData::getCalibDataName(ExtraCalcType, AQLMarketData::getYieldDataName(objPool, param.refName.back())));
				}
				else
				{
					param.refName.push_back(AQLMarketData::getBaseYieldName(ccys[i]));
	...
	// set DDL
	AQLString fxKey =  AQLMarketData::getFXKey(/*targetCcys[0]*/ccys[0], /*targetCcys[1]*/ccys[1]);
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createOptionAnalyticEntity(const AQLString &ccy, AQLDataInstance &dataInstance,int index)  const
{
	index;
...
*/
vector<pair<AQLString, vector<AQLObject *> > >
AQLRiskConfiguration::createOptionAnalyticRiskEntity(AQLObjectPool &objPool) const
{
	vector<pair<AQLString, vector<AQLObject *> > > ret = AQLRiskConfiguration::createRiskEntity(objPool);
...
*/
void
AQLRiskConfiguration::setUpOptionAnalyticTargetNames(const AQLString &ccy, AQLObject &e) const
{
	(void)ccy;
	AQLString ret(PREM);
	e.remove(PRICING_DATA_TARGETNAMES);
...
*/
AQLString
AQLRiskConfiguration::getAnalyticalRiskType(const AQLString& fx, AQLObject& e) const
{
	(void)fx;(void)e;
...
bool 
AQLRiskConfiguration::IsSucceedAnalyticalRiskType(const AQLString& fx, AQLObject& e) const
{
	AQLString ret;
	AQLString fxcur = fx;
	fxcur.toUpper();
...
AQLStringVector
AQLRiskConfiguration::getRiskCurrencys(AQLObjectPool& objPool) const
{
	objPool;
...
void 
AQLRiskConfiguration::setUpRiskOutputCurrency(const AQLString &ccy, AQLObject &e) const
{
	...
	if (isriskcurrencymode)
	{
		...
		{
			ret = AQLMarketData::getBaseCurrencyOfFXPair(ccy);
		}
		else
		{
			ret = ccy;
...
void 
AQLRiskConfiguration::setUpIsAnalytic(const AQLString &ccy, AQLObject &e) const
{
...
void 
AQLRiskConfiguration::setUpDeltaType(const AQLString &ccy, AQLObject &e) const
{
...
void
AQLRiskConfiguration::setUpVegaType(const AQLString &ccy, AQLObject &e) const
{
...
AQLString 
AQLRiskConfiguration::getScenarioBaseYieldName(const AQLString& ccy) const
{
	return AQLMarketData::getBaseYieldName(ccy);
}
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createBaseForeignYieldEntity(const AQLString &ccy, const AQLString &fCcy, AQLDataInstance &dataInstance, int index, const bool isFirst)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createBaseCollateralYieldEntity(const AQLString &ccy, const AQLString &colCcy, AQLDataInstance &dataInstance, int index)  const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	const AQLString model = AQLMarketData::getModelName(colCcy);
	const AQLString riskName = getRiskName();
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createBaseForeignIRVolEntity(const AQLString& ccy, const AQLString& fCcy, AQLDataInstance &dataInstance, int index) const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	const AQLString model = AQLMarketData::getModelName(fCcy);
	const AQLString riskName = getRiskName();
	...
	param.refName.push_back(infoName);
	param.isParallel = true;
	const AQLString& yieldName = AQLMarketData::getBaseYieldName(fCcy);
...
*/
AQLStringVector 
AQLRiskConfiguration::getIRBaseExtraTargetNames(const AQLString &ccy, AQLDataInstance &dataInstance) const
{
	...
	{
		ret.push_back(AQLMarketData::getBaseYieldName(*it));
	}
	for (StringSet::const_iterator it = curveCcys.begin(); it != curveCcys.end(); ++it)
	{
		...
		if (isCalibTarget(*it))
		{
			ret.push_back(AQLMarketData::getBaseVolatilityName(*it));
		}
	}
	// check calibration target
	if (isCalibTarget(ircur))
	{
		ret.push_back(AQLMarketData::getBaseVolatilityName(ircur));
	}
	...
	for (unsigned int i = 0; i < fxSize; ++i)
	{
		...
		ret.push_back(AQLMarketData::getBaseVolatilityName(key_fx));
	}
	return ret;
}
...
*/
vector<AQLObject *>
AQLRiskConfiguration::createIRBaseExtraScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
	AQLObjectPool &objPool = dataInstance.getObjectPool();
	...
	const AQLString model = AQLMarketData::getModelName(ircur);
	const AQLString riskName = getRiskName();
	...
	if (isCalibTarget(ircur))
	{
		...
		param.model = model;
		param.inputType = AQLMarketData::getVolInputType(model, ircur, riskName);
		param.targetName = AQLMarketData::getBaseVolatilityName(ircur);
		...
		{
			param.isCalib = false;
			AQLMarketData::getVolFuncFilePath(model, ircur, ircur, riskName, SCENARIO_1, param.paraFile, false, 0, &bShiftStr, true);
		}
	...
	for (unsigned int i = 0; i < fxSize; ++i)
	{
		...
		{
			param.isCalib = false;
			AQLMarketData::getVolFuncFilePath(model_fx, ircur, key_fx, riskName, SCENARIO_1, param.paraFile, false, 0, &bShiftStr, true);
			// set reference
...
*/
vector<AQLObject *>
AQLRiskConfiguration::createIRBaseScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
	const AQLString ircur = getIRBaseCurrency(ccy);
	const AQLString model = AQLMarketData::getModelName(ircur);
	const AQLString riskName = getRiskName();
	...
	param.targetName = AQLMarketData::getBaseYieldName(ircur);
...
*/
DoubleArray 
AQLRiskConfiguration::getBaseShifts(const AQLString &ccy, int index) const
{
...
*/
DoubleArray
AQLRiskConfiguration::getIRBaseShifts(const AQLString &ccy, int index) const
{
...
*/
AQLString
AQLRiskConfiguration::getIRBaseShiftStr(const AQLString &ccy , int index) const
{
...
*/
vector<AQLObject *>
AQLRiskConfiguration::createBasisBaseScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
	const AQLString ircur = getIRBaseCurrency(ccy);
	const AQLString model = AQLMarketData::getModelName(ircur);
	const AQLString riskName = getRiskName();
	...
	// create scenario
	AQLScenarioConfiguration *sceCreator = 
		AQLScenarioConfigurationManager::getInstance()->createScenarioCreator(RISK_SCENARIO_YIELDBASIS);
...
*/
AQLString 
AQLRiskConfiguration::getCalcType(const AQLString &ccy, SCENARIONUM scenarioNum, int index) const
{
	const AQLString riskName = getRiskName();
...
*/
AQLString 
AQLRiskConfiguration::getExtraCalcType(const AQLString &ccy, SCENARIONUM scenarioNum, int index) const
{
	const AQLString riskName = getRiskName();
...
*/
AQLString
AQLRiskConfiguration::getBaseOperator(void) const
{ 
	return FN_LINEAR_STR;
}	
...
*/
AQLString  
AQLRiskConfiguration::getBaseCoefficient(const AQLString &ccy) const
{
	(void)ccy;
...
*/
AQLString 
AQLRiskConfiguration::getBaseCalcType(const AQLString &ccy, int index) const
{
	const AQLString riskName = getRiskName();
...
*/
AQLString 
AQLRiskConfiguration::getBaseExtraCalcType(const AQLString &ccy, int index) const
{
	const AQLString riskName = getRiskName();
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createBaseFXEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index)  const
{
...
*/
vector<AQLObject *> 
AQLRiskConfiguration::createBaseFXVolEntity(const AQLString &fx, AQLDataInstance &dataInstance, int index)  const
{
	...
	paramvol.targetName = AQLMarketData::getBaseVolatilityName(fx);
	paramvol.inputType = AQLMarketData::getVolInputType(model, fx, riskName);
	...
	for(unsigned int i = 0; i < ccys.size(); ++i)
	{
		...
		if(FwdFXGrids.isDefined() && FwdFXGrids != AQ_NO_DATA)
		{
			...
			if(riskName == RISK_FRONT_FX_SHIFTDELTA)
			{
				...
				paramvol.refName.push_back(AQLMarketData::getBaseYieldName(ccys[i]) + "_" + BaseExtraCalcType);
				paramvol.refName.push_back(AQLMarketData::getCalibDataName(BaseExtraCalcType, AQLMarketData::getYieldDataName(objPool, paramvol.refName.back())));
			}
			else
			{
				paramvol.refName.push_back(AQLMarketData::getBaseYieldName(ccys[i]));
...
*/
vector<AQLObject *>
AQLRiskConfiguration::createFXBaseScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
	vector<AQLObject *> ret;

	// create fx object
	ret = AQLRiskConfiguration::createBaseFXEntity(ccy, dataInstance, index);
	...
	//if (isCalib)
	//{
	//	vector<AQLObject *> base_vol = AQLRiskConfiguration::createBaseFXVolEntity(fx, dataInstance, index);
...
*/
vector<AQLObject *>
AQLRiskConfiguration::createFXBaseExtraScenarioEntity(const AQLString &ccy, AQLDataInstance &dataInstance, int index) const
{
	vector<AQLObject *> ret;

	const AQLString tmpfxcur = getCrossBaseCurrency(ccy);

	const AQLString model = AQLMarketData::getModelName(tmpfxcur);
	const AQLString riskName = getRiskName();
	// scenario param
	AQLScenarioParam param;
	param.ccy = tmpfxcur;
	...
	// search shift target currency(foreign currency)
	AQLStringVector ccys;
	AQLMarketData::convertToCurrency(tmpfxcur, ccys);
	const AQLStringVector &fx_ccys = targetFX->getCurrencys().get();
	AQLStringVector::const_iterator it = find(fx_ccys.begin(), fx_ccys.end(), ccys[1]);
	if (it == fx_ccys.end())
	{
	...
	if (size != 0 && std::find(calibfxvec.begin(),calibfxvec.end(),tmpfxcur) != calibfxvec.end())
	{
		...
		paramvol.model = model;
		paramvol.targetName = AQLMarketData::getBaseVolatilityName(tmpfxcur);
		paramvol.inputType = AQLMarketData::getVolInputType(model, tmpfxcur, riskName);
		paramvol.isParallel = true;
		paramvol.isGrid = false;
...
*/
AQLString
AQLRiskConfiguration::getFXBaseTargetNames(const AQLString &ccy, AQLDataInstance &dataInstance) const
{
...
*/
AQLStringVector
AQLRiskConfiguration::getFXBaseExtraTargetNames(const AQLString &ccy, AQLDataInstance &dataInstance) const
{
	AQLStringVector ret;
	...
	if (size != 0 && std::find(calibfxvec.begin(),calibfxvec.end(), getCrossBaseCurrency(ccy).toUpper()) != calibfxvec.end())
	{
		...
		const AQLString targetFXVolname = AQLMarketData::getBaseVolatilityName(fxcur);
...
*/
void 
AQLRiskConfiguration::setScenarioParamReferences(const AQLString& targetCcy, const AQLStringVector& ccys, const AQLStringVector& fCurveCcys, 
								...
								const AQLString& suffix, const int idx) const
{
	if (ccys[0] == targetCcy)
	{
		...
		{
			refName.push_back(AQLMarketData::getCalibDataName(calcType, AQLMarketData::getYieldDataName(objPool, refName.back()), idx));
		}
		else
		{
			refName.push_back(AQLMarketData::getCalibDataName(KEY_PV, AQLMarketData::getYieldDataName(objPool, AQLMarketData::getBaseYieldName(ccys[0]))));
		}
		...
		if (fCurveCcys.size() != 0 && find(fCurveCcys.begin(), fCurveCcys.end(), ccys[1]) != fCurveCcys.end())
		{
			...
			{
				refName.push_back(AQLMarketData::getCalibDataName(KEY_PV, AQLMarketData::getYieldDataName(objPool, forBaseYieldName)));
			}
		}
		else
		{
			refName.push_back(AQLMarketData::getBaseYieldName(ccys[1]));
			refName.push_back(AQLMarketData::getCalibDataName(KEY_PV, AQLMarketData::getYieldDataName(objPool, refName.back())));
		}
	}
	else
	{
		...
		{
			refName.push_back(AQLMarketData::getBaseYieldName(ccys[0]));
			refName.push_back(AQLMarketData::getCalibDataName(KEY_PV, AQLMarketData::getYieldDataName(objPool, refName.back())));
		}
		...
		if (ccys[1] == targetCcy)
		{
			...
			{
				refName.push_back(AQLMarketData::getCalibDataName(KEY_PV, AQLMarketData::getYieldDataName(objPool, AQLMarketData::getBaseYieldName(ccys[1]))));
			}
		}
		else
		{
...
*/
vector<AQLString> 
AQLRiskConfiguration::getGridRangeTerm(const AQLString &ccy) const
{
	AQLStringVector ret;
	AQLString gridRange = AQLCoreDataService::getContext(ARG_KEY_GRIDRANGE).toUpper();
	...
	if (pos_s > gridTerm.size())
	{
		...
		AQLCoreDataService::setContext(CONTEXT_KEY_RISKGRID_ISOMITSTART, "TRUE");
		AQLCoreDataService::setContext(CONTEXT_KEY_RISKGRID_ISOMITEND, "TRUE");
		return ret;
	}
	--pos_s;
	--pos_e;
