...
class AQLCalibrationParametersSZ;

// Schobel-Zhu SDE generator 
class AQLCalibrateModelSZ : public AQLCalibrateModelFX
{

public:
	// constructor
	explicit AQLCalibrateModelSZ();
	// destructor
	virtual ~AQLCalibrateModelSZ(void);
	// copy constructor
	AQLCalibrateModelSZ(const AQLCalibrateModelSZ &rhs);
	AQLCalibrateModelSZ &operator=(const AQLCalibrateModelSZ &rhs);

	//==============================================
	// sde generator class for sde of volatility
	class VF : public AQLCalibrateModelVolFactor
	{
...
protected:
	...
	virtual AQLCalibrationParametersSZ *createCalibInfoCreator(void) const;
