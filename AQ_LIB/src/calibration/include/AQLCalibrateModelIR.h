...
//===================== Class Declare AQLCalibrateModelIR==================================
/*! 
...
*/
class AQLCalibrateModelIR : public AQLCalibrateModel
{
public:
	// constructor
	explicit AQLCalibrateModelIR(const AQLString &baseCurrency);
	// destructor
	virtual ~AQLCalibrateModelIR(void);
	// copy constructor
	AQLCalibrateModelIR(const AQLCalibrateModelIR &rhs);
	AQLCalibrateModelIR &operator=(const AQLCalibrateModelIR &rhs);
	//==============================================
