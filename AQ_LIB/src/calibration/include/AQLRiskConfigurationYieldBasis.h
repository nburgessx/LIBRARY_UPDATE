...
//===================== Class Declare AQLRiskConfigurationYieldBasis==================================
/*! 
    @brief Yield basis setup class
	

*/
class AQLRiskConfigurationYieldBasis : public AQLRiskConfigurationYield
{
public:
	// constructor
	explicit AQLRiskConfigurationYieldBasis(void);
	// destructor
	virtual ~AQLRiskConfigurationYieldBasis(void);
	// copy constructor
	AQLRiskConfigurationYieldBasis(const AQLRiskConfigurationYieldBasis &rhs);
	AQLRiskConfigurationYieldBasis &operator=(const AQLRiskConfigurationYieldBasis &rhs);
...
private:
	AQLString mBasisCurrency; // basis currency
