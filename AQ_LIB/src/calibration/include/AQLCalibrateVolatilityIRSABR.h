...
//===================== Class Declare AQLCalibrateVolatilityIRSABR==================================
/*! 
    @brief Volatility data create class for ptberg
	

*/
class AQLCalibrateVolatilityIRSABR : public AQLCalibrateVolatility
{
public:
	// constructor
	explicit AQLCalibrateVolatilityIRSABR(void);
	// destructor
	virtual ~AQLCalibrateVolatilityIRSABR(void);
	// copy constructor
	AQLCalibrateVolatilityIRSABR(const AQLCalibrateVolatilityIRSABR &rhs);
	AQLCalibrateVolatilityIRSABR &operator=(const AQLCalibrateVolatilityIRSABR &rhs);
