...
*/
//  2008, AlgoQuantHub.
#ifndef AQLRiskConfigurationYieldBasisDelta_h
#define AQLRiskConfigurationYieldBasisDelta_h
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRiskConfigurationYieldBasisDelta.h
//
...
//===================== Class Declare AQLRiskConfigurationYieldBasisDelta==================================
/*! 
    @brief Basis Delta setup class
	

*/
class AQLRiskConfigurationYieldBasisDelta : public AQLRiskConfigurationYield
{
public:
	// constructor
	explicit AQLRiskConfigurationYieldBasisDelta(void);
	// destructor
	virtual ~AQLRiskConfigurationYieldBasisDelta(void);
	// copy constructor
	AQLRiskConfigurationYieldBasisDelta(const AQLRiskConfigurationYieldBasisDelta &rhs);
	AQLRiskConfigurationYieldBasisDelta &operator=(const AQLRiskConfigurationYieldBasisDelta &rhs);
