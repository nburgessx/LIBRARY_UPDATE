...
*/
//  2008, AlgoQuantHub.
#ifndef AQLCalibrateVolatilityFXStrangleSolver_h
#define AQLCalibrateVolatilityFXStrangleSolver_h
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLCalibrateVolatilityFXStrangleSolver.h
//
...
//===================== Class Declare AQLCalibrateVolatilityFXStrangleSolver==================================
/*! 
    @brief Volatility data create class for ptberg
	

*/
class AQLCalibrateVolatilityFXStrangleSolver : public AQLCalibrateVolatility
{
public:
	// constructor
	explicit AQLCalibrateVolatilityFXStrangleSolver(void);
	// destructor
	virtual ~AQLCalibrateVolatilityFXStrangleSolver(void);
	// copy constructor
	AQLCalibrateVolatilityFXStrangleSolver(const AQLCalibrateVolatilityFXStrangleSolver &rhs);
	AQLCalibrateVolatilityFXStrangleSolver &operator=(const AQLCalibrateVolatilityFXStrangleSolver &rhs);
