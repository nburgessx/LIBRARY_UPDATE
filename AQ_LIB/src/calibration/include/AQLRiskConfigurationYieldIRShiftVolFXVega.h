...
*/
//  2008, AlgoQuantHub.
#ifndef AQLRiskConfigurationYieldIRShiftVolFXVega_h
#define AQLRiskConfigurationYieldIRShiftVolFXVega_h
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRiskConfigurationYieldIRShiftVolFXVega.h
//
...
//===================== Class Declare AQLRiskConfigurationYieldIRShiftVolFXVega==================================
/*! 
    @brief FX Vega setup class
	

*/
class AQLRiskConfigurationYieldIRShiftVolFXVega : public AQLRiskConfigurationVolFXVega
{
public:
	// constructor
	explicit AQLRiskConfigurationYieldIRShiftVolFXVega(void);
	// destructor
	virtual ~AQLRiskConfigurationYieldIRShiftVolFXVega(void);
	// copy constructor
	AQLRiskConfigurationYieldIRShiftVolFXVega(const AQLRiskConfigurationYieldIRShiftVolFXVega &rhs);
	AQLRiskConfigurationYieldIRShiftVolFXVega &operator=(const AQLRiskConfigurationYieldIRShiftVolFXVega &rhs);
