...
//===================== Class Declare AQLMarketDataLMM==================================
/*! 
    @brief LMM(Libor market model) util class

   
*/
class AQLMarketDataLMM
{
public:
	//==============================================================================
...
private:
	// constructor
	AQLMarketDataLMM(void);
	// destructor
	~AQLMarketDataLMM(void);
	// copy constructor
	AQLMarketDataLMM(const AQLMarketDataLMM &rhs);
	AQLMarketDataLMM &operator=(const AQLMarketDataLMM &rhs);
};
