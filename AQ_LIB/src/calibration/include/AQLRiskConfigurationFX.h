...
//===================== Class Declare AQLRiskConfigurationFX==================================
/*! 
    @brief FX setup class for calc risk
...
*/
class AQLRiskConfigurationFX : public AQLRiskConfigurationYield
{
public:
	// constructor
	explicit AQLRiskConfigurationFX(void);
	// destructor
	virtual ~AQLRiskConfigurationFX(void);
	// copy constructor
	AQLRiskConfigurationFX(const AQLRiskConfigurationFX &rhs);
	AQLRiskConfigurationFX &operator=(const AQLRiskConfigurationFX &rhs);
...
protected:
	...
	virtual DoubleArray getScenario1GridShift(const AQLString &ccy) const {return AQLRiskConfiguration::getScenario1GridShift(ccy); };
	//==============================================
	// get scenario2 grid shift
	virtual DoubleArray getScenario2GridShift(const AQLString &ccy) const {return AQLRiskConfiguration::getScenario1GridShift(ccy); };
	//==============================================
