...
//===================== Class Declare AQLCalibrateModelFXVannaVolga==================================
/*! 
    @brief FXVanilla SDE generator 
	

*/
class AQLCalibrateModelFXVannaVolga : public AQLCalibrateModelFX
{

public:
	// constructor
	explicit AQLCalibrateModelFXVannaVolga();
	// destructor
	virtual ~AQLCalibrateModelFXVannaVolga(void);
	// copy constructor
	AQLCalibrateModelFXVannaVolga(const AQLCalibrateModelFXVannaVolga &rhs);
	AQLCalibrateModelFXVannaVolga &operator=(const AQLCalibrateModelFXVannaVolga &rhs);
protected:
