...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRiskConfigurationYieldDelta.h
//
...
//===================== Class Declare AQLRiskConfigurationYieldDelta==================================
/*! 
    @brief Yield delta setup class
	

*/
class AQLRiskConfigurationYieldDelta : public AQLRiskConfigurationYield
{
public:
	// constructor
	explicit AQLRiskConfigurationYieldDelta(void);
	// destructor
	virtual ~AQLRiskConfigurationYieldDelta(void);
	// copy constructor
	AQLRiskConfigurationYieldDelta(const AQLRiskConfigurationYieldDelta &rhs);
	AQLRiskConfigurationYieldDelta &operator=(const AQLRiskConfigurationYieldDelta &rhs);
