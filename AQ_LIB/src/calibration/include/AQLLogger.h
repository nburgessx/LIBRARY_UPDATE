...
//===================== Class Declare AQLLoggerImpl==================================
/*! 
    @brief  Logger concrete class

   
*/
class AQLLoggerImpl : public AQLLogger
{
public:
	                         //=============
	                         // debug  
	...
	friend class AQLLogManager;

private:
	// constructor
	explicit AQLLoggerImpl(const AQLString &file, std::ios_base::openmode mode = std::ios_base::app);
	// destructor
	virtual ~AQLLoggerImpl(void);
	// copy constructor
	AQLLoggerImpl(const AQLLoggerImpl &rhs);
	const AQLLoggerImpl &operator =(const AQLLoggerImpl &rhs);
