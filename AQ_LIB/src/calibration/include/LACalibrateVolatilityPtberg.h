...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LACalibrateVolatilityPtberg.h
//
...
//===================== Class Declare LACalibrateVolatilityPtberg==================================
/*! 
    @brief Volatility data create class for ptberg
	

*/
class LACalibrateVolatilityPtberg : public LACalibrateVolatility
{
public:
	// constructor
	explicit LACalibrateVolatilityPtberg(void);
	// destructor
	virtual ~LACalibrateVolatilityPtberg(void);
	// copy constructor
	LACalibrateVolatilityPtberg(const LACalibrateVolatilityPtberg &rhs);
	LACalibrateVolatilityPtberg &operator=(const LACalibrateVolatilityPtberg &rhs);
