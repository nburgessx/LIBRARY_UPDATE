...
//===================== Class Declare AQLCalibrateModel==================================
/*! 
    @brief SDE generator 
...
public:
	// constructor
	explicit AQLCalibrateModel(void);
	// destructor
	virtual ~AQLCalibrateModel(void);
	// copy constructor
	AQLCalibrateModel(const AQLCalibrateModel &rhs);
	AQLCalibrateModel &operator=(const AQLCalibrateModel &rhs);
