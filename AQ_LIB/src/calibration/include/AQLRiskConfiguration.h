...
//===================== Class Declare AQLRiskConfiguration==================================
/*! 
    @brief Risk setup class
...
*/
class AQLRiskConfiguration
{
public:
	// constructor
	explicit AQLRiskConfiguration(bool fxFlg);
	// destructor
	virtual ~AQLRiskConfiguration(void);
	// copy constructor
	AQLRiskConfiguration(const AQLRiskConfiguration &rhs);
	AQLRiskConfiguration &operator=(const AQLRiskConfiguration &rhs);
...
protected:
	...
	virtual void setFXEntityParams(const AQLString &ccy, const AQLString &fx, AQLDataInstance &dataInstance, const SCENARIONUM scenarioNum, int index, AQLScenarioParam &param) const;
	//==============================================
	// set fx volatility object params
	virtual void setFXVolEntityParams(const AQLString &ccy, const AQLString &fx, AQLDataInstance &dataInstance, SCENARIONUM scenarioNum, int index, AQLScenarioParam &param, bool isYield) const;
