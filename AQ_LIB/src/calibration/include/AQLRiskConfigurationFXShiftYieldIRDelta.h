...
*/
//  2008, AlgoQuantHub.
#ifndef AQLRiskConfigurationFXShiftYieldIRDelta_h
#define AQLRiskConfigurationFXShiftYieldIRDelta_h
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRiskConfigurationFXShiftYieldIRDelta.h
//
...
//===================== Class Declare AQLRiskConfigurationFXShiftYieldIRDelta==================================
/*! 
    @brief IR Delta setup class
	

*/
class AQLRiskConfigurationFXShiftYieldIRDelta : public AQLRiskConfigurationYieldIRDelta
{
public:
	// constructor
	explicit AQLRiskConfigurationFXShiftYieldIRDelta(void);
	// destructor
	virtual ~AQLRiskConfigurationFXShiftYieldIRDelta(void);
	// copy constructor
	AQLRiskConfigurationFXShiftYieldIRDelta(const AQLRiskConfigurationFXShiftYieldIRDelta &rhs);
	AQLRiskConfigurationFXShiftYieldIRDelta &operator=(const AQLRiskConfigurationFXShiftYieldIRDelta &rhs);
