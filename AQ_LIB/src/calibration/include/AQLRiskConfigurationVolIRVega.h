...
//===================== Class Declare AQLRiskConfigurationVolIRVega==================================
/*! 
    @brief IR Vega setup class
	

*/
class AQLRiskConfigurationVolIRVega : public AQLRiskConfigurationVolatility
{
public:
	// constructor
	explicit AQLRiskConfigurationVolIRVega(void);
	// destructor
	virtual ~AQLRiskConfigurationVolIRVega(void);
	// copy constructor
	AQLRiskConfigurationVolIRVega(const AQLRiskConfigurationVolIRVega &rhs);
	AQLRiskConfigurationVolIRVega &operator=(const AQLRiskConfigurationVolIRVega &rhs);
...
friend class AQLRiskConfigurationVolCreatorLMM;
	...
	virtual void storeIRAdditionalInfo(AQLDataInstance &dataInstance, const AQLScenarioParam& param) const;
};
