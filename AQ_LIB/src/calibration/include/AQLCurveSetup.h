#ifndef AQL_CURVE_SETUP_H
#define AQL_CURVE_SETUP_H
...
protected:
	...
	static void setStaticDataValue(AQLStaticData &staticData, const AQLString &key, const AQLString &val, const bool is_override = false);
};
//#endif