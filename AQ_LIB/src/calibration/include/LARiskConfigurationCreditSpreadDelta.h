...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LARiskConfigurationCreditSpreadDelta.h
//
//  DESCRIPTION :       CreditSpreadDelta risk setup class
//                      
//  SEE ALSO    :       
//  VIRSION		:
//  STATUS      :       
...
//===================== Class Declare LARiskConfigurationCreditSpreadDelta==================================
/*! 
    @brief CreditSpreadDelta risk setup class
...
*/
class LARiskConfigurationCreditSpreadDelta : public LARiskConfiguration
{
public:
	// constructor
	explicit LARiskConfigurationCreditSpreadDelta(void);
	// destructor
	virtual ~LARiskConfigurationCreditSpreadDelta(void);
	// copy constructor
	LARiskConfigurationCreditSpreadDelta(const LARiskConfigurationCreditSpreadDelta &rhs);
	LARiskConfigurationCreditSpreadDelta &operator=(const LARiskConfigurationCreditSpreadDelta &rhs);
