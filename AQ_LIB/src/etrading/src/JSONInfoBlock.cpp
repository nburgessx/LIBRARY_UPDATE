...
namespace etrading
{
    ...
    /* @brief			Function to trim and remove blank rows from AQObj object Information Blocks
    ...
    *  @return			Returns a AQObj object information blocks with empty data rows removed
    */ 
    ...
    /* @brief			Function to trim and remove blank rows from a single AQObj object Information Block
    *  @param [in]		infoBlocks		        A vector of info blocks
    *  @param [in]		checkForErrors		    Parameter to control throw if an error is found, default is true
    ...
    */ 
    ...
    JSONInfoBlockTuple JSONInfoBlock::createInfoBlock( const VariantMatrix & dataMatrix, const bool enforceVariantDataType )
    {
        ...
        // Data must be transposed from Columns to Rows in AQObj JSON Format
        // ----------------------------------------------------------------------
