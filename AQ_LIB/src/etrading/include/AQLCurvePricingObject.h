...
namespace etrading
{
    ...
    public:
        ...
        //	get Interpolation
        const AQLPriceDataInterpolation&  getInterpolation() const;
        
        //	get Interpolation
        AQLPriceDataInterpolation& getInterpolation();
        
        //	get Interpolation
        const AQLPriceDataInterpolation& getInterpolation(const AQLString &curveType) const;
        
        //	get Interpolation
        AQLPriceDataInterpolation& getInterpolation(const AQLString &curveType);

        // get DayCountConvension
        const AQLPriceDataDayCount& getDayCount(void) const;
        
        // get DayCountConvension
        AQLPriceDataDayCount& getDayCount(void);
        
        // get YieldData
        const AQLDataReference& getYieldData() const;
        
        // get YieldData
        AQLDataReference& getYieldData();
        
        // get Calendar
        const AQLPriceDataCalendar& getCalendar() const;
        
        // get Calendar
        AQLPriceDataCalendar& getCalendar();
        
        // get SlidingRule
        const AQLPriceDataSlidingRule& getSlidingRule() const;
        ...
        double				getParRate(const AQLString& term_str, AQLString foreCurveName = STD, AQLString dfCurveName = STD, bool isFWDInter = true, const AQLString* roll_convention = NULL);

        //	get ParRate from DateVector 
        double				getParRate(const DateVector& dates, const DateVector& dates_float, AQLString foreCurveName = STD, AQLString dfCurveName = STD, bool isFWDInter = true);
		...
		*/
        ...
        static const RateConvention setRC(AQLString Freq);

        // get DFInterpolationMethod
        const AQLDataString& getDFInterpolationMethod() const;
        
        // get DFInterpolationMethod
        AQLDataString& getDFInterpolationMethod();
        
        // get DF2InterpolationMethod
        const AQLDataString& getDF2InterpolationMethod() const;
        
        // get DF2InterpolationMethod
        AQLDataString& getDF2InterpolationMethod();
        ...
        // get DayCountConvension
        const AQLPriceDataDayCount& getDayCount(const AQLString &curveType) const;
        ...
        void				getCurveConvention(AQLString& freq, AQLPriceDataCalendar& cal, AQLPriceDataSlidingRule& sld, AQLPriceDataDayCount& dc, AQLString& accessary, const AQLString& curveName) const;
    ...
    protected:
        ...
        AQLString    mCurveType;		    // curve index
