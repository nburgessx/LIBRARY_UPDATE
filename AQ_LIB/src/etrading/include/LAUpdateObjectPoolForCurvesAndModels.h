...
public:
	...
	virtual void generateCorrelation(const AQLString &currency, AQLDataInstance &dataInstance) const {return;};
#ifndef VISUAL_STUDIO_2010_ANALYTICS
	//! generate sde volatility
	virtual void generateVolatility(const AQLString &key, AQLDataInstance &dataInstance) const {return;};
#endif
...
protected:
	...
	//==============================================
	//! set volatility 
	virtual  void setVolatility(const AQLString &key, LARatesSDEBase &sde)  const {return;};	
	//==============================================
	//! set drift 
	...
	//==============================================
	//! setup vol method
	virtual void setUpVolFunc(const AQLString &key,LAMathVolatility &vol, AQLDataInstance &dataInstance) const {return;};
	//==============================================
