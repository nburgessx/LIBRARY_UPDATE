...
namespace google_test
{
	...
	{
		// Load Curves
		auto loadOIS = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AUD_OIS, etrading::JSON);
		auto load3ML = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AUD_3ML, etrading::JSON);

		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_AUD, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_AUD, etrading::JSON);
		...
		auto actualSpread = validation_api::tryMeLWOAssetSwapSpread(swapName, bondName, bondPrice, valuationSettingsLVB, fixingTableNames);
	...
	TEST_F(TestBondSpreads, SNAPSHOT_ZSpread_AUD)
	{
		...
		//1) Check Price Matching
		auto actual_zSpread = validation_api::tryMeLWOBondZSpread(inputFile["bondObjectName"], inputFile["settlementDate"], inputFile["bondPrice"], inputFile["curveCollection"], inputFile["forecastCurve"], true);
	...
	{
		// Load Curves
		auto loadOIS = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_USD_OIS, etrading::JSON);
		auto load3ML = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_USD_3ML, etrading::JSON);

		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_USD, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_USD, etrading::JSON);
	...
	TEST_F(TestBondSpreads, SNAPSHOT_AssetSwapSpread_German)
	{
		...
		auto load6ML = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_EUR_6ML, etrading::JSON);

		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_German, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_German, etrading::JSON);
	...
	TEST_F(TestBondSpreads, SNAPSHOT_AssetSwapSpread_Dutch)
	{
		...
		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_Dutch, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_Dutch, etrading::JSON);
	...
	TEST_F(TestBondSpreads, SNAPSHOT_AssetSwapSpread_French)
	{
		...
		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_French, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_French, etrading::JSON);
	...
	TEST_F(TestBondSpreads, SNAPSHOT_AssetSwapSpread_Italian)
	{
		...
		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_Italian, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_Italian, etrading::JSON);
	...
	{
		// Load Curves
		auto loadOIS = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_JPY_OIS, etrading::JSON);
		auto load6ML = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_JPY_6ML, etrading::JSON);

		// Load Bond
		auto loadBond = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_Bond_JGB, etrading::JSON);
		// Load Swap
		auto loadSwap = validation_api::tryMeLWOLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_JGB, etrading::JSON);
