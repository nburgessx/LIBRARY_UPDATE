...
#define TEST_DIR "ETrading/LWObjects/TestLWOSwapStubImpactOnParRate/"
...
namespace google_test
{
    ...
    //
    ME_BUILD_JPY_CURVE( TestLWOSwapStubImpactOnParRate, JPYYC_OIS, JPYYC_1M, JPYYC_3M, JPYYC_6M, JPYYC_12M);
    ...
    TEST_F( TestLWOSwapStubImpactOnParRate, SNAPSHOT_IMM_Swaps)
    {
        runTest("IMM_SWAPS");
    }

	TEST_F( TestLWOSwapStubImpactOnParRate, SNAPSHOT_Stub_Swaps)
    {
        runTest("STUB_SWAPS");
    }

	TEST_F( TestLWOSwapStubImpactOnParRate, SNAPSHOT_Libor_Swaps)
    {
        runTest("LIBOR_SWAPS");
    }
