...
{
    class TestBondPricesAustraliaType23Govt : public virtual testing::Test, public virtual google_test::InitializeMLibGoogleTest //: public TestBondFactory 
	{
	public:
    ...
    TEST_F( TestBondPricesAustraliaType23Govt, SCENARIO_CheckBondPricesAndYieldsMatchLiveMarketData1)
    {
        ...
        try
        {
             for ( i = 0; i < TEST_COUNT1; ++i )
             {
				...
				auto actualPrices = validation_api::tryMeLWOBondPrice(bondObjectName, settlementDates, yields);
