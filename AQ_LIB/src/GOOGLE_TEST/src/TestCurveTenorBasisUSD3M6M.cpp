...
#define TEST_DIR "Vanilla/Curves/TestCurveTenorBasisUSD3M6M/"
...
namespace
{
    ...
    // curve input files
    //
    extern const char CurveOisInputs[]					= TEST_DIR "USDYC_OIS_tryMirSetUpOISCurve_inputs";
    extern const char CurveStdInputs[]					= TEST_DIR "USDYC_STD_tryMirSetUpSwapCurve_inputs";
    extern const char CurveTenorBasisInputs[]			= TEST_DIR "USDYC_3M6M_tryMirSetUpBasisSwapCurve_inputs";

    //
    // test call input and reference files
    //
    extern const char OutPutDFReference_32bit[]				= TEST_DIR "USDYC_3M6M_tryMirOutputCurve_outputs_32bit";
	extern const char OutPutDFReference_64bit[]				= TEST_DIR "USDYC_3M6M_tryMirOutputCurve_outputs_64bit";

    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "USDYC_OIS_tryMirGetDF1_inputs";
    extern const char CheckDiscountFactorsReference[]	= TEST_DIR "USDYC_OIS_tryMirGetDF1_outputs";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "USDYC_USDDF_tryMirGetForwardRate1_inputs";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "USDYC_USDDF_tryMirGetForwardRate1_outputs";
}
...
namespace google_test
{
    ...
    typedef BindFileToClassConstructor<CurveStd, CurveStdInputs> CurveStdBound;
    typedef BindFileToClassConstructor<CurveTenorBasis, CurveTenorBasisInputs> CurveTenorBasisBound;
    ...
    class TestCurveTenorBasisUSD3M6M : public testing::Test, public CurveTenorBasisBuilt
    {
    public:
        //
    ...
    TEST_F( TestCurveTenorBasisUSD3M6M, SNAPSHOT_OutPutDF )
    {
    ...
    TEST_F( TestCurveTenorBasisUSD3M6M, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveTenorBasisUSD3M6M, SNAPSHOT_CheckForwardRates )
    {
