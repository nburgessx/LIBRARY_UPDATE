...
#define TEST_DIR "Vanilla/Curves/TestCurveStdUSD/"
...
namespace google_test
{
    ...
    class TestCurveStdUSD : public virtual testing::Test, public CurveStdBuilt
    {
    public:
    ...
    TEST_F( TestCurveStdUSD, SNAPSHOT_OutPutDF )
    {
    ...
    TEST_F( TestCurveStdUSD, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveStdUSD, SNAPSHOT_CheckForwardRates )
    {
