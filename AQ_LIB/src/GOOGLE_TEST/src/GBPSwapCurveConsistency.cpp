...
namespace google_test
{
    ...
    class GBP_SwapCurve_Consistency : public virtual testing::Test, public virtual google_test::InitializeMLibGoogleTest
    {
    public:
    ...
    TEST_F( GBP_SwapCurve_Consistency, CONSISTENCY_GBP3ML_Swap_Instrument_Repricing )
    {
        ...
        for ( size_t i = 0; i < swapTerms.size(); ++i )
        {
            ...
            const std::string swapName                  = "GBP3ML_Swap" + MLIB_TO_STRING_FROM_SIZE_T( i );
