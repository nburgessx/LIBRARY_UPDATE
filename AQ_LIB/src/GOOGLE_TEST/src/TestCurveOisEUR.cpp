...
#define TEST_DIR "Vanilla/Curves/TestCurveOisEUR/"
...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "EURYC_OIS_tryMirSetUpOISCurve_inputs.csv";
    ...
    extern const char CheckForwardRatesInputs[]			= TEST_DIR "EURYC_EURDF_tryMirGetForwardRate2_inputs.csv";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "EURYC_EURDF_tryMirGetForwardRate2_outputs.csv";
}
...
namespace google_test
{
    ...
    class TestCurveOisEUR : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TestCurveOisEUR, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveOisEUR, SNAPSHOT_CheckForwardRates )
    {
