...
namespace google_test
{
    ...
    class TryMeTestCurveOisUSD : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TryMeTestCurveOisUSD, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveOisUSD, SNAPSHOT_CheckMeCurveForwardRatesFromForwardDates )
    {
