...
#define TEST_DIR "Vanilla/Trades/TestTradeUSDSwapParRate/"
...
namespace google_test
{
    ...
    //
    ADD_USD_CURVE_DEPENDENCIES( TestTradeUSDSwapParRate, USDYC_OIS, USDYC_1M, USDYC_3M, USDYC_6M, USDYC_12M );
    ...
    TEST_F( TestTradeUSDSwapParRate, SNAPSHOT_CheckHardCodedSwapParRateUnchanged )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestTradeUSDSwapParRate, SNAPSHOT_CheckSwapParRateAgainstYieldCurveParRate )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestTradeUSDSwapParRate, SNAPSHOT_CheckParSwapPriceIsZero )
    {
        int i = 0;
        try
        {
