...
#define TEST_DIR "Vanilla/Curves/TestCurveStdJPY/"
...
namespace
{
    ...
    // curve input files
    //
    extern const char JPYYC_OIS[]					= TEST_DIR "JPYYC_OIS_tryMirSetUpOISCurve_inputs.csv";
    extern const char JPYYC_STD[]					= TEST_DIR "JPYYC_STD_tryMirSetUpSwapCurve_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char OutPutDFReference[]				= TEST_DIR "JPYYC_STD_tryMirOutputCurve_outputs.csv";

    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "JPYYC_OIS_tryMirGetDF1_inputs.csv";
    extern const char CheckDiscountFactorsReference[]	= TEST_DIR "JPYYC_OIS_tryMirGetDF1_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "JPYYC_JPYDF_tryMirGetForwardRate1_inputs.csv";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "JPYYC_JPYDF_tryMirGetForwardRate1_outputs.csv";
}
...
namespace google_test
{
    ...
    class TestCurveStdJPY : public virtual testing::Test, public CurveStdBuilt
    {
    public:
    ...
    TEST_F( TestCurveStdJPY, SNAPSHOT_OutPutDF )
    {
    ...
    TEST_F( TestCurveStdJPY, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveStdJPY, SNAPSHOT_CheckForwardRates )
    {
