...
#define TEST_DIR "Vanilla/Trades/TestTradeJPYSwapParRate/"
...
namespace
{
    ...
    extern const char JPYYC_3M[]			= "";
    extern const char JPYYC_6M[]			= TEST_DIR "JPYYC_STD_tryMirSetUpSwapCurve_inputs";
    extern const char JPYYC_12M[]			= "";

    //
    // test call input and reference files
    //
    extern const char getParRateInputs[]    = TEST_DIR "JPYYC_tryMirGetParRate4_inputs";
    extern const char getParRateOutputs[]	= TEST_DIR "JPYYC_tryMirGetParRate4_outputs";
}
...
namespace google_test
{
    ...
    //
    // All tenor curve name MUST be defined for the ADD_JPY_CURVE_DEPENDENCIES macro to work.
    // If any curve is not in use and not defined, simply assign a "" to the curve name.
    //
    ADD_JPY_CURVE_DEPENDENCIES( TestTradeJPYSwapParRate, JPYYC_OIS, JPYYC_1M, JPYYC_3M, JPYYC_6M, JPYYC_12M );
    ...
    TEST_F( TestTradeJPYSwapParRate, SNAPSHOT_CheckHardCodedSwapParRateUnchanged )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestTradeJPYSwapParRate, SNAPSHOT_CheckSwapParRateAgainstYieldCurveParRate )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestTradeJPYSwapParRate, SNAPSHOT_CheckParSwapPriceIsZero )
    {
        int i = 0;
        try
        {
