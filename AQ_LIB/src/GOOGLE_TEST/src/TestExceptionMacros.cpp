...
namespace google_test
{
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_SET_VARIABLE_OR_OVERRIDE_ON_FAILURE )
    {
        ...
        AQ_SET_VARIABLE_OR_OVERRIDE_ON_FAILURE( result_of_failure, badFunction( 1.0 ), 999.0 );
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_ROUND )
    {
        ...
        EXPECT_EQ( AQ_ROUND( 123, 100.0 ),        100.0 );

        EXPECT_EQ( AQ_ROUND( 187, 1.0 ),          187.0 );
        EXPECT_EQ( AQ_ROUND( 187, 10.0 ),         190.0 );
        EXPECT_EQ( AQ_ROUND( 187, 100.0 ),        200.0 );
        ...
        EXPECT_EQ( AQ_ROUND( 10.0001, 1.0 ),      10.0 );
        EXPECT_EQ( AQ_ROUND( 10.0001, 0.001 ),    10.0 );
        EXPECT_EQ( AQ_ROUND( 10.0001, 0.0001 ),   10.0001 );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_EQUAL )
    {
        ...
        EXPECT_TRUE( AQ_IS_EQUAL( 10.0000000000000000000001, 10 ) );
        
        EXPECT_FALSE( AQ_IS_EQUAL( 9, 10 ) );
        EXPECT_FALSE( AQ_IS_EQUAL( 9.9999, 10 ) );
        EXPECT_FALSE( AQ_IS_EQUAL( 10.0001, 10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_LESS_THAN )
    {
        ...
        EXPECT_FALSE( AQ_IS_LESS_THAN( 9.99999999999999999999999, 10 ) );
        EXPECT_FALSE( AQ_IS_LESS_THAN( 10.1, 10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_LESS_THAN_OR_EQUAL )
    {
        ...
        EXPECT_TRUE( AQ_IS_LESS_THAN_OR_EQUAL( -10, 10 ) );
        EXPECT_TRUE( AQ_IS_LESS_THAN_OR_EQUAL( 9.9, 10 ) );

        EXPECT_FALSE( AQ_IS_LESS_THAN_OR_EQUAL( 10.1, 10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_GREATER_THAN )
    {
        ...
        EXPECT_FALSE( AQ_IS_GREATER_THAN( -15, 10 ) );
        EXPECT_FALSE( AQ_IS_GREATER_THAN( 10.0000000000000000000001, 10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_GREATER_THAN_OR_EQUAL )
    {
        ...
        EXPECT_TRUE( AQ_IS_GREATER_THAN_OR_EQUAL( 15, 10 ) );
        EXPECT_TRUE( AQ_IS_GREATER_THAN_OR_EQUAL( 10.1, 10 ) );

        EXPECT_FALSE( AQ_IS_GREATER_THAN_OR_EQUAL( -15, 10 ) );
        EXPECT_FALSE( AQ_IS_GREATER_THAN_OR_EQUAL( 9.99999, 10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_EQUAL_ZERO )
    {
        ...
        EXPECT_FALSE( AQ_IS_EQUAL_ZERO( 0.0001 ) );
        EXPECT_FALSE( AQ_IS_EQUAL_ZERO( -0.0001 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_LESS_THAN_ZERO )
    {
        ...
        EXPECT_FALSE( AQ_IS_LESS_THAN_ZERO( 0.00000000000000000001 ) );
        EXPECT_FALSE( AQ_IS_LESS_THAN_ZERO( -0.00000000000000000001 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_LESS_THAN_OR_EQUAL_TO_ZERO )
    {
        ...
        EXPECT_TRUE( AQ_IS_LESS_THAN_OR_EQUAL_TO_ZERO( -0.00001 ) );
        EXPECT_TRUE( AQ_IS_LESS_THAN_OR_EQUAL_TO_ZERO( -10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_GREATER_THAN_ZERO )
    {
        ...
        EXPECT_FALSE( AQ_IS_GREATER_THAN_ZERO( 0.000000000000000001 ) );
        EXPECT_FALSE( AQ_IS_GREATER_THAN_ZERO( -10 ) );
    }
    ...
    TEST( TestExceptionMacros, UNIT_TestMacro_MLIB_IS_GREATER_THAN_OR_EQUAL_TO_ZERO )
    {
        ...
        EXPECT_TRUE( AQ_IS_GREATER_THAN_OR_EQUAL_TO_ZERO( 0.00001 ) );
        EXPECT_TRUE( AQ_IS_GREATER_THAN_OR_EQUAL_TO_ZERO( 10 ) );

        EXPECT_FALSE( AQ_IS_GREATER_THAN_OR_EQUAL_TO_ZERO( -10 ) );
    }
