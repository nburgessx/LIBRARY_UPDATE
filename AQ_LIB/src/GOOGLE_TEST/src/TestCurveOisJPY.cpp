...
#define TEST_DIR "Vanilla/Curves/TestCurveOisJPY/"
...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "JPYYC_OIS_tryMirSetUpOISCurve_inputs.csv";
    ...
    extern const char CheckForwardRatesInputs[]			= TEST_DIR "JPYYC_JPYDF_tryMirGetForwardRate2_inputs.csv";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "JPYYC_JPYDF_tryMirGetForwardRate2_outputs.csv";
}
...
namespace google_test
{
    ...
    class TestCurveOisJPY : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TestCurveOisJPY, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveOisJPY, SNAPSHOT_CheckForwardRates )
    {
