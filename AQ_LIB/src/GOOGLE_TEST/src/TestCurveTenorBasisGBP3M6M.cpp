...
#define TEST_DIR "Vanilla/Curves/TestCurveTenorBasisGBP3M6M/"
...
namespace
{
    ...
    //
    extern const char OutPutDFReference_32bit[]				= TEST_DIR "GBPYC_3M6M_tryMirOutputCurve_outputs_32bit";
	extern const char OutPutDFReference_64bit[]				= TEST_DIR "GBPYC_3M6M_tryMirOutputCurve_outputs_64bit";

    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "GBPYC_OIS_tryMirGetDF1_inputs";
    extern const char CheckDiscountFactorsReference[]	= TEST_DIR "GBPYC_OIS_tryMirGetDF1_outputs";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "GBPYC_GBPDF_tryMirGetForwardRate1_inputs";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "GBPYC_GBPDF_tryMirGetForwardRate1_outputs";
}
...
namespace google_test
{
    ...
    typedef BindFileToClassConstructor<CurveTenorBasis, GBPYC_3M6M> CurveTenorBasisBound;
    ...
    class TestCurveTenorBasisGBP3M6M : public testing::Test, public CurveTenorBasisBuilt
    {
    public:
        //
    ...
    TEST_F( TestCurveTenorBasisGBP3M6M, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveTenorBasisGBP3M6M, SNAPSHOT_CheckForwardRates )
    {
