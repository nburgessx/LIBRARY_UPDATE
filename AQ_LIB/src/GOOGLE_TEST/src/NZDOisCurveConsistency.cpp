...
namespace google_test
{
    ...
    class NZD_OisCurve_Consistency : public virtual testing::Test, public virtual google_test::InitializeMLibGoogleTest
    {
    public:
    ...
    TEST_F( NZD_OisCurve_Consistency, CONSISTENCY_NZDOIS_OisSwap_Instrument_Repricing )
    {
        ...
        for ( size_t i = 0; i < oisSwapTerms.size(); ++i )
        {
            ...
            const std::string swapName                  = "NZDOIS_Swap" + MLIB_TO_STRING_FROM_SIZE_T( i );
