...
#define ADD_EUR_CURVE_DEPENDENCIES(test_name, source_ois, source_1m, source_3m, source_6m, source_12m)	\
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency4<  BindFileToClassConstructor< CurveTenorBasis, source_1m >,	\
...
#define ADD_JPY_CURVE_DEPENDENCIES(test_name, source_ois, source_1m, source_3m, source_6m, source_12m)	\
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency4<  BindFileToClassConstructor< CurveTenorBasis, source_12m >,	\
        BindFileToClassConstructor< CurveOis,		   source_ois >,	\
        BindFileToClassConstructor< CurveStd,          source_6m >,	\
        BindFileToClassConstructor< CurveTenorBasis,   source_3m >,	\
...
#define ME_BUILD_EUR_CURVE(test_name, source_ois, source_1m, source_3m, source_6m, source_12m)	\
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency4<  BindFileToClassConstructor< TryMeCurveTenorBasis, source_1m >,	\
...
#define ME_BUILD_JPY_CURVE(test_name, source_ois, source_1m, source_3m, source_6m, source_12m)	\
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency4<  BindFileToClassConstructor< TryMeCurveTenorBasis, source_12m >,	\
        BindFileToClassConstructor< TryMeCurveOis,		  source_ois >,	\
        BindFileToClassConstructor< TryMeCurveStd,         source_6m >,	\
        BindFileToClassConstructor< TryMeCurveTenorBasis,  source_3m >,	\
...
#define ME_BUILD_EURUSD_XCCY_CURVE(test_name, usd_source_ois, usd_source_3m, eur_source_ois, eur_source_6m, eur_source_3m, eur_source_xccy ) \
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency5<  BindFileToClassConstructor<  TryMeCurveXccyBasis, eur_source_xccy  >,   \
...
#define ME_BUILD_EURUSD_JPYUSD_XCCY_CURVE(test_name, usd_source_ois, usd_source_3m, eur_source_ois, eur_source_6m, eur_source_3m, eur_source_xccy, jpy_source_ois, jpy_source_6m_jscc, jpy_source_6m_lch, jpy_source_3m_lch, jpy_source_xccy ) \
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency10<  BindFileToClassConstructor<  TryMeCurveXccyBasis, jpy_source_xccy  >,   \
        BindFileToClassConstructor< TryMeCurveOis,	        usd_source_ois >,	\
        BindFileToClassConstructor< TryMeCurveStd,          usd_source_3m >,	\
		BindFileToClassConstructor< TryMeCurveOis,	        eur_source_ois >,	\
        BindFileToClassConstructor< TryMeCurveStd,          eur_source_6m >,	\
...
#define ME_BUILD_GBPEUR_FWD_CURVE(test_name, usd_source_ois, usd_source_3m, eur_source_ois, eur_source_6m, eur_source_3m, eur_source_xccy, gbp_source_ois, gbp_source_6m, gbp_source_3m, gbp_source_xccy, gbp_eur_csa ) \
    class test_name : public testing::Test, public virtual google_test::InitializeMLibGoogleTest, public Dependency10<  BindFileToClassConstructor<  TryMeCurveFwdFxConst, gbp_eur_csa  >,   \
        BindFileToClassConstructor< TryMeCurveOis,	        usd_source_ois >,	\
        BindFileToClassConstructor< TryMeCurveStd,          usd_source_3m >,	\
        BindFileToClassConstructor< TryMeCurveOis,	        eur_source_ois >,	\
        BindFileToClassConstructor< TryMeCurveStd,          eur_source_6m >,	\
