...
REM and places swig_R_wrap.cpp in the src\AQ_API\source folder
"%AQ_EXTERNAL_LIB_PATH%\library\swigwin-4.0.0\swig.exe" -v -c++ -outdir "%GENERATED_FILES%" -o "%AQ%\src\AQ_API\source\swig_R_wrap.cpp" -r "%AQ%\src\AQ_API\source\swig_R.i"
...
REM R CMD SHLIB -o AQ_API "%AQ%\src\AQ_API\source\swig_R_wrap.cpp"
