                    ...
                    const SWIG_STRINGMATRIX & fixingTableNames )
{
    ...
    double result = validation::tryAqObjSwapsPV( swapName,
                      ...
                      const SWIG_STRINGMATRIX & fixingTableNames )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsPV01( swapName,
                                                        valuationSettingsAsStringMatrix,
                                                        fixingTableAsStringMatrix );
    return result;
                         ...
                         const SWIG_STRINGMATRIX & fixingTableNames )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsParRate( swapName,
                                                            valuationSettingsAsStringMatrix,
                                                            fixingTableAsStringMatrix );
    return result;
                         ...
                         const std::string& legName )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsParRate( swapName, valuationSettingsAsStringMatrix, fixingTableAsStringMatrix, legName );
                         ...
                         const std::string& legName )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsAnnuity( swapName,
                                                            valuationSettingsAsStringMatrix,
                                                            legNameAsAQLString );
    return result;
    AQ_API_END
                           ...
                           const std::string & spreadLegName )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsParSpread( swapName,
                                                           valuationSettingsAsStringMatrix,
                                                           fixingTableAsStringMatrix,
                        ...
                        const std::string & spreadLegName )
{
    ...
    // Call Function and Return Result
    double result = validation::tryAqObjSwapsSpread( swapName,
                                                       valuationSettingsAsStringMatrix,
                                                       fixingTableAsStringMatrix,
                                                       spreadLegNameAsAQLString );
    return result;
											 ...
											 const bool showColumnHeaders )
{
	...
	std::vector<AnyTypeMatrix> result
		= validation::tryAqObjSwapsDisplayCashflows( swapName,
														valuationSettingsAsStringMatrix,
														legNameAsAQLString,
														fixingTableAsStringMatrix,
														showColumnHeaders );
