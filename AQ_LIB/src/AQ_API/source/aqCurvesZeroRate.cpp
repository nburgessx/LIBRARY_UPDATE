						...
						const std::string& dayCount)
{
	...
	DoubleVector results = validation::tryAqCurvesZeroRatesFromYearFractions(yearFractions,
																				tmp_curveCollection, 
																				tmp_curveIndex,
																				tmp_frequency, 
																				tmp_dayCount);
						...
						const std::string& dayCount)
{
	...
	ret = validation::tryAqCurvesZeroRatesFromYearFractions(yearFractions,
																tmp_curveCollection, 
																tmp_curveIndex,
																tmp_frequency, 
																tmp_dayCount);
						...
						const std::string& businessDayAdj)
{
	...
	std::vector<double> results = validation::tryAqCurvesZeroRatesFromTenors(tenors,
																				tmp_curveCollection, 
																				tmp_curveIndex,
																				tmp_frequency, 
																				tmp_dayCount, 
						...
						const std::string& businessDayAdj)
{
	...
	ret = validation::tryAqCurvesZeroRatesFromTenors(tmp_tenors,
														tmp_curveCollection, 
														tmp_curveIndex,
														tmp_frequency, 
														tmp_dayCount, 
