...
/* @brief			swig interface for aqCurveCalibrateBasis
...
*/
const std::string aqCurveCalibrateBasis(const std::string& curveCollection, 
										...
										const SWIG_STRINGMATRIX & spotFxRates) 
{
	...
	ret = validation::tryAqCurveCalibrateBasis(
												tmp_curveCollection,
												tmp_staticDataTable,
												tmp_curveIndex,
												tmp_curveConv,
