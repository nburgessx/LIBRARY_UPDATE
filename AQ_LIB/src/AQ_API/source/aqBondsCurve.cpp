...
*/
swig::NelsonSiegelSvenssonCalibrationResults aqBondsCurveNelsonSiegelCalibrate( const std::vector<double>& bondMaturities,
																	  ...
																	  const std::vector<double>& upperBounds )
{
    ...
    etrading::NelsonSiegelSvenssonCalibrationResults nsResult = validation::tryAqBondsCurveNelsonSiegelCalibrate( bondMaturities,
                                                                                                                        bondYields,
...
*/
swig::NelsonSiegelSvenssonCalibrationResults aqBondsCurveSvenssonCalibrate( const std::vector<double>& bondMaturities,
															      const std::vector<double>& bondYields,
															      const swig::NelsonSiegelSvenssonParameters& initialGuess,
															      const unsigned int& maxIterations,
															      const unsigned int& maxStationaryStateIterations,
															      ...
															      const std::vector<double>& upperBounds )
{
    ...
    // Call validation method and marshall swig inputs
    etrading::NelsonSiegelSvenssonCalibrationResults sResult = validation::tryAqBondsCurveSvenssonCalibrate( bondMaturities,
                                                                                                                bondYields,
                                                                                                                swig::fromSwigNelsonSiegelSvenssonParameters( initialGuess ), 
                                                                                                                maxIterations,
                                                                                                                maxStationaryStateIterations,
...
/* @brief Main API: Calibrates Polynomial-interpolation coefficients to the specified bond yields and maturities
	...
	*/
swig::PolynomialCalibrationResults aqBondsCurvePolynomialCalibrate( const unsigned int polynomialOrder,
																  ...
																  const double upperBound )
{
    ...
    etrading::PolynomialCalibrationResults nsResult = validation::tryAqBondsCurvePolynomialCalibrate( polynomialOrder,
                                                                                                         bondMaturities,
                                                                                                         bondYields,
                                                                                                         maxIterations,
                                                                                                         maxStationaryStateIterations,
...
*/
std::vector<double> aqBondsCurveNelsonSiegelYield( const double& beta0,
										          const double& beta1,
										          const double& beta2,
										          const double& lambda,
										          const std::vector<double>& bondMaturities )
{
    ...
    // Call validation method
    std::vector<double> result = validation::tryAqBondsCurveNelsonSiegelYield( beta0, beta1, beta2, lambda, bondMaturities );
    return result;
...
*  @returns		A vector of interpolated bond yields, one yield per supplied maturity.
*/
std::vector<double> aqBondsCurveSvenssonYield( const double& beta0,
									          const double& beta1,
									          const double& beta2,
									          const double& beta3,
									          ...
									          const std::vector<double>& bondMaturities )
{
    ...
    // Call validation method
    std::vector<double> result = validation::tryAqBondsCurveSvenssonYield( beta0, beta1, beta2, beta3, lambda1, lambda2, bondMaturities );
    return result;
...
*/
std::vector<double> aqBondsCurvePolynomialYield( const std::vector<double>& coefficients, const std::vector<double>& bondMaturities )
{
    AQ_API_START

    // Call validation method
    std::vector<double> result = validation::tryAqBondsCurvePolynomialYield( coefficients, bondMaturities );
    return result;
