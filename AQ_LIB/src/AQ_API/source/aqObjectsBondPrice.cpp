// aqObjectsBondPrice.cpp

/* 
 * @brief			Swig interface for aqObjectsBondPrice... functions
...
/* @brief			swig interface for aqObjectsBondPrice function
...
*/
const std::vector<double> aqObjectsBondPrice( const std::string& bondObjectName,
                                          ...
                                          const std::string& yieldCalculationType )
{
    ...
    const std::vector<double> results = validation::tryAqObjectsBondPrice( bondObjectName, settlementDatesAsDateVector, yields, yieldCalculationType );
    return results;
    
    AQ_API_END
}

/* @brief			swig interface for aqObjectsBondCleanPrice function
*  @param [in]		bondObjectName		    Bond Object Name
*  @param [in]		settlementDates	        Bond Settlement Date(s)
*  @param [in]		yields     	            Bond Yield(s)
*  @param [in]		yieldCalculationType	Yield Calculation Type
...
*/
const std::vector<double> aqObjectsBondCleanPrice( const std::string& bondObjectName,
                                               const std::vector<std::string>& settlementDates,
                                               const std::vector<double>& yields,
                                               const std::string& yieldCalculationType )
{
    ...
    // Call validation method
    const std::vector<double> results = validation::tryAqObjectsBondCleanPrice( bondObjectName, settlementDatesAsDateVector, yields, yieldCalculationType );
    return results;

    AQ_API_END
}

/* @brief			swig interface for aqObjectsBondDirtyPrice function
*  @param [in]		bondObjectName		    Bond Object Name
*  @param [in]		settlementDates	        Bond Settlement Date(s)
*  @param [in]		yields     	            Bond Yield(s)
*  @param [in]		yieldCalculationType	Yield Calculation Type
*  @param [out]		Returns a vector of clean bond prices for each settlement date
*/
const std::vector<double> aqObjectsBondDirtyPrice( const std::string& bondObjectName,
                                               const std::vector<std::string>& settlementDates,
                                               const std::vector<double>& yields,
                                               const std::string& yieldCalculationType )
{
    ...
    // Call validation method
    const std::vector<double> results = validation::tryAqObjectsBondDirtyPrice( bondObjectName, settlementDatesAsDateVector, yields, yieldCalculationType );
    return results;
...
/* @brief			swig interface for aqObjectsBondYield function
*  @param [in]		bondObjectName		    Bond Object Name
*  @param [in]		settlementDates	        Bond Settlement Date(s)
...
*  @param [out]		Returns a vector of clean bond prices for each settlement date
*/
const std::vector<double> aqObjectsBondYield( const std::string& bondObjectName,
                                          const std::vector<std::string>& settlementDates,
                                          ...
                                          const bool& optimizePerformance )
{
    ...
    // Call validation method
    const std::vector<double> results = validation::tryAqObjectsBondYield( bondObjectName, settlementDatesAsDateVector, quotedPrices, yieldCalculationType, optimizePerformance );
    return results;
...
*/
double aqObjectsBondForwardPrice( const std::string& bondObjectName,
                              ...
                              const std::string& repoDayCount )
{
    ...
    // Call validation method
    const double result = validation::tryAqObjectsBondForwardPrice( bondObjectName, settleDate_, forwardSettleDate_, price, repoRate, repoDayCount );
    return result;
