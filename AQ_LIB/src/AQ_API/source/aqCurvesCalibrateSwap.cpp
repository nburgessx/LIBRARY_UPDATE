...
/* @brief			swig interface for aqCurvesCalibrateSwap
...
*/
const std::string aqCurvesCalibrateSwap( const std::string& curveCollection, 
								        ...
								        const SWIG_STRINGMATRIX & tenorBasisRates ) 
{
	...
	ret = validation::tryAqCurvesCalibrateSwap( tmp_curveCollection,
                                                    tmp_staticDataTable,
                                                    tmp_curveIndex,
                                                    tmp_curveConv,
                                                    tmp_moneyMarketConv,
