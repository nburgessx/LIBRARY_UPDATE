											             ...
											             const std::string& dayCount)
{
	...
	results = validation::tryAqCurveForwardRatesFromYearFraction( tmp_fromDates, 
																	    yearFraction,
																	    tmp_dayCount,
																	    tmp_curveCollection, 
																	    tmp_curveIndex );
										 ...
										 const std::string& curveIndex)
{
	...
	results = validation::tryAqCurveForwardRates( tmp_fixingDates, 
														tmp_curveCollection, 
														tmp_curveIndex );
	return results;
    AQ_API_END
											             ...
											             const std::string& curveIndex )
{
	...
	results = validation::tryAqCurveForwardRatesFromForwardDates( tmp_fromDates,
                                                                        tmp_toDates,
														                tmp_curveCollection, 
														                tmp_curveIndex );
	return results;
