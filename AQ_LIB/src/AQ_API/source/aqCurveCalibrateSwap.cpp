...
/* @brief			swig interface for aqCurveCalibrateSwap
...
*/
const std::string aqCurveCalibrateSwap( const std::string& curveCollection, 
								        ...
								        const SWIG_STRINGMATRIX & tenorBasisRates ) 
{
	...
	ret = validation::tryAqCurveCalibrateSwap( tmp_curveCollection,
                                                    tmp_staticDataTable,
                                                    tmp_curveIndex,
                                                    tmp_curveConv,
                                                    tmp_moneyMarketConv,
