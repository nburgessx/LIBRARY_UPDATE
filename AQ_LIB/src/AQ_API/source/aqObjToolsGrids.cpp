...
SWIG_STRINGMATRIX aqObjToolsGridDisplay( const std::string& objectName, const bool& displayColumnNames  )
{
	AQ_API_START
	auto result = validation::tryAqObjToolsGridDisplay( objectName );
