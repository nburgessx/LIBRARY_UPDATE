...
*/
std::vector<std::vector<double> > aqCurveDisplay(const std::string& curveCollection, const std::string& curveIndex)
{
	AQ_API_START
    DoubleMatrix ret;
	...
	DoubleArray ans = validation::tryAqCurveDisplay(tmp_curveCollection, tmp_curveIndex);
