...
#include "tryAqCurvesDualBootstrap.h"
...
*/
const std::string aqCurvesDualBootstrap(const std::string& curveCollection,
										...
										const SWIG_STRINGMATRIX & tenorBasisRates_swap)
{
	...
	ret = validation::tryAqCurvesDualBootstrap(tmp_curveCollection,
													tmp_curveName_db,
													tmp_curveName_swap,
													tmp_curveName_OIS,
													tmp_curveIndex_OIS,
