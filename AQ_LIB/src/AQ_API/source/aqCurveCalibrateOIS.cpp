...
/* @brief			swig interface for aqCurveCalibrateOIS
...
*/
const std::string aqCurveCalibrateOIS(const std::string& curveCollection, 
								...
								const SWIG_STRINGMATRIX & swapRates) 
{
	...
	ret = validation::tryAqCurveCalibrateOIS(
										tmp_curveCollection,
                                        tmp_staticDataTable,
                                        tmp_curveIndex,
                                        tmp_curveConv,
