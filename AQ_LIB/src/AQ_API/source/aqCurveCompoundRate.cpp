...
/* @brief swig interface for aqCurveCompoundRate method
...
*/
std::vector<double> aqCurveCompoundRate(const std::vector<std::string>& startDates, 
									...
									const std::string& lastStubDate)
{
	...
	ret = validation::tryAqCurveCompoundRate(
								tmp_startDates,
								tmp_endDates,
								tmp_curveCollection,
...
*/
double aqCurveCompoundRate(const std::string& startDate, 
