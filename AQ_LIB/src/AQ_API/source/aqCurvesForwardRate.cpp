											             ...
											             const std::string& dayCount)
{
	...
	results = validation::tryAqCurvesForwardRatesFromYearFraction( tmp_fromDates, 
																	    yearFraction,
																	    tmp_dayCount,
																	    tmp_curveCollection, 
																	    tmp_curveIndex );
										 ...
										 const std::string& curveIndex)
{
	...
	results = validation::tryAqCurvesForwardRates( tmp_fixingDates, 
														tmp_curveCollection, 
														tmp_curveIndex );
	return results;
    AQ_API_END
											             ...
											             const std::string& curveIndex )
{
	...
	results = validation::tryAqCurvesForwardRatesFromForwardDates( tmp_fromDates,
                                                                        tmp_toDates,
														                tmp_curveCollection, 
														                tmp_curveIndex );
	return results;
