                                            ...
                                            const std::string& curveIndex ) 
{
    ...
    result = validation::tryAqCurvesDiscountFactors( tempPaymentDates, curveCollection.c_str(), curveIndex.c_str() );
	return result;
											...
											const std::string& curveIndex)
{
	...
	std::vector<double> DFs = validation::tryAqCurvesDiscountFactorsFromYearFractions(yearFractions,
																						tmp_dayCount,
																						tmp_curveCollection, 
																						tmp_curveIndex);
	ret = DFs[0];
															...
															const std::string& curveIndex)
{
	...
	ret = validation::tryAqCurvesDiscountFactorsFromYearFractions(yearFractions, 
																	tmp_dayCount,
																	tmp_curveCollection, 
																	tmp_curveIndex);
    return ret;
					...
					const std::string& calendar)
{
	...
	std::vector<double> DFs = validation::tryAqCurvesDiscountFactorsFromTenors(tenors,
																				tmp_curveCollection, 
																				tmp_curveIndex,
																				tmp_businessDayAdj, 
																				tmp_calendar);
					...
					const std::string& calendar)
{
	...
	ret = validation::tryAqCurvesDiscountFactorsFromTenors(tmp_tenors,
															tmp_curveCollection, 
															tmp_curveIndex,
															tmp_businessDayAdj, 
															tmp_calendar);
												...
												const std::string& curveIndex)
{
	...
	std::vector<double> DFs = validation::tryAqCurvesDiscountFactorsForwardStarting(
										fromDates, 
										toDates,
										tmp_curveCollection, 
										tmp_curveIndex
															...
															const std::string& curveIndex)
{
	...
	ret = validation::tryAqCurvesDiscountFactorsForwardStarting(
										tmp_fromDates, 
										tmp_toDates,
										tmp_curveCollection, 
										tmp_curveIndex
																...
																const std::string& curveIndex)
{
	...
	std::vector<double> DFs = validation::tryAqCurvesDiscountFactorsForwardStartingFromYearFractions( fromDates, 
														                                                 yearFractions,
														                                                 tmp_dayCount,
														                                                 tmp_curveCollection, 
														                                                 tmp_curveIndex);
																			...
																			const std::string& curveIndex)
{
	...
	ret = validation::tryAqCurvesDiscountFactorsForwardStartingFromYearFractions( tmp_fromDates, 
														                             yearFractions,
                                                                                     tmp_dayCount,
														                             tmp_curveCollection, 
														                             tmp_curveIndex);
														...
														const std::string& calendar)
{
	...
	std::vector<double> DFs = validation::tryAqCurvesDiscountFactorsForwardStartingFromTenor(
												fromDates, 
												tmp_tenor,
												tmp_curveCollection, 
												tmp_curveIndex,
