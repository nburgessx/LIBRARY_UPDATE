...
/* @brief			swig interface for aqCurvesCalibrateFXForwards
...
*/
const std::string aqCurvesCalibrateFXForwards(const std::string& curveCollection, 
											...
											const SWIG_STRINGMATRIX & fxFwdConv)
{
	...
	ret = validation::tryAqCurvesCalibrateFXForwards(
										tmp_curveCollection,
                                        tmp_staticDataTable,
                                        tmp_curveIndex,
                                        tmp_curveConv,
