...
#include "tryAqObjSwapsPricing.h"    // Credit Model
                                    ...
                                    const std::vector<std::vector<std::string> > & dataBlock2 )
{
    ...
    // Call the Function
    std::string result = validation::tryAqObjCreditModelCreate( objectName, infoBlockNames, infoBlocks );
...
double aqObjCreditModelSurvivalProbability( const std::string& creditModelName, const std::string& toDate, const std::string& fromDate )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditModelSurvivalProbability( creditModelName, toDate_, fromDate_ );
...
double aqObjCreditModelDefaultProbability( const std::string& creditModelName, const std::string& toDate, const std::string& fromDate )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditModelDefaultProbability( creditModelName, toDate_, fromDate_ );
...
double aqObjCreditModelHazardRate( const std::string& creditModelName, const std::string& paymentDate )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditModelHazardRate( creditModelName, paymentDate_ );
...
double aqObjCreditModelRiskyDiscountFactor( const std::string& creditModelName, const std::string & paymentDate )
{
    ...
    std::vector<double> resultVector = validation::tryAqObjCreditModelRiskyDiscountFactors( creditModelName, paymentDateAsVector );
...
std::vector<double> aqObjCreditModelRiskyDiscountFactors( const std::string& creditModelName, const std::vector<std::string>& paymentDates )
{
    ...
    // Call the Function
    std::vector<double> result = validation::tryAqObjCreditModelRiskyDiscountFactors( creditModelName, paymentDates_ );
...
double aqObjCreditDefaultSwapPV( const std::string& swapName, const std::string& creditModelName,  const std::string& legName )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditDefaultSwapPV( swapName, creditModelName, legName.c_str() );
...
double aqObjCreditDefaultSwapRiskyAnnuity( const std::string& swapName, const std::string& creditModelName, const std::string& legName )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditDefaultSwapRiskyAnnuity( swapName, creditModelName, legName.c_str() );
...
double aqObjCreditDefaultSwapCS01( const std::string& swapName, const std::string& creditModelName, const std::string& legName )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditDefaultSwapCS01( swapName, creditModelName, legName.c_str() );
...
double aqObjCreditDefaultSwapParSpread( const std::string& swapName, const std::string& creditModelName, const std::string& premiumLegName, const std::string& protectionLegName )
{
    ...
    // Call the Function
    double result = validation::tryAqObjCreditDefaultSwapParSpread( swapName, creditModelName, premiumLegName.c_str(), protectionLegName.c_str() );
