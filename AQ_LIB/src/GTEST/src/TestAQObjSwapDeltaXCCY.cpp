...
#define TEST_DIR "ETrading/AQObjects/TestAQObjSwapDeltaXCCY/"
...
namespace google_test
{
	...
	AQL_BUILD_EURUSD_JPYUSD_XCCY_CURVE( TestAQObjSwapDeltaXCCY, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY, JPYYC_OIS, JPYYC_JSCC_STD, JPYYC_LCH_6M, JPYYC_LCH_3M, JPYYC_XCCY );
	...
	TEST_F( TestAQObjSwapDeltaXCCY, RISK_DeltaLadder_ValuationCCY_USD )
    {
	...
	TEST_F( TestAQObjSwapDeltaXCCY, RISK_DeltaLadder_ValuationCCY_JPY_EUR )
    {
		// 1. Load the Input Files
	...
	TEST_F( TestAQObjSwapDeltaXCCY, RISK_DeltaLadder_ValuationCCY_JPY_EUR_Report_LegCCY )
    {
		// 1. Load the Input Files
