...
namespace google_test
{
    ...
    typedef BindFileToClassConstructor<TryAqCurvesTenorBasis, EURYC_3M6M> CurveTenorBasisBound;
    ...
    class TryAqTestCurveTenorBasisEUR3M6M : public testing::Test, public CurveTenorBasisBuilt
    {
    };
    ...
    TEST_F( TryAqTestCurveTenorBasisEUR3M6M, SNAPSHOT_CheckMeCurveDisplay )
    {
    ...
    TEST_F( TryAqTestCurveTenorBasisEUR3M6M, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryAqTestCurveTenorBasisEUR3M6M, SNAPSHOT_CheckMeCurveForwardRatesFromYearFraction )
    {
