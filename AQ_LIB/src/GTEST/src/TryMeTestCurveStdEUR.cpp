...
namespace google_test
{
    ...
    class TryMeTestCurveStdEUR : public virtual testing::Test, public CurveStdBuilt
    {
    };
    ...
    TEST_F( TryMeTestCurveStdEUR, SNAPSHOT_CheckMeCurveDisplay )
    {
    ...
    TEST_F( TryMeTestCurveStdEUR, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveStdEUR, SNAPSHOT_CheckMeCurveForwardRatesFromYearFraction )
    {
    ...
    class TryMeTestCurveStdEUR_ConvexAdjOverride : public virtual testing::Test, public Dependency1<BindFileToClassConstructor<TryMeCurveStd, EURYC_STD>, Dependency0<BindFileToClassConstructor<TryMeCurveOis, EURYC_OIS> > >
    {
    };
    ...
    TEST_F( TryMeTestCurveStdEUR_ConvexAdjOverride, SNAPSHOT_CheckMeCurveDisplay )
    {
    ...
    TEST_F( TryMeTestCurveStdEUR_ConvexAdjOverride, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
        const ReadDataFile::Load inputFile( CheckDiscountFactorsInputs );
    ...
    TEST_F( TryMeTestCurveStdEUR_ConvexAdjOverride, SNAPSHOT_CheckMeCurveForwardRatesFromYearFraction )
    {
        const ReadDataFile::Load inputFile( CheckForwardRatesInputs );
