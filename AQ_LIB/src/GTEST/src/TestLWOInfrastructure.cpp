...
#define SK2(NAME,C1_TYPE,C2_TYPE,C1_NAME,C2_NAME) \
	...
	DECLARE_TEST_FIXTURE(TestLWOInfrastructure);

    TEST_F( TestLWOInfrastructure, UNIT_Variant )
    {
    ...
    TEST_F( TestLWOInfrastructure, UNIT_CreateVariantVector )
    {
        std::vector<int> inputValues_i = boost::assign::list_of( 32 )( 41 )( 50 )( 60 );
	...
	TEST_F( TestLWOInfrastructure, UNIT_VariantMatrixTranspose )
	{
	...
	TEST_F(TestLWOInfrastructure, UNIT_RaggedVariantMatrixTranspose)
	{
    ...
    TEST_F( TestLWOInfrastructure, UNIT_RuleInterface )
    {
    ...
    TEST_F( TestLWOInfrastructure, UNIT_Environment )
    {
        // server kicks off...
		...
		auto lwoPtr = wrkCtxt->accessObjectInterface<TableDateDouble>("MyTableDateDouble");

		EXPECT_FALSE(lwoPtr == nullptr);
		EXPECT_STREQ(lwoPtr->getRefToName().c_str(), "MyTableDateDouble" );
		EXPECT_TRUE(lwoPtr->getEnumType() == etrading::TABLE);
		EXPECT_TRUE(dynamic_cast<TableDateDouble*>(lwoPtr.get()) != nullptr);
    ...
    TEST_F(TestLWOInfrastructure, UNIT_copySharedPtrToSharedPtr)
    {
    ...
    TEST_F( TestLWOInfrastructure, UNIT_Serialization )
    {
    ...
    TEST_F( TestLWOInfrastructure, UNIT_FreeObject )
    {
