...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "JPYYC_OIS_tryAqCurvesCalibrateOIS_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "JPYYC_OIS_tryAqCurvesDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]	= TEST_DIR "JPYYC_OIS_tryAqCurvesDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "JPYYC_OIS_tryAqCurvesForwardRates_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "JPYYC_OIS_tryAqCurvesForwardRates_outputs.csv";
}
