...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapDelta_JPY_LCH6M/"
...
{
	DECLARE_TEST_FIXTURE(TestAQOSwapDelta_JPY);
    ...
    */
	...
	// DV01 tests
	TEST_F( TestAQOSwapDelta_JPY, SNAPSHOT_swapDV01_LCH6M)
    {
        buildCurves_JPY();
