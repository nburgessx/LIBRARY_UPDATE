...
#define TEST_DIR "ETrading/Bonds/GermanBunds/"
...
namespace
{
    ...
    extern const char createBondInputFile[]         ="ETrading/Bonds/GermanBunds/tryAqBondObjectCreate_inputs";
    extern const char priceBondInputFile[]          ="ETrading/Bonds/GermanBunds/tryAqBondObjectCleanPrice_inputs";
    extern const char priceBondOutputFile[]         ="ETrading/Bonds/GermanBunds/tryAqBondObjectCleanPrice_outputs";
}
...
namespace google_test
{
    ...
    class TestBondPricesGermanBunds : public TestBondFactory {};


    TEST_F( TestBondPricesGermanBunds, SCENARIO_CheckBondPricesAndYieldsMatchLiveMarketData )
    {
        int i = 0;
        try
        {
