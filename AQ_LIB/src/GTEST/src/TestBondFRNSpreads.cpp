...
namespace
{
	...
	const std::string assetSwapSpreadInputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectSpread_inputs";
	const std::string assetSwapSpreadOutputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectSpread_outputs";

	const std::string assetSwapSpreadFixedEqvCouponInputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFixedEqvCouponOutputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_outputs";

	const std::string assetSwapSpreadFromFixedEqvCouponInputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFromFixedEqvCouponOutputFile_EUR_Floater = TEST_DIR + "XS1781813511_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_outputs";
	...
	const std::string assetSwapSpreadInputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectSpread_inputs";
	const std::string assetSwapSpreadOutputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectSpread_outputs";

	const std::string assetSwapSpreadFixedEqvCouponInputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFixedEqvCouponOutputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_outputs";

	const std::string assetSwapSpreadFromFixedEqvCouponInputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFromFixedEqvCouponOutputFile_EUR_Floater_UNADJUSTED = TEST_DIR + "DE000A19X793_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_outputs";
	...
	const std::string assetSwapSpreadInputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectSpread_inputs";
	const std::string assetSwapSpreadOutputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectSpread_outputs";

	const std::string assetSwapSpreadFixedEqvCouponInputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFixedEqvCouponOutputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_outputs";

	const std::string assetSwapSpreadFromFixedEqvCouponInputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFromFixedEqvCouponOutputFile_EUR_Floater_UNADJUSTED_ACTACT = TEST_DIR + "XS1794195724_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_outputs";
	...
	const std::string assetSwapSpreadInputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectSpread_inputs";
	const std::string assetSwapSpreadOutputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectSpread_outputs";

	const std::string assetSwapSpreadFixedEqvCouponInputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFixedEqvCouponOutputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_outputs";

	const std::string assetSwapSpreadFromFixedEqvCouponInputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFromFixedEqvCouponOutputFile_GBP_Floater = TEST_DIR + "XS1082839553_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_outputs";
	...
	const std::string assetSwapSpreadInputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectSpread_inputs";
	const std::string assetSwapSpreadOutputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectSpread_outputs";

	const std::string assetSwapSpreadFixedEqvCouponInputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFixedEqvCouponOutputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectFixedEqvCoupon_outputs";

	const std::string assetSwapSpreadFromFixedEqvCouponInputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_inputs";
	const std::string assetSwapSpreadFromFixedEqvCouponOutputFile_USD_Floater = TEST_DIR + "US30231GAE26_ASSET_SWAP_tryAqAssetSwapObjectSpreadFromFixedEqvCoupon_outputs";
...
namespace google_test
{
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_AssetSwapSpread_EUR_Floater)
	{
		...
		// Load Bond
		auto loadBond = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_Bond_EUR_Floater, etrading::JSON);
		// Load Swap
		auto loadSwap = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_EUR_Floater, etrading::JSON);
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_FixedEqvCoupon_EUR_Floater)
	{
		...
		auto actualRate = validation::tryAqAssetSwapObjectFixedEqvCoupon(swapName, bondName, bondPrice, valuationSettingsLVB, fixingTableNames);
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_AssetSwapSpread_FromFixedEqvCoupon_EUR_Floater)
	{
		...
		auto actualSpread = validation::tryAqAssetSwapObjectSpreadFromFixedEqvCoupon(swapName, fixedEqvCoupon, valuationSettingsLVB, fixingTableNames);
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_AssetSwapSpread_EUR_Floater_UNADJUSTED)
	{
		...
		// Load Bond
		auto loadBond = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_Bond_EUR_Floater_UNADJUSTED, etrading::JSON);
		// Load Swap
		auto loadSwap = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_EUR_Floater_UNADJUSTED, etrading::JSON);
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_AssetSwapSpread_EUR_Floater_UNADJUSTED_ACTACT)
	{
		...
		// Load Bond
		auto loadBond = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_Bond_EUR_Floater_UNADJUSTED_ACTACT, etrading::JSON);
		// Load Swap
		auto loadSwap = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_EUR_Floater_UNADJUSTED_ACTACT, etrading::JSON);
	...
	{
		// Load Curves
		auto loadOIS = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_GBP_OIS, etrading::JSON);
		auto load3ML = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_GBP_3ML, etrading::JSON);

		// Load Bond
		auto loadBond = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_Bond_GBP_Floater, etrading::JSON);
		// Load Swap
		auto loadSwap = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_GBP_Floater, etrading::JSON);
	...
	TEST_F(TestBondFRNSpreads, SNAPSHOT_AssetSwapSpread_USD_Floater)
	{
		...
		// Load Bond
		auto loadBond = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_Bond_USD_Floater, etrading::JSON);
		// Load Swap
		auto loadSwap = validation::tryAqObjectLoad(etrading::getGoogleTestFolder() + fileName_AssetSwap_USD_Floater, etrading::JSON);
