...
namespace google_test
{
    ...
    class TryMeTestCurveStdJPY : public virtual testing::Test, public CurveStdBuilt
    {
    };
    ...
    TEST_F( TryMeTestCurveStdJPY, SNAPSHOT_CheckMeCurveDisplay )
    {
    ...
    TEST_F( TryMeTestCurveStdJPY, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveStdJPY, SNAPSHOT_CheckMeCurveForwardRatesFromYearFraction )
    {
