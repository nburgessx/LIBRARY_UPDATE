// TestAQOSwapEUROvernightIndexedSwaps.cpp
...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapOvernightIndexedSwaps/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EUR_CURVE( TestAQOSwapEUROvernightIndexedSwaps, EURYC_OIS, EURYC_1M, EURYC_3M, EURYC_6M, EURYC_12M );
    ...
    TEST_F( TestAQOSwapEUROvernightIndexedSwaps, UNIT_CreateOvernightIndexedSwaps )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestAQOSwapEUROvernightIndexedSwaps, SNAPSHOT_CheckOisPV )
    {
        int i = 0;
        try
        {
            for ( i = 1; ; ++i )
            {
                ...
                const ReadDataFile::Load swapPVFile( SwapPVFilename );
					...
					double localSwapPV              = validation::tryAqObjectsSwapPV( swapObjectName, etrading::fromStringToLVB("EURYC"));
    ...
    TEST_F( TestAQOSwapEUROvernightIndexedSwaps, SNAPSHOT_CheckOisParRate )
    {
        int i = 0;
        try
        {
            for ( i = 1; ; ++i )
            {
                ...
                const ReadDataFile::Load swapParRateFile( SwapParRateFilename );
                    ...
                    double localSwapParRate         = validation::tryAqObjectsSwapParRate( swapObjectName, etrading::fromStringToLVB("EURYC") );
    ...
    TEST_F( TestAQOSwapEUROvernightIndexedSwaps, SNAPSHOT_CheckOisPV01 )
    {
        int i = 0;
        try
        {
            for ( i = 1; ; ++i )
            {
                ...
                const ReadDataFile::Load swapPV01File( SwapPV01Filename );
                    ...
                    double localSwapPV01            = validation::tryAqObjectsSwapPV01( swapObjectName, etrading::fromStringToLVB("EURYC") );
