...
namespace
{
    ...
    extern const char USDYC_3M6M[]					= TEST_DIR "USDYC_3M6M_tryAqCurveCalibrateBasis_inputs";

    //
    // test call input and reference files
    //
    extern const char curveDisplayInputs[]				= TEST_DIR "USDYC_3M6M_tryAqCurveDisplay_inputs.csv";
    extern const char curveDisplayOutputs_32bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveDisplay_outputs_32bit.csv";
	extern const char curveDisplayOutputs_64bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveDisplay_outputs_64bit.csv";

    extern const char CheckDiscountFactorsInputs[]				= TEST_DIR "USDYC_3M6M_tryAqCurveDiscountFactorsFromYearFractions_inputs";
    extern const char CheckDiscountFactorsOutputs_32bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveDiscountFactorsFromYearFractions_outputs_32bit";
	extern const char CheckDiscountFactorsOutputs_64bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveDiscountFactorsFromYearFractions_outputs_64bit";

    extern const char CheckForwardRatesInputs[]				= TEST_DIR "USDYC_3M6M_tryAqCurveForwardRatesFromYearFraction_inputs";
    extern const char CheckForwardRatesOutputs_32bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveForwardRatesFromYearFraction_outputs_32bit";
	extern const char CheckForwardRatesOutputs_64bit[]		= TEST_DIR "USDYC_3M6M_tryAqCurveForwardRatesFromYearFraction_outputs_64bit";
}
