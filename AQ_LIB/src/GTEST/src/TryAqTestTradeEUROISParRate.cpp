...
namespace google_test
{
    ...
    //
    typedef BindFileToClassConstructor<TryAqCurvesOis, DIR_EURYC_OIS> CurveOisBound;
    typedef Dependency0<CurveOisBound> CurveOisBuilt;

    class TryAqTestTradeEUROISParRate : public virtual testing::Test, public CurveOisBuilt
    {
    };
    ...
    //
    TEST_F( TryAqTestTradeEUROISParRate, SNAPSHOT_CheckHardCodedOISParRateUnchanged )
    {
        int i = 0;
        try
        {
    ...
    //
    TEST_F( TryAqTestTradeEUROISParRate, SNAPSHOT_CheckHardCodedOISPVUnchanged )
    {
        int i = 0;
        try
        {
