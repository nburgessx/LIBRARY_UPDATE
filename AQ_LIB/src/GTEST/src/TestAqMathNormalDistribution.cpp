// TestAqMathNormalDistribution.cpp
...
TEST( TestAqMathNormalDistribution, UNIT_StandardNormalDistribution_CDF )
{
...
TEST( TestAqMathNormalDistribution, UNIT_StandardNormalDistribution_PDF )
{
...
TEST( TestAqMathNormalDistribution, UNIT_StandardNormalDistributionInverse_NormalVariate )
{
...
TEST( TestAqMathNormalDistribution, UNIT_NormalDistribution_CDF )
{
...
TEST( TestAqMathNormalDistribution, UNIT_NormalDistribution_PDF )
{
...
TEST( TestAqMathNormalDistribution, UNIT_NormalDistributionInverse_NormalVariate )
{
