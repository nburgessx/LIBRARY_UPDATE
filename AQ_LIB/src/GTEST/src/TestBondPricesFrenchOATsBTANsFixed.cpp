...
namespace
{
    ...
    extern const char createBondInputFile[]         =TEST_DIR "tryAqBondObjectCreate_inputs";
    extern const char priceBondInputFile[]          =TEST_DIR "tryAqBondObjectCleanPrice_inputs";
    extern const char priceBondOutputFile[]         =TEST_DIR "tryAqBondObjectCleanPrice_outputs";
}
