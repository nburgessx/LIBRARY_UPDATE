...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "GBPYC_OIS_tryAqCurveCalibrateOIS_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "GBPYC_OIS_tryAqCurveDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]	= TEST_DIR "GBPYC_OIS_tryAqCurveDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "GBPYC_OIS_tryAqCurveForwardRates_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "GBPYC_OIS_tryAqCurveForwardRates_outputs.csv";
}
