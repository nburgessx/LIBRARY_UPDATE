...
namespace
{
	...
	const std::string TEST_DIR = "ETrading/AQObjects/TestAQOSwapFromBespokeSchedule/";
...
namespace google_test
{
	...
	// Declare Test TestAQOSwapFromBespokeSchedule Class
	DECLARE_TEST_FIXTURE(TestAQOSwapFromBespokeSchedule)

	// Call Test Fixture Class
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_PV)
	{
		loadCurves();
		loadSwap();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_ParRate)
	{
		loadCurves();
		loadSwap();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_PV01)
	{
		loadCurves();
		loadSwap();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_DV01)
	{
		loadCurves();
		loadSwap();
	...
	// Call Test Fixture Class
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_PV_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_ParRate_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_PV01_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
	...
	TEST_F(TestAQOSwapFromBespokeSchedule, SNAPSHOT_Swap_DV01_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
