...
namespace
{
    ...
    //
    extern const char curveDisplayInputs[]				= TEST_DIR "EURYC_XCCY_tryAqCurvesDisplay_inputs.csv";
    extern const char curveDisplayOutputs_32bit[]		= TEST_DIR "EURYC_XCCY_tryAqCurvesDisplay_outputs_32bit.csv";
	extern const char curveDisplayOutputs_64bit[]		= TEST_DIR "EURYC_XCCY_tryAqCurvesDisplay_outputs_64bit.csv";
