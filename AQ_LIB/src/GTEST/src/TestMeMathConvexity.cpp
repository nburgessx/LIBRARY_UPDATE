...
TEST( meMathLiborConvexityAdjustmentInArrears, UNIT_UnnaturalLibor_ConvexityCorrections_EUR_NormalVol )
{
...
TEST( meMathLiborRateInArrears, UNIT_UnnaturalLibor_Rates_EUR_NormalVol )
{
    // Normal Volatility Parameters
    const double normalVol = 0.0020; // 20 bps
    etrading::VolatilityTypeEnum NORMALVOL = etrading::NORMAL_VOLATILITY;
...
TEST( meMathLiborConvexityAdjustmentInArrears, UNIT_UnnaturalLibor_ConvexityCorrections_USD_LognormalVol )
{
...
TEST( meMathLiborRateInArrears, UNIT_UnnaturalLibor_Rates_USD_LognormalVol )
{
    // Lognormal Volatility Parameters
    const double lognormalVol = 0.3150; // 31.50%
    etrading::VolatilityTypeEnum LOGNORMALVOL = etrading::LOGNORMAL_VOLATILITY;
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsLiborInArrears_EUR_NormalVol )
{
    // Normal Volatility Parameters
    const double normalVol = 0.0020; // 20 bps
    etrading::VolatilityTypeEnum NORMALVOL = etrading::NORMAL_VOLATILITY;
...
TEST( meMathLiborRateForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsLiborInArrears_EUR_NormalVol )
{
    // Normal Volatility Parameters
    const double normalVol = 0.0020; // 20 bps
    etrading::VolatilityTypeEnum NORMALVOL = etrading::NORMAL_VOLATILITY;
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsLiborInArrears_USD_LognormalVol )
{
    // Lognormal Volatility Parameters
    const double logNormalVol = 0.3150; // 31.50%
    etrading::VolatilityTypeEnum LOGNORMALVOL = etrading::LOGNORMAL_VOLATILITY;
...
TEST( meMathLiborRateForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsLiborInArrears_USD_LognormalVol )
{
    // Lognormal Volatility Parameters
    const double logNormalVol = 0.3150; // 31.50%
    etrading::VolatilityTypeEnum LOGNORMALVOL = etrading::LOGNORMAL_VOLATILITY;
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, UNIT_UnnaturalLibor_ConvexityAdjustmentsLiborInArrears_EUR_ShiftedLognormalVol )
{
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, UNIT_UnaturalLibor_Rates_LiborInArrears_EUR_ShiftedLognormalVol )
{
    // Shifted-LogNormal Volatility Parameters
    const double shiftedLognormalVol = 0.1100;  // 11.00 %
    const double shiftSize = 0.01;              // Volatility Shift 1.00%
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsLiborInArrears_EUR_ShiftedLognormalVol )
{
    // Shifted-LogNormal Volatility Parameters
    const double shiftedLognormalVol = 0.1100;  // 11.00 %
    const double shiftSize = 0.01;              // Volatility Shift 1.00%
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsNaturalLibor_EUR_NormalVol )
{
    // Normal Volatility Parameters
    const double normalVol = 0.0020; // 20 bps
    etrading::VolatilityTypeEnum NORMALVOL = etrading::NORMAL_VOLATILITY;
...
TEST( meMathLiborRateWithArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsNaturalLibor_EUR_NormalVol )
{
    // Normal Volatility Parameters
    const double normalVol = 0.0020; // 20 bps
    etrading::VolatilityTypeEnum NORMALVOL = etrading::NORMAL_VOLATILITY;
...
TEST( meMathLiborConvexityAdjustmentForArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsNaturalLibor_USD_LognormalVol )
{
    // Lognormal Volatility Parameters
    const double logNormalVol = 0.3150; // 31.50%
    etrading::VolatilityTypeEnum LOGNORMALVOL = etrading::LOGNORMAL_VOLATILITY;
...
TEST( meMathLiborRateWithArbitraryFixingDate, CONSISTENCY_CheckBoundaryCondition_WhenArbitraryTimeEqualsNaturalLibor_USD_LognormalVol )
{
    // Lognormal Volatility Parameters
    const double logNormalVol = 0.3150; // 31.50%
    etrading::VolatilityTypeEnum LOGNORMALVOL = etrading::LOGNORMAL_VOLATILITY;
