...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapXccySwapsEURUSDFixedFloat/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQOSwapEURUSDXccySwapFixedFloat, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );


    TEST_F( TestAQOSwapEURUSDXccySwapFixedFloat, SNAPSHOT_HardCodedParSpreadCheck_FixedLegSpread )
    {
        try
        {
   ...
   TEST_F( TestAQOSwapEURUSDXccySwapFixedFloat, SNAPSHOT_HardCodedSpreadCheck_FixedLegSpread )
    {
        try
        {
                // 1. Create the Input File Names 
    ...
    TEST_F( TestAQOSwapEURUSDXccySwapFixedFloat, SNAPSHOT_HardCodedParSpreadCheck_FloatLegSpread )
    {
        try
        {
                // 1. Create the Input File Names 
   ...
   TEST_F( TestAQOSwapEURUSDXccySwapFixedFloat, SNAPSHOT_HardCodedSpreadCheck_FloatLegSpread )
    {
        try
        {
                // 1. Create the Input File Names 
