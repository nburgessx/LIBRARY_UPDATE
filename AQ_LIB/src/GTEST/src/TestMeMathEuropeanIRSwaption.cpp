...
#include "tryMeMathEuropeanIRSwaption.h"
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestCashSettledAnnuity )
{
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestCashSettledAnnuity_WithShortStartStub )
{
    // CashAnnuity( Notional (N), SwapRate (r), nCouponsPerYear (m), TenorInYears (t), StubType )
    double              N;
    double              r;
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestCashSettledAnnuity_WithShortEndStub )
{
    // CashAnnuity( Notional (N), SwapRate (r), nCouponsPerYear (m), TenorInYears (t), StubType )
    double              N;
    double              r;
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestCashSettledAnnuity_WithLongStartStub )
{
    // CashAnnuity( Notional (N), SwapRate (r), nCouponsPerYear (m), TenorInYears (t), StubType )
    double              N;
    double              r;
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestCashSettledAnnuity_WithLongEndStub )
{
    // CashAnnuity( Notional (N), SwapRate (r), nCouponsPerYear (m), TenorInYears (t), StubType )
    double              N;
    double              r;
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestMeMathEuropeanIRSwaptionPrice_LogNormalVol )
{
...
TEST( TestMeMathEuropeanIRSwaption, UNIT_TestMeMathEuropeanIRSwaptionPrice_NormalVol )
{
    const double priceTestPrecision = 1e-6;
