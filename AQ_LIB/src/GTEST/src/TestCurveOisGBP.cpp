...
#define TEST_DIR "Vanilla/Curves/TestCurveOisGBP/"
...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "GBPYC_OIS_tryMirSetUpOISCurve_inputs.csv";
    ...
    extern const char CheckForwardRatesInputs[]			= TEST_DIR "GBPYC_GBPDF_tryMirGetForwardRate2_inputs.csv";
    extern const char CheckForwardRatesReference[]		= TEST_DIR "GBPYC_GBPDF_tryMirGetForwardRate2_outputs.csv";
}
...
namespace google_test
{
    ...
    class TestCurveOisGBP : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TestCurveOisGBP, SNAPSHOT_CheckDiscountFactors )
    {
    ...
    TEST_F( TestCurveOisGBP, SNAPSHOT_CheckForwardRates )
    {
