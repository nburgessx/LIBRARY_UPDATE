...
namespace
{
    ...
    //
    extern const char curveDisplayInputs[]				= TEST_DIR "GBPYC_STD_tryAqCurveDisplay_inputs.csv";
    extern const char curveDisplayOutputs[]				= TEST_DIR "GBPYC_STD_tryAqCurveDisplay_outputs.csv";

    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "GBPYC_STD_tryAqCurveDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]	    = TEST_DIR "GBPYC_STD_tryAqCurveDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "GBPYC_STD_tryAqCurveForwardRatesFromYearFraction_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "GBPYC_STD_tryAqCurveForwardRatesFromYearFraction_outputs.csv";
}
