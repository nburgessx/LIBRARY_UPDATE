...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapDeltaDualBootstrap/"
...
{
	DECLARE_TEST_FIXTURE(TestAQOSwapDeltaDualBootstrap);
	

	// This test checks the delta ladder profile of 3 EUR vanilla swaps
	TEST_F(TestAQOSwapDeltaDualBootstrap, SNAPSHOT_EUR_SWAP_IR_DELTA)
	{
		// Load all the swaps 
	...
	TEST_F(TestAQOSwapDeltaDualBootstrap, SNAPSHOT_USD_SWAP_IR_DELTA)
	{
		// Load all the swaps 
