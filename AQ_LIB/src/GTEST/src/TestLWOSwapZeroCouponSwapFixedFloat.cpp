...
#define TEST_DIR "ETrading/AQObjects/TestLWOSwapZeroCouponSwapFixedFloat/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_USD_CURVE( TestLWOSwapZeroCouponSwapFixedFloat, USDYC_OIS, USDYC_1M, USDYC_STD, USDYC_6M, USDYC_12M);
