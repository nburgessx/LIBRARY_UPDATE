...
namespace google_test
{
    ...
    AQL_BUILD_EUR_CURVE( TestAqCurvesOisAUD_1, DIR_OIS_1, DIR_DUMMY_1, DIR_DUMMY_2, DIR_DUMMY_3, DIR_DUMMY_4);
	AQL_BUILD_EUR_CURVE( TestAqCurvesOisAUD_2, DIR_OIS_2, DIR_DUMMY_1, DIR_DUMMY_2, DIR_DUMMY_3, DIR_DUMMY_4);
    ...
    TEST_F( TestAqCurvesOisAUD_1, SNAPSHOT_CheckDiscountFactors )
    {
	...
	// Other longer tenors use BBSW 6M vs OIS basis
	// SmoothShortend = TRUE
	TEST_F( TestAqCurvesOisAUD_2, SNAPSHOT_CheckDiscountFactors )
    {
        const ReadDataFile::Load inputFile( CheckDF_inputs );
