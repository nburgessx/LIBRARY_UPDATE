...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapZeroCouponSwapFloatFloat/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_USD_CURVE( TestAQOSwapZeroCouponSwapFloatFloat, USDYC_OIS, USDYC_1M, USDYC_STD, USDYC_6M, USDYC_12M);
    
    //
    // Call Test Fixture
    //

    TEST_F( TestAQOSwapZeroCouponSwapFloatFloat, SNAPSHOT_HardCodedParSpreadCheck )
    {
        try
        {
    ...
    TEST_F( TestAQOSwapZeroCouponSwapFloatFloat, SNAPSHOT_SwapPVZeroCheck )
    {
        try
        {
	...
	TEST_F( TestAQOSwapZeroCouponSwapFloatFloat, CONSISTENCY_IsFwdInterCheck )
    {
        try
        {
                // 2. Load the Input Files
