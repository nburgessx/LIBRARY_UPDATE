...
#define TEST_DIR "ETrading/Curves/TestCurveOisEUR/"
...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "EURYC_OIS_tryMeCurveCalibrateOIS_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "EURYC_OIS_tryMeCurveDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]		= TEST_DIR "EURYC_OIS_tryMeCurveDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "EURYC_OIS_tryMeCurveForwardRates_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "EURYC_OIS_tryMeCurveForwardRates_outputs.csv";
}
...
namespace google_test
{
    ...
    class TryAqTestCurveOisEUR : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TryAqTestCurveOisEUR, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryAqTestCurveOisEUR, SNAPSHOT_CheckMeCurveForwardRates )
    {
