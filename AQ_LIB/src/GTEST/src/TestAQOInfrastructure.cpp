...
#define SK2(NAME,C1_TYPE,C2_TYPE,C1_NAME,C2_NAME) \
	...
	DECLARE_TEST_FIXTURE(TestAQOInfrastructure);

    TEST_F( TestAQOInfrastructure, UNIT_Variant )
    {
    ...
    TEST_F( TestAQOInfrastructure, UNIT_CreateVariantVector )
    {
        std::vector<int> inputValues_i = boost::assign::list_of( 32 )( 41 )( 50 )( 60 );
	...
	TEST_F( TestAQOInfrastructure, UNIT_VariantMatrixTranspose )
	{
	...
	TEST_F(TestAQOInfrastructure, UNIT_RaggedVariantMatrixTranspose)
	{
    ...
    TEST_F( TestAQOInfrastructure, UNIT_RuleInterface )
    {
    ...
    TEST_F( TestAQOInfrastructure, UNIT_Environment )
    {
        // server kicks off...
		...
		auto aqoPtr = wrkCtxt->accessObjectInterface<TableDateDouble>("MyTableDateDouble");

		EXPECT_FALSE(aqoPtr == nullptr);
		EXPECT_STREQ(aqoPtr->getRefToName().c_str(), "MyTableDateDouble" );
		EXPECT_TRUE(aqoPtr->getEnumType() == etrading::TABLE);
		EXPECT_TRUE(dynamic_cast<TableDateDouble*>(aqoPtr.get()) != nullptr);
    ...
    TEST_F(TestAQOInfrastructure, UNIT_copySharedPtrToSharedPtr)
    {
    ...
    TEST_F( TestAQOInfrastructure, UNIT_Serialization )
    {
    ...
    TEST_F( TestAQOInfrastructure, UNIT_FreeObject )
    {
