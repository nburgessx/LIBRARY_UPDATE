...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapZeroCouponSwapXccyFloatFloat/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQOSwapZeroCouponSwapXccyFloatFloat, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );
    
    //
    // Call Test Fixture
    //

    TEST_F( TestAQOSwapZeroCouponSwapXccyFloatFloat, SNAPSHOT_HardCodedParSpreadCheck )
    {
        try
        {
    ...
    TEST_F( TestAQOSwapZeroCouponSwapXccyFloatFloat, SNAPSHOT_SwapPVZeroCheck )
    {
        try
        {
                // 2. Load the Input Files
	...
	TEST_F( TestAQOSwapZeroCouponSwapXccyFloatFloat, CONSISTENCY_IsFwdInterCheck )
    {
        try
        {
                // 2. Load the Input Files
