...
namespace
{
    ...
    //
    extern const char zeroCouponSwapInputs[]	= TEST_DIR "XCCYFLOATFLOATZEROCOUPONSWAP@1_tryAqObjectsSwapCreate_inputs";
    extern const char parSpreadInputs[]	        = TEST_DIR "XCCYFLOATFLOATZEROCOUPONSWAP@1_tryAqObjectsSwapParSpread_inputs";
    extern const char parSpreadOutputs[]	    = TEST_DIR "XCCYFLOATFLOATZEROCOUPONSWAP@1_tryAqObjectsSwapParSpread_outputs";
    extern const char parSpreadOutputs64[]	    = TEST_DIR "XCCYFLOATFLOATZEROCOUPONSWAP@1_tryAqObjectsSwapParSpread_outputs64_";
...
namespace google_test
{
	...
	TEST_F( TestAQOSwapZeroCouponSwapXccyFloatFloat, CONSISTENCY_IsFwdInterCheck )
    {
        try
        {
                ...
                validation::tryAqObjectsSwapPV( swapName, curveCollectionLVB, "", fixingTableLVB);
