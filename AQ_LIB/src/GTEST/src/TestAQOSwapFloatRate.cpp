...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapFloatRate/"
...
namespace google_test
{
    ...
    //
    //
    AQL_BUILD_EUR_CURVE( TestAQOSwapFloatRatesFixingsAndStubs, EURYC_OIS, EURYC_1M, EURYC_3M, EURYC_6M, EURYC_12M);
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_SourceFloatRates_FromFixingTable )
    {
        try
        {
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_SourceFloatRates_FromFirstFixingAndLastFixing_Parameters )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_CheckZeroFloatRates_WhenPaymentDateInThePast_NoFixingTable )
    {
        try
        {
               // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_SourceFloatRate_FromFixingTable_WhenPaymentDateIsAsOfDate )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_CheckFirstFixingParameter_AppliedToCurrentCashflow )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_CheckFirstFixingParameterApplied_WhenFirstFixingDateInFuture )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_CheckStubPriority_FirstFixingParameter_HasHigherPriorityThan_InternalStubRateMethod )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, SNAPSHOT_CheckSwapWithStub_StubRateUsedWhenNoFirstFixing )
    {
        try
        {
                // Load the Input Files
    ...
    TEST_F( TestAQOSwapFloatRatesFixingsAndStubs, CONSISTENCY_CheckSwapWithSingleCashflow_CheckFirstFixingParameter_HasHigherPriorityThan_LastFixingParameter )
    {
        try
        {
                // Load the Input Files
