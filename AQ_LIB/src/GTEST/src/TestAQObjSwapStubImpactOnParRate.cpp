...
#define TEST_DIR "ETrading/AQObjects/TestAQObjSwapStubImpactOnParRate/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_JPY_CURVE( TestAQObjSwapStubImpactOnParRate, JPYYC_OIS, JPYYC_1M, JPYYC_3M, JPYYC_6M, JPYYC_12M);
    ...
    TEST_F( TestAQObjSwapStubImpactOnParRate, SNAPSHOT_IMM_Swaps)
    {
        runTest("IMM_SWAPS");
    }

	TEST_F( TestAQObjSwapStubImpactOnParRate, SNAPSHOT_Stub_Swaps)
    {
        runTest("STUB_SWAPS");
    }

	TEST_F( TestAQObjSwapStubImpactOnParRate, SNAPSHOT_Libor_Swaps)
    {
        runTest("LIBOR_SWAPS");
    }
