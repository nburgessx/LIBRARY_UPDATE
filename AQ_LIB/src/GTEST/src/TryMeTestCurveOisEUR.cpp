...
namespace google_test
{
    ...
    class TryMeTestCurveOisEUR : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TryMeTestCurveOisEUR, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveOisEUR, SNAPSHOT_CheckMeCurveForwardRates )
    {
