...
namespace
{
    ...
    //
    extern const char curveDisplayInputs[]				= TEST_DIR "GBPYC_XCCY_tryAqCurveDisplay_inputs.csv";
    extern const char curveDisplayOutputs_32bit[]		= TEST_DIR "GBPYC_XCCY_tryAqCurveDisplay_outputs_32bit.csv";
	extern const char curveDisplayOutputs_64bit[]		= TEST_DIR "GBPYC_XCCY_tryAqCurveDisplay_outputs_64bit.csv";
...
namespace google_test
{
    ...
    class TryAqTestCurveXccyBasisGBP: public testing::Test, public CurveGBPYC_XCCY
    {
    ...
    TEST_F( TryAqTestCurveXccyBasisGBP, SNAPSHOT_CheckMeCurveDisplay )
    {
