...
#define TEST_DIR "ETrading/AQObjects/TestLWOSwapXccySwaps/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestLWOSwapEURUSDXccySwap, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );
