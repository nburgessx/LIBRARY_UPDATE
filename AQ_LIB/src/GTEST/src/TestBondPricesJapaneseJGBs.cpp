...
namespace
{
    ...
    extern const char createBondInputFile1[]         ="ETrading/Bonds/JapaneseJGBs1/tryAqBondObjectCreate_inputs";
    extern const char createBondInputFile2[]         ="ETrading/Bonds/JapaneseJGBs2/tryAqBondObjectCreate_inputs";
    extern const char createBondInputFile3[]         ="ETrading/Bonds/JapaneseJGBs3/tryAqBondObjectCreate_inputs";

    extern const char priceBondInputFile1[]          ="ETrading/Bonds/JapaneseJGBs1/tryAqBondObjectCleanPrice_inputs";
    extern const char priceBondInputFile2[]          ="ETrading/Bonds/JapaneseJGBs2/tryAqBondObjectCleanPrice_inputs";
    extern const char priceBondInputFile3[]          ="ETrading/Bonds/JapaneseJGBs3/tryAqBondObjectCleanPrice_inputs";

    extern const char priceBondOutputFile1[]         ="ETrading/Bonds/JapaneseJGBs1/tryAqBondObjectCleanPrice_outputs";
    extern const char priceBondOutputFile2[]         ="ETrading/Bonds/JapaneseJGBs2/tryAqBondObjectCleanPrice_outputs";
    extern const char priceBondOutputFile3[]         ="ETrading/Bonds/JapaneseJGBs3/tryAqBondObjectCleanPrice_outputs";
