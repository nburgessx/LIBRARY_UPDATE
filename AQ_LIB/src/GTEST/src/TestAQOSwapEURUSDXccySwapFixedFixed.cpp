...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapXccySwapsEURUSDFixedFixed/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQOSwapEURUSDXccySwapFixedFixed, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );


    TEST_F( TestAQOSwapEURUSDXccySwapFixedFixed, SNAPSHOT_HardCodedParSpreadCheck )
    {
        try
        {
    ...
    TEST_F( TestAQOSwapEURUSDXccySwapFixedFixed, SNAPSHOT_SwapPVZeroCheck )
    {
        try
        {
                // 2. Load the Input Files
