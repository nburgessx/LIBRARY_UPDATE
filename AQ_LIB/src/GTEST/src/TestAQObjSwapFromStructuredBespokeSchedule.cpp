...
namespace
{
	...
	const std::string bespokeScheduleCreationInput_Fixed = TEST_DIR + "FIXED_SCHEDULE_STRUCTURED_tryAqSwapObjectScheduleCreateBespokeFromCashflows_inputs";
	const std::string bespokeScheduleCreationInput_Float = TEST_DIR + "FLOAT_SCHEDULE_STRUCTURED_tryAqSwapObjectScheduleCreateBespokeFromCashflows_inputs";

	const std::string legCreationInput_Fixed = TEST_DIR + "FIXED_LEG_STRUCTURED_tryAqSwapObjectLegCreateFromSchedule_inputs";
	const std::string legCreationInput_Float = TEST_DIR + "FLOAT_LEG_STRUCTURED_tryAqSwapObjectLegCreateFromSchedule_inputs";

	const std::string swapCreationInput = TEST_DIR + "VNS_SWAP_STRUCTURED_tryAqSwapObjectCreateFromLegs_inputs";
	...
	std::string createBespokeSchedule(const std::string& fileName)
	{
		...
		validation::tryAqSwapObjectScheduleCreateBespokeFromCashflows(scheduleName, bespokeScheduleProperties, bespokeScheduleLVB);
