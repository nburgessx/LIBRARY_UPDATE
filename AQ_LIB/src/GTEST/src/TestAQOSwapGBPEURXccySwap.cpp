...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapXccySwapsGBPEUR/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_GBPEUR_FWD_CURVE( TestAQOSwapGBPEURXccySwap, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY, GBPYC_OIS, GBPYC_STD, GBPYC_3M6M, GBPYC_XCCY, GBPYC_FWDEUR  );

    //
    // Call Test Fixture
    //
  
    TEST_F( TestAQOSwapGBPEURXccySwap, SNAPSHOT_HardCodedParSpreadCheck )
    {
        try
        {
