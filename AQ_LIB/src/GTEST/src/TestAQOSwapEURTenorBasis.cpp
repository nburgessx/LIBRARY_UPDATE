...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapTenorBasis/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EUR_CURVE( TestAQOSwapEURTenorBasis, EURYC_OIS, EURYC_1M, EURYC_3M, EURYC_6M, EURYC_12M );
    ...
    TEST_F( TestAQOSwapEURTenorBasis, UNIT_CreateTenorBasisSwapUsingLegLabelValueBlocks )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestAQOSwapEURTenorBasis, SNAPSHOT_CheckTenorBasisPV )
    {
        int i = 0;
        try
        {
    ...
    TEST_F( TestAQOSwapEURTenorBasis, SNAPSHOT_CheckTenorBasisSpread )
    {
        int i = 0;
        try
        {
            for ( i = 1; ; ++i )
            {
                ...
                const ReadDataFile::Load swapPVFile( SwapPVFilename );
                    ...
                    std::string swapObjectName      = swapPVFile["swapName"];
                    double localBasisSpread         = validation::tryAqObjectsSwapSpread( swapObjectName, etrading::fromStringToLVB("EURYC"));
