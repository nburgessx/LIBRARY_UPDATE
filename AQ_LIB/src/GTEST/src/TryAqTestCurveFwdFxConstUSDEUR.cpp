...
namespace google_test
{
    ...
    typedef BindFileToClassConstructor<TryAqCurvesFwdFxConst,	USDYC_FWDEUR>	SourceUSDYC_FWDEUR;
    ...
    class TryAqTestCurveFwdFxConstUSDEUR : public testing::Test, public CurveUSDYC_FWDEUR
    {
    ...
    TEST_F( TryAqTestCurveFwdFxConstUSDEUR, SNAPSHOT_CheckMeCurveDisplay )
    {
