...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapDeltaXCCY_CSA/"
...
{
	DECLARE_TEST_FIXTURE(TestAQOSwapDeltaXCCY_CSA);
    ...
    */
	...
	// DV01 tests
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDV01_USDCSA)
    {
        buildCurves_USDCSA();
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDV01_EURCSA)
    {
        buildCurves_EURCSA();
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDV01_JPYCSA)
    {
        buildCurves_JPYCSA();
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDV01_GBPCSA)
    {
        buildCurves_GBPCSA();
	...
	// DeltaLadder tests
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDeltaLadder_USDCSA)
    {
        buildCurves_USDCSA();
		createSwapFromDataFile( xccySwap_USDCSA );
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDeltaLadder_EURCSA)
    {
        buildCurves_EURCSA();
		createSwapFromDataFile( xccySwap_EURCSA );
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDeltaLadder_JPYCSA)
    {
        buildCurves_JPYCSA();
		createSwapFromDataFile( xccySwap_JPYCSA );
	...
	TEST_F( TestAQOSwapDeltaXCCY_CSA, RISK_swapDeltaLadder_GBPCSA)
    {
        buildCurves_GBPCSA();
		createSwapFromDataFile( xccySwap_GBPCSA );
