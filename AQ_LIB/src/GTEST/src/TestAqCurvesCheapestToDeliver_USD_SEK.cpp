...
{
	DECLARE_TEST_FIXTURE(TestAqCurvesCheapestToDeliver_USD_SEK);

    //
    // Call Test Fixture
    //

    TEST_F( TestAqCurvesCheapestToDeliver_USD_SEK, SNAPSHOT_CheckMeCurveDisplay )
    {
