...
namespace google_test
{
    ...
    DECLARE_TEST_FIXTURE(TestAQOSwapGenerator);
    ...
    TEST_F( TestAQOSwapGenerator, UNIT_CreateSwapUsingGenerator )
    {
        try
        {
        ...
        {
            std::cout <<  "Test Error: TestAQOSwapGenerator.UNIT_CreateSwapUsingGenerator. Unable to read test input/output file(s).";
            ASSERT_FALSE( true );
        }
    ...
    TEST_F( TestAQOSwapGenerator, UNIT_CreateSwapUsingGenerator_Repeat2 )
    {
        try
        {
        ...
        {
            std::cout <<  "Test Error: TestAQOSwapGenerator.UNIT_CreateSwapUsingGenerator_Repeat2. Unable to read test input/output file(s).";
            ASSERT_FALSE( true );
        }
        catch( const AQLCoreError& m )
        {
    ...
    // Call Test Fixture - We use a fixture so the fixture class contructor can initialize / start-up the library to load the swap generator
    TEST_F( TestAQOSwapGenerator, UNIT_CreateSwapUsingGeneratorWithMaturityAsTenorString )
    {
        try
        {
        ...
        {
            std::cout <<  "Test Error: TestAQOSwapGenerator.UNIT_CreateSwapUsingGeneratorWithMaturityAsTenorString. Unable to read test input/output file(s).";
            ASSERT_FALSE( true );
        }
        catch( const AQLCoreError& m )
        {
    ...
    // Call Test Fixture - We use a fixture so the fixture class contructor can initialize / start-up the library to load the swap generator
    // We create the swap twice to test the sub function which checks if the swap already exists
    TEST_F( TestAQOSwapGenerator, UNIT_CreateSwapUsingGeneratorWithMaturityAsTenorString_Repeat2 )
    {
        try
        {
        ...
        {
            std::cout <<  "Test Error: TestAQOSwapGenerator.UNIT_CreateSwapUsingGeneratorWithMaturityAsTenorString_Repeat2. Unable to read test input/output file(s).";
            ASSERT_FALSE( true );
        }
        catch( const AQLCoreError& m )
        {
