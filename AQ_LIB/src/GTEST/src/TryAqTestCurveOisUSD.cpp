...
#define TEST_DIR "ETrading/Curves/TestCurveOisUSD/"
...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "USDYC_OIS_tryAqCurveCalibrateOIS_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "USDYC_OIS_tryAqCurveDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]	= TEST_DIR "USDYC_OIS_tryAqCurveDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "USDYC_OIS_tryAqCurveForwardRates_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "USDYC_OIS_tryAqCurveForwardRates_outputs.csv";
}
...
namespace google_test
{
    ...
    class TryAqTestCurveOisUSD : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TryAqTestCurveOisUSD, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryAqTestCurveOisUSD, SNAPSHOT_CheckMeCurveForwardRatesFromForwardDates )
    {
