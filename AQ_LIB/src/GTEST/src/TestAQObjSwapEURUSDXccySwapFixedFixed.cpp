...
#define TEST_DIR "ETrading/AQObjects/TestAQObjSwapXccySwapsEURUSDFixedFixed/"
...
namespace
{
    ...
    //
    extern const char xccySwapInputs[]	        = TEST_DIR "XCCYFIXEDFIXED@1_tryAqSwapObjectCreate_inputs";
    extern const char parSpreadInputs[]	        = TEST_DIR "XCCYFIXEDFIXED@1_tryAqSwapObjectParSpread_inputs";
    extern const char parSpreadOutputs[]	    = TEST_DIR "XCCYFIXEDFIXED@1_tryAqSwapObjectParSpread_outputs";
    extern const char parSpreadOutputs64[]	    = TEST_DIR "XCCYFIXEDFIXED@1_tryAqSwapObjectParSpread_outputs64_";
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQObjSwapEURUSDXccySwapFixedFixed, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );


    TEST_F( TestAQObjSwapEURUSDXccySwapFixedFixed, SNAPSHOT_HardCodedParSpreadCheck )
    {
        try
        {
    ...
    TEST_F( TestAQObjSwapEURUSDXccySwapFixedFixed, SNAPSHOT_SwapPVZeroCheck )
    {
        try
        {
                // 2. Load the Input Files
