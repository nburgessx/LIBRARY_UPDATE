...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapZeroCouponSwapXccyFixedFloat/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQOSwapZeroCouponSwapXccyFixedFloat, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );
    
    //
    // Call Test Fixture
    //

    TEST_F( TestAQOSwapZeroCouponSwapXccyFixedFloat, SNAPSHOT_SwapHardCodedParRateCheck )
    {
        try
        {
    ...
    TEST_F( TestAQOSwapZeroCouponSwapXccyFixedFloat, SNAPSHOT_SwapPVZeroCheck )
    {
        try
        {
                // 2. Load the Input Files
	...
	TEST_F( TestAQOSwapZeroCouponSwapXccyFixedFloat, CONSISTENCY_IsFwdInterCheck )
    {
        try
        {
                // 2. Load the Input Files
