...
namespace
{
    ...
    // curve input file
    extern const char CurveOisInputs[]					= TEST_DIR "JPYYC_OIS_tryMeCurveCalibrateOIS_inputs.csv";

    //
    // test call input and reference files
    //
    extern const char CheckDiscountFactorsInputs[]		= TEST_DIR "JPYYC_OIS_tryMeCurveDiscountFactorsFromYearFractions_inputs.csv";
    extern const char CheckDiscountFactorsOutputs[]	= TEST_DIR "JPYYC_OIS_tryMeCurveDiscountFactorsFromYearFractions_outputs.csv";

    extern const char CheckForwardRatesInputs[]			= TEST_DIR "JPYYC_OIS_tryMeCurveForwardRates_inputs.csv";
    extern const char CheckForwardRatesOutputs[]		= TEST_DIR "JPYYC_OIS_tryMeCurveForwardRates_outputs.csv";
}
...
namespace google_test
{
    ...
    class TryMeTestCurveOisJPY : public virtual testing::Test, public CurveOisBuilt
    {
    public:
    };
    ...
    TEST_F( TryMeTestCurveOisJPY, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveOisJPY, SNAPSHOT_CheckMeCurveForwardRates )
    {
