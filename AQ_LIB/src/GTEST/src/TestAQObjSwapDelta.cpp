...
#define TEST_DIR "ETrading/AQObjects/TestAQObjSwapDelta/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQObjSwapDelta, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );


	
	// This test checks the FlatShiftDelta for a 6Y OIS
    TEST_F( TestAQObjSwapDelta, RISK_FlatShiftDeltaOIS )
    {
    ...
    TEST_F( TestAQObjSwapDelta, RISK_FlatShiftDeltaIRS )
    {
		// 1. Load the Input Files
    ...
    TEST_F( TestAQObjSwapDelta, RISK_FlatShiftDeltaTenorBasis )
    {
		// 1. Load the Input Files
    ...
    TEST_F( TestAQObjSwapDelta, RISK_FlatShiftDeltaXCCY )
    {
		// 1. Load the Input Files
    ...
    TEST_F( TestAQObjSwapDelta, RISK_swapDV01 )
    {
		// 1. Load the Input Files
	...
	TEST_F( TestAQObjSwapDelta, RISK_DeltaLadderPortfolio )
    {
