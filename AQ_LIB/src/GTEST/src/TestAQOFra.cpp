...
#define TEST_DIR "ETrading/AQObjects/TestAQOFra/"
...
namespace google_test
{
	...
	//
	AQL_BUILD_USD_CURVE(TestAQOFra, USDYC_OIS, USDYC_1M, USDYC_STD, USDYC_6M, USDYC_12M);
	...
	TEST_F(TestAQOFra, SNAPSHOT_CheckFraPV)
	{
		try
		{
	...
	TEST_F(TestAQOFra, SNAPSHOT_CheckStubFraPV_withFirstStubCurveIndex)
	{
		try
		{
			// 1. Create the Input File Names 
