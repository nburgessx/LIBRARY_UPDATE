...
namespace google_test
{
    ...
    typedef BindFileToClassConstructor<TryMeCurveTenorBasis, GBPYC_3M6M> CurveTenorBasisBound;
    ...
    class TryMeTestCurveTenorBasisGBP3M6M : public testing::Test, public CurveTenorBasisBuilt
    {
    };
    ...
    TEST_F( TryMeTestCurveTenorBasisGBP3M6M, SNAPSHOT_CheckMeCurveDisplay )
    {
    ...
    TEST_F( TryMeTestCurveTenorBasisGBP3M6M, SNAPSHOT_CheckMeCurveDiscountFactorsFromYearFractions )
    {
    ...
    TEST_F( TryMeTestCurveTenorBasisGBP3M6M, SNAPSHOT_CheckMeCurveForwardRatesFromYearFraction )
    {
