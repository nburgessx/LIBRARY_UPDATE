...
namespace
{
    ...
    extern const char createBondInputFile1[]         ="ETrading/Bonds/AustraliaType23Govt1/tryAqBondObjectCreateFromLVB_inputs";
	extern const char priceBondInputFile1[]          ="ETrading/Bonds/AustraliaType23Govt1/tryAqBondObjectPrice_inputs";
    extern const char priceBondOutputFile1[]         ="ETrading/Bonds/AustraliaType23Govt1/tryAqBondObjectPrice_outputs";
	extern const char yieldBondInputFile1[]			 = "ETrading/Bonds/AustraliaType23Govt1/tryAqBondObjectYield_inputs";
	extern const char yieldBondOutputFile1[]		 = "ETrading/Bonds/AustraliaType23Govt1/tryAqBondObjectYield_outputs";

	extern const char createBondInputFile2[]		= "ETrading/Bonds/AustraliaType23Govt2/tryAqBondObjectCreateFromLVB_inputs";
	extern const char priceBondInputFile2[]			= "ETrading/Bonds/AustraliaType23Govt2/tryAqBondObjectPrice_inputs";
	extern const char priceBondOutputFile2[]		= "ETrading/Bonds/AustraliaType23Govt2/tryAqBondObjectPrice_outputs";
	extern const char yieldBondInputFile2[]			= "ETrading/Bonds/AustraliaType23Govt2/tryAqBondObjectYield_inputs";
	extern const char yieldBondOutputFile2[]		= "ETrading/Bonds/AustraliaType23Govt2/tryAqBondObjectYield_outputs";
    ...
    TEST_F( TestBondPricesAustraliaType23Govt, SCENARIO_CheckBondPricesAndYieldsMatchLiveMarketData1)
    {
        ...
        try
        {
             for ( i = 0; i < TEST_COUNT1; ++i )
             {
				...
				auto actualPrices = validation::tryAqBondObjectPrice(bondObjectName, settlementDates, yields);
				...
				auto actualYields = validation::tryAqBondObjectYield(bondObjectName, settlementDates, prices);
				auto compoundYields = validation::tryAqBondObjectCompoundYield(bondObjectName, settlementDates, prices);
