...
namespace
{
    ...
    extern const char inputsBRL[]           = TEST_DIR_BRL "BRLYC_BRLDF_tryAqCurveDiscountFactorsFromTenors_inputs.csv";
    extern const char outputsBRL[]          = TEST_DIR_BRL "BRLYC_BRLDF_tryAqCurveDiscountFactorsFromTenors_outputs.csv";
    ...
    extern const char inputsCNH[]           = TEST_DIR_CNH "CNHYC_CNHDF_tryAqCurveDiscountFactorsFromTenors_inputs.csv";
    extern const char outputsCNH[]          = TEST_DIR_CNH "CNHYC_CNHDF_tryAqCurveDiscountFactorsFromTenors_outputs.csv";
}
...
namespace google_test
{
    ...
    {
        // Load Curves
        const std::string loadUSDOIS     = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameBRLUSDOIS,  etrading::JSON );
        const std::string loadUSD3ML     = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameBRLUSD3ML,  etrading::JSON );
        const std::string loadBRLXCCY    = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameBRLXCCY,    etrading::JSON );

        // Calculate Actual Discount Factors
        const ReadDataFile::Load inputFile( inputsBRL );
        std::vector<double> discountFactorResults = validation::tryAqCurveDiscountFactorsFromTenors( inputFile["tenors"],
    ...
    {
        // Load Curves
        const std::string loadUSDOIS     = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameCNHUSDOIS,  etrading::JSON );
        const std::string loadUSD3ML     = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameCNHUSD3ML,  etrading::JSON );
        const std::string loadCNHXCCY    = validation::tryAqObjectLoad( etrading::getGoogleTestFolder() + fileNameCNHXCCY,    etrading::JSON );
