...
namespace
{
	...
	const std::string TEST_DIR = "ETrading/AQObjects/TestAQOSwapFromStructuredBespokeSchedule/";
...
namespace google_test
{
	...
	DECLARE_TEST_FIXTURE(TestAQOSwapFromStructuredBespokeSchedule)

	// Call Test Fixture Class
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_PV)
	{
		loadCurves();
		loadSwap();
	...
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_ParRate)
	{
		loadCurves();
		loadSwap();
	...
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_PV01)
	{
		loadCurves();
		loadSwap();
	...
	// Call Test Fixture Class
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_PV_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
	...
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_ParRate_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
	...
	TEST_F(TestAQOSwapFromStructuredBespokeSchedule, SNAPSHOT_Swap_PV01_withFee)
	{
		loadCurves();
		loadSwapWithFeeLeg();
