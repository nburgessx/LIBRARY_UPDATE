...
namespace google_test
{
    ...
    //
    AQL_BUILD_EUR_CURVE( TryAqTestTradeEURSwapStubRate, Test1_DIR_EURYC_OIS, Test1_DIR_EURYC_1M, Test1_DIR_EURYC_3M, Test1_DIR_EURYC_6M, Test1_DIR_EURYC_12M );

    //
    // Call Test Fixture
    //
    TEST_F( TryAqTestTradeEURSwapStubRate, SNAPSHOT_CheckHardCodedSwapStubRateUnchanged )
    {
        int i = 0;
        try
        {
    ...
    // If any curve is not in use and not defined, simply assign a "" to the curve name.
    //
    AQL_BUILD_EUR_CURVE( TryAqTestTradeEURSwapStubRate2, Test2_DIR_EURYC_OIS, Test2_DIR_EURYC_1M, Test2_DIR_EURYC_3M, Test2_DIR_EURYC_6M, Test2_DIR_EURYC_12M );

    //
    // Call Test Fixture
    //
    TEST_F( TryAqTestTradeEURSwapStubRate2, SNAPSHOT_CheckHardCodedSwapStubRateUnchanged )
    {
        int i = 0;
        try
        {
    ...
    // If any curve is not in use and not defined, simply assign a "" to the curve name.
    //
    AQL_BUILD_EUR_CURVE( TryAqTestTradeEURSwapStubRate3, Test3_DIR_EURYC_OIS, Test3_DIR_EURYC_1M, Test3_DIR_EURYC_3M, Test3_DIR_EURYC_6M, Test3_DIR_EURYC_12M );

    //
    // Call Test Fixture
    //
    TEST_F( TryAqTestTradeEURSwapStubRate3, CONSISTENCY_CheckStubRatesMatchFixingInputs )
    {
        int i = 0;
        try
        {
    ...
    AQL_BUILD_EUR_CURVE( TryAqTestTradeEURSwapStubRate4, Test4_DIR_EURYC_OIS, Test4_DIR_EURYC_1M, Test4_DIR_EURYC_3M, Test4_DIR_EURYC_6M, Test4_DIR_EURYC_12M );
    
    //
    // Call Test Fixture
    //
    TEST_F( TryAqTestTradeEURSwapStubRate4, SNAPSHOT_CheckStubRateInterpolationOnFixings )
    {
        int i = 0;
        try
        {
