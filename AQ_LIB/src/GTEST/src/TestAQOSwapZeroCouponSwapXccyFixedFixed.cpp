...
#define TEST_DIR "ETrading/AQObjects/TestAQOSwapZeroCouponSwapXccyFixedFixed/"
...
namespace google_test
{
    ...
    //
    AQL_BUILD_EURUSD_XCCY_CURVE( TestAQOSwapZeroCouponSwapXccyFixedFixed, USDYC_OIS, USDYC_STD, EURYC_OIS, EURYC_STD, EURYC_3M6M, EURYC_XCCY );
    
    //
    // Call Test Fixture
    //

    TEST_F( TestAQOSwapZeroCouponSwapXccyFixedFixed, SNAPSHOT_SwapHardCodedPVCheck )
    {
        try
        {
