...
#define TEST_DIR "ETrading/AQObjects/TestAQObjSwapAmortization/"
...
namespace google_test
{
    ...
    //
    //
    AQL_BUILD_EUR_CURVE( TestAQObjSwapAmortization, EURYC_OIS, EURYC_1M, EURYC_3M, EURYC_6M, EURYC_12M);
    
    //
    // Call Test Fixture
    //

    TEST_F( TestAQObjSwapAmortization, SNAPSHOT_SwapHardCodedPVCheck )
    {
        try
        {
    ...
    TEST_F( TestAQObjSwapAmortization, SNAPSHOT_SwapHardCodedParRateCheck )
    {
        try
        {
                // 1. Create the Input File Names 
    ...
    TEST_F( TestAQObjSwapAmortization, SNAPSHOT_SwapHardCodedPV01Check )
    {
        try
        {
                // 1. Create the Input File Names 
