...
class LAFTQuasiRandGS : public LARandBase
{
public:
...
//===================	LAFTQuasiRandGS.h  20051014(1) start =======================//
	//copy constructor
//	LAFTQuasiRandGS(const LAFTQuasiRandGS&);
//===================	LAFTQuasiRandGS.h  20051014(1)  end  =======================//
	
	//destructor
    virtual ~LAFTQuasiRandGS();

	LAFTQuasiRandGS & operator=( const LAFTQuasiRandGS & ) { return *this; }
