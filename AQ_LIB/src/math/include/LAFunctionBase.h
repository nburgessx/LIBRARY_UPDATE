...
*/
class LAFunctionBase : public LACoreFunctionBase
{
public:
//  LIFECYCLE
	// Default constructor
	explicit LAFunctionBase(bool checkflag = false);
	//	Copy constructor
//	LAFunctionBase(const LAFunctionBase& v);
	// Destructor
	virtual ~LAFunctionBase();
...
//  QUERY
	...
	virtual double				integral(double xl, double xu,
	                            ...
	                            // Return integral result
//	virtual double				integral(double xl, double xu,
//										const LA1DIntegral* pIntegral, const DoubleArray& grids) const;
	                            //==========================================
	                            // Return integral result
...
//  OPERATION
     ...
     virtual void				convertFromString(const LAString& str);//added by matsumura 20061204
								//==========================================
	                            // set check flag
