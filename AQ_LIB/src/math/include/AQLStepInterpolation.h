...
/* 
	...
	This class derives from AQLInterpolationBase
*/
class AQLStepInterpolation : public AQLInterpolationBase
{
public:

	// constructor
	explicit AQLStepInterpolation(StepType steptype = RIGHT_CONTINUOUS);
	
	// destructor
	~AQLStepInterpolation();
	
	// copy constructor
	AQLStepInterpolation(const AQLStepInterpolation& v);
	...
	// assignment operator
	AQLStepInterpolation & operator=( const AQLStepInterpolation & ) { return *this; }
...
protected:
	...
	class AQLStepInterpolationDataProvider : public AQLDataProvider
	{
	public:
		...
		*/
		AQLStepInterpolationDataProvider(const DoubleArray& i1, const DoubleArray& v, unsigned int s1)
		...
		AQLStepInterpolationDataProvider & operator=( const AQLStepInterpolationDataProvider & ) { return *this; }
	};
	...
	// Member Data
	AQLStepInterpolationDataProvider *mpDataProvider;	// Pointer to class data
	StepType mStepType;
