...
// LAInterpolationBase Data Enum ID
...
class LAInterpolationBase : public LACoreFunctionBase
{
public:

	// Constructors
	LAInterpolationBase();
	virtual ~LAInterpolationBase();
	LAInterpolationBase(const LAInterpolationBase& v);
