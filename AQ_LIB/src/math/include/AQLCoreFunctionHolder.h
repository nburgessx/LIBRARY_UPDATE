...
//	LIFECYCLE
    ...
    // copy constructor
	AQLCoreFunctionHolder(const AQLCoreFunctionHolder& objectHolder);
    // destructor
...
//  OPERATION
    ...
    */
    ...
    // assignment operator
	AQLCoreFunctionHolder&	operator=(const AQLCoreFunctionHolder& e) {return copy(e);}
    ...
    */
	...
	bool                operator==(const AQLCoreFunctionHolder& objectHolder) const
...
protected:
	...
	virtual AQLCoreFunctionHolder&   copy(const AQLCoreFunctionHolder& e);

private:
	const AQLCoreFunctionBase*    mpFunction;  // Function object
