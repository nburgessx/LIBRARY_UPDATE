...
*/
class AQLSplineInterpolation : public AQLInterpolationBase
{
public:

	// default constructor
	AQLSplineInterpolation();

    // constructor allowing the setting of the 'useNaturalSpline' parameter
	AQLSplineInterpolation( const bool useNaturalSpline );

	// destructor
	virtual ~AQLSplineInterpolation();

	//	copy constructor
	AQLSplineInterpolation(const AQLSplineInterpolation& v);
	...
	// assignment operator
	AQLSplineInterpolation & operator=( const AQLSplineInterpolation & ) { return *this; }
...
protected:
	...
	*/
	class AQLSplineInterpolationDataProvider : public AQLDataProvider
	{
	public:
		/*!
		@brief constructor
		...
		*/
		...
		AQLSplineInterpolationDataProvider(const DoubleArray& dataIndex,
		...
		// assignment operator
		AQLSplineInterpolationDataProvider & operator=( const AQLSplineInterpolationDataProvider & ) { return *this; }
	};
	...
	AQLSplineInterpolationDataProvider *mpDataProvider;
