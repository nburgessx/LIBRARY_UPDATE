...
class AQLMonotoneSplineInterpolation : public AQLInterpolationBase
{
public:
	...
	AQLMonotoneSplineInterpolation();
	
	// @brief Constructor allowing the setting of the monotone interpolation sub-type
	AQLMonotoneSplineInterpolation( const MonotoneInterpolationEnum monotoneInterpolationType );

	// @brief Destructor
	virtual ~AQLMonotoneSplineInterpolation();
	
	// @brief Copy constructor
	AQLMonotoneSplineInterpolation(const AQLMonotoneSplineInterpolation& v);
	...
	*/
	...
	AQLMonotoneSplineInterpolation & operator=( const AQLMonotoneSplineInterpolation & ) { return *this; }
