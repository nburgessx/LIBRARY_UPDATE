...
*/
class LAConstrainedSplineInterpolation : public LAInterpolationBase
{
public:

	// constructor
	LAConstrainedSplineInterpolation();
	
	// destructor
	~LAConstrainedSplineInterpolation();
	
	//	copy constructor
	LAConstrainedSplineInterpolation(const LAConstrainedSplineInterpolation& v);
	...
	LAConstrainedSplineInterpolation & operator=( const LAConstrainedSplineInterpolation & ) { return *this; }
...
protected:
	...
	*/
	class LAConstrainedSplineInterpolationDataProvider : public LADataProvider
	{
	public:
		/*!
		@brief constructor
		...
		*/
		...
		LAConstrainedSplineInterpolationDataProvider(const DoubleArray dataIndex,
		...
		LAConstrainedSplineInterpolationDataProvider & operator=( const LAConstrainedSplineInterpolationDataProvider & ) { return *this; }
	};

//	pointer of the class
LAConstrainedSplineInterpolationDataProvider *mpDataProvider;
