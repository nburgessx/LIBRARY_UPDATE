...
// Funciton ID of AQLMinMethod
#define FN_MIN	1212
// Function Name of AQLMinMethod
...
*/
class AQLMinMethod : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLMinMethod();
	// destructor
	virtual ~AQLMinMethod();

	// assignment operator
	AQLMinMethod & operator=( const AQLMinMethod & ) { return *this; }
