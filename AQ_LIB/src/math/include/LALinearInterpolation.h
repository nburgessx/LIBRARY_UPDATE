...
*/
class LALinearInterpolation : public LAInterpolationBase
{
public:
	// Constructors
	// ------------------------
	explicit LALinearInterpolation(ExtrapolationType type = LINEAR_EXTRAPOLATION_TYPE);
	virtual ~LALinearInterpolation();
	LALinearInterpolation(const LALinearInterpolation& v);
	...
	// assignment operator
	LALinearInterpolation & operator=( const LALinearInterpolation & ) { return *this; }
...
protected:
	...
	class LALinearInterpolationDataProvider : public LADataProvider
	{
	public:
		/*!
		@brief constructor
		...
		*/
		LALinearInterpolationDataProvider(const DoubleArray& i1, const DoubleArray& v, unsigned int s1)
		...
		// assignment operator
		LALinearInterpolationDataProvider & operator=( const LALinearInterpolationDataProvider & ) { return *this; }
	};
	...
	// Member Data
	LALinearInterpolationDataProvider *mpDataProvider;
