...
// Funciton ID of LA1DDataSet
#define FN_1DDATASET	1203
// Function Name of LA1DDataSet
...
*/
class LA1DDataSet : public LAFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	explicit LA1DDataSet(bool checkflag = false);
	// destructor
	virtual ~LA1DDataSet();
	//	Copy constructor
	LA1DDataSet(const LA1DDataSet& v);
//  QUERY
								//======================================
...
//  OPERATION
	...
	virtual void				setInterpolation(const LAInterpolationBase& v);
	...
	LA1DDataSet & operator=( const LA1DDataSet & ) { return *this; }

private:
	DoubleArray mGrids;					// grid points
	mutable LAInterpolationBase* mpInter;	// pointer to interpolation function
