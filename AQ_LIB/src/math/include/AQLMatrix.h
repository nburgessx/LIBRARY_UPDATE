...
//  Matrix Operation	
	...
	void					svDecomp(AQLMatrix& u, AQLMatrix& w, 
											AQLMatrix& v) const;
							//==============================================
...
private:
	...
	*/
	...
	// LU Decomposition
	static void				lubksb(const AQLMatrix& a, const std::vector<int>& indx, 
													std::vector<double>& b);
	static void				mprove(const AQLMatrix& a, const AQLMatrix& alud, 
