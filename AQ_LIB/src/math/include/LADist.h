...
public:
	...
	static double			invNormdist(double x)
							{
								if (x <= 0) throw LACoreNumericalError("argument must be over 0 for invNormdist", __FILE__, __LINE__);
								if (x >= 1) throw LACoreNumericalError("argument must be under 1 for invNormdist", __FILE__, __LINE__);
                                ...
                                t = t * MM_SQRT2PI * LAMath::exp(u*u/2);   // f(u)/df(u)
	...
	static double			invNormdistHalleyMod(double u)
							{
								if (u <= 0) throw LACoreNumericalError("argument must be over 0 for invNormdist", __FILE__, __LINE__);
								if (u >= 1) throw LACoreNumericalError("argument must be under 1 for invNormdist", __FILE__, __LINE__);
