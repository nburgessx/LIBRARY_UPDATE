...
// AQLMonotoneConvexInterpolation Function ID
#define FN_MONOTONECONVEXINTERPOLATION	1006

// AQLMonotoneConvexInterpolation Function Name
...
*/
class AQLMonotoneConvexInterpolation : public AQLInterpolationBase
{
public:

	// default constructor
	AQLMonotoneConvexInterpolation();
	AQLMonotoneConvexInterpolation(const double dLambda, const bool dIsAllowedNegative);
	AQLMonotoneConvexInterpolation(const double dLambda, const bool dIsAllowedNegative, const int dInputMode, const int dOutputMode);

	// destructor
	~AQLMonotoneConvexInterpolation();

	//	copy constructor
	AQLMonotoneConvexInterpolation(const AQLMonotoneConvexInterpolation& v);
	...
	// assignment operator
	AQLMonotoneConvexInterpolation & operator=( const AQLMonotoneConvexInterpolation & ) { return *this; }
...
protected:
	...
	*/
	class AQLMonotoneConvexInterpolationDataProvider : public AQLDataProvider
	{
	public:
		/*!
		@brief constructor
		...
		*/
		...
		// assignment operator
		AQLMonotoneConvexInterpolationDataProvider & operator=( const AQLMonotoneConvexInterpolationDataProvider & ) { return *this; }
	};
	
	// pointer to hold data
	AQLMonotoneConvexInterpolationDataProvider *mpDataProvider;
