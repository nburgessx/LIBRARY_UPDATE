...
*/
class LALinearSplineInterpolation : public LAInterpolationBase
{
public:

    // default constructor
    LALinearSplineInterpolation(); 

    // alternative constructor
    // FLAT_EXTRAPOLATION = Piecewise-Constant Extrapolation
	// LINEAR_EXTRAPOLATION = Linear Extrapolation
	explicit LALinearSplineInterpolation( ExtrapolationType extrapolationType, const bool useNaturalSpline); 
    
    // destructor
	virtual ~LALinearSplineInterpolation();
	
    // copy constructor
	LALinearSplineInterpolation( const LALinearSplineInterpolation& v );
	...
	LALinearSplineInterpolation & operator=( const LALinearSplineInterpolation & ) { return *this; }
...
protected:
    ...
    std::shared_ptr<LASplineInterpolation>  splineInterpolation_;
