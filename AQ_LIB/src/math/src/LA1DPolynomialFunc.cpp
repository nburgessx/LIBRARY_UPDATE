...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LA1DPolynomialMethod.cpp
//
//  SYNOPSIS    :       LA1DPolynomialMethod
...
#include "LA1DPolynomialFunc.h"
#include "LABasic.h"
#include "LADist.h"

using namespace std;
//================ LA1DPolynomialMethod ===================================
/*!
	@brief default constructor
*/
LA1DPolynomialMethod::LA1DPolynomialMethod() 
: LAFunctionBase()
{
...
*/
LACoreFunctionBase*	
LA1DPolynomialMethod::clone() const
{
    try 
	{
		return new LA1DPolynomialMethod(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
LA1DPolynomialMethod::isTypeOf(function_t id) const
{
	return (id == FN_POLYNOMIAL ? true : LAFunctionBase::isTypeOf(id));
}
...
*/
function_t
LA1DPolynomialMethod::getType() const
{
...
*/
double
LA1DPolynomialMethod::operator()(const DoubleArray& x) const
{
...
*/
double
LA1DPolynomialMethod::operator()(double x) const
{
	double ret = 0.0;
	double xx = 1.0;
...
*/
double
LA1DPolynomialMethod::integral(const std::vector<std::pair<double,double> >& x)const
{
	if ((mCheckFlag && x.size() != 1) || x.size() == 0)
	{
...
*/
double
LA1DPolynomialMethod::integral(double xl,double xu) const
{
...
*/
double
LA1DPolynomialMethod::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
LA1DPolynomialMethod::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
