...
LABivariateDistribution::LABivariateDistribution()
{
    mMeanX = mMeanY = 0.0;
    mStDevX = mStDevY = 1.0;
    mStandard = true;
...
LABivariateDistribution::LABivariateDistribution(double meanX_, double meanY_, double stDevX_, double stDevY_)
{
...
double LABivariateDistribution::Standardize(double x, double mu, double sigma)
{
    return (x - mu) / sigma;
}
