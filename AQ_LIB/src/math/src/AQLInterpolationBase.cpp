...
// Constructor
AQLInterpolationBase::AQLInterpolationBase() 
: AQLCoreFunctionBase()
{}

// Copy Constructor
AQLInterpolationBase::AQLInterpolationBase(const AQLInterpolationBase& v) 
...
bool AQLInterpolationBase::isTypeOf(function_t id) const
{
	return (id == FN_INTERPOLATION ? true : AQLCoreFunctionBase::isTypeOf(id));
}

// Function to get the interpolation type
function_t AQLInterpolationBase::getType() const
{
...
double AQLInterpolationBase::differentiate( const double xPoint ) const
{
...
double AQLInterpolationBase::differentiateOverRange( const double fromXPoint, const double toXPoint ) const
{
...
double AQLInterpolationBase::integrate( const double lowerBound, const double upperBound ) const
{ 
...
size_t AQLInterpolationBase::supremum( const double & value ) const
{
...
Interval AQLInterpolationBase::getInterval( const size_t & endIndex ) const
{
...
double AQLInterpolationBase::intervalStartHeight( const Interval& interval ) const
{
...
// Function to calculate the start height at the start of a given interval
double AQLInterpolationBase::intervalEndHeight( const Interval& interval ) const
{
	// Integrand Start Height
...
double AQLInterpolationBase::intervalWidth( const Interval& interval, const double & lowerBound, const double & upperBound  ) const
{
...
double AQLInterpolationBase::intervalSlope( const Interval& interval ) const
{
	AQ_THROW( "Mathematical Differentiation Not Supported for this Interpolation Type" );
}
...
double AQLInterpolationBase::intervalArea( const size_t & endIndex, const double & lowerBound, const double & upperBound ) const
{
	AQ_THROW( "Mathematical Integration Not Supported for this Interpolation Type" );
}