...
*/
AQLPriceDataType::AQLPriceDataType(const staticData_t attr)
...
*/
AQLPriceDataType::AQLPriceDataType(const AQLPriceDataType& attr)
			:  mpHolder(NULL), 
...
/*!
    @brief destructor
*/
AQLPriceDataType::~AQLPriceDataType()
{
}
...
*/
bool				
AQLPriceDataType::strToData(const AQLString& str, AQLString& data) const
{
...
*/
void
AQLPriceDataType::update(int type)
{
	if (mpHolder != NULL)
...
*/
AQLObject*
AQLPriceDataType::getObject(void)
{
	if (mpHolder != NULL)
...
*/
const AQLObject*
AQLPriceDataType::getObject(void) const
{
	if (mpHolder != NULL)
		return mpHolder->getObject();
	else
...
*/
void
AQLPriceDataType::setHolder(AQLDataHolder* holder)
{
	mpHolder = holder;
}
