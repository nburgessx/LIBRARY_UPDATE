...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LABoxMuller.cpp
//
//  SYNOPSIS    :       LABoxMuller
//  DESCRIPTION :       
//                      
//                     
//                      
//  SEE ALSO    :       LABoxMuller.h
//  TYPE        :       CLASS
//  STATUS      :       
////X///////////////////X///////////////////////////////X///////////////////

#include "LABoxMuller.h"
...
/*!
	@brief constructor
*/
LABoxMuller::LABoxMuller() 
: LARandBase(),mpRand(NULL),mIsOdd(true)
{
...
*/
LABoxMuller::LABoxMuller(const LABoxMuller& v):
...
*/
LACoreFunctionBase*
LABoxMuller::clone() const
{
    try 
    {
        return new LABoxMuller(*this);
    }
    catch (bad_alloc & e)
    {
...
*/
bool
LABoxMuller::isTypeOf(function_t id) const
{
    return (id == FN_RAND_BOXMULLER ? true : LARandBase::isTypeOf(id));
}
...
*/
void
LABoxMuller::getUniforms(DoubleArray& variates)
{
...
*/
void
LABoxMuller::getGaussians(DoubleArray& variates)
{
	DoubleArray  u1(2);
    ...
    if ( mIsOdd )
    {
	    for ( unsigned int i=0; i<variates.size(); i++ )
	    {
            ...
            double multiple = LAMath::sqrt( -2.0 * LAMath::log( s ) / s );
...
*/
void
LABoxMuller::setSeed(const UlongArray& seed)
{
...
*/
void
LABoxMuller::setDim(const UintArray& dimValue)
{
...
*/
void
LABoxMuller::setRandGenerator(const LARandBase& v)
{
	if (mpRand) delete mpRand;
	mpRand = NULL;
