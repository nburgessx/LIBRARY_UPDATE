...
//// DEFINES ////
// Entitiy id of AQLMathIndexEntity
...
*/
class AQLMathIndexEntity : public AQLObject
{
public:
// LIFECYCLE
    // default constructor
	AQLMathIndexEntity(AQLDataInstance* dataInstance);
    // copy constructor
	AQLMathIndexEntity(const AQLMathIndexEntity& irse);
    // destructor
	virtual ~AQLMathIndexEntity();
...
//  QUERY
	...
	*/
	...
	// getYieldCurvePro
	//const AQLMathYieldCurvePro& getYieldCurvePro (void) const;
...
//private:
	...
	// calc SpreadMat
	void						calcSpreadMat(const AQLMathYieldCurve &curve, const DoubleMatrix &gridMat);
...
//	int							mCacheSize;	// cash size 
	...
	AQLMathPathEntity*				mpPath;		// pointer to path object
	AQLMathFXEntity*				mpFX;		// pointer to fx object
	...
	AQLMathPlainVanillaEntity*		mpVanilla; // pointer to plain vanilla object
