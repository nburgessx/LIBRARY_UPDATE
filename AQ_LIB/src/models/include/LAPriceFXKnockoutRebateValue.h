#ifndef LAPriceFXKnockoutRebateValue_h
#define LAPriceFXKnockoutRebateValue_h
...
class LAPriceFXKnockoutRebateValue : public LAPriceFXOptionValue
{
public:
	// Default constructor
	LAPriceFXKnockoutRebateValue();
	// Destructor
	~LAPriceFXKnockoutRebateValue();
								//======================================
