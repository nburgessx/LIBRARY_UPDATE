...
// Funciton ID of AQLProductMethod
#define FN_PRODUCT	1217
// Function Name of AQLProductMethod
#define FN_PRODUCT_STR	"fn_product"



///////////////////////////////////////////////////////////////////////
/*! 
    @brief Class declaration to represent Product function.

	This class derives from AQLFunctionBase

*/
class AQLProductMethod : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLProductMethod();
	// destructor
	virtual ~AQLProductMethod();

	// assignment operator
	AQLProductMethod & operator=( const AQLProductMethod & ) { return *this; }
