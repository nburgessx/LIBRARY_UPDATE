...
*/
class AQLMathFXEntity : public AQLObject
{
public:
// LIFECYCLE
    // default constructor
	AQLMathFXEntity(AQLDataInstance* dataInstance);
    // copy constructor
	AQLMathFXEntity(const AQLMathFXEntity& fx);
    // destructor
	virtual ~AQLMathFXEntity();
