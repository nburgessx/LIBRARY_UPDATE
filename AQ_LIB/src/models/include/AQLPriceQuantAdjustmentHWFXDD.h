...
// ID for AQLPriceQuantAdjustmentHWFXDD
...
*/
class AQLPriceQuantAdjustmentHWFXDD : public AQLPriceQuantAdjustmentFuncBase
{
public:
//  LIFECYCLE
	// Default constructor
	AQLPriceQuantAdjustmentHWFXDD(const AQLString& sdeAttrNameIR_F, const AQLString& sdeAttrNameFX, const bool isAdjustInPath = false, double fxCriteria = 0.01, const double quantoCriteria = 10.0);
	//	Copy constructor
	AQLPriceQuantAdjustmentHWFXDD(const AQLPriceQuantAdjustmentHWFXDD& v);
	// Destructor
	virtual ~AQLPriceQuantAdjustmentHWFXDD();
...
protected:
	...
	AQLPriceDriftHW*				mpDriftIR;		// drift function of foregin ir 
	AQLRatesNumeraireBase*	        mpNumeraireF;	// numerarire of foreign currency
