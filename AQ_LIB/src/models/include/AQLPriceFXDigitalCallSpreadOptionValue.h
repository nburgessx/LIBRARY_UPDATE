#ifndef AQLPriceFXDigitalCallSpreadOptionValue_h
#define AQLPriceFXDigitalCallSpreadOptionValue_h
...
class AQLPriceFXDigitalCallSpreadOptionValue : public AQLPriceFXOptionValue
{
public:
	// Default constructor
	AQLPriceFXDigitalCallSpreadOptionValue();
	// Destructor
	~AQLPriceFXDigitalCallSpreadOptionValue();
								//======================================
