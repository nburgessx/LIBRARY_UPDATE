#ifndef AQLPriceFXDigitalOptionValue_h
#define AQLPriceFXDigitalOptionValue_h
...
class AQLPriceFXDigitalOptionValue : public AQLPriceFXOptionValue
{
public:
	// Default constructor
	AQLPriceFXDigitalOptionValue();
	// Destructor
	~AQLPriceFXDigitalOptionValue();
								//======================================
