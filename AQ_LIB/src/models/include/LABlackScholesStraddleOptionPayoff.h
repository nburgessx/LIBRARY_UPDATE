...
*/
class LABlackScholesStraddleOption : public LABlackScholesCapletOption
{
public:
//  LIFECYCLE
	// constructor
	...
	// destructor
	virtual ~LABlackScholesStraddleOption();

	//20061017--David--Remove warning:C4512
	LABlackScholesStraddleOption & operator=( const LABlackScholesStraddleOption & ) { return *this; }
