...
class LAMathInterpolationUtilities
{
public:
...
private:
    LAMathInterpolationUtilities(void) {};
    ~LAMathInterpolationUtilities(void) {}; 
	LAMathInterpolationUtilities(const LAMathInterpolationUtilities &rhs);
	LAMathInterpolationUtilities &operator=(const LAMathInterpolationUtilities &rhs);
};
