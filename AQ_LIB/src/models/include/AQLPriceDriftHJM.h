...
// ID for AQLPriceDriftHJM
#define FN_DRIFTHJM	2212
// Function name for AQLPriceDriftHJM
...
*/
class AQLPriceDriftHJM : public AQLMathDriftFuncBase
{
public:
//  LIFECYCLE
	// Default constructor
	AQLPriceDriftHJM();
	// constructor
	AQLPriceDriftHJM(const AQLString& sdeAttrName, double T, const DoubleArray& grid_T);	
	//	Copy constructor
	AQLPriceDriftHJM(const AQLPriceDriftHJM& v);
	// Destructor
	virtual ~AQLPriceDriftHJM();
