...
// Funciton ID of LARatesCpnCapFunc
#define FN_CPNCAP	1218
// Function Name of LARatesCpnCapFunc
...
*/
class LARatesCpnCapFunc : public LAFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	LARatesCpnCapFunc();
	// destructor
	virtual ~LARatesCpnCapFunc();

	//20061017--David--Remove warning:C4512
	LARatesCpnCapFunc & operator=( const LARatesCpnCapFunc & ) { return *this; }
