...
// ID for AQLPriceDriftQuantAdjustment
#define FN_DRIFTQUANTADJ	2205
// Function name for AQLPriceDriftQuantAdjustment
...
*/
class AQLPriceDriftQuantAdjustment : public AQLMathDriftFuncBase
{
public:
//  LIFECYCLE
	// Default constructor
	explicit AQLPriceDriftQuantAdjustment(AQLFunctionBase* driftIR);
	// constructor
	AQLPriceDriftQuantAdjustment(const AQLString& sdeAttrNameIR, const AQLString& sdeAttrNameFX, unsigned int i, AQLFunctionBase* driftIR);	
	//	Copy constructor
	AQLPriceDriftQuantAdjustment(const AQLPriceDriftQuantAdjustment& v);
	// Destructor
	virtual ~AQLPriceDriftQuantAdjustment();
...
//	OPERATION
	...
	void						setCorrelation(const DoubleArray& cor)
								...
								//======================================
								// set fx sde
	void						setFXSDE(AQLRatesSpotSDE* psde);
								//======================================
								// set suffix
								/*!
									@param[in] i suffix
