...
{
public:
    MVReplication(LAPriceSwaptionCalculator* swaptionCalculator_, double shift_, double annuity_, double dfPay_, double tau_, double nCashFlows_, string distributionType_, bool rescale_, double confidence_ = 0.0, int nPoints_ = 0);
...
private:
    ...
    LAPriceSwaptionCalculator* mSwpnCalculator;
...
//================ Utilities ===================================
MVReplication* GetReplicationMethod(string type, LAPriceSwaptionCalculator* swpnCalculator_, double shift,
