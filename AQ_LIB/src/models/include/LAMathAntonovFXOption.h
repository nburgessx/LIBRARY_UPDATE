...
#ifndef LAMathAntonovFXOption_h
#define LAMathAntonovFXOption_h
...
public:
	...
	*/
	...
	public:
		...
		virtual ~LAMathAntonovFXOptionDataProvider(); 
 ...
 protected:
	 // Copy constructor
	LAMathAntonovFXOption(const LAMathAntonovFXOption& v);
	// virtual method
