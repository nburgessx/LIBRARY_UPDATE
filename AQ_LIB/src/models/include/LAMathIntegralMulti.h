...
private:
	...
	//
	mutable AQLMathFunction<LAMathIntegralMulti> integral_2D_0_helper_;
	mutable AQLMathFunction<LAMathIntegralMulti> integral_2D_1_helper_;
	mutable AQLMathFunction<LAMathIntegralMulti> integral_2D_2_helper_;
    mutable AQLMathFunction<LAMathIntegralMulti> integral_3D_0_helper_;
