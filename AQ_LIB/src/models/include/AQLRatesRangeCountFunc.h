...
// Funciton ID of AQLRatesRangeCountFunc
#define FN_RANGECOUNT	1216
// Function Name of AQLRatesRangeCountFunc
...
*/
class AQLRatesRangeCountFunc : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	...
	// destructor
	virtual ~AQLRatesRangeCountFunc();

	//20061017--David--Remove warning:C4512
	AQLRatesRangeCountFunc & operator=( const AQLRatesRangeCountFunc & ) { return *this; }
