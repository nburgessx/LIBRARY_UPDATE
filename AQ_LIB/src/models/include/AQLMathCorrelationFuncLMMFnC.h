...
// Funciton ID of AQLMathCorrelationFuncLMMFnC
...
class AQLMathCorrelationFuncLMMFnC : public AQLMathCorrelationFuncLMM
{
public :

	// constructor
	explicit AQLMathCorrelationFuncLMMFnC(double x, double y);

	// destructor
	virtual ~AQLMathCorrelationFuncLMMFnC(void);

	// copy constructor
	AQLMathCorrelationFuncLMMFnC(const AQLMathCorrelationFuncLMMFnC &rhs);
    ...
    { 
        return  my + (1 - my) * exp( -mx * AQLModelUtilities::abs_( sqrt( T1 - t ) - sqrt( T2 - t ) ) );
    }
