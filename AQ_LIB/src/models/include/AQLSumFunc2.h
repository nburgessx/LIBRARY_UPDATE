...
// Funciton ID of AQLSumMethod2
#define FN_SUM2	10006
// Function Name of AQLSumMethod2
...
*/
class AQLSumMethod2 : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLSumMethod2();
	// destructor
	virtual ~AQLSumMethod2();

	// suppress warning C4512
	AQLSumMethod2 & operator=( const AQLSumMethod2 & ) { return *this; }
