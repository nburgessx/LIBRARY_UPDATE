...
// Funciton ID of LARatesCpnCapFuncForTARN
#define FN_CPNCAPFORTARN	10003
// Function Name of LARatesCpnCapFuncForTARN
...
*/
class LARatesCpnCapFuncForTARN : public LAFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	LARatesCpnCapFuncForTARN();
	LARatesCpnCapFuncForTARN(const DoubleArray& x); 
	// destructor
	virtual ~LARatesCpnCapFuncForTARN();

	//20061017--David--Remove warning:C4512
	LARatesCpnCapFuncForTARN & operator=( const LARatesCpnCapFuncForTARN & ) { return *this; }
