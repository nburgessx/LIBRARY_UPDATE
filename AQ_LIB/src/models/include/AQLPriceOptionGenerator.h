...
// Function ID for AQLPriceOptionGenerator
#define FN_IR_OPTIONGENERATOR		2016
// Function name for AQLPriceOptionGenerator
...
*/
class AQLPriceOptionGenerator : public AQLPriceCashFlowGenerator
{
public:
//  LIFECYCLE
    // constructor
	AQLPriceOptionGenerator();
    // destructor	
	virtual ~AQLPriceOptionGenerator();
...
protected:
    // copy constructor
	AQLPriceOptionGenerator(const AQLPriceOptionGenerator& p);
