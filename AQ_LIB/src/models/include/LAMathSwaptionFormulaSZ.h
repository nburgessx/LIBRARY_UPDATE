...
public:
	...
	DDSZ_util() {}
	DDSZ_util(LAMathPathYieldCurve& curve_d_,
...
protected:
    ...
    LAMathPathYieldCurve* curve_d;
	LAMathPathYieldCurve* curve_f;
...
{
public:
	Vol1_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     			 LAMathPathYieldCurve& curve_f_,
                 vector<double> T_param_,      
                 vector<double> beta_,      
                 double rho_,                   
...
{
public:
	Vol2_E_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     			   LAMathPathYieldCurve& curve_f_,
                   vector<double> T_param_,      
                   vector<double> beta_,        
                   double rho_,       
...
{
public:
	Rho_vol1_vol2_E_DDSV(LAMathPathYieldCurve& curve_d_,
     			         LAMathPathYieldCurve& curve_f_,
                         vector<double> T_param_,
                         vector<double> beta_,      
                         double rho_,                           
...
{
public:
	P1_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,
               double rho_,            
...
{
public:
	P1_Vol1_DDSV(LAMathPathYieldCurve& curve_d_,
     			 LAMathPathYieldCurve& curve_f_,
                 vector<double> T_param_,
                 vector<double> beta_,
                 double rho_,                   
...
{
public:
	P1_P2_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,      
               double rho_,                 
...
{
public:
	P1_P3_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,      
               double rho_,               
...
{
public:
	Rho_P1_P4_DDSV(LAMathPathYieldCurve& curve_d_,
     			   LAMathPathYieldCurve& curve_f_,
                   vector<double> T_param_,
                   vector<double> beta_,      
                   double rho_,                     
...
{
public:
	P1_P5_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
			   vector<double> T_param_,
			   vector<double> beta_,      
			   double rho_,                
...
{
public:
	P1_P6_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,
               double rho_,                 
...
{
public:
	Rho_P1_P7_DDSV(LAMathPathYieldCurve& curve_d_,
     	 		   LAMathPathYieldCurve& curve_f_,
                   vector<double> T_param_,
                   vector<double> beta_,
                   double rho_,                    
...
{
public:
	P1_P8_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
			   vector<double> T_param_,
			   vector<double> beta_,
			   double rho_,                
...
{
public:
	P1_P9_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_, 
               double rho_,                 
...
{
public:
	P2_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,      
               double rho_,                 
...
{
public:
	P4_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,      
               double rho_,
...
{
public:
	P6_SQ_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,      
               double rho_,              
...
{
public:
	Rho_P4_P6_DDSV(LAMathPathYieldCurve& curve_d_,
     	  		   LAMathPathYieldCurve& curve_f_,
                   vector<double> T_param_,
                   vector<double> beta_,      
                   double rho_,                    
...
{
public:
	P2_Vol1_DDSV(LAMathPathYieldCurve& curve_d_,
     			 LAMathPathYieldCurve& curve_f_,
                 vector<double> T_param_,
                 vector<double> beta_,      
                 double rho_,                   
...
{
public:
	Rho_Vol1_P4_DDSV(LAMathPathYieldCurve& curve_d_,
     			     LAMathPathYieldCurve& curve_f_,
                     vector<double> T_param_,
                     vector<double> beta_,      
                     double rho_,                     
...
{
public:
	P6_Vol1_DDSV(LAMathPathYieldCurve& curve_d_,
     			 LAMathPathYieldCurve& curve_f_,
                 vector<double> T_param_,
                 vector<double> beta_,
                 double rho_,                 
...
{
public:
	Rho_P2_P4_DDSV(LAMathPathYieldCurve& curve_d_,
     			   LAMathPathYieldCurve& curve_f_,
                   vector<double> T_param_,
                   vector<double> beta_,      
                   double rho_,                 
...
{
public:
	P2_P6_DDSV(LAMathPathYieldCurve& curve_d_,
     		   LAMathPathYieldCurve& curve_f_,
               vector<double> T_param_,
               vector<double> beta_,
               double rho_,                 
...
{
public:
	LAMathSwaptionFormulaSZ(LAMathPathYieldCurve& curve_d_,
                 		LAMathPathYieldCurve& curve_f_,
                        vector<double> T_param_,
                        vector<double> beta_,      
                        double rho_,                          
...
private:
	LAMathSwaptionFormulaSZ(const LAMathSwaptionFormulaSZ& rhs) {}
	...
	public:
		...
		////double operator()(double x) { return LAMathAnalyticalFormula::BlackFormula( mean_LN, x, margin, sgn) / prem - 1.; }
		double operator()(double x) const { return LAMathAnalyticalFormula::BlackFormula( mean_LN, x, margin, sgn) / prem - 1.; }
	private:
		double prem;
		double mean_LN;
		double margin;
