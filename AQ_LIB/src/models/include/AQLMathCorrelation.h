...
//// DEFINES ////
// Entitiy id of AQLMathCorrelation
...
*/
class AQLMathCorrelation : public AQLObject
{
public:
// LIFECYCLE
    // default constructor
	AQLMathCorrelation(AQLDataInstance* dataInstance);
    // copy constructor
	AQLMathCorrelation(const AQLMathCorrelation& cor);
    // destructor
	virtual ~AQLMathCorrelation();
...
private:
	...
	class AQLMathFactorLoadingFunction : public AQLFunctionBase
	{
	public:
		// Default constructor
		AQLMathFactorLoadingFunction();
		// Destructor
		~AQLMathFactorLoadingFunction();
		...
		AQLMathFactorLoadingFunction & operator=( const AQLMathFactorLoadingFunction & ) { return *this; }
