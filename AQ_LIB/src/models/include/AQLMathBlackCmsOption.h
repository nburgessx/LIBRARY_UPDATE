...
*/
class AQLMathBalckCmsOption
{
public:
	// constructor
	AQLMathBalckCmsOption(double S0_,
					   double annuity0_,
...
//
class AQLMathBalckCmsOptionApproxA : public AQLMathBalckCmsOption
{
public:

	// constructor
	AQLMathBalckCmsOptionApproxA(double S0_,
							 double annuity0_,
							 double option_maturity_,
							 double T_fix_,
							 double T_pay_,
