...
// Function ID for AQLPriceFXDisplacedDiffusionCalibration3F
#define FN_IR_FXDISPLACEDDIFFUSIONCALIBRATION3F		10143
// Function name for AQLPriceFXDisplacedDiffusionCalibration3F
...
class AQLPriceFXDisplacedDiffusionCalibration3F : public AQLPriceFXDisplacedDiffusionCalibration
{
public:
//  LIFECYCLE
    // constructor
	AQLPriceFXDisplacedDiffusionCalibration3F();
    // destructor	
	virtual ~AQLPriceFXDisplacedDiffusionCalibration3F();
	...
	virtual void	            calibMarketSkewVol(const AQLDate& basedate, 
										AQLObject& object, 
										const AQLDataProcedure& att) const;
    // calibrate hw dd parameter
	virtual void	            calibHybridHWDDProcess(const AQLDate& basedate, 
										AQLObject& object, 
										const AQLDataProcedure& att) const;
...
protected:
    // copy constructor
	AQLPriceFXDisplacedDiffusionCalibration3F(const AQLPriceFXDisplacedDiffusionCalibration3F& p);
