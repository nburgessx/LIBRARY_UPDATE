...
*/
class LAPriceFXVolatility : public LAFunctionBase
{
public:
//  LIFECYCLE
	// Default constructor
	LAPriceFXVolatility(LAFunctionBase* pVol_fx_and_t, LAFunctionBase* pVol_t, const DoubleArray& timegrid);
	//	Copy constructor
...
//  QUERY
	...
	const LAFunctionBase*		get_t_part() const {return mpVol_t;}
								//======================================
								// Return volatility function of fx and t part
	const LAFunctionBase*		get_fx_and_t_part() const {return mpVol_fx_and_t;}
	                            //==========================================
	                            // Return drift value
...
protected:
	LAFunctionBase*				mpVol_t;// < volatility of t function part
	LAFunctionBase*				mpVol_fx_and_t;// < volatility of fx rate function part
