...
// ID for AQLRatesPathElementLMMCurve
...
*/
class AQLRatesPathElementLMMCurve : public AQLRatesPathElementCurve
{
public:
//  LIFECYCLE
	// Default constructor
	AQLRatesPathElementLMMCurve(const DoubleArray& tenor, const DoubleArray& delta_tenor, double t = 0);
	// Destructor
	virtual ~AQLRatesPathElementLMMCurve();
	// copy constructor
	AQLRatesPathElementLMMCurve(const AQLRatesPathElementLMMCurve& v);
...
//  QUERY
    ...
    */
    virtual	AQLRatesPathElementLMMCurve&
								operator = (const AQLRatesPathElementLMMCurve& a);
