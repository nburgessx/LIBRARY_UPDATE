...
static const double MAXIMUM_2207 = LAMath::log(DBL_MAX) - 1.0;//
...
//  LIFECYCLE
	...
	// constructor
	LAPriceDriftLogLMMTerminal(const LAString& sdeAttrName, unsigned int i, const DoubleArray& tenor, const DoubleArray& delta_tenor, double Q = 1.0);	
	//	Copy constructor
