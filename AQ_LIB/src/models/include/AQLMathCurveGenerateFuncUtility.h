#ifndef AQLMathCurveGenerateFuncUtility_h
#define AQLMathCurveGenerateFuncUtility_h
...
class AQLMathCurveGenerateFuncUtility
{
//curve
public:	
    ...
    */
	...
	static void restoreSwapRateFromL(AQLMathYieldCurvePro &curve, const AQLString &ccy, const std::map<AQLString, double> &sRateMap, AQLStringMatrix sdata);
	
private:
    AQLMathCurveGenerateFuncUtility(void);
    ~AQLMathCurveGenerateFuncUtility(void);
    AQLMathCurveGenerateFuncUtility(const AQLMathCurveGenerateFuncUtility &rhs);
    AQLMathCurveGenerateFuncUtility &operator=(const AQLMathCurveGenerateFuncUtility &rhs);
