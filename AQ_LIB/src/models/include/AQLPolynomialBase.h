...
*/
class AQLPolynomialBase : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// Default constructor
	explicit AQLPolynomialBase(unsigned int order = 1, unsigned int varnum = 1, bool checkflag = false);
	//	Copy constructor
	AQLPolynomialBase(const AQLPolynomialBase& v);
	// Destructor
	virtual ~AQLPolynomialBase();
...
//  QUERY
	...
	AQLPolynomialBase & operator=( const AQLPolynomialBase & ) { return *this; }
