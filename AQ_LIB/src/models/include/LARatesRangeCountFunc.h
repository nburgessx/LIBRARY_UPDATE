...
// Funciton ID of LARatesRangeCountFunc
#define FN_RANGECOUNT	1216
// Function Name of LARatesRangeCountFunc
#define FN_RANGECOUNT_STR	"fn_rangecount"
...
*/
class LARatesRangeCountFunc : public LAFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	...
	// destructor
	virtual ~LARatesRangeCountFunc();

	//20061017--David--Remove warning:C4512
	LARatesRangeCountFunc & operator=( const LARatesRangeCountFunc & ) { return *this; }
