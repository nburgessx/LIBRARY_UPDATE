#ifndef LAPriceFXDigitalCallSpreadSingleBarrierOptionValue_h
#define LAPriceFXDigitalCallSpreadSingleBarrierOptionValue_h
...
class LAPriceFXDigitalCallSpreadSingleBarrierOptionValue : public LAPriceFXSingleBarrierOptionValue
{
public:
	// Default constructor
	LAPriceFXDigitalCallSpreadSingleBarrierOptionValue();
	// Destructor
	~LAPriceFXDigitalCallSpreadSingleBarrierOptionValue();
								//======================================
