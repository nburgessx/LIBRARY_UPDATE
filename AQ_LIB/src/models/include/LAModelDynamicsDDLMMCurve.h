...
*/
class LARatesPathElementDDLMMCurve : public LARatesPathElementLMMCurve
{
public:
//  LIFECYCLE
	// Default constructor
	LARatesPathElementDDLMMCurve(double s, const double constShift, const DoubleArray& tenor, const DoubleArray& delta_tenor, double t = 0);
	// copy constructor
	LARatesPathElementDDLMMCurve(const LARatesPathElementDDLMMCurve& v);
	// Destructor
	virtual ~LARatesPathElementDDLMMCurve();
...
//  QUERY
    ...
    */
    virtual	LARatesPathElementDDLMMCurve&
								operator = (const LARatesPathElementDDLMMCurve& a);
