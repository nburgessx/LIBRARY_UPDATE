...
*/
class AQLPriceArbFreeGenerator : public AQLCoreProcedure
{
public:
//  LIFECYCLE
    // constructor	
    ...
    // destructor	    
    virtual ~AQLPriceArbFreeGenerator();
...
protected:
	// copy constructor    
    AQLPriceArbFreeGenerator(const AQLPriceArbFreeGenerator& p);
	...
	class AQLMathAFCurveCalibrator : public AQLFunctionVector
	{
	public:
		// constructor
		AQLMathAFCurveCalibrator(
			...
			bool isUSD_);
		// destructor
		virtual ~AQLMathAFCurveCalibrator(){}
