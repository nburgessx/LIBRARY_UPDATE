...
// LAPricePayOff's function id
#define FN_IR_PAYOFF		2002
// LAPricePayOff's function name
...
//  LIFECYCLE
	...
	LAPricePayOff();
    // destructor	
	virtual ~LAPricePayOff();
	// copy constructor
	LAPricePayOff(const LAPricePayOff& v);
								//======================================
...
private:
	...
	std::vector<LAPriceEventTool*>		mTriggers;  // triggerTool
	std::vector<LAPriceEventHolder*> mActions; // triggerAction, potiner owner is mTriggers
