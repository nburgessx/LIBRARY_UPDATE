...
//  LIFECYCLE
    ...
    // destructor	
	virtual ~AQLPriceIndexToolBase();
	/*!
		@brief make copy(clone) of this class
	    @return deep copy of this class
	*/
	virtual AQLPriceIndexToolBase*		clone() const = 0;
	/*!
	...
	*/
	void							round(double& index) const
									{									
										if (!mIsRound) return;
										index = AQLPriceCFGenUtility::round(index, mRoundFunction, mRoundDigit);	
									}
	// get DF ratio
...
class AQLPriceIndexTool : public AQLPriceIndexToolBase 
{
public:
//  LIFECYCLE
    // constructor	
	AQLPriceIndexTool();
    // destructor	
	virtual ~AQLPriceIndexTool();
	// make copy(clone) of this class
	virtual AQLPriceIndexToolBase*		clone() const;// %%% COVARIANT RETURN %%%
	virtual bool                	isTypeOf(index_t id) const {return id == INDEX_TOOL ? true : AQLPriceIndexToolBase::isTypeOf(id);};
	// calculate index
	...
	*/	
	...
	const AQLMathIndexEntity* getIndexEntity(void) const {return mpIndex;}// index
...
protected:
	...
	*/
	...
	const AQLMathIndexEntity* mpIndex;// index object
...
*/
class AQLPriceIndexToolFixed : public AQLPriceIndexToolBase 
{
public:
//  LIFECYCLE
    // constructor	
	AQLPriceIndexToolFixed();
    // destructor	
	virtual ~AQLPriceIndexToolFixed();
	// make copy(clone) of this class
	virtual AQLPriceIndexToolBase*		clone() const;// %%% COVARIANT RETURN %%%
	virtual bool                	isTypeOf(index_t id) const {return id == INDEX_TOOLFIXED ? true : AQLPriceIndexToolBase::isTypeOf(id);};
	/*!
		@brief calculate index
		@return index
	*/	
...
*/
class AQLPriceIndexToolCpn : public AQLPriceIndexToolBase 
{
public:
//  LIFECYCLE
    // constructor	
    ...
    // destructor	
	virtual ~AQLPriceIndexToolCpn();
	// copy constructor	
	AQLPriceIndexToolCpn(const AQLPriceIndexToolCpn& v);
	// make copy(clone) of this class
	virtual AQLPriceIndexToolBase*		clone() const;// %%% COVARIANT RETURN %%%
	virtual bool                	isTypeOf(index_t id) const {return id == INDEX_TOOLCPN ? true : AQLPriceIndexToolBase::isTypeOf(id);};
	/*!
		@brief calculate index
		@return index
	*/	
...
protected:
	...
	const AQLPricePayOff* mPayOff;// payoff 
...
*/
class AQLPriceIndexToolCpnCF : public AQLPriceIndexToolCpn 
{
public:
//  LIFECYCLE
    // constructor	
	AQLPriceIndexToolCpnCF();
    // destructor	
	virtual ~AQLPriceIndexToolCpnCF();
	// Make copy(clone) of this class
	virtual AQLPriceIndexToolBase*		clone() const;// %%% COVARIANT RETURN %%%
	virtual bool                	isTypeOf(index_t id) const {return id == INDEX_TOOLCPNCF ? true : AQLPriceIndexToolCpn::isTypeOf(id);};
	// calculate index
	virtual double					calcIndex(void) const
									{
										double index;
...
class AQLPriceIndexToolCompound : public AQLPriceIndexTool
{
public:
	AQLPriceIndexToolCompound();
	virtual ~AQLPriceIndexToolCompound();
	virtual AQLPriceIndexToolBase* clone() const;// %%% COVARIANT RETURN %%%
	virtual bool isTypeOf(index_t id) const {return id == INDEX_TOOLLIBORCOMPOUND ? true : AQLPriceIndexTool::isTypeOf(id);};
