#ifndef AQLPriceCMSSpreadTools_h
#define AQLPriceCMSSpreadTools_h
...
class AQLPriceCMSMLATMTarget;

class AQLPriceCMSSpreadUtility
{
public:
    ...
    static AQLPriceCMSMLATMTarget WarmUpMLPrice(AQLDataInstance* dataInstance, const AQLString& tenor1, const AQLString& tenor2,
                                          const AQLString& expiryTerm, const AQLStringMatrix& pricingConfig,
                                          const AQLStringMatrix& legScheduler, const AQLStringMatrix& cmsScheduler,
                                          const AQLString& proxySpreadID);
...
class AQLPriceCMSMLATMTarget : public AQLFunction
{
public:
    AQLPriceCMSMLATMTarget(AQLDataInstance* dataInstance, const AQLString& ccy, AQLDate valDate,
