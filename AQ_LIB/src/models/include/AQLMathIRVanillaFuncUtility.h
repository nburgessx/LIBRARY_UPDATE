#ifndef AQLMathIRVanillaFuncUtility_h
#define AQLMathIRVanillaFuncUtility_h
...
{
public:
	impliedVolFinder(const double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2)
	...
	AQLBlackScholesBase*& _bs;
	AQLBlackScholesBase*& _vega;
...
{
public:
	impliedStraddleVolFinder(const double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2, AQLBlackScholesBase*& p3, AQLBlackScholesBase*& p4)
	...
	double _prem;
	AnalyticParam& _param;
	AQLBlackScholesBase*& _bscall;
	AQLBlackScholesBase*& _vegacall;
	AQLBlackScholesBase*& _bsput;
	AQLBlackScholesBase*& _vegaput;
...
{
public:
	fwdDeltaFinder(const double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2)
	...
	double _target;
	AnalyticParam& _param;
	AQLBlackScholesBase*& _delta;
	AQLBlackScholesBase*& _gamma;

	virtual void calc( const double x, double& pre, double& deri);

};

class AQLSABRCAIntegral: public AQLFunction
{
public:
	AQLSABRCAIntegral(double S0_,double T_,const vector<double>& sabr_params, double threshold_);
	~AQLSABRCAIntegral();
...
class AQLMathIRVanillaFuncUtility
{
public:
	...
	static double getAnnuity(const AQLDate& fromdate, AQLString& term_str, const AQLMathYieldCurve& yc);

	static double getCashSettledAnnuity(const AQLDate& fromdate, AQLString& term_str, const AQLMathYieldCurve& yc, const double swaprate);
	...
	static double optimize(double x1, double x2,double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2);	
	static double optimize2(double x1, double x2, double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2);
	static double optimize(const double x1, const double x2);
	static double optimize(double x1, double x2, double x3, AnalyticParam& param, AQLBlackScholesBase*& p1, AQLBlackScholesBase*& p2, AQLBlackScholesBase*& p3, AQLBlackScholesBase*& p4);

	static int businessDaysBetween(const AQLDate& d1, const AQLDate& d2, const AQLString& calendar);

private:
	AQLMathIRVanillaFuncUtility(void);
	~AQLMathIRVanillaFuncUtility(void);
	AQLMathIRVanillaFuncUtility(const AQLMathIRVanillaFuncUtility &rhs);
	AQLMathIRVanillaFuncUtility &operator=(const AQLMathIRVanillaFuncUtility &rhs);
