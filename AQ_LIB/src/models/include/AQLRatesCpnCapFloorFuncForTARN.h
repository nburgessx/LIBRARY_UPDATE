...
// Funciton ID of AQLRatesCpnCapFloorFuncForTARN
#define FN_CPNCAPFLOORFORTARN	10003
// Function Name of AQLRatesCpnCapFloorFuncForTARN
...
*/
class AQLRatesCpnCapFloorFuncForTARN : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLRatesCpnCapFloorFuncForTARN();
	AQLRatesCpnCapFloorFuncForTARN(const DoubleArray& x); 
	// destructor
	virtual ~AQLRatesCpnCapFloorFuncForTARN();

	// suppress warning C4512
	AQLRatesCpnCapFloorFuncForTARN & operator=( const AQLRatesCpnCapFloorFuncForTARN & ) { return *this; }
