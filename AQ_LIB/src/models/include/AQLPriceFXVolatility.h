...
// ID for AQLPriceFXVolatility
#define FN_FXVOLATILITY	2303 
// Function name for AQLPriceFXVolatility
...
*/
class AQLPriceFXVolatility : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// Default constructor
	AQLPriceFXVolatility(AQLFunctionBase* pVol_fx_and_t, AQLFunctionBase* pVol_t, const DoubleArray& timegrid);
	//	Copy constructor
	AQLPriceFXVolatility(const AQLPriceFXVolatility& v);
	// Destructor
	virtual ~AQLPriceFXVolatility();
