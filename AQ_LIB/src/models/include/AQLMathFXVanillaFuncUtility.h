#ifndef AQLMathFXVanillaUtility_h
#define AQLMathFXVanillaUtility_h
...
//date method
class AQLMathFXVanillaFuncUtility
{
public:
...
private:
	AQLMathFXVanillaFuncUtility(void);
	~AQLMathFXVanillaFuncUtility(void);
	AQLMathFXVanillaFuncUtility(const AQLMathFXVanillaFuncUtility &rhs);
	AQLMathFXVanillaFuncUtility &operator=(const AQLMathFXVanillaFuncUtility &rhs);
};
#endif 