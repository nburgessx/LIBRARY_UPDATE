...
*/
class AQLMathYieldCurve : public AQLObject
{
public:
// LIFECYCLE
	// constructor
	AQLMathYieldCurve(AQLDataInstance* dataInstance, const AQLString *const pCurveType = 0);
	// copy constructor
	AQLMathYieldCurve(const AQLMathYieldCurve& curve);
	// destructor
	virtual ~AQLMathYieldCurve();
...
//  OPERATION 
	...
	double getCurBasisSwapValue(const AQLMathYieldCurve& yc, const AQLDate& valueDate, const AQLDate& startDate, 
	...
	virtual bool operator==(const AQLMathYieldCurve& a) const;
...
public:
	// Default constructor
	AQLMathPathYieldCurve(const AQLMathYieldCurve* yc, double t, DayCount dc);
	// Destructor
	~AQLMathPathYieldCurve();
		
										// Make copy(clone) of this class
	virtual AQLRatesPathElementBase*		clone() const;// %%% COVARIANT RETURN %%%
										//======================================
										// get value
	/*!
		@return yield curve object
	*/
	const AQLMathYieldCurve*			getYC(void) const {return mpYC;}
...
/*	virtual void					set(const void* pdata) 
									{	
										const AQLMathYieldCurve* pdata_YC = reinterpret_cast<const AQLMathYieldCurve*>(pdata); 
...
private:
	const AQLMathYieldCurve*	mpYC;		// pointer to AQLMathYieldCurve class
