...
// Funciton ID of AQLMathVolFuncFXVannaVolga
#define FN_VOLFUNCFXVANNAVOLGA	10062
// Function Name of AQLMathVolFuncFXVannaVolga
...
class AQLMathVolFuncFXVannaVolga : public AQLFunctionBase
{
public :
//  LIFECYCLE
	// constructor
	explicit AQLMathVolFuncFXVannaVolga(AQLDataInstance* dataInstance, const ATMInterpolationMethod &atmMethod,
	...
	//AQLMathVolFuncFXVannaVolga(mpDataInstance,mAtmMethod,mFxParams,mSmileData,mMatuTerms365,
	//												mdYieldDataName,mfYieldDataName,mSpotRate);
	
	// destructor
	virtual ~AQLMathVolFuncFXVannaVolga(void);
	// copy constructor
	AQLMathVolFuncFXVannaVolga(const AQLMathVolFuncFXVannaVolga &rhs);
