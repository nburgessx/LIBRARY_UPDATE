...
#ifndef AQLPriceIRVegaUnderlyingAsset_h
#define AQLPriceIRVegaUnderlyingAsset_h
...
class AQLPriceIRVegaUnderlyingAsset
{
public:
	virtual ~AQLPriceIRVegaUnderlyingAsset()
	{}
...
// An implementation of AQLPriceIRVegaUnderlyingAsset
// for already set-up calib-info entities.
class AQLPriceOriginalIRSABRUnderlyingAsset : public AQLPriceIRVegaUnderlyingAsset
{
...
public:
	...
	AQLPriceOriginalIRSABRUnderlyingAsset(
...
// Data names of risk entities referenced by AQLPriceAnotherUnderlyingAsset STARTS HERE
...
// Data names of risk entities referenced by AQLPriceAnotherUnderlyingAsset ENDS HERE

// An implementation of AQLPriceIRVegaUnderlyingAsset
// for arbitrary underlying assets after risk entities.
class AQLPriceAnotherUnderlyingAsset : public AQLPriceIRVegaUnderlyingAsset
{
	AQLDataInstance* mDataInstance;
	AQLString mCurveID;
	AQLDate mBaseDate;
...
public:
	...
	// @param info
	//     The risk object
	AQLPriceAnotherUnderlyingAsset(const AQLDate& baseDate, const AQLString& curveID, AQLObject& info);
