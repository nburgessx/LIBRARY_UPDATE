#ifndef AQLMathBoundaryConstraintVolLMMQlib_h
#define AQLMathBoundaryConstraintVolLMMQlib_h

#include "AQLQuantLibConstraint.h"

// %Constraint of vol_LMM_model1_V
class AQLMathBoundaryConstraintLMMVolVQlib : public QuantLib::Constraint
{
public:
    AQLMathBoundaryConstraintLMMVolVQlib(double low, double high)
    :
    QuantLib::Constraint(boost::shared_ptr<QuantLib::Constraint::Impl>( new AQLMathBoundaryConstraintLMMVolVQlib::Impl(low, high) ) )
    {
    }
...
//----------
//
class AQLMathBoundaryConstraintLMMVolFQlib : public QuantLib::Constraint
{
public:
    AQLMathBoundaryConstraintLMMVolFQlib(double low, double high)
    :
    QuantLib::Constraint(boost::shared_ptr<QuantLib::Constraint::Impl>( new AQLMathBoundaryConstraintLMMVolFQlib::Impl(low, high) ) )
    {
    }
...
//----------
//
class AQLMathBoundaryConstraintLMMVolGQlib : public QuantLib::Constraint
{
public:
    AQLMathBoundaryConstraintLMMVolGQlib(double low, double high, size_t G_size_, double smooth_bound_ = numeric_limits<double>::max())
    :
    QuantLib::Constraint(boost::shared_ptr<QuantLib::Constraint::Impl>( new AQLMathBoundaryConstraintLMMVolGQlib::Impl(low, high, G_size_, smooth_bound_) ) )
    {
    }
