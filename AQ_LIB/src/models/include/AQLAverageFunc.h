...
// Funciton ID of AQLAverageMethod
#define FN_AVERAGE	1213
// Function Name of AQLAverageMethod
...
*/
class AQLAverageMethod : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLAverageMethod();
	// destructor
	virtual ~AQLAverageMethod();

	// assignment operator
	AQLAverageMethod & operator=( const AQLAverageMethod & ) { return *this; }
