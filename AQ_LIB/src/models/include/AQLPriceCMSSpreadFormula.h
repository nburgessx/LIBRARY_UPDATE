#ifndef AQLPriceCMSSpreadFormula_h
#define AQLPriceCMSSpreadFormula_h
...
class AQLPriceCMSSpreadFormula
{
public:
...
class AQLPriceCMSSpreadCallPricer : public AQLFunction
{
public:
    AQLPriceCMSSpreadCallPricer() {}
    AQLPriceCMSSpreadCallPricer(double t_, double K_, double alpha_, double beta_, double S1_, double S2_, double vol1_, double vol2_);
