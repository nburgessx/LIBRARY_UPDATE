...
// Funciton ID of LAProductMethod
#define FN_PRODUCT	1217
// Function Name of LAProductMethod
...
*/
class LAProductMethod : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	LAProductMethod();
	// destructor
	virtual ~LAProductMethod();

	// assignment operator
	LAProductMethod & operator=( const LAProductMethod & ) { return *this; }
