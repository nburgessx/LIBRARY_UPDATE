#ifndef AQLMathArbitrageFreeCurve_h
#define AQLMathArbitrageFreeCurve_h
...
*/
class AQLMathArbitrageFreeCurve
{
public:
	// constructor
	AQLMathArbitrageFreeCurve(AQLDataInstance* dataInstance,const AQLString& curveName);
	// copy constructor
	AQLMathArbitrageFreeCurve(const AQLMathArbitrageFreeCurve& curve);
	// destructor
	virtual ~AQLMathArbitrageFreeCurve();
