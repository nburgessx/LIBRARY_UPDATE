#ifndef AQLPriceFXSingleBarrierOptionValue_h
#define AQLPriceFXSingleBarrierOptionValue_h
...
class AQLPriceFXSingleBarrierOptionValue : public AQLPriceFXOptionValue
{
public:
	// Default constructor
