...
*/
class AQLLinearRegression
{
public:
//  LIFECYCLE
	// constructor
	AQLLinearRegression(bool isExcludeOutlier_Y = false, double criteria_Y = 5, bool isExcludeOutlier_X = false, double criteria_X = 5, bool isExcludeOutlier_e = false, double criteria_e = 5, double SVDTolerance = 1.E-13);
	// Destructor
	virtual ~AQLLinearRegression();
