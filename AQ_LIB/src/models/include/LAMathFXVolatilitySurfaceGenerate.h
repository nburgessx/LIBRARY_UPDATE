/*!
    \file LAMathFXVolatilitySurfaceGenerate.h
    \brief
    \authorb kikuchei
    \date 2009/4/14
    \version 1.0
...
public:
	...
	static double FindHighButterfly( const InterpolationMethod& method,
                                     ...
                                     bool isWing );
private:
	LAMathFXVolatilitySurfaceGenerate(void);
	~LAMathFXVolatilitySurfaceGenerate(void);
	LAMathFXVolatilitySurfaceGenerate(const LAMathFXVolatilitySurfaceGenerate &rhs);
	LAMathFXVolatilitySurfaceGenerate &operator=(const LAMathFXVolatilitySurfaceGenerate &rhs);
};
#endif