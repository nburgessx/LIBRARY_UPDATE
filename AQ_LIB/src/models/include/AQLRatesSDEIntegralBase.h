...
// ID for AQLRatesSDEIntegralBase
...
*/
class AQLRatesSDEIntegralBase : public AQLCoreFunctionBase
{
public:
//  LIFECYCLE
	// Default constructor
	explicit AQLRatesSDEIntegralBase(SDEINTEGRAL_TYPE type);
	// Default constructor
	explicit AQLRatesSDEIntegralBase(SDEINTEGRAL_TYPE type, const AQLString& sdeAttrName);
	//	Copy constructor
	AQLRatesSDEIntegralBase(const AQLRatesSDEIntegralBase& v);
	// Destructor
	virtual ~AQLRatesSDEIntegralBase();
