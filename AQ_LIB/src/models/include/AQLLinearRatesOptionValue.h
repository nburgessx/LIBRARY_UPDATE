...
class AQLLinearRatesOptionValueDataProvider;


class AQLLinearRatesOptionValue : public AQLCoreValuation
{
public:
	// Default constructor
	...
	virtual std::vector< std::vector<AQLBlackScholesBase* > > getPayoffMethod(AQLObject& object, AQLDataProvider* dp) const;
...
protected:
    ...
    virtual void setUpNumeraireCurrency(const AQLObject& trade, AQLLinearRatesOptionValueDataProvider* dataProvider) const;
...
//protected:
//	// Copy constructor
//	AQLLinearRatesOptionValue(AQLLinearRatesOptionValue& v);
};
