...
// ID for AQLRatesNumeraireBankAccount
#define FN_NUMERAIREBANKACCOUNT	2102 
// Function name for AQLRatesNumeraireBankAccount
...
*/
class AQLRatesNumeraireBankAccount : public AQLRatesNumeraireBase
{
public:
//  LIFECYCLE
	// Default constructor
	explicit AQLRatesNumeraireBankAccount(double T, bool isStochasticIR = true);
	//	Copy constructor
//	AQLRatesNumeraireBankAccount(const AQLRatesNumeraireBankAccount& v);
	// Destructor
	virtual ~AQLRatesNumeraireBankAccount();
