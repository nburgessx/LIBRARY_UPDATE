...
// Funciton ID of AQLSumMethod
#define FN_SUM	1214
// Function Name of AQLSumMethod
#define FN_SUM_STR	"fn_sum"
...
*/
class AQLSumMethod : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLSumMethod();
	// destructor
	virtual ~AQLSumMethod();

	// assignment operator
	AQLSumMethod & operator=( const AQLSumMethod & ) { return *this; }
