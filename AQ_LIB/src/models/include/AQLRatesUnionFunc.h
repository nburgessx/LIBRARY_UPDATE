...
// Funciton ID of AQLRatesUnionFunc
#define FN_UNIONFUNC	10002
// Function Name of AQLRatesUnionFunc
...
*/
class AQLRatesUnionFunc : public AQLFunctionBase
{
public:
//  LIFECYCLE
	// constructor
	AQLRatesUnionFunc();
	// destructor
	virtual ~AQLRatesUnionFunc();

	//20061017--David--Remove warning:C4512
	AQLRatesUnionFunc & operator=( const AQLRatesUnionFunc & ) { return *this; }
