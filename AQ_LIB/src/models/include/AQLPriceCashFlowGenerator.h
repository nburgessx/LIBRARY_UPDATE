...
// Function ID for AQLPriceCashFlowGenerator
#define FN_IR_CASHFLOWGENERATOR		2001
// Function name for AQLPriceCashFlowGenerator
...
*/
class AQLPriceCashFlowGenerator : public AQLCoreProcedure
{
public:
...
//  LIFECYCLE
    ...
    // destructor	
	virtual ~AQLPriceCashFlowGenerator();
...
protected:
    // copy constructor
	AQLPriceCashFlowGenerator(const AQLPriceCashFlowGenerator& p);
...
class AQLPriceCashFlowGenerator::CashletCreator
{
public:
    CashletCreator(const AQLPriceCashFlowGenerator* cf_gen_,
                   AQLObject* leg_);
...
protected:
    const AQLPriceCashFlowGenerator* cf_gen;
    AQLObject* leg;
