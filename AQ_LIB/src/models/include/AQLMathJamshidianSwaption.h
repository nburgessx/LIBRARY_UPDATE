...
#ifndef AQLMathJamshidianSwaption_h
#define AQLMathJamshidianSwaption_h
...
class AQLMathJamshidianSwaption : public AQLCoreValuation
{
public:
	// Default constructor
	AQLMathJamshidianSwaption();
	// Copy constructor
	//AQLMathJamshidianSwaption(AQLMathJamshidianSwaption& v);
	// Destructor
	~AQLMathJamshidianSwaption();
								//======================================
	...
	*/
	class AQLMathJamshidianSwaptionDataProvider : public AQLDataProvider
	{
	public:
		AQLMathJamshidianSwaptionDataProvider();
		
		virtual ~AQLMathJamshidianSwaptionDataProvider(); 
		...
		AQLMathJamshidianRStarFinder* mprStar;
		AQLRatesPathElementCurve* mpCurve;
		AQLRatesPathElementCurve* mpCurve0;
		AQLMathYieldCurve* mpTmpCurve;              // temp curve
		double mWeight;							// weight;
		AQLBlackScholesBase* mAnalyticMethod;
