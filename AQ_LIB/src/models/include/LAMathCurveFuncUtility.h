...
public:
   ...
   static double getBasisSwapValue(AQLDataInstance* dataInstance, const AQLDate& valueDate, const AQLDate& startDate, AQLString& term, const  AQLString& arbFreeCurveID,
	...
	static  LAMathYieldCurve& getYieldCurveForCurveID(AQLDataInstance* dataInstance, const AQLString& curveid);
	static void setCalendarForCurveID(LAMathYieldCurve& yc, const AQLString& calendar);
	static bool setUpForwardDayCount(AQLDataInstance *dataInstance, const AQLString &curveid, const AQLString &curveName, LAMathYieldCurve &yc);
	...
	*/
	...
	static std::tuple<std::vector<double>,std::vector<double>> LAMathCurveFuncUtility::getXY(AQLDataInstance* dataInstance, const AQLString& curveCollection);
