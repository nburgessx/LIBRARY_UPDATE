...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LARatesCpnCapFloorFuncForTARN.cpp
//
//  SYNOPSIS    :       LARatesCpnCapFloorFuncForTARN
...
LARatesCpnCapFloorFuncForTARN::clone() const
{
    try 
	{
		return new LARatesCpnCapFloorFuncForTARN(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
function_t
LARatesCpnCapFloorFuncForTARN::getType() const
{
...
double
LARatesCpnCapFloorFuncForTARN::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
LARatesCpnCapFloorFuncForTARN::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
