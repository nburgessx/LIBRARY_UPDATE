...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLBlackScholesStrangleOption.cpp
//
//  SYNOPSIS    :       AQLBlackScholesStrangleOption
...
using namespace std;
//================ AQLBlackScholesStrangleOption ===================================
/*!
	@brief default constructor
*/
AQLBlackScholesStrangleOption::AQLBlackScholesStrangleOption() 
...
*/
AQLCoreFunctionBase*	
AQLBlackScholesStrangleOption::clone() const
{
    try 
	{
		return new AQLBlackScholesStrangleOption(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLBlackScholesStrangleOption::isTypeOf(function_t id) const
{
	return (id == FN_IR_STRANGLEOPTIONFUNC ? true : AQLBlackScholesCapletOption::isTypeOf(id));
}
...
*/
function_t
AQLBlackScholesStrangleOption::getType() const
{
	return FN_IR_STRANGLEOPTIONFUNC;
}


AQLStringVector 
AQLBlackScholesStrangleOption::getOptionType()
{
...
AQLStringVector 
AQLBlackScholesStrangleOption::getBSComponentVector(AQLString risktype) const
{
	AQLStringVector ret(2);
...
AQLStringVector 
AQLBlackScholesStrangleOption::getBSPayoffComponentVector(AQLString risktype) const
{
	AQLStringVector ret(2);
...
*/
double
AQLBlackScholesStrangleOption::operator()(const DoubleArray& x) const
{
...
//#endif		
	...
	for (unsigned int j = 0; j < 2; ++j)
	{
		...
		param->F = rate;
		//strikes are different beween options
...
AQLBlackScholesStrangleOption::getAnalyticParam(void)
{
	mBSInputParam.clear();
