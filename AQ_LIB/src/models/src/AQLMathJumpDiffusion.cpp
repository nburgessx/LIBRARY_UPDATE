...
void AQLMathJumpDiffusion::SetHestonParams(HestonParams& params, const DoubleMatrix& inputdatas)
{
    //error check
...
void AQLMathJumpDiffusion::SetHestonParams(HestonParams& params, const DoubleVector& inputdatas, double term )
{
    //error check
    if( inputdatas.empty() ) {	throw AQLCoreInvalidData("data size is not supported",__FILE__, __LINE__);}
    for(size_t i=0;i<6;i++)
...
void AQLMathJumpDiffusion::AdjustHestonParam(HestonParams& params, double T)
{
...
void AQLMathJumpDiffusion::SetIntensityParams(IntensityParams& params, DoubleVector inputdatas)
{
...
void AQLMathJumpDiffusion::SetLNParams(LNParams& params, DoubleVector inputdatas)
{
	params.Nu_ = inputdatas[0];
	params.Delta_ = inputdatas[1];
};

DoubleComplex AQLMathJumpDiffusion::MeanJump_LN(DoubleComplex phi, LNParams ln_params)
{
...
void AQLMathJumpDiffusion::SetLEParams(LEParams& params, DoubleVector inputdatas)
{
...
DoubleComplex AQLMathJumpDiffusion::MeanJump_LE(DoubleComplex phi, LEParams le_params)
{
...
DoubleComplex AQLMathJumpDiffusion::Lambda_LN(DoubleComplex phi, LNParams ln_params)
{
	DoubleComplex one = DoubleComplex(1, 0.0);
...
DoubleComplex AQLMathJumpDiffusion::Lambda_LE(DoubleComplex phi, LEParams le_params)
{
...
DoubleComplex AQLMathJumpDiffusion::zeta(DoubleComplex phi, 
				                      double kappa_, 
				                      double epsilon_, 
                                      double rho_
				                      )
...
DoubleComplex AQLMathJumpDiffusion::psi(DoubleComplex phi, 
			                         DoubleComplex zeta, 
			                         double kappa_, 
                                     double epsilon_, 
			                         double rho_, 
...
DoubleComplex AQLMathJumpDiffusion::D(DoubleComplex Lambda, 
				                   double tau_, 
...
DoubleComplex AQLMathJumpDiffusion::C(DoubleComplex Lambda, 
	                               double tau_, 
	                               double kappa_lambda_,
...
DoubleComplex AQLMathJumpDiffusion::B(DoubleComplex psi_plus, 
...
DoubleComplex AQLMathJumpDiffusion::A__(DoubleComplex psi_plus, 
				                     DoubleComplex psi_minus,
                                     DoubleComplex zeta, 
				                     double tau_, 
				                     double kappa_, 
...
DoubleComplex AQLMathJumpDiffusion::A_(DoubleComplex psi_plus, 
				                    DoubleComplex psi_minus,
				                    DoubleComplex zeta, 
				                    double tau_, 
				                    double tau1_, 
...
{
	 return AQLMathJumpDiffusion::A__(psi_plus, psi_minus, zeta, tau_, kappa_, theta_, epsilon_) -
					AQLMathJumpDiffusion::A__(psi_plus, psi_minus, zeta, tau1_, kappa_, theta_, epsilon_); 
};

DoubleComplex AQLMathJumpDiffusion::A(DoubleComplex psi_plus, 
				                   DoubleComplex psi_minus, 
                                   DoubleComplex zeta, 
				                   DoubleVector tau_, 
				                   double kappa_, 
				                   ...
				                   )
{
    ...
    DoubleComplex ret;
	ret = AQLMathJumpDiffusion::A_(psi_plus, psi_minus, zeta, tau_[n-1], tau_[n-1] - tau_[0], kappa_, theta_[0], epsilon_);
    for(size_t i=1;i<n;i++)
	{
        ret += AQLMathJumpDiffusion::A_(psi_plus, psi_minus, zeta, tau_[n-1] - tau_[i-1], tau_[n-1] - tau_[i], kappa_, 
                    theta_[i], epsilon_);
	}
...
DoubleComplex AQLMathJumpDiffusion::G(DoubleComplex phi, 
				                   double T, 
				                   double FX0, 
				                   ...
				                   )
{
    ...
    //Get A,B
    DoubleComplex zeta_ = AQLMathJumpDiffusion::zeta(phi, kappa_, epsilon_, rho_);
    DoubleComplex psi_plus = AQLMathJumpDiffusion::psi(phi, zeta_, kappa_, epsilon_, rho_, 1);
    DoubleComplex psi_minus = AQLMathJumpDiffusion::psi(phi, zeta_, kappa_, epsilon_, rho_, -1);
    DoubleComplex  A_ = AQLMathJumpDiffusion::A(psi_plus, psi_minus, zeta_, T_, kappa_, theta_, epsilon_);
    DoubleComplex  B_ = AQLMathJumpDiffusion::B(psi_plus, psi_minus, zeta_, phi, T);
    ...
    //Get C,D
    DoubleComplex C_ = AQLMathJumpDiffusion::C(Lambda_, T, kappa_lambda_, theta_lambda_);
    DoubleComplex D_ = AQLMathJumpDiffusion::D(Lambda_, T, kappa_lambda_);
...
double AQLMathJumpDiffusion::F_Integral(double z, 
				                     double T, 
				                     double FX0, 
				                     double K, 
                                     const TypeOfJump& type_of_jump, 
				                     ...
				                     )
{
	...
	DoubleComplex G_ = AQLMathJumpDiffusion::G(phi, T, FX0, type_of_jump, heston_params, intensity_arams, jump_params);
...
double AQLMathJumpDiffusion::Get_F(double T, 
			                    double FX0, 
			                    double K,
			                    int sgn,
			                    const TypeOfJump& type_of_jump, 
			                    ...
			                    )
{
	...
	{
        tmp += AQLMathJumpDiffusion::F_Integral(x[i],T, FX0, K, type_of_jump, heston_params, intensity_arams, jump_params) 
                * weight[i];
    }
...
double AQLMathJumpDiffusion::BS_Heston_Jump(double T,
					                     double FX0,
					                     double K, 
					                     double P0,
					                     int sgn,
					                     ...
					                     )
{
	...
	double F = AQLMathJumpDiffusion::Get_F(T, FX0, K, sgn, type_of_jump, heston_params, intensity_arams, jump_params, 144, 1.);
