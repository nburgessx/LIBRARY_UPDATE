...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRatesUnionFunc.cpp
//
//  SYNOPSIS    :       AQLRatesUnionFunc
...
*/
AQLRatesUnionFunc::AQLRatesUnionFunc() 
: AQLFunctionBase()
{
...
*/
AQLCoreFunctionBase*	
AQLRatesUnionFunc::clone() const
{
    try 
	{
		return new AQLRatesUnionFunc(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLRatesUnionFunc::isTypeOf(function_t id) const
{
...
*/
function_t
AQLRatesUnionFunc::getType() const
{
	return FN_UNIONFUNC;
}
...
*/
double
AQLRatesUnionFunc::operator()(const DoubleArray& x) const
{
