...
*/
AQLMathArbitrageFreeCurve::AQLMathArbitrageFreeCurve(AQLDataInstance* dataInstance, const AQLString& curveID)
{
    mName = curveID;
...
/*!
    @brief destructor	
*/
AQLMathArbitrageFreeCurve::~AQLMathArbitrageFreeCurve()
{
}

void 
AQLMathArbitrageFreeCurve::setForecastCurve(AQLDataInstance* dataInstance, const AQLString& curveName)
{
...
double AQLMathArbitrageFreeCurve::getDF(double term)
{
    return mDFData.value(term);
}

double AQLMathArbitrageFreeCurve::getRate(double term, const AQLString curveName)
{
    return mForecastDataMap[curveName].value(term);
}

double 
AQLMathArbitrageFreeCurve::getBasisLegValue
