...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRatesNumeraireBankAccount.cpp
//
//  SYNOPSIS    :       AQLRatesNumeraireBankAccount
...
//================ AQLRatesNumeraireBankAccount ===================================
/*!
	@brief default constructor
	@param[in] T payment time of last forward libor 
	@param[in] isStochasticIR interest rate is stochastic or not
*/
AQLRatesNumeraireBankAccount::AQLRatesNumeraireBankAccount(double T, bool isStochasticIR) 
...
*/
/*AQLRatesNumeraireBankAccount::AQLRatesNumeraireBankAccount(const AQLRatesNumeraireBankAccount& v) 
...
/*!
	@brief destructor
*/
AQLRatesNumeraireBankAccount::~AQLRatesNumeraireBankAccount() 
{
...
*/
AQLCoreFunctionBase*	
AQLRatesNumeraireBankAccount::clone() const
{
    try 
	{
		return new AQLRatesNumeraireBankAccount(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLRatesNumeraireBankAccount::isTypeOf(function_t id) const
{
	return (id==FN_NUMERAIREBANKACCOUNT ? true : AQLRatesNumeraireBase::isTypeOf(id));
}
...
*/
function_t
AQLRatesNumeraireBankAccount::getType() const
{
...
*/
double
AQLRatesNumeraireBankAccount::operator()(double t) const
{
	if (!mIsStochastic)
	{
...
*/
void
AQLRatesNumeraireBankAccount::setCurve(double t, const AQLRatesPathElementCurve* pcurve)
{
...
*/	
void
AQLRatesNumeraireBankAccount::setTerminal(double T) 
{
	mTerminal = T; 
/*	if (mIsStochastic)
	{
...
// calc nuemraire	
void
AQLRatesNumeraireBankAccount::calcNumeraire(void) const
{
...
// set time grid
void
AQLRatesNumeraireBankAccount::setTimeGrid(const DoubleArray &timeGrid) const
{
	if (timeGrid.empty())
	{
...
void
AQLRatesNumeraireBankAccount::setDFRatioForNumeraire() const
{
	if (mTimeGrid.empty())
	{
...
// set df ratio 
void
AQLRatesNumeraireBankAccount::setDFRatio(double t) const
{
	if (mpBasisCurve)
	{      
		if (mTimeGrid.empty())
