...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLPolyFitLS.cpp
//
//  SYNOPSIS    :       AQLPolyFitLS
...
*/
AQLPolyFitLS::AQLPolyFitLS(bool isExcludeOutlier_Y, double criteria_Y, bool isExcludeOutlier_X, double criteria_X, bool isExcludeOutlier_e, double criteria_e, bool isShift_Y, bool isScale_Y, bool isShift_X, bool isScale_X)
...
*/
/*AQLPolyFitLS::AQLPolyFitLS(const AQLPolyFitLS& v) 
...
*/
AQLCoreFunctionBase*	
AQLPolyFitLS::clone() const
{
    try 
	{
		return new AQLPolyFitLS(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLPolyFitLS::isTypeOf(function_t id) const
{
	return (id == FN_POLYFITLS ? true : AQLPolyFitBase::isTypeOf(id));
}
...
*/
void
AQLPolyFitLS::regress(const DoubleArray& y, const DoubleMatrix& x, AQLPolynomialBase& poly, DoubleArray *p_y_t, DoubleMatrix *p_x_t) const
{
	if (x.size() != y.size())
	{
		//error
...
void
AQLPolyFitLS::setRegParam(bool isExcludeOutlier_Y, double criteria_Y, bool isExcludeOutlier_X, double criteria_X, bool isExcludeOutlier_e, double criteria_e, bool isShift_Y, bool isScale_Y, bool isShift_X, bool isScale_X, double SVDTolerance)
{
