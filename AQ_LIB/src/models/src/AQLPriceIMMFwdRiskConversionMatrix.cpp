...
AQLPriceIMMFwdRiskConversionMatrix::AQLPriceIMMFwdRiskConversionMatrix(
...
const AQLStringVector& AQLPriceIMMFwdRiskConversionMatrix::getTerms() const
{
	return mTerms;
}

const DoubleMatrix& AQLPriceIMMFwdRiskConversionMatrix::getDsDfExpanded() const
{
	return mDsDfExpanded;
}

const DateVector& AQLPriceIMMFwdRiskConversionMatrix::getDates() const
{
	return mDates;
}

const DateVector& AQLPriceIMMFwdRiskConversionMatrix::getIMMGridDates() const
{
	return mIMMGridDates;
}

const DoubleMatrix& AQLPriceIMMFwdRiskConversionMatrix::getDfDs() const
{
	return mDfDs;
}

const DoubleMatrix& AQLPriceIMMFwdRiskConversionMatrix::getDsDf() const
{
	return mDsDf;
}

DoubleVector AQLPriceIMMFwdRiskConversionMatrix::apply(const AQLStringVector& riskTerms, const DoubleVector& riskValues) const
{
...
DoubleMatrix
AQLPriceIMMFwdRiskConversionMatrix::calcInverseMatrix(const DoubleMatrix &original)
{
...
DoubleMatrix
AQLPriceIMMFwdRiskConversionMatrix::expand(const DoubleMatrix& dsdf, const DateVector& gridDates, const DateVector& immGridDates)
{
...
*/
DoubleVector
AQLPriceIMMFwdRiskConversionMatrix::expand(const DoubleVector& original, const DateVector& gridDates, const DateVector& immGridDates)
{
