/*! @file
    @brief Source code for class to represent correlation.
			...
			5.IR_CALIBRATION_DATA_FACTORNUM_AFTER(AQLPriceInt)<BR>
			6.IR_CALIBRATION_DATA_FACTORNUM_BEFORE(AQLPriceInt)<BR>
...
*/
AQLMathCorrelation::AQLMathCorrelation(AQLDataInstance* dataInstance) : 
				AQLObject()
{
...
/*!
	...
	@param[in] fx AQLMathCorrelation object
*/
AQLMathCorrelation::AQLMathCorrelation(
	const AQLMathCorrelation& cor) : 
	AQLObject(cor)
{
...
*/
object_t	
AQLMathCorrelation::getType(void) const
{
...
*/
bool
AQLMathCorrelation::isTypeOf(object_t id) const
{
...
*/
const AQLDataString&	
AQLMathCorrelation::getName() const	
{
...
AQLMathCorrelation::getInterpolation() const
{
...
AQLMathCorrelation::getInterpolation()
{
...
*/
const AQLDataBool&
AQLMathCorrelation::getIsMultiVol() const
{
...
*/
AQLDataBool&
AQLMathCorrelation::getIsMultiVol()
{
...
AQLMathCorrelation::getTGrid() const
{
...
AQLMathCorrelation::getOptWeight() const	
{
...
*/
AQLDataDoubleMatrix&	
AQLMathCorrelation::getOptWeight()
{
...
*/
const AQLDataDoubleMatrix&
AQLMathCorrelation::getCorFactors() const
{
...
*/
AQLDataDoubleMatrix&
AQLMathCorrelation::getCorFactors()
{
    return dynamic_cast<AQLDataDoubleMatrix&>(mpCorFactors->get());
}
...
*/
const AQLDataBools&
AQLMathCorrelation::getIsExtraTGrid() const
{
...
*/
AQLDataBools&
AQLMathCorrelation::getIsExtraTGrid()
{
	return dynamic_cast<AQLDataBools&>(mpIsExtraGrid_T->get());
}
...
AQLMathCorrelation::getCorrelationFunc() const
{
...
vector<DoubleMatrix>
AQLMathCorrelation::getFactorLoading(const DoubleArray& grid_t) const
{
	bool isCorInput = dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).get();	
...
*/
void
AQLMathCorrelation::setFactorLoading(const DoubleArray& grid_t, const vector<DoubleMatrix>& loading)
{
...
*/
void
AQLMathCorrelation::setFactorLoading(const DoubleMatrix& loading)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(false);
	dynamic_cast<AQLDataBool&>(mpIsDataInput->get()).set(true);
	dynamic_cast<AQLDataInt&>(mpFactorNum_before->get()).set(loading.size());
...
*/
void
AQLMathCorrelation::setFactorLoading(const vector<vector<AQLFunctionBase*> >& loading)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(false);
...
*/
void
AQLMathCorrelation::setCorrelation(const DoubleArray& grid_t, const vector<DoubleMatrix>& cor)
{
...
*/
void
AQLMathCorrelation::setCorrelation(const DoubleMatrix& cor)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(true);
	dynamic_cast<AQLDataBool&>(mpIsDataInput->get()).set(true);
	dynamic_cast<AQLDataInt&>(mpFactorNum_before->get()).set(cor.size());
...
*/
void
AQLMathCorrelation::setCorrelation(const vector<vector<AQLFunctionBase*> >& cor)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(true);
	dynamic_cast<AQLDataBool&>(mpIsDataInput->get()).set(false);
	dynamic_cast<AQLDataInt&>(mpFactorNum_before->get()).set(cor.size());
...
*/
void
AQLMathCorrelation::setCorrelation(AQLFunctionBase* cor)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(true);
	dynamic_cast<AQLDataBool&>(mpIsDataInput->get()).set(false);
...
*/
void
AQLMathCorrelation::setCorrelation(unsigned int factornum)
{
	dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).set(true);
	dynamic_cast<AQLDataBool&>(mpIsDataInput->get()).set(true);
...
*/
void
AQLMathCorrelation::calcFactorLoading() const
{
	bool isCorInput = dynamic_cast<AQLDataBool&>(mpIsCorInput->get()).get();	
...
*/
DoubleMatrix
AQLMathCorrelation::calcFactorLoading(const DoubleMatrix& corrMat, const DoubleMatrix& initialValue) const
{	
	unsigned int factorNum = dynamic_cast<AQLDataInt&>(mpFactorNum_after->get()).get();

	AQLMathFactorLoadingFunction method;
	...
	return AQLMathFactorLoadingFunction::fromthitaTob(x, corrMat.size(), factorNum);
}
...
vector<vector<AQLFunctionBase*> >
AQLMathCorrelation::calcCorrelationFromFactorLoading() const
{
	unsigned int ai = dynamic_cast<AQLDataInt&>(mpFactorNum_after->get()).get();
	unsigned int bi = dynamic_cast<AQLDataInt&>(mpFactorNum_before->get()).get();
...
*/
vector<vector<AQLFunctionBase*> >
AQLMathCorrelation::calcCorrelationFromCorrelation() const
{
	unsigned int bi = dynamic_cast<AQLDataInt&>(mpFactorNum_before->get()).get();
	vector<vector<AQLFunctionBase*> > ret(bi);
...
*/
void
AQLMathCorrelation::calcFactorLoading(const DoubleMatrix& cor, DoubleMatrix& loading, unsigned int factornum, bool isOptim) const
{
	AQLMathFactorLoadingFunction method;
	...
	else
	{
		...
		DoubleMatrix b = AQLMathFactorLoadingFunction::fromthitaTob(x, cor.size(), factornum);
...
*/
AQLObject* 
AQLMathCorrelation::clone() const
{
    try 
	{
    	AQLMathCorrelation*	pCor = new AQLMathCorrelation(*this);
    	return pCor;
    }
    catch (bad_alloc & e)
	{
	...
	const AQLObject& e)
{
	...
	{
		AQLString err = "Assignement error for AQLMathCorrelation : from ";
...
*/
AQLDataHolder&
AQLMathCorrelation::add(const AQLString& name)
{
...
///////////////AQLMathFactorLoadingFunction class///////////////////////////
/*!
    @brief Default constructor
*/

AQLMathCorrelation::AQLMathFactorLoadingFunction::AQLMathFactorLoadingFunction()
{
}
/*!
    @brief Destructor
...
AQLCoreFunctionBase*
AQLMathCorrelation::AQLMathFactorLoadingFunction::clone() const
{
    try 
	{
		return new AQLMathFactorLoadingFunction(*this);
    }
    catch (bad_alloc & e)
	{
        throw AQLCoreSystemError(e.what(), __FILE__, __LINE__);
...
double
AQLMathCorrelation::AQLMathFactorLoadingFunction::operator()(const DoubleArray& x) const
{
...
double
AQLMathCorrelation::AQLMathFactorLoadingFunction::operator()(const double& x) const
{
	return 0.0;
}
...
*/
void
AQLMathCorrelation::AQLMathFactorLoadingFunction::setCorrelation(const DoubleMatrix& corr)
{
...
*/
void
AQLMathCorrelation::AQLMathFactorLoadingFunction::setOptWeight(const DoubleMatrix& weight)
{
...
*/
void
AQLMathCorrelation::AQLMathFactorLoadingFunction::setFactornum(unsigned int& factornum)
{
...
*/
DoubleMatrix
AQLMathCorrelation::AQLMathFactorLoadingFunction::fromthitaTob(const DoubleArray& thita, unsigned int CorrSize, unsigned int factornum)
{
