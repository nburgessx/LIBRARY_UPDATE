...
*/
double
LAMathJamshidianSwaptionByImplyVol::value(const AQLDate& basedate, AQLObject& object,
...
*/
AQLDataProvider*					
LAMathJamshidianSwaptionByImplyVol::setUpDataProvider(const AQLDate& basedate, AQLObject& object, 
											const AQLDataValuation& att) const
{
	AQLDataHolder* dh;
