...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LARatesPCIntegral.cpp
//
//  SYNOPSIS    :       LARatesPCIntegral
...
*/
LARatesPCIntegral::LARatesPCIntegral(SDEINTEGRAL_TYPE type)
...
*/
LARatesPCIntegral::LARatesPCIntegral(const LARatesPCIntegral& v) 
...
/*!
	@brief destructor
*/
LARatesPCIntegral::~LARatesPCIntegral() 
{
...
LARatesPCIntegral::clone() const
{
    try 
	{
		return new LARatesPCIntegral(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
LARatesPCIntegral::isTypeOf(function_t id) const
{
	return (id==FN_PCINTEGRAL ? true : LARatesSDEIntegralBase::isTypeOf(id));
}
...
*/
function_t
LARatesPCIntegral::getType() const
{
