...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LAPolynomialBase.cpp
//
//  SYNOPSIS    :       LAPolynomialBase
//  DESCRIPTION :       Declaration of base class of polynomial class
//
//  SEE ALSO    :       
//  TYME        :       CLASS
//  STATUS      :       
...
/*!
	@brief destructor
*/
LAPolynomialBase::~LAPolynomialBase() 
{
...
*/
function_t
LAPolynomialBase::getType() const
{
...
*/
double
LAPolynomialBase::operator()(const DoubleArray& x) const
{
	if (!mIsConvert)
	{
...
*/
unsigned int
LAPolynomialBase::combin(unsigned int m, unsigned int n) const
{
	if (m < n)
	{
...
*/
void
LAPolynomialBase::calcTransformedValue(const DoubleArray& y, const DoubleMatrix& x , bool isScale_Y, bool isShift_Y, bool isScale_X, bool isShift_X, DoubleArray& y_t,  DoubleMatrix& x_t)
{
	y_t = y;
	x_t = x;
...
*/
void
LAPolynomialBase::setStandardizationParam(const double shift_y, const double scale_y, const DoubleArray &shift_x, const DoubleArray &scale_x)
{
	mShift_Y = shift_y;
	mScale_Y = scale_y;
	mShift_X = shift_x;
...
*/
void
LAPolynomialBase::getStandardizationParam(double &shift_y, double &scale_y, DoubleArray &shift_x, DoubleArray &scale_x) const
{
	shift_y = mShift_Y;
	scale_y = mScale_Y;
	shift_x = mShift_X;
