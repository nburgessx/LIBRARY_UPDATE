...
// constructor
/*!*/
AQLLinearRatesVolatility::AQLLinearRatesVolatility(void)
{}
// destructor
/*!*/
AQLLinearRatesVolatility::~AQLLinearRatesVolatility(void)
...
// ! setupvol
void 
AQLLinearRatesVolatility::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
	return;
}

//================ AQLPricePlainVolatilityFromDirectInput ===================================
// constructor
/*!*/
AQLPricePlainVolatilityFromDirectInput::AQLPricePlainVolatilityFromDirectInput(void)
{}
// destructor
/*!*/
AQLPricePlainVolatilityFromDirectInput::~AQLPricePlainVolatilityFromDirectInput(void)
...
// ! setupvol
void 
AQLPricePlainVolatilityFromDirectInput::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
...
// ! setupvol
void 
AQLPricePlainVolatilityFromDirectInputOfCashlets::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
	AQLLinearRatesOptionValueDataProvider* dataProvider = dynamic_cast<AQLLinearRatesOptionValueDataProvider*>(dp);
...
*/
AQLPriceFXStrangleSolverVolatility::AQLPriceFXStrangleSolverVolatility(void)
:AQLLinearRatesVolatility()
{
}
// destructor
...
// ! setupvol
void 
AQLPriceFXStrangleSolverVolatility::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
	...
	const AQLMathVolFuncFXStrangleSolver& fxvol = dynamic_cast<const AQLMathVolFuncFXStrangleSolver&>(*(dataProvider->mVolfunc));
...
//================ AQLPriceFXStrangleSolverATMVolatility ===================================
// constructor
/*!

*/
AQLPriceFXStrangleSolverATMVolatility::AQLPriceFXStrangleSolverATMVolatility(void)
:AQLLinearRatesVolatility()
{
}
// destructor
...
// ! setupvol
void 
AQLPriceFXStrangleSolverATMVolatility::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
...
*/
AQLPriceFXVannaVolgaVolatility::AQLPriceFXVannaVolgaVolatility(void)
:AQLLinearRatesVolatility()
{
}
// destructor
...
// ! setupvol
void 
AQLPriceFXVannaVolgaVolatility::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
...
//================ AQLPriceIRSABRVolatility ===================================
// constructor
/*!

*/
AQLPriceIRSABRVolatility::AQLPriceIRSABRVolatility(void)
:AQLLinearRatesVolatility()
{
}
// destructor
...
// ! setupvol
void 
AQLPriceIRSABRVolatility::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
	...
	const AQLMathVolFuncIRSABR& irvol = dynamic_cast<const AQLMathVolFuncIRSABR&>(*(dataProvider->mVolfunc));

	const AQLMathYieldCurve &yc = dataProvider->mpvanilla->getIRCurve(dataProvider->mnumerairecur);
	...
	for (unsigned int i = 0; i < dataProvider->mParam.size(); i++)
	{
		...
		for (unsigned int j = 0; j < dataProvider->mParam[i].size(); j++)
		{
			...
			else
			{
				...
				volvec[1] = mtenorval;
				volvec[2] = (dataProvider->mIsFRateFromCurve) ? AQLMathSwaptionVolUtility::getForward(	object.getDataInstance(),
...
//================ AQLPricePlainVolatilityPVVolMatrixUse ===================================
// constructor
/*!

*/
AQLPricePlainVolatilityPVVolMatrixUse::AQLPricePlainVolatilityPVVolMatrixUse(void)
:AQLLinearRatesVolatility()
{
}
// destructor
...
// ! setupvol
void 
AQLPricePlainVolatilityPVVolMatrixUse::setVolatility(AQLDataProvider* dp, AQLObject& object, AQLString model)
{
	AQLLinearRatesOptionValueDataProvider* dataProvider = dynamic_cast<AQLLinearRatesOptionValueDataProvider*>(dp);
