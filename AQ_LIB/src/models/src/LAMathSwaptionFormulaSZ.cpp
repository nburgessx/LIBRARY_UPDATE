...
//
DDSZ_util::DDSZ_util(LAMathPathYieldCurve& curve_d_,
...
LAMathSwaptionFormulaSZ::LAMathSwaptionFormulaSZ(LAMathPathYieldCurve& curve_d_,
     									 LAMathPathYieldCurve& curve_f_,
										 vector<double> T_param_,
										 vector<double> beta_,
										 double rho_,
...
int_multi(new LAMathIntegralMulti())
{
	cathe_q1[0.] = 0.;
	cathe_q2[0.] = 0.;
	cathe_q3[0.] = 0.;
...
//
double LAMathSwaptionFormulaSZ::q3( double t )
{
	double q3_;
	//
	vector<AQLFunction*> funcs;
...
//
double LAMathSwaptionFormulaSZ::q3( double ts, double te )
{
	double q3_;
	//
	vector<AQLFunction*> funcs;
...
double LAMathSwaptionFormulaSZ::q4( double t )
{
	double tmp = q1(t);
	return tmp * tmp;
}

double LAMathSwaptionFormulaSZ::q4( double ts, double te )
{
	double tmp = q1(ts, te);
	return tmp * tmp;
}

double LAMathSwaptionFormulaSZ::q5( double t )
{
	double q5_;
...
double LAMathSwaptionFormulaSZ::q5( double ts, double te )
{
	double q5_;
...
double LAMathSwaptionFormulaSZ::q6( double t )
{
	double q6_;
...
double LAMathSwaptionFormulaSZ::q6( double ts, double te )
{
	double q6_;
...
double LAMathSwaptionFormulaSZ::q7( double t )
{
    double tmp = q2(t); 
    return tmp * tmp;
}

double LAMathSwaptionFormulaSZ::q7( double ts, double te )
{
    double tmp = q2(ts,te); 
    return tmp * tmp;
}

double LAMathSwaptionFormulaSZ::q8( double t )
{
	double q8_;
...
double LAMathSwaptionFormulaSZ::q8( double ts, double te )
{
	double q8_;
...
double LAMathSwaptionFormulaSZ::q9( double t )
{
	double q9_;
...
double LAMathSwaptionFormulaSZ::q9( double ts, double te )
{
	double q9_;
...
//
double LAMathSwaptionFormulaSZ::q10( double t )
{
	return q1(t) * q2(t);
}

//
double LAMathSwaptionFormulaSZ::q10( double ts, double te )
{
	return q1(ts,te) * q2(ts,te);
}

//
double LAMathSwaptionFormulaSZ::q11( double t )
{
	double q11_;
...
//
double LAMathSwaptionFormulaSZ::q11( double ts, double te )
{
	double q11_;
...
//
double LAMathSwaptionFormulaSZ::q12( double t )
{
	double q12_;
...
//
double LAMathSwaptionFormulaSZ::q12( double ts, double te )
{
	double q12_;
...
void LAMathSwaptionFormulaSZ::clear_cache()
{
	cathe_Sigma.clear();
