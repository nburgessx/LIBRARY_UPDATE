...
//#include "AQLBasic.h"
//
//#include "AQLMathFXVolSurfUtility.h"
...
//
//double 
//AQLMathFXVolSurfUtility::FindStrikeFromDelta( AQLDataInstance* dataInstance, double delta, double vol, int sgn, 
...
//
//    double logStrike = AQLMathFXVolatilitySurfaceGenerate::FindLogStrikeFromDelta(delta, vol, sgn, fxParam);
//    return exp( logStrike ) * fxParam.F;
//}
//
//void AQLMathFXVolSurfUtility::SetDeltaType( const AQLString& deltaType_str, FXDeltaType& deltaType )
//{
...
//}
//
//AQLString AQLMathFXVolSurfUtility::SetUpFXVolatilitySurface( AQLDataInstance* dataInstance, AQLStringMatrix& volSurfaceInfo, 
...
//    AQLMathFXVolatilitySurfaceGenerate::SetInterpolationMethod( method_str, method );
//
...
//    AQLMathFXVolatilitySurfaceGenerate::SetInterpolationTarget( interpoVariable, target );
//    
//    DoubleVector wfs = AQLCoreUtility::changeDoubleFromString(searchvecbycol(wingFactor,"WINGFACTOR",true));
...
//		for(i=0;i<dataNum;i++)
//		{
//			smDatas[i] = AQLMathFXVolatilitySurfaceGenerate::BuildSmile( smParams[i], fxParams[i], false, 1., AQLString("") );
//
//			for(j=1;j<6;j++)
//			{
...
//        if( isApproximationFlag )
//        {
//            smDatas[i] = AQLMathFXVolatilitySurfaceGenerate::BuildSmile( smParams[i], fxParams[i], isWingFlag, wfs[i], warningMSG );
//        }
//        else
//        {
//            smDatas[i] = AQLMathFXVolatilitySurfaceGenerate::FindStrangleVol( fxParams[i], smParams[i], method, target, 
//                                isWingFlag, wfs[i] );
//        }
//
//        if( isWingFlag )
...
//		AQLDataDoubles& smDatas_att_ = dynamic_cast<AQLDataDoubles& >(dh->get());
//		smDatas_att_.set(smDatas_att);
//		AQLMathFXVolatilitySurfaceGenerate::SmileDataCheck( smDatas[i], isWingFlag );
//
...
//
//void 
//AQLMathFXVolSurfUtility::OutPutVolatilitySurface( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, DoubleVector& ret, 
...
//}
//void 
//AQLMathFXVolSurfUtility::OutPutFXOptionData( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, DoubleVector& ret, size_t& dataNum )
//{
//    AQLObjectPool& objPool = dataInstance->getObjectPool();
//	const AQLObject& e = objPool.getObject( volSurfaceID, ENCHKTYPE_ISDEFINED ).get();
...
//
//double
//AQLMathFXVolSurfUtility::GetVolatility( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, double point, const AQLDate& expiryPoint, 
...
//    AQLMathFXVolatilitySurfaceGenerate::SetATMInterpolationMethod( maturityMethod_str, maturityMethod );
//    //set variable
//    InterpolationVariable variable;
//    AQLMathFXVolatilitySurfaceGenerate::SetInterpolationVariable( variable_str, variable );
//    vector<FXOptionData > fxParams(dataNum);
//    AQLDate maturityDate,deliveryDate;
//    for(i=0; i<dataNum;i ++)
//    {
...
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( AQLMath::log(point/x.F), x.T, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//        else
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( AQLMath::log(point/x.F), x.Days, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//    }
//    else
...
//        if( maturityMethod == TermWeighted || maturityMethod == TermNoWeighted )
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( point, x.T, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//        else
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( point, x.Days, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//    }
//    return ret;
...
//
//double
//AQLMathFXVolSurfUtility::GetVolatility2( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, double point, double expiryPoint, 
...
//        if( maturityMethod == TermWeighted || maturityMethod == TermNoWeighted )
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( AQLMath::log(point / forwardFX), expiryPoint, method, target, variable, 
...
//        if( maturityMethod == TermWeighted || maturityMethod == TermNoWeighted )
//        {
//            ret = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( point, expiryPoint, method, target, variable, 
//                        maturityMethod, fxOptData, smDatas, isWingFlag );
//        }
//        else
//        {
...
//
//double
//AQLMathFXVolSurfUtility::GetATMVolatility( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, 
...
//
//double 
//AQLMathFXVolSurfUtility::GetFXPremiumFromSurface( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, double point, const AQLDate& expiryPoint, 
...
//        if( maturityMethod == TermWeighted || maturityMethod == TermNoWeighted )
//        {
//            V = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( AQLMath::log(point/x.F), x.T, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//        else
//        {
//            V = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( AQLMath::log(point/x.F), x.Days, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//    }
//    else
...
//        if( maturityMethod == TermWeighted || maturityMethod == TermNoWeighted )
//        {
//            V = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( point, x.T, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//        else
//        {
//            V = AQLMathFXVolatilitySurfaceGenerate::GetSurfaceInterpolation( point, x.Days, method, target, variable, 
//                        maturityMethod, fxParams, smDatas, isWingFlag );
//        }
//    }
//
...
//    else if( variable_str == "DELTAPUT" ) { K = AQLMath::exp(  AQLMathFXVolatilitySurfaceGenerate::FindLogStrikeFromDelta(point,V,-1,x) ) * x.F; }
//    else if( variable_str == "DELTACALL" ) { K = AQLMath::exp(  AQLMathFXVolatilitySurfaceGenerate::FindLogStrikeFromDelta(point,V,1,x) ) * x.F; }
//    
//    int sgn;
...
//    }
//
//    return AQLMathFXVolatilitySurfaceGenerate::GetFXOptionPremium( K, V, sgn, x );
//}
//
//void 
//AQLMathFXVolSurfUtility::GetWingFactorFromHeston( AQLDataInstance* dataInstance, AQLStringMatrix& volSurfaceInfo, AQLStringMatrix& fxOptionData, 
...
//
//        //BuildSmile
//        smDatas = AQLMathFXVolatilitySurfaceGenerate::BuildSmile( smParams, fxParams, false, 1., AQLString("") );
//        for(j=0;j<5;j++)
//        {
//            strikes[0][j] = AQLMath::exp( smDatas.logStrikes[j+1] ) * fxParams.F;
//        }
//
//        wfs[i] = AQLMathDisplacedHestonTDP::GetWingFactorFromHeston(fxParams,smParams,smDatas.deltaPuts[3],
//                        hestonParam,smDatas.logStrikes[0],smDatas.logStrikes[1]);
//    }
//}
//
//void 
//AQLMathFXVolSurfUtility::GetMarketDataFromSmileData( AQLDataInstance* dataInstance, const AQLString& volSurfaceID, 
...
//		    mkDatas[i*5+2] = (AQLMathFXVolatilitySurfaceGenerate::FindHighButterfly(method,target,fxParams[i],smDatas[i],isWingFlag))*100;
//		    mkDatas[i*5+3] = (smDatas[i].vols[5] - smDatas[i].vols[1])*100;
//		    mkDatas[i*5+4] = (AQLMathFXVolatilitySurfaceGenerate::FindLowButterfly(method,target,fxParams[i],smDatas[i],isWingFlag))*100;
//        }
//        else
//        {
