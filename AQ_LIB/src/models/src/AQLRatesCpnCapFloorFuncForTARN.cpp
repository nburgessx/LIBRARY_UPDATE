...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRatesCpnCapFloorFuncForTARN.cpp
//
//  SYNOPSIS    :       AQLRatesCpnCapFloorFuncForTARN
...
using namespace std;
//================ AQLRatesCpnCapFloorFuncForTARN ===================================
/*!
	@brief default constructor
*/
AQLRatesCpnCapFloorFuncForTARN::AQLRatesCpnCapFloorFuncForTARN() 
: AQLFunctionBase()
{
...
/*!
	@brief default constructor
*/
AQLRatesCpnCapFloorFuncForTARN::AQLRatesCpnCapFloorFuncForTARN(const DoubleArray& x) 
: AQLFunctionBase()
{
	(void)x;
}
...
*/
AQLCoreFunctionBase*	
AQLRatesCpnCapFloorFuncForTARN::clone() const
{
    try 
	{
		return new AQLRatesCpnCapFloorFuncForTARN(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLRatesCpnCapFloorFuncForTARN::isTypeOf(function_t id) const
{
...
*/
function_t
AQLRatesCpnCapFloorFuncForTARN::getType() const
{
	return FN_CPNCAPFLOORFORTARN;
}
...
*/
double
AQLRatesCpnCapFloorFuncForTARN::operator()(const DoubleArray& x) const
{
...
double
AQLRatesCpnCapFloorFuncForTARN::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
AQLRatesCpnCapFloorFuncForTARN::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
