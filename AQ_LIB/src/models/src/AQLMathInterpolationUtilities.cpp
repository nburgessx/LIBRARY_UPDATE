...
double AQLMathInterpolationUtilities::interpolate( const DoubleArray& xValues, const DoubleArray& yValues, const double & xPoint, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::interpolate( xValues, yValues, xPoint, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

double AQLMathInterpolationUtilities::interpolate( const DoubleArray& xValues, const DoubleArray& yValues, const double & xPoint, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::interpolate( xValues, yValues, std::vector<double>(1, xPoint), interpolationEnum, joinXValue )[0];
}

std::vector<double> AQLMathInterpolationUtilities::interpolate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & xPoints, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::interpolate( xValues, yValues, xPoints, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

std::vector<double> AQLMathInterpolationUtilities::interpolate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & xPoints, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
...
std::shared_ptr<AQLInterpolationBase> AQLMathInterpolationUtilities::buildInterpolator( const DoubleArray& xValues, const DoubleArray& yValues, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
...
double AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const double & xPoint, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, xPoint, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

double AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const double & xPoint, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, std::vector<double>(1, xPoint), interpolationEnum, joinXValue )[0];
}

std::vector<double> AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & xPoints, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, xPoints, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

std::vector<double> AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & xPoints, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	const size_t nPoints = xPoints.size();
...
double AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const double & fromXPoint, const double & toXPoint, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, fromXPoint, toXPoint, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

double AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const double & fromXPoint, const double & toXPoint, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, std::vector<double>(1, fromXPoint), std::vector<double>(1, toXPoint), interpolationEnum, joinXValue )[0];
}

std::vector<double> AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & fromXPoints, const std::vector<double> & toXPoints, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::differentiate( xValues, yValues, fromXPoints, toXPoints, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

std::vector<double> AQLMathInterpolationUtilities::differentiate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & fromXPoints, const std::vector<double> & toXPoints, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
...
double AQLMathInterpolationUtilities::integrate( const DoubleArray& xValues, const DoubleArray& yValues, const double & lowerBound, const double & upperBound, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::integrate( xValues, yValues, lowerBound, upperBound, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

double AQLMathInterpolationUtilities::integrate( const DoubleArray& xValues, const DoubleArray& yValues, const double & lowerBound, const double & upperBound, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::integrate( xValues, yValues, std::vector<double>(1, lowerBound), std::vector<double>(1, upperBound), interpolationEnum, joinXValue )[0];
}

std::vector<double> AQLMathInterpolationUtilities::integrate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & lowerBounds, const std::vector<double> & upperBounds, const StandardString& interpolation, const double & joinXValue )
{
	return AQLMathInterpolationUtilities::integrate( xValues, yValues, lowerBounds, upperBounds, etrading::toInterpolationEnum( interpolation ), joinXValue );
}

std::vector<double> AQLMathInterpolationUtilities::integrate( const DoubleArray& xValues, const DoubleArray& yValues, const std::vector<double> & lowerBounds, const std::vector<double> & upperBounds, const etrading::InterpolationEnum& interpolationEnum, const double & joinXValue )
{
	const size_t nPoints = xValues.size();
...
double AQLMathInterpolationUtilities::monotoneconvex(DoubleVector& xValues, DoubleVector& yValues, double xPoint, double lambda, bool isAllowedNegative, int inputMode, int outputMode)
{
...
double AQLMathInterpolationUtilities::linear(DoubleVector& xValues, DoubleVector& yValues, double xPoint, bool isExtraConstFlag)
{
    double result;
...
double 
AQLMathInterpolationUtilities::linearReverse(DoubleVector& xValues, DoubleVector& yValues, double xPoint, bool isExtraConstFlag)
{
...
double 
AQLMathInterpolationUtilities::spline(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
...
double 
AQLMathInterpolationUtilities::splineReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::monotoneSpline(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
	AQLMonotoneSplineInterpolation interpolator(AQLMonotoneSplineInterpolation::FRITSCH_BUTLAND);
	interpolator.set(xValues,yValues);
	double result = interpolator.value(xPoint);
...
double 
AQLMathInterpolationUtilities::monotoneSplineReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::monotoneParabolic(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
	AQLMonotoneSplineInterpolation interpolator(AQLMonotoneSplineInterpolation::MONOTONE_PARABOLIC);
	interpolator.set(xValues,yValues);
	double result = interpolator.value(xPoint);
...
double 
AQLMathInterpolationUtilities::monotoneParabolicReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::parabolic(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    AQLParabolicInterpolation interpolator;
	interpolator.set(xValues,yValues);
	double result = interpolator.value(xPoint);
...
double 
AQLMathInterpolationUtilities::parabolicReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::linearSpline(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    AQLLinearSplineInterpolation interpolator;
...
double 
AQLMathInterpolationUtilities::linearSplineReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::linearMonotoneSpline(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    AQLLinearMonotoneSplineInterpolation interpolator(AQLMonotoneSplineInterpolation::FRITSCH_BUTLAND);
    interpolator.setJoinDateAsDouble(joinDateAsDouble);
    interpolator.set(xValues,yValues);
...
double 
AQLMathInterpolationUtilities::linearMonotoneSplineReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::linearMonotoneParabolic(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    AQLLinearMonotoneSplineInterpolation interpolator(AQLMonotoneSplineInterpolation::MONOTONE_PARABOLIC);
    interpolator.setJoinDateAsDouble(joinDateAsDouble);
    interpolator.set(xValues,yValues);
...
double 
AQLMathInterpolationUtilities::linearMonotoneParabolicReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint, double joinDateAsDouble)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::constrainedSpline(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
	AQLConstrainedSplineInterpolation interpolator;
	interpolator.set(xValues,yValues);
	double result = interpolator.value(xPoint);
...
double 
AQLMathInterpolationUtilities::constrainedSplineReverse(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
    size_t n = xValues.size();
    DoubleArray array1_(n),array2_(n);
    for(size_t i=0;i<n;i++)
...
double 
AQLMathInterpolationUtilities::step(DoubleArray& xValues, DoubleArray& yValues, double xPoint)
{
	AQLStepInterpolation interpolator;
	interpolator.set(xValues,yValues);
	double result = interpolator.value(xPoint);
...
unsigned int 
AQLMathInterpolationUtilities::searchIndex(const DoubleArray& X, double xPoint)
{
    size_t size = X.size();
...
double 
AQLMathInterpolationUtilities::getLinearInterpolation(double x1, double x2, double y1, double y2, double xPoint)
{
    DoubleArray X(2); X[0] = x1; X[1] = x2;
    DoubleArray Y(2); Y[0] = y1; Y[1] = y2;
	return AQLMathInterpolationUtilities::linear(X,Y,xPoint);
}

DoubleArray 
AQLMathInterpolationUtilities::solve_cubic_equation(double a1, double a2, double a3)
...
DoubleArray 
AQLMathInterpolationUtilities::solve_quadratic_equation(double a1, double a2)
{
	DoubleArray result;
...
AQLMathInterpolationUtilities::createInterpolation(const AQLString &str)
{
