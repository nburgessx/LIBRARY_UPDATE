...
/*!
    ...
    @param[in] tau_
*/
LAMathCapFloor::LAMathCapFloor(LARatesPathElementCurve& curve0_,
...
*/
LAMathCapFloor::LAMathCapFloor(const LAMathCapFloor& rhs)
:
mCurve0( rhs.mCurve0 != 0 ? dynamic_cast<LARatesPathElementCurve*>(rhs.mCurve0->clone()) : 0 ),
mT_fix(rhs.mT_fix),
mT_pay(rhs.mT_pay),
mTau(rhs.mTau),
mn( mT_fix.size() ),
...
*/
LAMathCapFloor& LAMathCapFloor::operator=(const LAMathCapFloor& rhs)
{
    if( this != &rhs)
    {
        delete mCurve0;
...
*/
double LAMathCapFloor::getStdDev( int sgn )
{
    DoubleVector P0(mn);
...
/*!
	...
	@param[in] T_pay
*/
double LAMathCapFloor::getForwardLIBOR( double T_fix, double term_rate, double T_pay ) const
{
    if( T_pay < T_fix )
    {
...
/*!
	...
	@param[in] T_pay
*/
double LAMathCapFloor::getForwardRateValue( double T_fix, double T_pay ) const
{
    if ( T_fix < 0.0 )
    {
        AQLString msg("T_fix < 0.0");
...
/*!
    ...
    @param[in] fix_rate
*/
double LAMathCapFloor::getFRA( double T_fix, double T_pay, double term_acc, double fix_rate ) const
{
...
/*!
    ...
    @param[in] swap_rate
*/
double LAMathCapFloor::getSwapValue( const DoubleVector& T_fix, const DoubleVector& T_pay, const DoubleVector& term, double swap_rate ) const
{
...
/*!
    ...
    @param[in] term_acc
*/
double LAMathCapFloor::getSwapRate( const DoubleVector& T_fix, const DoubleVector& T_pay, const DoubleVector& term_acc ) const
{
...
/*!
	...
	@param[in] T_pay
*/
double LAMathCapFloor::getSwapFloat( const DoubleVector& T_fix, const DoubleVector& T_pay) const
{
    size_t n = T_fix.size();
    if ( T_pay.size() != n )
    {
...
/*!
	...
	@param[in] term_acc
*/
double LAMathCapFloor::getAnnuity( const DoubleVector& T_pay, const DoubleVector& term_acc ) const
{
...
/*!
	@brief constructor
*/
LAMathCapFloorBlackVol::LAMathCapFloorBlackVol()
:
LAMathCapFloor(),
mBlackVol(0.0),
mCloned(false)
...
/*!
    ...
    @param[in] tau_
*/
LAMathCapFloorBlackVol::LAMathCapFloorBlackVol(LARatesPathElementCurve& curve0_,
										   double black_vol_,
										   const DoubleVector& T_fix_,
										   const DoubleVector& T_pay_,
										   const DoubleVector& tau_L,
...
:
LAMathCapFloor(curve0_, T_fix_, T_pay_, tau_L, tau_),
...
:
LAMathCapFloor(curve0_, T_fix_, T_pay_, tau_L, tau_, strike_),
mBlackVol(black_vol_),
mCloned(false)
{
}
...
/*!
	@brief copy constructor
*/
LAMathCapFloorBlackVol::LAMathCapFloorBlackVol(const LAMathCapFloorBlackVol& rhs)
:
LAMathCapFloor(rhs),
...
LAMathCapFloorBlackVol& LAMathCapFloorBlackVol::operator=(const LAMathCapFloorBlackVol& rhs)
{
	if( this != &rhs )
	{
        (*this).LAMathCapFloor::operator = (rhs);
        mBlackVol = rhs.mBlackVol;
	}
	return *this;
}
...
*/
LAMathCapFloorBlackVol* LAMathCapFloorBlackVol::clone() const
{
    return new LAMathCapFloorBlackVol(*this);
}

void LAMathCapFloorBlackVol::getCapletVariance()
{ 
    for(size_t i = 0; i < mn; ++i)
    {
...
/*!
	@brief constructor
*/
LAMathCapFloorVolLMMDiscModel::LAMathCapFloorVolLMMDiscModel()
:
LAMathCapFloor(),
mVolLMM(0),
mCloned(false)
...
/*!
    ...
    @param[in] tau_
*/
LAMathCapFloorVolLMMDiscModel::LAMathCapFloorVolLMMDiscModel(LARatesPathElementCurve& curve0_,
...
/*!
	@brief copy constructor
*/
LAMathCapFloorVolLMMDiscModel::LAMathCapFloorVolLMMDiscModel(const LAMathCapFloorVolLMMDiscModel& rhs)
:
LAMathCapFloor(rhs),
...
LAMathCapFloorVolLMMDiscModel& LAMathCapFloorVolLMMDiscModel::operator=(const LAMathCapFloorVolLMMDiscModel& rhs)
{
	if( this != &rhs )
	{
        (*this).LAMathCapFloor::operator = (rhs);
...
/*!
    ...
    @return Deep copy of this class
*/
LAMathCapFloorVolLMMDiscModel* LAMathCapFloorVolLMMDiscModel::clone() const
{
    return new LAMathCapFloorVolLMMDiscModel(*this);
}
...
*/
void LAMathCapFloorVolLMMDiscModel::getCapletVariance()
{
    for(size_t t_ = 0; t_ < mn; ++t_)
    {
        double t = mT_fix[t_];
        ...
        if( i != 0 && i < T_vol.size() ) i = LAModelUtilities::eq(t, T_vol[i], eps_1W) ? i : --i;
...
*/
double LAMathCapFloorVolLMMDiscModel::getVega()
{
    double tmp = 0;
    for(size_t t_ = 0; t_ < mn; ++t_)
    {
...
/*!
	...
	@param[in] G
*/
void LAMathCapFloorVolLMMDiscModel::setParam(const double Q_,
...
/*!
	...
	@param[in] paramV
*/
void LAMathCapFloorVolLMMDiscModel::setParamV(const DoubleVector& paramV_)
{
...
/*!
	...
	@param[in] paramF
*/
void LAMathCapFloorVolLMMDiscModel::setParamF(const DoubleVector& paramF_)
{
...
/*!
	...
	@param[in] G
*/
void LAMathCapFloorVolLMMDiscModel::setParamG(const DoubleVector& G_)
{
    if( mVolLMM->getG() != G_)
    {
