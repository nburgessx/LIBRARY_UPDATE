...
/*!
	@brief constructor
*/
LARatesCovariance::LARatesCovariance()
...
*/
/*LARatesCovariance::LARatesCovariance(const LARatesCovariance& v)
{
}*/
...
*/
double
LARatesCovariance::getCov (unsigned int i, unsigned int j, double t) const
{
...
*/
double
LARatesCovariance::getIntegratedCov (unsigned int i, unsigned int j, unsigned int pos1, unsigned int pos2) const
{
...
*/
double
LARatesCovariance::getIntegratedCov (unsigned int i, unsigned int j, double t1, double t2) const
{
	if (t1 == t2) return 0.0;
...
*/
void
LARatesCovariance::calcIntegratedCov(const DoubleArray& timegrid, const DoubleArray* pReset_timegrid)
{
