...
const char* AQLMathCurveFuncUtility::YIELD_CURVE_NAME_PREFIX = "YieldCurveFor_";

const char* AQLMathCurveFuncUtility::YIELD_CURVE_PRO_NAME_PREFIX = "PRO_YIELD_";

double 
AQLMathCurveFuncUtility::getParRate(DateVector& datevec, AQLDataInstance* dataInstance, const AQLString& curveid, 
								 AQLString daycount, AQLString interpolation, AQLString foreCurveName, AQLString dfCurveName, bool isFWDInter)
{
	...
	AQLMathYieldCurve& yc = getYieldCurveForCurveID(dataInstance,curveid);
	...
	{
		throw AQLCoreInvalidData("Forward interpolation failed. Check whether the forward rate was generated by AQLMathYieldCurvePro !!",__FILE__,__LINE__);
	}
...
*/
double AQLMathCurveFuncUtility::getStubRate( AQLDataInstance* dataInstance,
...
double 
AQLMathCurveFuncUtility::getParRate( DateVector& fixedAccrualDates,
...
double 
AQLMathCurveFuncUtility::getSwapPV( bool&            isFixedRatePayerSwap,
                                 double&          notional,
...
double 
AQLMathCurveFuncUtility::getSwapDV01( bool             isFixedRatePayerSwap,
                                   double           notional,
                                   DateVector&      fixedAccrualDates,
                                   DateVector&      fixedPaymentDates,
                                   DateVector&      floatFixingDates,
...
double 
AQLMathCurveFuncUtility::getSwapPV01( bool&            isFixedRatePayerSwap,
                                   double&          notional,
                                   DateVector&      fixedAccrualDates,
                                   DateVector&      fixedPaymentDates,
                                   AQLDataInstance*          dataInstance,
...
double 
AQLMathCurveFuncUtility::getAssetSwapSpread( const double&    bondPrice,
                                          DateVector&      fixedAccrualDates,
                                          DateVector&      fixedPaymentDates,
                                          DateVector&      floatFixingDates,
                                          DateVector&      floatAccrualDates,
...
double 
AQLMathCurveFuncUtility::getParRate(AQLDataInstance* dataInstance, const AQLString& curveid, const AQLDate& fromDate, const AQLDate& toDate, 
...
double 
AQLMathCurveFuncUtility::getRate(const AQLDate&  fromdate, AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
                              ...
                              const AQLString* roll_convention)
{
	...
	double ret=0.0;
	if(PARRATE == ratetype)
		ret = AQLMathCurveFuncUtility::getParRate(fromdate,term,dataInstance,curveid,frequency,
	...
	{
		AQLString none(NONE);
		ret = AQLMathCurveFuncUtility::getParRate(fromdate,term,dataInstance,curveid,none,
												daycount,slidingrule,calendar,interpolation,foreCurveName,STD,isFWDInter,roll_convention);
	}
	else if(ZERORATE == ratetype)
		ret = AQLMathCurveFuncUtility::getForwardRate(fromdate,term,dataInstance,curveid,frequency,
													daycount,slidingrule,calendar,interpolation,foreCurveName,isFWDInter);
	
	else if(DF	== ratetype)
	{	
		AQLString daycount(AC_365I);
		ret = AQLMathCurveFuncUtility::getDF(fromdate,term,dataInstance,curveid,daycount,slidingrule,calendar,interpolation,false,dfCurveName);
	}
	else 
...
double
AQLMathCurveFuncUtility::getParRate(AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
...
double
AQLMathCurveFuncUtility::getParRate(const AQLDate& fromdate, AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
					AQLString frequency, AQLString daycount, AQLString slidingrule, 
					AQLString calendar, AQLString interpolation, AQLString foreCurveName, AQLString dfCurveName, bool isFWDInter, const AQLString* roll_convention)
{	
	//change nospace & upper
...
double
AQLMathCurveFuncUtility::getZeroRate(double term, AQLDataInstance* dataInstance,
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiZeroRate(const DoubleArray& term, AQLDataInstance* dataInstance, const AQLString& curveid, 
...
double
AQLMathCurveFuncUtility::getZeroRate(AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid,
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiZeroRate(AQLStringVector term, AQLDataInstance* dataInstance, const AQLString& curveid, AQLString frequency,
...
double
AQLMathCurveFuncUtility::getDF(double term, AQLDataInstance* dataInstance, const AQLString& curveid,
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiDF(const DoubleArray& term, AQLDataInstance* dataInstance, const AQLString& curveid, AQLString daycount, 
...
double
AQLMathCurveFuncUtility::getBasisDF(double term, AQLDataInstance* dataInstance, const AQLString& curveid,
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiBasisDF(const DoubleArray& term, AQLDataInstance* dataInstance, const AQLString& curveid,
									  AQLString daycount, AQLString interpolation)
{
	//change nospace & upper
	upper(daycount);
...
double
AQLMathCurveFuncUtility::getDF(AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid,
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiDF(AQLStringVector term, AQLDataInstance* dataInstance, const AQLString& curveid, AQLString daycount, 
...
double
AQLMathCurveFuncUtility::getDF(const AQLDate& fromdate, const AQLDate& todate, AQLDataInstance* dataInstance, const AQLString& curveid,
							AQLString daycount, AQLString slidingrule, AQLString calendar, AQLString interpolation, 
							bool isbasisflag, AQLString curveName)
{
	//change nospace & upper
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiDF(const DateVector& fromdate, const DateVector& todate, AQLDataInstance* dataInstance, 
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiSpotDiscountFactors( const DateVector& todate,
                                                   AQLDataInstance* dataInstance, 
								                   const AQLString& curveid,
                                                   AQLString daycount,
                                                   AQLString slidingrule, 
...
double
AQLMathCurveFuncUtility::getDF(const AQLDate& fromdate, double term, AQLDataInstance* dataInstance, const AQLString& curveid,
			   AQLString daycount, AQLString slidingrule, AQLString calendar, AQLString interpolation, 
			   bool isbasisflag, AQLString curveName)
{
	//change nospace & upper
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiDF(const DateVector& fromdate, const DoubleArray& term, AQLDataInstance* dataInstance, 
								 const AQLString& curveid, AQLString daycount, AQLString slidingrule, 
								 AQLString calendar, AQLString interpolation, bool isbasisflag, AQLString curveName)
{
	//change nospace & upper
...
double
AQLMathCurveFuncUtility::getDF(const AQLDate& fromdate, AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
							AQLString daycount, AQLString slidingrule, AQLString calendar, AQLString interpolation, 
							bool isbasisflag, AQLString curveName)
{
	//change nospace & upper
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiDF(const DateVector& fromdate, AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
								 AQLString daycount, AQLString slidingrule, AQLString calendar, AQLString interpolation, 
								 bool isbasisflag, AQLString curveName)
{
	//change nospace & upper
...
double
AQLMathCurveFuncUtility::getForwardRate(const AQLDate& fromdate, double term, AQLDataInstance* dataInstance, const AQLString& curveid, 
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiForwardRate(const DateVector& fromdate, double term, AQLDataInstance* dataInstance, 
...
double
AQLMathCurveFuncUtility::getForwardRate(const AQLDate& fromdate, const AQLDate& todate, AQLDataInstance* dataInstance, 
									 const AQLString& curveid, AQLString frequency, AQLString daycount, 
									 AQLString slidingrule, AQLString calendar, AQLString interpolation, 
									 AQLString curveName, bool isFWDInter)
{
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiForwardRate(const DateVector& fromdate, const DateVector& todate, AQLDataInstance* dataInstance, 
										  const AQLString& curveid, AQLString frequency, AQLString daycount, 
										  AQLString slidingrule, AQLString calendar, AQLString interpolation,
										  AQLString curveName, bool isFWDInter, bool useFwdData)
{
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiForwardRatesUsingCurveFrequency( const DateVector& fromdate,
                                                               ...
                                                               bool useFwdData )
{
    ...
    DateVector todate = etrading::AQLDateSchedule::getMultiDate( fromdate, curveFrequency, slidingrule, calendar, nullptr); // rollconvention* = nullptr
...
double 
AQLMathCurveFuncUtility::getForwardRate(const AQLDate& fromdate, AQLString term, AQLDataInstance* dataInstance, const AQLString& curveid, 
									 AQLString frequency, AQLString daycount,  AQLString slidingrule, AQLString calendar,
									 AQLString interpolation, AQLString curveName, bool isFWDInter)
{
	//change nospace & upper
...
DoubleArray 
AQLMathCurveFuncUtility::getMultiForwardRate(const DateVector& fromdate, AQLString term, AQLDataInstance* dataInstance, 
										  const AQLString& curveid, AQLString frequency, AQLString daycount, 
										  AQLString slidingrule, AQLString calendar, AQLString interpolation, 
										  AQLString curveName, bool isFWDInter)
{
...
double	
AQLMathCurveFuncUtility::getGridRate(AQLDataInstance* dataInstance, const AQLString& curveid, AQLString currency,
								  AQLString index, AQLString grid)
{
	...
	{
		AQLDate tmp = etrading::AQLDateSchedule::getAQLDate(grid);
...
//Kondo add
 double 
 AQLMathCurveFuncUtility::getAnnuity(const AQLDate& start, const AQLDate& end, AQLDataInstance* dataInstance, const AQLString& curveid, 
								  ...
								  AQLString daycount, AQLString interpolation, AQLString curveName)
 {
	...
	DateVector datevec = etrading::AQLDateSchedule::generateSchedule(start, end, data_frequency, slidingrule, calendar, firstStubDate, lastStubDate, pday);
 ...
 double
 AQLMathCurveFuncUtility::getAnnuity(const DateVector& datevec, AQLDataInstance* dataInstance, const AQLString& curveid, AQLString daycount, 
...
double 
 AQLMathCurveFuncUtility::getBasisSwapValue
   ...
   const AQLString& slidingrule, const AQLString& calendar, double firstFixingRate, bool isEOMRoll, bool isFRN )
 {
	...
	AQLMathYieldCurve& yc = getYieldCurveForCurveID(dataInstance,arbFreeCurveID);
...
double 
AQLMathCurveFuncUtility::getCurBasisSwapValue
 ...
 const AQLString& daycount, const AQLString& slidingrule, const AQLString& calendar, bool isEOMRoll)
{
	...
	AQLMathYieldCurve& ycDol = getYieldCurveForCurveID(dataInstance,dolArbFreeCurveID);
 ...
 AQLMathYieldCurve& 
 AQLMathCurveFuncUtility::getYieldCurveForCurveID(AQLDataInstance* dataInstance, const AQLString& curveid)
 {
	 ...
	 {
		 return dynamic_cast<AQLMathYieldCurve &>(objPool.getObject(ycname).get());
	 }
	 else
	 {
		 AQLMathYieldCurve* ycp = new AQLMathYieldCurve(dataInstance);
 ...
 */
 bool
 AQLMathCurveFuncUtility::getForwardConvention(AQLDataInstance *dataInstance, const AQLString &curveid, const AQLString &curveName, AQLPriceDataDayCount &dc, AQLPriceDataSlidingRule &sld, AQLPriceDataCalendar &cal, AQLString &accessory)
 {
	...
	else
	{
	 ...
	 //const AQLMathYieldCurvePro *yp = 0;
	 //while (it != referencer.end())
	 //{
		// if ((*it)->isTypeOf(ENTITY_IRYCPRO))
		// {
		//	 const AQLMathYieldCurvePro *yp_ = dynamic_cast<const AQLMathYieldCurvePro *>(*it);
	 ...
	 //{
		...
		//	 {
		//		 const AQLMathYieldCurvePro &yp_ = dynamic_cast<const AQLMathYieldCurvePro &>(object);
		//		 const AQLString market = yp_.getMarketForCurve(curveName);
		//		 if (market != IR_NO_DATA)
		//		 {
		//			 yp = &yp_;
 ...
 */
 bool
 AQLMathCurveFuncUtility::setUpForwardDayCount(AQLDataInstance *dataInstance, const AQLString &curveid, const AQLString &curveName, AQLMathYieldCurve &yc)
 {
	 AQLPriceDataDayCount dc;
  ...
  /*!
	 ...
	 @return bool
 */
 bool AQLMathCurveFuncUtility::setUpForwardDayCount(AQLDataInstance *dataInstance, const AQLString &curveid, const AQLString &curveName, AQLPriceDataDayCount &dc)
 {
	 AQLPriceDataSlidingRule sld;
	 AQLPriceDataCalendar cal;
	 AQLString accessory;
 ...
 void
 AQLMathCurveFuncUtility::setCalendarForCurveID(AQLMathYieldCurve& yc, const AQLString& calendar)
 {
	 try
	 {
	 ...
	 {
		throw AQLCoreSystemError("Error has occured in AQLMathCurveFuncUtility::setCalednarForCurvID.", __FILE__, __LINE__);
	 }
...
*/
void
AQLMathCurveFuncUtility::setUpYieldCurveConvention(const AQLString &foreCurveName, const AQLString &inter, const AQLString &dc, const AQLString &sld, 
...
{
    const AQLDate next_day = etrading::AQLDateSchedule::getDate(d, "1d", "FOLLOWING", cal);
...
*/
bool AQLMathCurveFuncUtility::isFixingInAdvance(const AQLString& fixingAdvanceOrArrears)
{
...
static void updateAccrualFrequency(AQLString& accrualFreq, const AQLString& paymentFreq, bool fixingInAdvance=true)
{
	...
	double accrualFreqInMonths = AQLDateCalculations::getPeriodFrequencyInMonths(accrualFreq);
	if (paymentFreq != AQLString())
	{
		double paymentFreqInMonths = AQLDateCalculations::getPeriodFrequencyInMonths(paymentFreq);
...
static DateVector updatePaymentDates(const DateVector& accrualDates, const DateVector& paymentDates)
{
    ...
    //
void 
AQLMathCurveFuncUtility::generateSwapSchedule( AQLDate          effectiveDate,
...
void 
AQLMathCurveFuncUtility::generateFixedLegSchedule( AQLDate          effectiveDate,
                                                AQLDate          maturityDate,
                                                AQLString        fixedFrequency,
                                                AQLString        fixedAccrualBusinessDayAdjustment,
                                                AQLString        fixedAccrualCalendar,
												...
												AQLString		fixedPaymentFreq)
{
    ...
    //
void 
AQLMathCurveFuncUtility::generateFloatLegSchedule( AQLDate          effectiveDate,
                                                AQLDate          maturityDate,
                                                AQLString        floatFrequency,
                                                AQLString        floatFixingBusinessDayAdjustment,
                                                AQLString        floatFixingCalendar,
...
*/
void AQLMathCurveFuncUtility::validateAndGenerateAccrualStartAndEndDates(DateVector& accrualStartDates,
...
*/
void 
AQLMathCurveFuncUtility::generateAccrualAndPaymentSchedule(DateVector& accrualDates,
...

{
	...
	accrualDates = etrading::AQLDateSchedule::generateSchedule( effectiveDate, 
														  maturityDate,      
														  accrualFrequency,
	...
	DateVector paymentDatesNoLag = etrading::AQLDateSchedule::generateSchedule(effectiveDate, 
													maturityDate,      
													paymentFreq,
	...
	if (paymentLag.size()!= 0 && paymentLag != "0D")
	{
		...
		tempPaymentDates = etrading::AQLDateSchedule::calcDatesWithLag(paymentDatesNoLag,
																	paymentLag,
																	slidingRule,
																	& cal,
...
*      @Return	fixingDates
*/
DateVector AQLMathCurveFuncUtility::getFixingSchedule(const DateVector& accrualDates, 
														...
														bool removeExtraFixingDay)
{
	...
	DateVector fixingDates = etrading::AQLDateSchedule::calcDatesWithLag( datesToUseForFixing,
                                                         fixingLag,
                                                         fixingSlidingRule,
                                                         & fixingCal,
...
*/
void AQLMathCurveFuncUtility::generateFixingSchedule(DateVector&     fixingDates, 
											AQLDate          effectiveDate,
                                            AQLDate          maturityDate,
                                            AQLString        frequency,
											...
											const AQLString&	fixingAdvanceOrArrears)
{
    ...
    ///////////////////////////
    DateVector accrualDates = etrading::AQLDateSchedule::generateSchedule( effectiveDate, 
																	 maturityDate,      
																	 frequency,
...
double
AQLMathCurveFuncUtility::compound(AQLDataInstance* dataInstance,
                           const AQLString& curveID,
						   ...
						   const bool usePDay)
{
    ...
    AQLMathCurveFuncUtility::COMPOUND_TYPE compound_type;
    if(compound_type_str=="NORMAL") compound_type = AQLMathCurveFuncUtility::COMPOUND_NORMAL;
    else if(compound_type_str=="FLAT") compound_type = AQLMathCurveFuncUtility::COMPOUND_FLAT;
    else if(compound_type_str=="SIMPLE") compound_type = AQLMathCurveFuncUtility::COMPOUND_SIMPLE;
    else if(compound_type_str=="AVERAGE") compound_type = AQLMathCurveFuncUtility::AVERAGE;
    else{
        AQLString msg;
...
std::tuple<std::vector<double>,std::vector<double>> AQLMathCurveFuncUtility::getXY(AQLDataInstance* dataInstance, const AQLString& curveCollection)
{
	// , const AQLString& curveType
//	// requires extra parameters already calculated in common library, but access is a real pain	
	AQLMathYieldCurve& yc = AQLMathCurveFuncUtility::getYieldCurveForCurveID(dataInstance,curveCollection);  // curveid = curveCollection
	//AQLString inter =  AQLCoreComponentManager::getInterpolation(interpolation);
