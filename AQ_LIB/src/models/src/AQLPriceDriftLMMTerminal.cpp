...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLPriceDriftLMMTerminal.cpp
//
//  SYNOPSIS    :       AQLPriceDriftLMMTerminal
...
//================ AQLPriceDriftLMMTerminal ===================================
/*!
	@brief default constructor
	@param[in] Q val for displaced diffusion case
*/
AQLPriceDriftLMMTerminal::AQLPriceDriftLMMTerminal(double Q)
...
/*!
	...
	@param[in] Q val for displaced diffusion case
*/
AQLPriceDriftLMMTerminal::AQLPriceDriftLMMTerminal(const AQLString& sdeAttrName, unsigned int i, const DoubleArray& tenor, const DoubleArray& delta_tenor, double Q)
...
*/
AQLPriceDriftLMMTerminal::AQLPriceDriftLMMTerminal(const AQLPriceDriftLMMTerminal& v) 
...
/*!
	@brief destructor
*/
AQLPriceDriftLMMTerminal::~AQLPriceDriftLMMTerminal() 
{
...
*/
AQLCoreFunctionBase*	
AQLPriceDriftLMMTerminal::clone() const	
{
    try 
	{
		return new AQLPriceDriftLMMTerminal(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLPriceDriftLMMTerminal::isTypeOf(function_t id) const
{
	return (id==FN_DRIFTLMMTERMINAL ? true : AQLPriceDriftLMMBase::isTypeOf(id));
}
...
*/
function_t
AQLPriceDriftLMMTerminal::getType() const
{
...
*/
double
AQLPriceDriftLMMTerminal::operator()(const DoubleArray& x) const
{
...
*/
double
AQLPriceDriftLMMTerminal::integral(const std::vector<std::pair<double,double> >& x) const
{
...
*/
void
AQLPriceDriftLMMTerminal::setUp(AQLMathPathEntity& path)
{
