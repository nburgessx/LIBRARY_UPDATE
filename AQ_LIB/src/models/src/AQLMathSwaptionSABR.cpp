...
AQLMathSwaptionMatrix::AQLMathSwaptionMatrix( const DoubleMatrix& mat_, const DoubleVector& expiryVec_,
                                        const DoubleVector& tenorVec_ )
        :mat(mat_),tenorVec(tenorVec_),expiryVec(expiryVec_) {}

AQLMathSwaptionMatrix::~AQLMathSwaptionMatrix(){}

double
AQLMathSwaptionMatrix::lookUpMatrix( double expiry, double tenor )
{
	...
	else index_te = AQLMathInterpolationUtilities::searchIndex(tenorVec, tenor);

	unsigned int index_ex;
	if(expiryVec.front()>=expiry) index_ex = 0;
	else if(expiryVec.back()<=expiry) index_ex = size_ex;
	else index_ex = AQLMathInterpolationUtilities::searchIndex(expiryVec, expiry);
	...
	{
		ret = AQLMathInterpolationUtilities::getLinearInterpolation(tenorVec[index_te-1],tenorVec[index_te],
	...
	{
		ret = AQLMathInterpolationUtilities::getLinearInterpolation(expiryVec[index_ex-1],expiryVec[index_ex],
	...
	{
		double point1 = AQLMathInterpolationUtilities::getLinearInterpolation(tenorVec[index_te-1],tenorVec[index_te],
								mat[index_ex-1][index_te-1],mat[index_ex-1][index_te],tenor);
		double point2 = AQLMathInterpolationUtilities::getLinearInterpolation(tenorVec[index_te-1],tenorVec[index_te],
								mat[index_ex][index_te-1],mat[index_ex][index_te],tenor);
		ret =  AQLMathInterpolationUtilities::getLinearInterpolation(expiryVec[index_ex-1],expiryVec[index_ex],point1,point2,expiry);
	}
    return ret; 
}

//AQLMathSABRAlphaMatrix::AQLMathSABRAlphaMatrix( const DoubleMatrix& mat, const DoubleVector& expiryVec,
//                                          const DoubleVector& tenorVec )
//                                          : AQLMathSwaptionMatrix(mat, expiryVec, tenorVec)
//{
//    for(size_t i=0; i<mat.size(); i++)
//        for(size_t j=0; j<mat[0].size(); j++)
//            if(mat[i][j]<-0.00001) throw AQLCoreInvalidData("alpha is negative.",__FILE__,__LINE__);
//}
//AQLMathSABRAlphaMatrix::~AQLMathSABRAlphaMatrix(){}
//
//AQLMathSABRBetaMatrix::AQLMathSABRBetaMatrix( const DoubleMatrix& mat, const DoubleVector& expiryVec,
//                                        const DoubleVector& tenorVec )
//                     : AQLMathSwaptionMatrix(mat, expiryVec, tenorVec)
//{
//    for(size_t i=0; i<mat.size(); i++)
...
//}
//AQLMathSABRBetaMatrix::~AQLMathSABRBetaMatrix(){}
//
//AQLMathSABRNuMatrix::AQLMathSABRNuMatrix( const DoubleMatrix& mat, const DoubleVector& expiryVec,
//                                    const DoubleVector& tenorVec )
//                                    : AQLMathSwaptionMatrix(mat, expiryVec, tenorVec)
//{
//    for(size_t i=0; i<mat.size(); i++)
...
//}
//AQLMathSABRNuMatrix::~AQLMathSABRNuMatrix(){}
//
//AQLMathSABRRhoMatrix::AQLMathSABRRhoMatrix( const DoubleMatrix& mat, const DoubleVector& expiryVec,
//                                      const DoubleVector& tenorVec )
//                                      : AQLMathSwaptionMatrix(mat, expiryVec, tenorVec)
//{
//    for(size_t i=0; i<mat.size(); i++)
...
//}
//AQLMathSABRRhoMatrix::~AQLMathSABRRhoMatrix(){}
