...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LABlackScholesStrangleOption.cpp
//
//  SYNOPSIS    :       LABlackScholesStrangleOption
...
*/
LABlackScholesStrangleOption::LABlackScholesStrangleOption() 
...
*/
AQLCoreFunctionBase*	
LABlackScholesStrangleOption::clone() const
{
    try 
	{
		return new LABlackScholesStrangleOption(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
LABlackScholesStrangleOption::isTypeOf(function_t id) const
{
	return (id == FN_IR_STRANGLEOPTIONFUNC ? true : LABlackScholesCapletOption::isTypeOf(id));
}
...
*/
function_t
LABlackScholesStrangleOption::getType() const
{
...
AQLStringVector 
LABlackScholesStrangleOption::getOptionType()
{
...
AQLStringVector 
LABlackScholesStrangleOption::getBSComponentVector(AQLString risktype) const
{
	AQLStringVector ret(2);
...
AQLStringVector 
LABlackScholesStrangleOption::getBSPayoffComponentVector(AQLString risktype) const
{
	AQLStringVector ret(2);
...
*/
double
LABlackScholesStrangleOption::operator()(const DoubleArray& x) const
{
...
LABlackScholesStrangleOption::getAnalyticParam(void)
{
	mBSInputParam.clear();
