...
LAStringVector 
LABlackScholesStrangleOption::getBSComponentVector(LAString risktype) const
{
	LAStringVector ret(2);
...
LAStringVector 
LABlackScholesStrangleOption::getBSPayoffComponentVector(LAString risktype) const
{
	LAStringVector ret(2);
