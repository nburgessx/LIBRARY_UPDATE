...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLRatesRangeCountFunc.cpp
//
//  SYNOPSIS    :       AQLRatesRangeCountFunc
...
#include "AQLRatesRangeCountFunc.h"
#include <algorithm>

using namespace std;
//================ AQLRatesRangeCountFunc ===================================
/*!
	@brief default constructor
*/
AQLRatesRangeCountFunc::AQLRatesRangeCountFunc() 
: AQLFunctionBase()
{
...
*/
AQLCoreFunctionBase*	
AQLRatesRangeCountFunc::clone() const
{
    try 
	{
		return new AQLRatesRangeCountFunc(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLRatesRangeCountFunc::isTypeOf(function_t id) const
{
...
*/
function_t
AQLRatesRangeCountFunc::getType() const
{
...
*/
double
AQLRatesRangeCountFunc::operator()(const DoubleArray& x) const
{
	if (mParam.size() != 3)
...
double
AQLRatesRangeCountFunc::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
AQLRatesRangeCountFunc::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
