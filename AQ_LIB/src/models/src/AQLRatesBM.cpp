...
*/
AQLRatesBM::AQLRatesBM(const DoubleArray& timegrid, const AQLRandBase& rand, unsigned int factor_num)
...
*/
AQLRatesBM::AQLRatesBM(const DoubleArray& timegrid, const AQLRandBase& rand, const std::vector<DoubleMatrix>& loading)
...
/*!
	...
	@param[in] loading factor loading(i * j * time)
	@param[in] deleteflag delete flag of input AQLRatesBM	
*/
AQLRatesBM::AQLRatesBM(vector<pair<AQLRatesBM*, unsigned int> >& bm, 
...
*/
AQLRatesBM::AQLRatesBM(const AQLRatesBM& v)
...
/*!
	...
	@return Adress to AQLRatesBM
*/
AQLRatesBM*
AQLRatesBM::clone() const
{
    try
    {
		return new AQLRatesBM(*this);
    }
    catch (bad_alloc &e)
	{
...
*/
const DoubleArray&
AQLRatesBM::getTimeGrid (void) const
{
...
*/
void
AQLRatesBM::calcBM(bool isIdling)
{
	if (isIdling)
	{
		if (mType == GENERATOR)
...
*/		
void
AQLRatesBM::setAntithetic(bool flag)
{
	mIsAntithetic = flag;
...
*/
void
AQLRatesBM::setSeed(const UlongArray& seedValue)
{
	if (mType == GENERATOR)
...
*/
/*void
AQLRatesBM::setDim(const UintArray& dimValue)
{
	if (mType == GENERATOR)
...
*/
DoubleArray
AQLRatesBM::calcCorrelation(const AQLRatesBM& bm, unsigned int pos_other, unsigned int pos_this) const
{
...
AQLRatesBM::getReferenceBM()
{
	...
	for (unsigned int i = 0; i < mBM.size(); i++)
	{
		...
		set<AQLRatesBM*> bms = mBM[i].first->getReferenceBM();
...
*/
bool
AQLRatesBM::isGeneratorType(void) const
{
