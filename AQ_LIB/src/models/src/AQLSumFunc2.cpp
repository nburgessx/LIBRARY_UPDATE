...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       AQLSumMethod2.cpp
//
//  SYNOPSIS    :       AQLSumMethod2
...
*/
AQLCoreFunctionBase*	
AQLSumMethod2::clone() const
{
    try 
	{
		return new AQLSumMethod2(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLSumMethod2::isTypeOf(function_t id) const
{
...
*/
double
AQLSumMethod2::operator()(const DoubleArray& x) const
{
	double ret = 0.0;
...
double
AQLSumMethod2::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
AQLSumMethod2::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
...
/*
bool
AQLSumMethod2::isDifferentiable(const DoubleArray& x, unsigned int pos) 
const
{
...
/*
bool
AQLSumMethod2::isDifferentiable(const DoubleArray& x, unsigned int posi, unsigned int posj) 
const
{
