...
AQLMathConstraintSZ::AQLMathConstraintSZ(double max_beta, double min_beta,
...
:
Constraint(boost::shared_ptr<QuantLib::Constraint::Impl>( new AQLMathConstraintSZ::Impl(max_beta, min_beta,
										 							    max_theta, min_theta,
																					  max_kappa, min_kappa,
...
//
AQLMathConstraintSZ::Impl::Impl(double max_beta_, double min_beta_,
...
//
AQLMathConstraintSZ::Impl::Impl( const Impl& rhs )
:
...
//
AQLMathConstraintSZ::Impl::~Impl()
{
}


bool AQLMathConstraintSZ::Impl::test(const Array& p) const
{
 	//double m = p.size();
