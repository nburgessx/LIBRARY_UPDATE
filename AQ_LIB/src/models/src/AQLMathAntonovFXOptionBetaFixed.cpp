...
AQLMathAntonovFXOptionBetaFixed::AQLMathAntonovFXOptionBetaFixed()
: AQLMathAntonovFXOption()
{}

AQLMathAntonovFXOptionBetaFixed::AQLMathAntonovFXOptionBetaFixed(const AQLMathAntonovFXOptionBetaFixed& v)
...
function_t
AQLMathAntonovFXOptionBetaFixed::getType() const
{
	return FN_ANTONOVFXOPTIOINBETAFIXED;
}

AQLCoreFunctionBase*
AQLMathAntonovFXOptionBetaFixed::clone() const
{
    try 
	{
		return new AQLMathAntonovFXOptionBetaFixed(*this);
    }
    catch (bad_alloc & e)
	{
...
void			
AQLMathAntonovFXOptionBetaFixed::setCalibParamFirst(AQLMathAntonovFXOptionDataProvider* dataProvider, double vol, double beta) const
{
...
void			
AQLMathAntonovFXOptionBetaFixed::setCalibParam(AQLMathAntonovFXOptionDataProvider* dataProvider, double vol, double beta) const
{
	for(unsigned int i=dataProvider->mSpos ;i<= dataProvider->mEpos;i++)
	{
