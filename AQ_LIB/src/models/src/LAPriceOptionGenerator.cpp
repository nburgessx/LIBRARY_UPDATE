...
*/
void
LAPriceOptionGenerator::registerData(AQLPriceDataManager& dm) const
{
...
*/
void	            
LAPriceOptionGenerator::calibrateModel(const AQLDate& basedate, 
										AQLObject& object, 
...
*/
void
LAPriceOptionGenerator::createOptions(AQLObject& leg, AQLObject& trade) const  
{
	AQLDataHolder* dh;
...
*/
void
LAPriceOptionGenerator::setUpLegMaturity(AQLObject& trade) const
{
	AQLDataHolder* dh;
	//leg object
