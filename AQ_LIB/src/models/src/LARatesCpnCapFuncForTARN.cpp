...
////X///////////////////X///////////////////////////////X///////////////////
//  NAME        :       LARatesCpnCapFuncForTARN.cpp
//
//  SYNOPSIS    :       LARatesCpnCapFuncForTARN
...
#include "LARatesCpnCapFuncForTARN.h"
#include <algorithm>

using namespace std;
//================ LARatesCpnCapFuncForTARN ===================================
/*!
	@brief default constructor
*/
LARatesCpnCapFuncForTARN::LARatesCpnCapFuncForTARN() 
: LAFunctionBase()
{
...
/*!
	@brief default constructor
*/
LARatesCpnCapFuncForTARN::LARatesCpnCapFuncForTARN(const DoubleArray& x) 
: LAFunctionBase()
{
	(void)x;
}
...
*/
LACoreFunctionBase*	
LARatesCpnCapFuncForTARN::clone() const
{
    try 
	{
		return new LARatesCpnCapFuncForTARN(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
LARatesCpnCapFuncForTARN::isTypeOf(function_t id) const
{
	return (id == FN_CPNCAPFORTARN ? true : LAFunctionBase::isTypeOf(id));
}
...
*/
function_t
LARatesCpnCapFuncForTARN::getType() const
{
...
*/
double
LARatesCpnCapFuncForTARN::operator()(const DoubleArray& x) const
{
...
double
LARatesCpnCapFuncForTARN::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
LARatesCpnCapFuncForTARN::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
