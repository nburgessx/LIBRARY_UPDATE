...
void AQLMathParameterObject::SetParameterMatrix(AQLDataInstance* dataInstance, const AQLString& matID, const AQLString& convID, AQLStringMatrix& mat)
{
...
AQLStringMatrix AQLMathParameterObject::ParameterMatrix(AQLDataInstance* dataInstance, const AQLString& matID)
{
    AQLObjectPool& objPool = dataInstance->getObjectPool();
...
double AQLMathParameterObject::LookUpParameterMatrix(AQLDataInstance* dataInstance, const AQLString& matID, const AQLString& expPoint,
...
double AQLMathParameterObject::LookUpParameterMatrix(AQLDataInstance* dataInstance, const AQLString& matID, AQLDate expDate,
                                                 const AQLString& idxPoint, AQLString interpolationType)
{
    AQLObjectPool& objPool = dataInstance->getObjectPool();
    const DoubleMatrix& dataMatrix = dynamic_cast<AQLDataDoubleMatrix& >
...
AQLStringVector AQLMathParameterObject::ParameterMatrixTerms(AQLDataInstance* dataInstance, const AQLString& matID)
{
    AQLObjectPool& objPool = dataInstance->getObjectPool();
...
AQLStringVector AQLMathParameterObject::ParameterMatrixIndexes(AQLDataInstance* dataInstance, const AQLString& matID)
{
    AQLObjectPool& objPool = dataInstance->getObjectPool();
...
void AQLMathParameterObject::SetMatrixAxis(const AQLString& title, const AQLStringVector& terms, const AQLStringVector& indexes,
...
void AQLMathParameterObject::SetMatrixData(const DoubleMatrix& data, AQLStringMatrix& matrix)
{
...
double MFParameterMatrix::LookUp(double expiry, const AQLString& indexID, AQLString interpolationType)
{
    ...
    return AQLMathInterpolationUtilities::interpolate(mExpiries, mMatrix[idx], expiry, etrading::toInterpolationEnum(interpolationType.c_str()));
}
