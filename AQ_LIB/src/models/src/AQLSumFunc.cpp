...
*/
AQLCoreFunctionBase*	
AQLSumMethod::clone() const
{
    try 
	{
		return new AQLSumMethod(*this);
    }
    catch (bad_alloc & e)
	{
...
*/
bool
AQLSumMethod::isTypeOf(function_t id) const
{
...
*/
double
AQLSumMethod::operator()(const DoubleArray& x) const
{
	double ret = 0.0;
...
double
AQLSumMethod::partialDerivative(const DoubleArray& x, unsigned int pos,
...
*/
double
AQLSumMethod::partialDerivative2(const DoubleArray& x, unsigned int posi, unsigned int posj,
...
/*
bool
AQLSumMethod::isDifferentiable(const DoubleArray& x, unsigned int pos) 
const
{
...
/*
bool
AQLSumMethod::isDifferentiable(const DoubleArray& x, unsigned int posi, unsigned int posj) 
const
{
