...
AQLMathVolFuncWave::AQLMathVolFuncWave(double Tmax, double decay, double amp1, 
...
/*!
	@brief destructor
*/
AQLMathVolFuncWave::~AQLMathVolFuncWave(void)
{
...
*/
AQLMathVolFuncWave::AQLMathVolFuncWave(const AQLMathVolFuncWave &rhs) 
...
*/
AQLCoreFunctionBase*	
AQLMathVolFuncWave::clone() const
{
    try 
	{
		return new AQLMathVolFuncWave(*this);
    }
    catch (bad_alloc &e)
	{
...
*/
bool
AQLMathVolFuncWave::isTypeOf(function_t id) const
{
...
*/
function_t
AQLMathVolFuncWave::getType() const
{
...
*/
double
AQLMathVolFuncWave::operator()(const DoubleArray& x) const
{
...
*/
double
AQLMathVolFuncWave::operator()(double t) const
{
