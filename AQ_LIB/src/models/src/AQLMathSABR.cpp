...
//*/
//AQLMathSABR::AQLMathSABR()
//:alpha(1.),beta(0.5),nu(1.),rho(0.){}
//
//AQLMathSABR::AQLMathSABR(double alpha_, double beta_, double nu_, double rho_)
...
//
//void 
//AQLMathSABR::setSABRParam(double alpha_, double beta_, double nu_, double rho_)
//{
//    alpha = alpha_; beta = beta_; nu = nu_; rho = rho_;
//}
//    
////bool
////AQLMathSABR::checkSABRParam()
////{
...
//}
//
//double AQLMathSABR::getSABRVol(double T, double F, double K)
//{
...
//}
//
//double AQLMathSABR::chi(double z)
//{
...
//}
//
//double AQLMathSABR::getSABRPrem(double T, double F, double K, double Nu, unsigned int sgn)
//{
...
//}
//
//void AQLMathSABR::setAlphaForATMVol(double atmVol, double T, double F, bool isAlpha0Use)
//{
//	double alpha0 = alpha;
...
//	{
//		sol = AQLMathInterpolationUtilities::solve_cubic_equation(a1/a0, a2/a0, a3/a0);
//	}
//	else if( AQLMath::abs(a1) > eps_SABR )
//	{
//		sol = AQLMathInterpolationUtilities::solve_quadratic_equation(a2/a1, a3/a1);
...
//}
//
//bool AQLMathSABR::checkAlphaForATMVol(double atmVol, double T, double F)
//{
//    double a0 = (1.-beta)*(1.-beta)/AQLMath::pow(F, 3.-3.*beta)/24.*T;
//    double a1 = rho*beta*nu/AQLMath::pow(F, 2.-2.*beta)/4.*T;
//    double a2 = (1.+(2.-3.*rho*rho)*nu*nu/24.*T)/AQLMath::pow(F, 1.-beta);
...
double AQLMathSABR::BlackImplVol( double prem, double F, double T, double K, int sgn, double low, double high)
{
...
double AQLMathSABR::BlackPrem( double vol, double F, double T, double K, double Nu, int sgn)
{
...
void AQLMathSABR::set_alpha(double alpha_, bool isMap) 
{ 
...
void AQLMathSABR::set_beta(double beta_, bool isMap) 
{ 
...
void AQLMathSABR::set_nu(double nu_, bool isMap)
{ 
...
void AQLMathSABR::set_rho(double rho_,   bool isMap )
{ 
...
// constructor
AQLMathSABR_Hagan::AQLMathSABR_Hagan(double alpha_, double beta_, double nu_, double rho_, bool isLognormal_)
:
AQLMathSABR(alpha_,beta_,nu_,rho_), isLognormal(isLognormal_)
{
}

AQLMathSABR_Hagan::AQLMathSABR_Hagan(const vector<double>& parameters)
:
AQLMathSABR(parameters[0],parameters[1],parameters[2],parameters[3])
{
}
...
double AQLMathSABR_Hagan::getSABRLognormalVol(double T, double F, double K)
{
	double tmp1 = nu * nu * (2. - 3. * rho * rho) / 24.;
	tmp1 += rho * beta * nu * alpha / AQLMath::pow(F * K, (1. - beta) / 2.) / 4.;
	tmp1 += (1. - beta) * (1. - beta) * alpha * alpha / AQLMath::pow(F * K, (1. - beta)) / 24.;
...
// NORMAL Vol
double AQLMathSABR_Hagan::getSABRNormalVol(double T, double F, double K)
{
...
double AQLMathSABR_Hagan::getSABRVol(double T, double F, double K)
{
	if (isLognormal)
	{
...
double AQLMathSABR_Hagan::getSABRPremLognormalVol(double T, double F, double K, double numeraire, int sgn)
{
	double stdDev = getSABRVol(T, F, K) * AQLMath::sqrt(T);
...
double AQLMathSABR_Hagan::getSABRPremNormalVol(double T, double F, double K, double numeraire, int sgn)
{
...
double AQLMathSABR_Hagan::getSABRPrem(double T, double F, double K, double Nu, int sgn)
{
	if (isLognormal)
	{
...
void AQLMathSABR_Hagan::setAlphaForATMVol(double atmVol, double T, double F, bool isAlpha0Use)
{
	double alpha0 = alpha;
...
bool AQLMathSABR_Hagan::checkAlphaForATMVol(double atmVol, double T, double F)
{
	double a0 = isLognormal ? ((1. - beta) * (1. - beta) / AQLMath::pow(F, 2. - 2. * beta) / 24. * T)
							: (beta * (beta - 2.) / AQLMath::pow(F, 2. - 2. * beta) / 24. * T);
	double a1 = rho * beta * nu / AQLMath::pow(F, 1. - beta) / 4. * T;
...
double AQLMathSABR_Hagan::chi(double z)
{
    double tmp1 = AQLMath::sqrt(1. - 2. * rho * z + z * z);
    if(AQLMath::abs(z)<eps_SABR) return z;
...
//
 // constructor
AQLMathSABR_Antonov::AQLMathSABR_Antonov(double alpha_, double beta_, double nu_, double rho_, int int_step_)
:
AQLMathSABR(alpha_,beta_,nu_,rho_)
{
	sub_func = new swaption_prem_antonov(int_step_);
}

AQLMathSABR_Antonov::AQLMathSABR_Antonov(const AQLMathSABR_Antonov& rhs )
:
...
double AQLMathSABR_Antonov::getSABRVol(double T, double F, double K)
{
	...
	return AQLMathSABR::BlackImplVol(premium,F,T,K,1);
}

double AQLMathSABR_Antonov::getSABRPrem(double T, double F, double K, double Nu, int sgn)
{
	vector<double> sabr_params(4);
	sabr_params[0] = alpha;
	sabr_params[1] = beta;
...
void AQLMathSABR_Antonov::setAlphaForATMVol(double atmVol, double T, double F, bool isAlpha0Use)
{
...
bool AQLMathSABR_Antonov::checkAlphaForATMVol(double atmVol, double T, double F)
{
	return true;
}

//
AQLMathSABR_Antonov::swaption_prem_antonov::swaption_prem_antonov(int int_step_)
:
num_int_step(int_step_),
flg_negative_nu(false)
{
	int_1_.SetFunc(*this, &AQLMathSABR_Antonov::swaption_prem_antonov::int_1);
	int_2_.SetFunc(*this, &AQLMathSABR_Antonov::swaption_prem_antonov::int_2);
}

void AQLMathSABR_Antonov::swaption_prem_antonov::set(double S0_,double T_,const vector<double>& sabr_params)
{
...
double AQLMathSABR_Antonov::swaption_prem_antonov::operator()(double K) const
{
...
double AQLMathSABR_Antonov::swaption_prem_antonov::int_1(double x) const
{
...
double AQLMathSABR_Antonov::swaption_prem_antonov::phi(double s) const
{	
...
double AQLMathSABR_Antonov::swaption_prem_antonov::int_2(double x) const
{
	double eta = fabs( 0.5 / ( beta - 1.) );
	return sin(eta * M_PI) * pow(psi(x), eta) / sinh(x) * G(nu_ * nu_ * T,  x);
}

double AQLMathSABR_Antonov::swaption_prem_antonov::psi(double s) const
{	
...
double AQLMathSABR_Antonov::swaption_prem_antonov::G(double t, double s) const
{
	if( s < std::numeric_limits<double>::epsilon() ) return 1.;
	return sqrt(sinh(s)/s) * exp(-0.5 * s * s / t - t / 8.) * (R(t,s) + dR(t,s));

}
double AQLMathSABR_Antonov::swaption_prem_antonov::R(double t, double s) const
{
	if( s < 0.1 ) s = 0.1;
	double g = s / tanh(s) - 1.;
...
double AQLMathSABR_Antonov::swaption_prem_antonov::dR(double t, double s) const
{
...
//
 // constructor
AQLMathSABR_Chaos::AQLMathSABR_Chaos(double alpha_, double beta_, double nu_, double rho_)
:
AQLMathSABR(alpha_,beta_,nu_,rho_)
{
}

double AQLMathSABR_Chaos::getSABRVol(double T, double F, double K)
{
	vector<double> sabr_params(4);
	sabr_params[0] = alpha;
	sabr_params[1] = beta;
	...
	return AQLMathSABR::BlackImplVol(premium/domesticDF,F,T,K,(int)Sgn);
}

double AQLMathSABR_Chaos::getSABRPrem(double T, double F, double K, double Nu, int sgn)
{
	if(F > 0.)
	{
		double K_ = 1. - K / F;
...
void AQLMathSABR_Chaos::setAlphaForATMVol(double atmVol, double T, double F, bool isAlpha0Use)
{
	class ATMVolCostFunc : public AQLFunction
	{
	public:
...
bool AQLMathSABR_Chaos::checkAlphaForATMVol(double atmVol, double T, double F)
{
	return true;
}
...
AQLMathSABR_Chaos_DD::AQLMathSABR_Chaos_DD(double alpha_, double beta_, double nu_, double rho_)
:
AQLMathSABR_Chaos(alpha_,beta_,nu_,rho_)
{
}

//SABR & DD-SABR WIC Approximation
double 
AQLMathSABR_Chaos_DD::Sigma(double T_) const
{
	double A = alpha;
...
double 
AQLMathSABR_Chaos_DD::q1(double T_) const
{
...
double 
AQLMathSABR_Chaos_DD::q2(double T_) const
{
	double delta = alpha * beta * nu * rho * T_;
...
double 
AQLMathSABR_Chaos_DD::q3(double T_) const
{
    double temp = q1(T_);
    double q3 = temp * temp;
	return q3;
...
double 
AQLMathSABR_Chaos_DD::q4(double T_) const
{
		double delta = alpha * beta * nu * rho * T_;
...
double 
AQLMathSABR_Chaos_DD::q5(double T_) const
{
...
//
AQLMathConvexityAdust_Antonov::AQLMathConvexityAdust_Antonov(double T_,
													   double S0_,
													   double alpha,
													   double beta,
													   double nu,
													   double rho,
													   size_t num_int_step)
: T(T_),S0(S0_),swaption_prem(new AQLMathSABR_Antonov(alpha,beta,nu,rho,num_int_step)) {}

AQLMathConvexityAdust_Antonov::AQLMathConvexityAdust_Antonov(const AQLMathConvexityAdust_Antonov& rhs)
:
T(rhs.T),
S0(rhs.S0)
{
	swaption_prem = new AQLMathSABR_Antonov(rhs.swaption_prem->getAlpha(),
...
//	if(weight.size() != n)
//	{
//		throw invalid_argument(" strike.size() != weight.size() : AQLMathLeastSquareSABRCostFunc::AQLMathLeastSquareSABRCostFunc");
//	}
//	
//	if(param0.size() != 4)
//	{
//		throw invalid_argument("param0.size() != 4 : AQLMathLeastSquareSABRCostFunc::AQLMathLeastSquareSABRCostFunc");
//	}
//
//	if(flg.size() != 4)
//	{
//		throw invalid_argument("flg.size() != 4 : AQLMathLeastSquareSABRCostFunc::AQLMathLeastSquareSABRCostFunc");
//	}
//
...
//		if(sgn[i] != 1 && sgn[i] != -1)
//		{
//			throw invalid_argument("sgn must -1 or 1 : AQLMathLeastSquareSABRCostFunc::AQLMathLeastSquareSABRCostFunc");
//		}
//	}
//
//	alpha = param0[0];
...
//}
//
//QuantLib::Real AQLMathLeastSquareSABRCostFunc::value(const QuantLib::Array& x) const
//{   
//	size_t m = x.size();
//	
//	if(m == 0 || m > 4)
//		throw invalid_argument("m == 0 || m > 4 : AQLMathLeastSquareSABRCostFunc::value");
//
//	set_params(x);
...
//}
//
//QuantLib::Array AQLMathLeastSquareSABRCostFunc::values(const QuantLib::Array& x) const
//{
//	size_t m = x.size();
//	
//	if(m == 0 || m > 4)
...
//}
//
//void AQLMathLeastSquareSABRCostFunc::set_params(const QuantLib::Array& x) const
//{
//	// 1st
//	if(!flg[0])
//	{
...
//				if(!flg[3])
//				{
//					throw invalid_argument("All element of flg is false : AQLMathLeastSquareSABRCostFunc::set_params");
//				}
//				else rho = x[0];
//			}
//			else
...
////								                             double min_rho
////								                            )
////: QuantLib::Constraint(boost::shared_ptr<QuantLib::Constraint::Impl>( new AQLMathLeastSquareSABRConstraint::Impl(param0,
////																											  max_alpha,
////																											  min_alpha,
////																											  max_beta,
////																											  min_beta,
...
//
////
//AQLMathLeastSquareSABRConstraint::Impl::Impl(vector<double>& param0_,
//										  const vector<bool>& flg_,
//										  double max_alpha_,
//							              double min_alpha_,
//							              double max_beta_,
...
////
////
//bool AQLMathLeastSquareSABRConstraint::Impl::test(const QuantLib::Array& p) const
//{
// 	size_t m = p.size();
//	
//	set_params(p);
...
//}
//
//void AQLMathLeastSquareSABRConstraint::Impl::set_params(const QuantLib::Array& x) const
//{
//	// 1st
//	if(!flg[0])
//	{
...
//
////
//AQLMathLeastSquareSABRConstraint_Antonov::Impl::Impl( double fwd_,
...
//
////
//bool AQLMathLeastSquareSABRConstraint_Antonov::Impl::test(const QuantLib::Array& p) const
//{
// 	size_t m = p.size();
//	
//	set_params(p);
...
//}
//
//void AQLMathLeastSquareSABRConstraint_Antonov::Impl::set_params(const QuantLib::Array& x) const
//{
//	if(!flg[0])
//	{
//		if(!flg[1])
...
AQLMathSABRLimiter::AQLMathSABRLimiter(AQLStringMatrix paramFlag)
{
    upper(paramFlag);
    paramNum = 0;
    //alpha
...
void
AQLMathSABRLimiter::getArgument( AQLMathSABR_Hagan sabr, DoubleArray& x, bool isMap )
{
    size_t index=0;
    if( getAlphaFlag() ) 
    {
...
AQLMathSABR_Hagan
AQLMathSABRLimiter::getSABR(AQLMathSABR_Hagan& sabrOri, const DoubleArray& x, bool isMap)
{
    if( x.size() != paramNum ) 
...
bool
AQLMathSABRLimiter::checkArgument(AQLMathSABR_Hagan sabrOri, const DoubleArray& x)
{
	if( x.size() != paramNum ) 
        throw AQLCoreInvalidData("sizes are inconsistent",__FILE__,__LINE__);
...
AQLMathSABRCalibrator::AQLMathSABRCalibrator
...
void
AQLMathSABRCalibrator::operator()(DoubleArray& f, const DoubleArray& x)
{
    f.resize(targetNum);
    AQLMathSABR_Hagan sabrOpt = sabrLimiter.getSABR( sabr, x, isMap );
...
bool
AQLMathSABRCalibrator::constraintsAreViolated( const DoubleArray& x )
{
...
AQLMathSABRCalibratorATMFix::AQLMathSABRCalibratorATMFix
    (const AQLMathSABR_Hagan& sabr_, const DoubleArray& strike_, const DoubleArray& vol_, 
...
void
AQLMathSABRCalibratorATMFix::operator()(DoubleArray& f, const DoubleArray& x)
{
    f.resize(targetNum);
    AQLMathSABR_Hagan sabrOpt = sabrLimiter.getSABR( sabr, x, isMap );
...
bool
AQLMathSABRCalibratorATMFix::constraintsAreViolated( const DoubleArray& x )
{
	AQLMathSABR_Hagan sabrOpt = sabrLimiter.getSABR( sabr, x , isMap );
