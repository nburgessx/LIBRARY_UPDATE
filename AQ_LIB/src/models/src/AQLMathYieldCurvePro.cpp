...
*/
AQLMathYieldCurvePro::AQLMathYieldCurvePro(AQLDataInstance* dataInstance) : 
...
*/
AQLMathYieldCurvePro::AQLMathYieldCurvePro(
	const AQLMathYieldCurvePro& curve) : 
...
*/
object_t	
AQLMathYieldCurvePro::getType(void) const
{
...
*/
bool
AQLMathYieldCurvePro::isTypeOf(object_t id) const
{
...
*/
const AQLDataDate&  
AQLMathYieldCurvePro::getAsOfDate(void) const
{
...
*/
AQLDataDate&  
AQLMathYieldCurvePro::getAsOfDate(void)
{
...
*/
const AQLDataBool&  
AQLMathYieldCurvePro::getIsArbFree(void) const
{
...
*/
AQLDataBool&  
AQLMathYieldCurvePro::getIsArbFree(void)
{
...
AQLMathYieldCurvePro::getMarketData() const
{
...
AQLMathYieldCurvePro::getMarketData()
{
...
AQLMathYieldCurvePro::getBasisRates() const	
{
...
*/
AQLDataDoubleMatrix&
AQLMathYieldCurvePro::getBasisRates() 
{
...
const AQLDataMultiReference&
AQLMathYieldCurvePro::getBasisData() const	
{
...
*/
AQLDataMultiReference&
AQLMathYieldCurvePro::getBasisData() 
{
...
const AQLDataBool&
AQLMathYieldCurvePro::getIsFutureUse() const	
{
...
*/
AQLDataBool&
AQLMathYieldCurvePro::getIsFutureUse() 
{
...
const AQLDataBool&
AQLMathYieldCurvePro::getIsFRAUse() const	
{
...
*/
AQLDataBool&
AQLMathYieldCurvePro::getIsFRAUse() 
{
...
AQLMathYieldCurvePro::getBaseYieldCurve() const	
{
...
*/
AQLDataReference&
AQLMathYieldCurvePro::getBaseYieldCurve() 
{
...
AQLMathYieldCurvePro::getInterpolation_yg() const	
{
...
AQLMathYieldCurvePro::getInterpolation_yg() 
{
...
*/
const AQLPriceDataInterpolation&
AQLMathYieldCurvePro::getInterpolation_fw() const	
{
...
*/
AQLPriceDataInterpolation&
AQLMathYieldCurvePro::getInterpolation_fw() 
{
...
*/
const AQLPriceDataInterpolation&
AQLMathYieldCurvePro::getInterpolation_bs() const	
{
...
*/
AQLPriceDataInterpolation&
AQLMathYieldCurvePro::getInterpolation_bs() 
{
...
AQLMathYieldCurvePro::getBasisFunction() const	
{
...
*/
const AQLDataReference&
AQLMathYieldCurvePro::getFXEntity() const	
{
...
*/
AQLDataReference&
AQLMathYieldCurvePro::getFXEntity() 
{
...
*/
const AQLDataString&
AQLMathYieldCurvePro::getOptimizeMethod() const	
{
...
*/
AQLDataString&
AQLMathYieldCurvePro::getOptimizeMethod() 
{
...
*/
const AQLPriceDataFunction&
AQLMathYieldCurvePro::getCompoundingFunction() const
{
...
*/
AQLPriceDataFunction&
AQLMathYieldCurvePro::getCompoundingFunction()
{
...
*/
void
AQLMathYieldCurvePro::setInterpolation(
...
*/
void
AQLMathYieldCurvePro::setInterpolation(const AQLString& name)
{
	dynamic_cast<AQLPriceDataInterpolation*>(&(
...
*/
void
AQLMathYieldCurvePro::setDFGenerator(const AQLCoreProcedure* a,
...
*/
void
AQLMathYieldCurvePro::setDFGenerator(const AQLString& name)
{
	dynamic_cast<AQLDataProcedure*>(&(
...
*/
AQLObject* 
AQLMathYieldCurvePro::clone() const
{
    try {
    	AQLMathYieldCurvePro*	pCurve = new AQLMathYieldCurvePro(*this);
    	return pCurve;
    }
    catch (bad_alloc & e){
...
void               
AQLMathYieldCurvePro::reset(void)
{
	...
	const AQLObject& e)
{
	...
	{
		AQLString err = "Assignement error for AQLMathYieldCurvePro : from ";
...
*/
AQLDataHolder&
AQLMathYieldCurvePro::add(const AQLString& name)
{
...
*/
AQLDataHolder&
AQLMathYieldCurvePro::reset(const AQLString& name)
{
	AQLDataInstance* dataInstance = getDataInstance();
	AQLPriceDataManager& dm = dataInstance->getDataMaster();
	const AQLDataHolder& dh = dm.getData(name);
...
void
AQLMathYieldCurvePro::calcDiscountFactor(const AQLDate& asof)
{
	try
	{
...
*/
void
AQLMathYieldCurvePro::setDFByShiftZero(double width, unsigned int pos, const UintArray& grids)
{
...
*/
void
AQLMathYieldCurvePro::setDFByShiftZero(double width, FloorType type, double floor)
{
	unsigned int i;
...
*/
void
AQLMathYieldCurvePro::setBasisDFByShiftZero(double width, unsigned int pos, const UintArray& grids)
{
...
*/
void
AQLMathYieldCurvePro::setBasisDFByShiftZero(double width, FloorType type, double floor)
{
	AQLObjectHolder &eh_y = getYieldData().get();
	const AQLDataDoubles& terms = dynamic_cast<const AQLDataDoubles&> (eh_y.getData(CALIBRATION_DATA_TERMS + mCurveSuffix, ISNOTNULL).get());
...
*/
void 
AQLMathYieldCurvePro::setBasisRates(const DoubleMatrix& values)
{	
...
*/
void
AQLMathYieldCurvePro::setBasisRates(const AQLString &curveType)
{
	AQLDataHolder *dh = 0;
	...
	// set roll convention
	AQLString roll_conv(AQLPriceYieldGenerator::deduceRollConvention(c_freq, eom));
	...
	if (isSimuEq)
	{
		...
		for (unsigned int i = 0; i < b_size; ++i)
		{
			...
			if (is2Swap)
			{
				...
				if (isAgtSpread)
				{
					const AQLString a_roll_conv = AQLPriceYieldGenerator::deduceRollConvention(a_c_freq, eom);
					DateVector a_dates;
				...
				const AQLString o_roll_conv = AQLPriceYieldGenerator::deduceRollConvention(*f_freq, f_eom);
				DateVector o_dates;
...
*/
void
AQLMathYieldCurvePro::calcFwdFXConstantCurve(void)
{
	AQLString curveType;
	for (std::map<AQLString, AQLString>::const_iterator it = mAssignedCurveMktMap.begin(); it != mAssignedCurveMktMap.end(); ++it)
	{
...
*/
void
AQLMathYieldCurvePro::calcFwdFXConstantCurve(const AQLString &curveType)
{
	// get yield data
...
*/
const AQLDataMultiReference&
AQLMathYieldCurvePro::getMarketDataRef(const AQLString& mktName) const
{
	AQLString suffix;
...
*/
void
AQLMathYieldCurvePro::saveBasisCurve(const AQLString& curveType, const DoubleArray& terms, const DoubleMatrix& termsmtx_fwd, const DoubleArray& dfs, std::vector<AQLObject*>& data)
{
	AQLObjectHolder &objHolder = getYieldData().get();
	for (std::map<AQLString, AQLString>::const_iterator it = mAssignedCurveMktMap.begin(); it != mAssignedCurveMktMap.end(); it++)
	{
...
*/
void
AQLMathYieldCurvePro::setCurveInterpolation(const AQLString& curveName, const AQLObject &yieldData, AQLPriceDataInterpolation& inter) const
{
...
*/
void
AQLMathYieldCurvePro::calcIndexGrid(const AQLDate &asofdate, const AQLDate &date, int resetLag, const AQLPriceDataDayCount &dc, 
...
*/
void
AQLMathYieldCurvePro::calcBasisCF(const AQLPriceDataInterpolation &s_inter, const bool isDiscount, const bool isFwdRen, const bool isUSD, const bool isFWDInter, const AQLPriceDataInterpolation &f_inter, const AQLPriceDataInterpolation *fwd_inter, 
...
*/
double		
AQLMathYieldCurvePro::calcAgainstPV(const bool isFWDInter, const AQLPriceDataInterpolation &f_inter, const AQLPriceDataInterpolation *fwd_inter, const AQLPriceDataInterpolation &d_inter, 
...
*/
double		
AQLMathYieldCurvePro::calcAgainstPV(const bool isFWDInter, const AQLPriceDataInterpolation &f_inter, const AQLPriceDataInterpolation *fwd_inter, const AQLPriceDataInterpolation &d_inter, const AQLPriceDataInterpolation &a_s_inter, const AQLPriceDataInterpolation *adjust_inter, 
...
*/	
double
AQLMathYieldCurvePro::calcTargetPV(const AQLPriceDataInterpolation &s_inter, const bool isFWDInter, const AQLPriceDataInterpolation &f_inter, const AQLPriceDataInterpolation *fwd_inter, 
...
*/
double	
AQLMathYieldCurvePro::calcTargetPV(const AQLPriceDataInterpolation &s_inter, const DoubleArray &dfsVec, const double spread, const IntArray& cpd_times,
...
*/
double
AQLMathYieldCurvePro::calcLegPV(const DoubleArray &fwdsVec, const DoubleMatrix &dfsMat, const DoubleArray &a_dfsVec, const AQLPriceDataInterpolation *adjust_inter,
...
*/
void
AQLMathYieldCurvePro::setBasisRates(void)
{
	mBCurveGenMap.clear();
	AQLDataHolder *dh = 0;
	// calc basis dfs
...
*/
void 
AQLMathYieldCurvePro::setDF2(void)
{
...
*/
void
AQLMathYieldCurvePro::setBasisRates_old(void)
{
...
*/
void
AQLMathYieldCurvePro::setBasisRates2(const AQLString& basisCurveID)
{
	vector<const AQLObject *> data_basis;
	// get market data
	const AQLDataMultiReference &mr = getMarketData();
...
*/
void
AQLMathYieldCurvePro::addBasisRates(void)
{	
	AQLObjectHolder objHolder = getYieldData().get();
	const AQLObject& YieldData = objHolder.get();
...
*/
void
AQLMathYieldCurvePro::setArbFreeCurveName(const AQLStringVector& curveNames_6ML, 
...
*/
AQLMathYieldCurvePro::CalibrationCostFunction::CalibrationCostFunction(AQLMathYieldCurvePro& outerObject,
...
*/
AQLMathYieldCurvePro::CalibrationCostFunction::CalibrationCostFunction(const CalibrationCostFunction& rhs)
: mParent(rhs.mParent), 
...
*/
AQLMathYieldCurvePro::CalibrationCostFunction::~CalibrationCostFunction()
{
}
...
*/
bool
AQLMathYieldCurvePro::CalibrationCostFunction::constraintsAreViolated(const DoubleArray& x)
{
	//no constraint
	return false;
}
...
/*!
    @brief default constructor for calibration cost function inner class
*/
AQLMathYieldCurvePro::CalibrationCostFunctionBasis::CalibrationCostFunctionBasis(AQLMathYieldCurvePro& outerObject,
                                                                              const DoubleArray grid_spread_time,
...
/*!
    @brief copy constructor for calibration cost function inner class
*/
AQLMathYieldCurvePro::CalibrationCostFunctionBasis::CalibrationCostFunctionBasis(const CalibrationCostFunctionBasis& rhs)
...
/*!
    @brief destructor for calibration cost function inner class
*/
AQLMathYieldCurvePro::CalibrationCostFunctionBasis::~CalibrationCostFunctionBasis()
{
}
...
void
AQLMathYieldCurvePro::CalibrationCostFunctionBasis::operator()(DoubleArray& f, const DoubleArray& x)
{
	DoubleArray x_;
	x_.push_back(0.0);
...
/*!
    @brief constructor
*/
AQLMathBasisFunction::AQLMathBasisFunction()
{
}
...
function_t
AQLMathBasisFunction::getType() const
{
...
*/
AQLCoreFunctionBase*
AQLMathBasisFunction::clone() const
{
    try 
	{
		return new AQLMathBasisFunction(*this);
    }
    catch (bad_alloc & e)
	{
        throw AQLCoreSystemError(e.what(), __FILE__, __LINE__);
...
*/
double
AQLMathBasisFunction::operator()(const DoubleArray& x) const
{
	if(x.size() == 1)
		return operator()(x[0]);
...
*/
double
AQLMathBasisFunction::operator()(const double& x) const
{
	double ret = 0.0;
...
/*!
    @brief constructor
*/
AQLMathBasisFunction2::AQLMathBasisFunction2()
{
}
...
*/
AQLCoreFunctionBase*
AQLMathBasisFunction2::clone() const
{
    try 
	{
		return new AQLMathBasisFunction2(*this);
    }
    catch (bad_alloc & e)
	{
        throw AQLCoreSystemError(e.what(), __FILE__, __LINE__);
...
*/
double
AQLMathBasisFunction2::operator()(const DoubleArray& x) const
{
	if(x.size() == 1)
		return operator()(x[0]);
	throw AQLCoreInvalidData("parameter size must be one", __FILE__, __LINE__);
...
*/
double
AQLMathBasisFunction2::operator()(const double& x) const
{
...
void
AQLMathYieldCurvePro::setdNPVdm(const AQLString &curveType)
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
const AQLDataDoubleMatrix&
AQLMathYieldCurvePro::getConversionMatrix(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
AQLMathYieldCurvePro::getConversionMatrixTerm(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
const AQLDataDoubles&	
AQLMathYieldCurvePro::getConversionMarketRates(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
const AQLDataInts&
AQLMathYieldCurvePro::getConversionOmitGrids(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
const AQLDataStrings&
AQLMathYieldCurvePro::getConversionMatrixTermTypes(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
const AQLDataStrings&
AQLMathYieldCurvePro::getConversionMarketTypes(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
bool 
AQLMathYieldCurvePro::isOmitGridsExist(const AQLString &curveType) const
{
	AQLString suffix = "";
	if (curveType != STD)
		suffix = "_" + curveType;
...
void
AQLMathYieldCurvePro::setCurveDependencyMap(void)
{
...
AQLMathYieldCurvePro::getCurveDependeny(const AQLString &curveType) const 
{
...
void
AQLMathYieldCurvePro::changeZeroRiskIntoMarketRisk(AQLString curveType, const DoubleVector& termZeroVals, const DoubleVector& riskZeroVals,
...
*/
const AQLDataBool&  
AQLMathYieldCurvePro::getIsSwapTenorAdjust(void) const
{
...
*/
AQLDataBool&  
AQLMathYieldCurvePro::getIsSwapTenorAdjust(void)
{
...
*/
const AQLDataReference&
AQLMathYieldCurvePro::getForeignYieldData() const
{
...
*/
AQLDataReference&
AQLMathYieldCurvePro::getForeignYieldData()
{
...
*/
const AQLDataReference&
AQLMathYieldCurvePro::getColYieldData() const
{
...
*/
AQLDataReference&
AQLMathYieldCurvePro::getColYieldData()
{
...
*/
void
AQLMathYieldCurvePro::setFloater(const AQLString& curveName)
{
...
*/
bool 
AQLMathYieldCurvePro::checkCurveAttr(const AQLString& mktName) const
{
	bool ret = true;
	const AQLDataHolder *dh;
...
*/
void 
AQLMathYieldCurvePro::removeAllCuveData(AQLObject &yieldData) const
{
	for (std::map<AQLString, AQLString>::const_iterator it = mAssignedCurveMktMap.begin(); it != mAssignedCurveMktMap.end(); it++)
	{
...
*/
void 
AQLMathYieldCurvePro::removeCuveData(AQLObject &yieldData, const AQLString& mktName) const
{
...
*/
void 
AQLMathYieldCurvePro::removeBasisCuveData(AQLObject &yieldData) const
{
...
*/
void 
AQLMathYieldCurvePro::getForwardConvention(const AQLString &curveName, AQLPriceDataDayCount &dc, AQLPriceDataSlidingRule &sld, AQLPriceDataCalendar &cal, AQLString &accessary) const
{
...
*/
void 
AQLMathYieldCurvePro::insertNonRemovableMarket(const AQLString& mktName)
{
	if (mNonRemovableMarket.end() == mNonRemovableMarket.find(mktName))
	{
...
*/
void 
AQLMathYieldCurvePro::eraseNonRemovableMarket(const AQLString& mktName)
{
	if (mNonRemovableMarket.end() != mNonRemovableMarket.find(mktName))
	{
...
*/
void
AQLMathYieldCurvePro::setCurveConvention(AQLObjectHolder& objHolder,
...
/*
	...
	@return annuity
*/
double AQLMathYieldCurvePro::calcAnnuity(double spotTerm, const DoubleArray& terms_grid, const DoubleArray& terms_interval, const AQLPriceDataInterpolation& d_inter)
{
	double annuity = 0.0;
...
/*
	...
	@return void
*/
void AQLMathYieldCurvePro::deducePaymentDatesAndTerms(const AQLDate& spotdate, const AQLString& strTerm, const AQLPriceDataSlidingRule& sld, const AQLPriceDataCalendar& cal,
	...
	DateVector& dates, DoubleArray& terms_grid, DoubleArray& terms_interval, IntArray& num_reset)
{
	...
	{
		AQLPriceYieldGenerator::getPaymentDates(spotdate, end, freq, cal, sld, dc, dates, terms_grid, terms_interval, eom, isBackward);
	...
	else
	{
		...
		AQLPriceYieldGenerator::getPaymentDates(spotdate, reset_dates[0], freq, cal, sld, dc, dates, terms_grid, terms_interval, eom, isBackward);
		...
		for (unsigned int i = 1; i < reset_dates.size(); ++i)
		{
			...
			AQLPriceYieldGenerator::getPaymentDates(spotdate, reset_dates[i - 1], reset_dates[i], freq, cal, sld, dc, index_payment_dates, index_payment_grids, index_accrual_term, eom, isBackward);
...
/*
	...
	@return void
*/
void AQLMathYieldCurvePro::deducePaymentDatesAndTermsThisSide(const AQLString& strTerm, const AQLString& roll_conv, bool eom, bool isSameGridIndex,
