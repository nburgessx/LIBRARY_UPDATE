...
*/
LALinearRegression::LALinearRegression(bool isExcludeOutlier_Y, double criteria_Y, bool isExcludeOutlier_X, double criteria_X, bool isExcludeOutlier_e, double criteria_e, double SVDTolerance)
...
/*!
	@brief destructor
*/
LALinearRegression::~LALinearRegression() 
{
