/*! @file
    @brief Source code for AQLMathBlackCmsOption.
*/
#include <AQLMathBlackCmsOption.h>
#include "AQLDist.h"
...
*/
AQLMathBalckCmsOption::AQLMathBalckCmsOption(double S0_,
								   double annuity0_,
...
*/
double AQLMathBalckCmsOption::Get_cms_option(double P, double K, int sgn)
{
...
/*!
    ...
    @return d value
*/
double AQLMathBalckCmsOption::d(double S, double K, double var, double lambda)
{
...
*/
AQLMathBalckCmsOptionApproxA::AQLMathBalckCmsOptionApproxA(double S0_,
												   double annuity0_,
												   double option_maturity_,
												   double T_fix_,
												   double T_pay_,
...
/*!
    ...
    @return delta value
*/
double AQLMathBalckCmsOptionApproxA::delta()
{
	return q * (t_p - T);
}
...
/*!
    ...
    @return G_D value
*/
double AQLMathBalckCmsOptionApproxA::G_D()
{
	double tmp = (q + S0) / q;
