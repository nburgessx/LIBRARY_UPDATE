...
*/
LAMathHybridHWLVProcessHelper::LAMathHybridHWLVProcessHelper(double T,
                                                         double fx0,
...
mNumInt(numInt)
{
    mIntInvE_d.SetFunc( *this, &LAMathHybridHWLVProcessHelper::calcInvE_d );
    mIntInvE_f.SetFunc( *this, &LAMathHybridHWLVProcessHelper::calcInvE_f );

	mIntLamSQ.SetFunc(*this, &LAMathHybridHWLVProcessHelper::calcLambdaSQ);
}
...
*/
LAMathHybridHWLVProcessHelper::LAMathHybridHWLVProcessHelper( const LAMathHybridHWLVProcessHelper& rhs )
:
mT(rhs.mT),
mFX0(rhs.mFX0),
mNumInt(rhs.mNumInt),
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcE_d(double t) const
{ 
    if(!mIsCacheE_d[t])
    {
	    //
...
/*!
	...
	@param[in] t
*/
inline double LAMathHybridHWLVProcessHelper::calcInvE_d(double t) const
{ 
    return 1. / calcE_d(t);
}
...
/*!
	...
	@param[in] T
*/
double LAMathHybridHWLVProcessHelper::calcVol_Pd(double t, double T) const
{ 
    if(T == 0)
    {
	    return 0.;
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcE_f(double t) const
{ 
	if(!mIsCacheE_f[t])
	{
		//
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcInvE_f(double t) const
{ 
	return 1. / calcE_f(t);
}
...
/*!
	...
	@param[in] T
*/
double LAMathHybridHWLVProcessHelper::calcVol_Pf(double t, double T) const
{ 
    if(T == 0)
    {
	    return 0.;
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcLambda(double t) const
{
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcLambdaSQ(double t) const
{
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWLVProcessHelper::calcIntLamSQ(double t) const
{
	if(t == 0)
	{
		return 0.;
...
/*!
	...
	@param[in] T
*/
void LAMathHybridHWLVProcessHelper::setT(double T) const
{
...
*/
void LAMathHybridHWLVProcessHelper::clearCache1() const
{
//    mCacheE_d.clear();
//    mIsCacheE_d.clear();
//    mCacheVol_Pd.clear();
...
*/
void LAMathHybridHWLVProcessHelper::clearCache2() const
{
}
...
*/
LAMathHybridHWDDProcessHelper::LAMathHybridHWDDProcessHelper(double T,
                                                         double fx0,
                                                         LAMathHullWhiteParams& hwParams_d,
                                                         LAMathHullWhiteParams& hwParams_f,
...
:
LAMathHybridHWLVProcessHelper(T, fx0, hwParams_d, hwParams_f, corParams, integralTimeSteps, numInt),
mpDDParams(&ddParams)
{
}
...
/*!
	...
	@param[in] rhs copy source 
*/
LAMathHybridHWDDProcessHelper::LAMathHybridHWDDProcessHelper( const LAMathHybridHWDDProcessHelper& rhs )
:
LAMathHybridHWLVProcessHelper(rhs),
...
/*!
	...
	@param[in] s
*/
double LAMathHybridHWDDMPProcessHelper::calcU1helper(double s) const
{
    //
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper::calcWeight(double t) const
{
    //
    size_t t_idx = searchIdx(t, mpDDParams->mT);
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper::calcU1(double t) const
{
    set_t(t);
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper::calcU2(double t) const
{
...
/*!
	...
	@param[in] t
*/
void LAMathHybridHWDDMPProcessHelper::set_t(double t) const
{
...
/*!
	...
	@param[in] x
*/
double LAMathHybridHWDDMPProcessHelper::calcGamma(double t, double x) const
{ 
...
*/
double LAMathHybridHWDDMPProcessHelper::calcSkew() const
{
...
*/
double LAMathHybridHWDDMPProcessHelper::calcSkewHelper(double t) const
{
    //size_t i = upper_bound(mpDDParams->mT.begin(), mpDDParams->mT.end(), t) - mpDDParams->mT.begin();
...
/*!
	...
	@param[in] te_
*/
double LAMathHybridHWDDMPProcessHelper::calcCDF(double ts_, double te_) const
{
    //
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper::calcCDFHelper(double t) const
{
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcC1(double t) const
{
    if(!mIsCacheC1[t])
    {
	    //
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcC1Helper(double t) const
{
    //
    size_t t_idx = searchIdx(t, mpCorParams->mT);
    double rho_df = mpCorParams->mRho[t_idx][0][1];
...
/*!
	...
	@param[in] s
*/
double LAMathHybridHWDDMPProcessHelper2::calcU3Helper(double s) const
{
    //
    double delta_vol_Pf = calcVol_Pf(s, mT) - calcVol_Pf(s, m_t);
    double delta_vol_Pd = calcVol_Pd(s, mT) - calcVol_Pd(s, m_t);
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcU3(double t) const
{
    set_t(t);
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcWeight(double t) const
{
    //
    size_t t_idx = searchIdx(t, mpDDParams->mT);
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcU2(double t) const
{
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcIntLamSQApproximated(double t) const
{
	if(t == 0)
	{
		return 0.;
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcLamSQApproximated(double t) const
{
...
/*!
	...
	@param[in] t
*/
double LAMathHybridHWDDMPProcessHelper2::calcLambdaApproximated(double t) const
{
    //size_t t_idx = upper_bound(mpCorParams->mT.begin(), mpCorParams->mT.end(), t) - mpCorParams->mT.begin();
    //if( t_idx != 0 && t_idx < mpCorParams->mT.size() ) t_idx = eq(t, mpCorParams->mT[t_idx], 1. / 367. ) ? t_idx : --t_idx;
    size_t t_idx  = searchIdx(t, mpCorParams->mT);
