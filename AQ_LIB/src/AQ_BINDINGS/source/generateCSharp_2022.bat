...
REM and places swig_CSharp_wrap.cxx in the src\AQ_BINDINGS\source folder
"%AQ_EXTERNAL_LIB_PATH%\library\swigwin-4.0.0\swig.exe" -v -c++ -outdir "%GENERATED_FILES%" -o "%AQ%\src\AQ_BINDINGS\source\swig_CSharp_wrap.cxx" -csharp "%AQ%\src\AQ_BINDINGS\source\swig_CSharp.i"
