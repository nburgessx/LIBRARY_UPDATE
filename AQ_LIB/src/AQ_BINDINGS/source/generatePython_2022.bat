...
REM This places the Client *.py files into the GeneratedFiles output folder,
REM and places swig_Python_wrap.cxx in the src\AQ_BINDINGS\source folder
"%AQ_EXTERNAL_LIB_PATH%\library\swigwin-4.0.0\swig.exe" -v -c++ -outdir "%GENERATED_FILES%" -o "%AQ%\src\AQ_BINDINGS\source\swig_Python_wrap.cxx" -python -py3 "%AQ%\src\AQ_BINDINGS\source\swig_Python.i"
